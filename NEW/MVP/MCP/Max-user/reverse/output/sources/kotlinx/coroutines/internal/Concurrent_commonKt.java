...
public final class Concurrent_commonKt {
    ...
    public static final <T> void loop(AtomicReference<T> atomicReference, sm6 sm6Var) {
        while (true) {
            sm6Var.invoke(atomicReference, getValue(atomicReference));
        }
    }
