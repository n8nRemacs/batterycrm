...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (iGlCreateProgram == 0) {
            throw new RuntimeException(ho7.f(GLES20.glGetError(), "glCreateProgram() failed. GLES20 error: "));
        }
    ...
    private static int compileShader(int i, String str) {
        ...
        if (iGlCreateShader == 0) {
            throw new RuntimeException(ho7.f(GLES20.glGetError(), "glCreateShader() failed. GLES20 error: "));
        }
    ...
    public int getAttribLocation(String str) {
        ...
        throw new RuntimeException(ho7.i("Could not locate '", str, "' in program"));
    }
    ...
    public int getUniformLocation(String str) {
        ...
        throw new RuntimeException(ho7.i("Could not locate uniform '", str, "' in program"));
    }
