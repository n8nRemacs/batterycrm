...
public class EglBase10Impl implements EglBase10 {
    ...
    public static class EglConnection implements EglBase10.EglConnection {
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            this.refCountDelegate = new RefCountDelegate(new qj4(16, this));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new mc(8));
        }
    }
    ...
    public static EGLContext createEglContext(EGL10 egl10, EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i) {
        ...
        throw new GLException(egl10.eglGetError(), wy1.h("Failed to create EGL context: 0x", Integer.toHexString(egl10.eglGetError())));
    }
    ...
    private void createSurfaceInternal(Object obj) {
        ...
        if (eGLSurfaceEglCreateWindowSurface == eGLSurface2) {
            throw new GLException(egl.eglGetError(), wy1.h("Failed to create window surface: 0x", Integer.toHexString(egl.eglGetError())));
        }
    }
    ...
    public static EGLConfig getEglConfig(EGL10 egl10, EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!egl10.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            throw new GLException(egl10.eglGetError(), wy1.h("eglChooseConfig failed: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (iArr2[0] <= 0) {
    ...
    public static EGLDisplay getEglDisplay(EGL10 egl10) {
        ...
        if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            throw new GLException(egl10.eglGetError(), wy1.h("Unable to get EGL10 display: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (egl10.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
            return eGLDisplayEglGetDisplay;
        }
        throw new GLException(egl10.eglGetError(), wy1.h("Unable to initialize EGL10: 0x", Integer.toHexString(egl10.eglGetError())));
    }
