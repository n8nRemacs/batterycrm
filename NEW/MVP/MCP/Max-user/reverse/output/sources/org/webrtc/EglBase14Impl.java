...
public class EglBase14Impl implements EglBase14 {
    ...
    public static class EglConnection implements EglBase14.EglConnection {
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            this.refCountDelegate = new RefCountDelegate(new qj4(17, this));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new mc(9));
        }
    }
    ...
    public static EGLContext createEglContext(EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i) {
        ...
        throw new GLException(EGL14.eglGetError(), wy1.h("Failed to create EGL context: 0x", Integer.toHexString(EGL14.eglGetError())));
    }
    ...
    private void createSurfaceInternal(Object obj) {
        ...
        if (eGLSurfaceEglCreateWindowSurface == EGL14.EGL_NO_SURFACE) {
            throw new GLException(EGL14.eglGetError(), wy1.h("Failed to create window surface: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
    }
    ...
    public static EGLConfig getEglConfig(EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!EGL14.eglChooseConfig(eGLDisplay, iArr, 0, eGLConfigArr, 0, 1, iArr2, 0)) {
            throw new GLException(EGL14.eglGetError(), wy1.h("eglChooseConfig failed: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
        if (iArr2[0] <= 0) {
    ...
    public static EGLDisplay getEglDisplay() {
        ...
        if (eGLDisplayEglGetDisplay == EGL14.EGL_NO_DISPLAY) {
            throw new GLException(EGL14.eglGetError(), wy1.h("Unable to get EGL14 display: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
        int[] iArr = new int[2];
        if (EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1)) {
            return eGLDisplayEglGetDisplay;
        }
        throw new GLException(EGL14.eglGetError(), wy1.h("Unable to initialize EGL14: 0x", Integer.toHexString(EGL14.eglGetError())));
    }
    ...
    public void createPbufferSurface(int i, int i2) {
        ...
        StringBuilder sbK = wy1.k("Failed to create pixel buffer surface with size ", i, "x", i2, ": 0x");
        sbK.append(hexString);
        throw new GLException(iEglGetError, sbK.toString());
    }
