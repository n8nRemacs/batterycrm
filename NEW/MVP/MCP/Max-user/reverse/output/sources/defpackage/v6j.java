...
public enum v6j implements ami {
    UNKNOWN_EVENT(0),
    ...
    CUSTOM_MODEL_RUN(HttpStatus.SC_PROCESSING),
    ...
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(HttpStatus.SC_SWITCHING_PROTOCOLS),
    ...
    AGGREGATED_CUSTOM_MODEL_INFERENCE(HttpStatus.SC_CREATED),
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(HttpStatus.SC_ACCEPTED),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION),
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(HttpStatus.SC_NO_CONTENT),
    ...
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(HttpStatus.SC_MOVED_PERMANENTLY),
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(HttpStatus.SC_MOVED_TEMPORARILY),
    INPUT_IMAGE_CONSTRUCTION(361),
    HANDLE_LEAKED(371),
    CAMERA_SOURCE(381),
    OPTIONAL_MODULE_IMAGE_LABELING(391),
    OPTIONAL_MODULE_LANGUAGE_ID(HttpStatus.SC_UNAUTHORIZED),
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(HttpStatus.SC_PAYMENT_REQUIRED),
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(HttpStatus.SC_FORBIDDEN),
    ...
    NLCLASSIFIER_CLIENT_LIBRARY_CREATE(HttpStatus.SC_UNPROCESSABLE_ENTITY),
    NLCLASSIFIER_CLIENT_LIBRARY_CLASSIFY(HttpStatus.SC_LOCKED),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(HttpStatus.SC_BAD_GATEWAY),
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(HttpStatus.SC_SERVICE_UNAVAILABLE),
