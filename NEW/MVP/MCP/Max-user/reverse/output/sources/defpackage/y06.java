...
public final class y06 extends ugc {
    public final w3b E0;
    ...
    public y06(Context context) {
        ...
        w3bVar.setId(hzc.profile_edit_first_name_field);
        ...
        w3bVar.setHint(w3bVar.getResources().getText(u8b.b0));
        ...
        this.E0 = w3bVar;
        this.F0 = ipi.b(3, new ns2(context, 10));
        linearLayout.setOrientation(1);
        linearLayout.setGravity(16);
        linearLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, -2));
        linearLayout.addView(w3bVar);
        tqi.c(new ld0(this, (Continuation) null, 14), linearLayout);
    }
