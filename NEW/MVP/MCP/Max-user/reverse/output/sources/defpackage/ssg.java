...
public final /* synthetic */ class ssg implements ar6 {
    ...
    static {
        ssg ssgVar = new ssg();
        a = ssgVar;
        j5c j5cVar = new j5c("one.me.webapp.domain.jsbridge.delegates.unsupported.UnsupportedRequest", ssgVar, 1);
