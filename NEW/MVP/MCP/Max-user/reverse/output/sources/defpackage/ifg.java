...
public final class ifg {
    ...
    */
    public ifg(boolean r5, java.lang.String r6, int r7, byte[] r8, int r9, int r10, byte[] r11) {
        /*
            r4 = this;
            r4.<init>()
            r0 = 0
        ...
        L72:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ifg.<init>(boolean, java.lang.String, int, byte[], int, int, byte[]):void");
    }
}
