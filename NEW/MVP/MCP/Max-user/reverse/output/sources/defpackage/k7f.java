...
public final class k7f implements TextWatcher, SpanWatcher {
    public final Object a;
    public final AtomicInteger b = new AtomicInteger(0);

    public k7f(Object obj) {
        this.a = obj;
    }
    ...
    public final void onSpanAdded(Spannable spannable, Object obj, int i, int i2) {
        if (this.b.get() <= 0 || !(obj instanceof apg)) {
    ...
    */
    public final void onSpanChanged(android.text.Spannable r9, java.lang.Object r10, int r11, int r12, int r13, int r14) {
        /*
            ...
            int r0 = r0.get()
            if (r0 <= 0) goto Ld
            boolean r0 = r10 instanceof defpackage.apg
            if (r0 == 0) goto Ld
            return
        Ld:
        ...
        L1e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.k7f.onSpanChanged(android.text.Spannable, java.lang.Object, int, int, int, int):void");
    }
