...
public abstract class d66 extends ViewGroup {
    public int a;
    public int b;
    public boolean c;
    public int d;
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < getChildCount(); i7++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(uxc.row_index_key, -1);
            } else {
                ...
                childAt.setTag(uxc.row_index_key, Integer.valueOf(this.d - 1));
    ...
    public final void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int i10 = i4;
                if (childAt.getMeasuredWidth() + paddingLeft + i5 > paddingRight && !((n83) this).c) {
