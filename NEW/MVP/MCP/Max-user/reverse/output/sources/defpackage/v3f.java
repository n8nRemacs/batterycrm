...
public final class v3f extends s19 implements t3f, pdh, qdh, ii9 {
    public final OneMeDraweeView A0;
    ...
    private final xq0 getBlurPostProcessor() {
        return (xq0) this.B0.getValue();
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, k18] */
    private final l1h getTransferStatusView() {
        return (l1h) this.E0.getValue();
    }

    /* JADX WARN: Type inference failed for: r4v5, types: [java.lang.Object, k18] */
    public static final void y(v3f v3fVar, xz xzVar) {
        s3f s3fVar = (s3f) v3fVar.getModel();
        if (fni.a(s3fVar != null ? Long.valueOf(s3fVar.a) : null, xzVar != null ? Long.valueOf(xzVar.a()) : null)) {
            ...
            fqi.b(v3fVar, v3fVar.getTransferStatusView(), new ViewGroup.LayoutParams(-2, -2));
            v3fVar.getTransferStatusView().setVisibility(0);
            l1h transferStatusView = v3fVar.getTransferStatusView();
            CharSequence charSequenceB = xzVar.b().b(v3fVar.getContext());
    ...
    public final int b(int i, int i2) {
        vs8 vs8Var = this.z0;
        boolean zO = vs8Var.o();
        OneMeDraweeView oneMeDraweeView = this.A0;
        int measuredHeight = zO ? ((oneMeDraweeView.getMeasuredHeight() - vs8Var.getMeasuredHeight()) / 2) + i2 : i2;
        int measuredWidth = (!this.C0 || vs8Var.o()) ? i : (getMeasuredWidth() - vs8Var.getMeasuredWidth()) / 2;
        if (this.C0) {
        ...
        if (r1.e()) {
            float f = 4;
            cri.c((l1h) r1.getValue(), u45.c(f, vw4.d().getDisplayMetrics().density, measuredWidth), u45.c(f, vw4.d().getDisplayMetrics().density, vs8Var.getTop()), 0, 12);
        }
        float f2 = 4;
        int iC = u45.c(f2, vw4.d().getDisplayMetrics().density, i);
        int measuredHeight2 = vs8Var.getMeasuredHeight() + i2;
        l1h l1hVar = this.D0;
        cri.c(l1hVar, iC, u45.q(f2, vw4.d().getDisplayMetrics().density, measuredHeight2 - l1hVar.getMeasuredHeight()), 0, 12);
        return this.C0 ? oneMeDraweeView.getMeasuredHeight() : vs8Var.getMeasuredHeight();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view != this.z0 && view != oneMeDraweeView && view != this.x0.U()) {
    ...
    public final boolean i(MotionEvent motionEvent) {
        return shh.c(this.z0, this).contains((int) motionEvent.getX(), (int) motionEvent.getY());
    }
    ...
    public final long v(int i, int i2, int i3, int i4) {
        ...
        return bhi.a(Math.max(this.C0 ? oneMeDraweeView.getMeasuredWidth() : vs8Var.getMeasuredWidth(), Math.max(dqi.m(r1), l1hVar.getMeasuredWidth() + getDate().getMeasuredWidth())), Math.max(this.C0 ? oneMeDraweeView.getMeasuredHeight() : vs8Var.getMeasuredHeight(), Math.max(getDate().getMeasuredHeight(), dqi.l(r1))));
    }
    ...
    public final void x(ws8 ws8Var) throws NumberFormatException {
        ...
        s0h s0hVar = s3fVar.c;
        this.z0.setImageAttach(new od7(0L, s0hVar.b, s0hVar.c, s0hVar.d, false, s0hVar.e, false, s0hVar.h, s0hVar.i, null, null, null, 7680));
