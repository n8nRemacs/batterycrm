...
public final class tp {
    ...
    public final int c(RectF rectF) {
        ...
        while (i3 <= i) {
            ...
            StaticLayout staticLayoutA = pp.a(charSequence, (Layout.Alignment) e(textView, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
