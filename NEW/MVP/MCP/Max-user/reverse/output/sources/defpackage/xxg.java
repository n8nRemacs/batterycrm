...
public abstract class xxg {
    ...
    static {
        ...
        d = str3;
        StringBuilder sb = new StringBuilder(u45.f(u45.f(u45.f(17, str), str3), str2));
        sb.append(str);
        sb.append(", ");
        sb.append(str3);
        sb.append(", ");
    ...
    public static String C(String str) throws MissingResourceException {
        ...
        if (str4 != null) {
            ...
            strG = strValueOf.length() != 0 ? str4.concat(strValueOf) : new String(str4);
            str2 = str4;
        }
        ...
        while (true) {
            ...
            if (strG.startsWith(strArr2[i2])) {
                ...
                String strValueOf3 = String.valueOf(strG.substring(strArr2[i2].length()));
    ...
    public static Object[] D(int i2, Object[] objArr) {
        fsi.b(i2 <= objArr.length);
        return Arrays.copyOf(objArr, i2);
    }

    public static long E(String str) throws ParserException {
    ...
    public static void G(List list, int i2, int i3) {
    ...
    public static void I(long j2, long[] jArr) {
        int i2 = 0;
    ...
    public static String x(String str) throws ClassNotFoundException {
        try {
            ...
            pai.c("Util", str.length() != 0 ? "Failed to read system property ".concat(str) : new String("Failed to read system property "), e2);
            return null;
        }
    }

    public static boolean y(qyg qygVar, qyg qygVar2, Inflater inflater) {
        if (qygVar.c() <= 0) {
            return false;
        }
        if (qygVar2.a.length < qygVar.c()) {
            qygVar2.d(qygVar.c() * 2);
        }
        if (inflater == null) {
            inflater = new Inflater();
        }
        inflater.setInput(qygVar.a, qygVar.b, qygVar.c());
        int iInflate = 0;
        while (true) {
            try {
                byte[] bArr = qygVar2.a;
