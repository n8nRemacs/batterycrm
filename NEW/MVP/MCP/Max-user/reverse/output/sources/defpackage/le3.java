...
public final class le3 extends ea9 implements id3 {
    public final zd3 D0;
    ...
    public final void e(MotionEvent motionEvent, int[] iArr) {
        this.D0.g(kti.d(motionEvent.getX()), kti.d(motionEvent.getY()), iArr);
    }
    ...
    public final void invalidateDrawable(Drawable drawable) {
        ...
        if (handler != null) {
            handler.postAtFrontOfQueue(new he3(this, drawable, 0));
        } else {
            post(new ie3(this, drawable, 0));
        }
    }

    @Override // defpackage.ii9
    public final jd3 o(MotionEvent motionEvent) {
        return this.D0.b(kti.d(motionEvent.getX()), kti.d(motionEvent.getY()));
    }
    ...
    public final void scheduleDrawable(Drawable drawable, Runnable runnable, long j) {
        ...
        Handler handler = getHandler();
        if (handler != null) {
            handler.postAtFrontOfQueue(new je3(this, drawable, runnable, j, 0));
        } else {
            post(new je3(this, drawable, runnable, j, 1));
        }
    }
    ...
    public final void unscheduleDrawable(Drawable drawable, Runnable runnable) {
        ...
        Handler handler = getHandler();
        if (handler != null) {
            handler.postAtFrontOfQueue(new ke3(this, drawable, runnable, 0));
        } else {
            post(new ke3(this, drawable, runnable, 1));
        }
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        return this.D0.l(drawable) || super.verifyDrawable(drawable);
    }
    ...
    public final void unscheduleDrawable(Drawable drawable) {
        ...
        Handler handler = getHandler();
        if (handler != null) {
            handler.postAtFrontOfQueue(new he3(this, drawable, 1));
        } else {
            post(new ie3(this, drawable, 1));
        }
    }
}
