...
public final class uk4 implements h34 {
    public static final uk4 c = new uk4(Collections.EMPTY_MAP);
    public int a;
    public final Map b;
    ...
    public final uk4 b(j34 j34Var) {
        byte[] bytes;
        Map map = this.b;
        HashMap map2 = new HashMap(map);
        List listUnmodifiableList = Collections.unmodifiableList(new ArrayList(j34Var.b));
        for (int i = 0; i < listUnmodifiableList.size(); i++) {
            map2.remove(listUnmodifiableList.get(i));
        }
        HashMap map3 = new HashMap(j34Var.a);
        ...
        for (Map.Entry entry2 : Collections.unmodifiableMap(map3).entrySet()) {
            ...
            if (value2 instanceof Long) {
                ...
                bytes = ((String) value2).getBytes(mb2.c);
            } else {
        ...
        return c(map, map2) ? this : new uk4(map2);
    }
