...
public final class rda {
    ...
    public rda(ViewGroup viewGroup) {
        this.c = viewGroup;
    }
    ...
    public final boolean a(float f, float f2, boolean z) {
        ...
        if (this.d && (viewParentE = e(0)) != null) {
            try {
                return bhh.a(viewParentE, this.c, f, f2, z);
    ...
    public final boolean b(float f, float f2) {
        ...
        if (this.d && (viewParentE = e(0)) != null) {
            try {
                return bhh.b(viewParentE, this.c, f, f2);
            } catch (AbstractMethodError e) {
    ...
    public final boolean c(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        if (viewParentE instanceof sda) {
            ((sda) viewParentE).n(viewGroup, i, i2, iArr3, i3);
        } else if (i3 == 0) {
            try {
                bhh.c(viewParentE, viewGroup, i, i2, iArr3);
            } catch (AbstractMethodError e) {
    ...
    public final boolean d(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (this.d && (viewParentE = e(i5)) != null) {
            if (i != 0 || i2 != 0 || i3 != 0 || i4 != 0) {
                ...
                if (viewParentE instanceof tda) {
                    ((tda) viewParentE).h(viewGroup, i, i2, i3, i4, i5, iArr3);
                } else {
                    iArr3[0] = iArr3[0] + i3;
                    iArr3[1] = iArr3[1] + i4;
                    if (viewParentE instanceof sda) {
                        ((sda) viewParentE).i(viewGroup, i, i2, i3, i4, i5);
                    } else if (i5 == 0) {
                        try {
                            bhh.d(viewParentE, viewGroup, i, i2, i3, i4);
                        } catch (AbstractMethodError e) {
        ...
        if (!f(i2)) {
            if (this.d) {
                ...
                for (ViewParent parent = viewGroup.getParent(); parent != null; parent = parent.getParent()) {
                    boolean z = parent instanceof sda;
                    if (z) {
                        zF = ((sda) parent).j(view, viewGroup, i, i2);
                    } else if (i2 == 0) {
                        try {
                            zF = bhh.f(parent, view, viewGroup, i);
                        } catch (AbstractMethodError e) {
                    ...
                    if (zF) {
                        ...
                        if (z) {
                            ((sda) parent).l(view, viewGroup, i, i2);
                        } else if (i2 == 0) {
                            try {
                                bhh.e(parent, view, viewGroup, i);
    ...
    public final void h(int i) {
        ...
        if (viewParentE != null) {
            boolean z = viewParentE instanceof sda;
            ViewGroup viewGroup = this.c;
            if (z) {
                ((sda) viewParentE).m(viewGroup, i);
            } else if (i == 0) {
                try {
                    bhh.g(viewParentE, viewGroup);
                } catch (AbstractMethodError e) {
