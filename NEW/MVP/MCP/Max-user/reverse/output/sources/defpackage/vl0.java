...
public final class vl0 extends wyi {
    public final ejg a;

    public vl0(ejg ejgVar) {
        this.a = ejgVar;
    }
    ...
    public final List a(String str, List list) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, NoSuchProviderException, SSLPeerUnverifiedException {
        ...
        boolean z = false;
        for (int i = 0; i < 9; i++) {
            Object objD = wy1.d(arrayList, 1);
            if (objD == null) {
                throw new NullPointerException("null cannot be cast to non-null type java.security.cert.X509Certificate");
            }
            X509Certificate x509Certificate = (X509Certificate) objD;
            ...
            if (x509CertificateA == null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (fni.a(x509Certificate.getIssuerDN(), x509Certificate2.getSubjectDN())) {
                        try {
            ...
            if (fni.a(x509CertificateA.getIssuerDN(), x509CertificateA.getSubjectDN())) {
                try {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof vl0) && fni.a(((vl0) obj).a, this.a);
    }
