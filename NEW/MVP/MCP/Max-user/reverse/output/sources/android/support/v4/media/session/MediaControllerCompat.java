...
public final class MediaControllerCompat {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    ...
                    mediaControllerImplApi21.mSessionToken.setSession2Token(rmb.d(bundle));
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        public void setRepeatMode(int i) {
            sendCustomAction(MediaSessionCompat.ACTION_SET_REPEAT_MODE, ho7.e(i, MediaSessionCompat.ACTION_ARGUMENT_REPEAT_MODE));
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void setShuffleMode(int i) {
            sendCustomAction(MediaSessionCompat.ACTION_SET_SHUFFLE_MODE, ho7.e(i, MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE));
        }
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(x0d.media_controller_compat_view_tag);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(x0d.media_controller_compat_view_tag, mediaControllerCompat);
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(int i, int i2, int i3, int i4, int i5) {
            ...
            this(i, new AudioAttributesCompat(new AudioAttributesImplApi26(builder.build(), 0)), i3, i4, i5);
        }
