...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static {
        ...
        usVar.put(METADATA_KEY_TITLE, 1);
        usVar.put(METADATA_KEY_ARTIST, 1);
        usVar.put(METADATA_KEY_DURATION, 0);
        usVar.put(METADATA_KEY_ALBUM, 1);
        usVar.put(METADATA_KEY_AUTHOR, 1);
        usVar.put(METADATA_KEY_WRITER, 1);
        usVar.put(METADATA_KEY_COMPOSER, 1);
        usVar.put(METADATA_KEY_COMPILATION, 1);
        usVar.put(METADATA_KEY_DATE, 1);
        usVar.put(METADATA_KEY_YEAR, 0);
        usVar.put(METADATA_KEY_GENRE, 1);
        usVar.put(METADATA_KEY_TRACK_NUMBER, 0);
        usVar.put(METADATA_KEY_NUM_TRACKS, 0);
        usVar.put(METADATA_KEY_DISC_NUMBER, 0);
        usVar.put(METADATA_KEY_ALBUM_ARTIST, 1);
        usVar.put(METADATA_KEY_ART, 2);
        usVar.put(METADATA_KEY_ART_URI, 1);
        usVar.put(METADATA_KEY_ALBUM_ART, 2);
        usVar.put(METADATA_KEY_ALBUM_ART_URI, 1);
        usVar.put(METADATA_KEY_USER_RATING, 3);
        usVar.put(METADATA_KEY_RATING, 3);
        usVar.put(METADATA_KEY_DISPLAY_TITLE, 1);
        usVar.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        usVar.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        usVar.put(METADATA_KEY_DISPLAY_ICON, 2);
        usVar.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        usVar.put(METADATA_KEY_MEDIA_ID, 1);
        usVar.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        usVar.put(METADATA_KEY_MEDIA_URI, 1);
        usVar.put(METADATA_KEY_ADVERTISEMENT, 0);
