...
final class LZ4HCJavaSafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:70:0x0210, code lost:
        ...
        r0 = r23;
        r1 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r0, r16, r14.start, r14.ref, r14.len, r26, r17, r7);
        r2 = r14.end();
     */
    ...
    */
    ...
    public class HashTable {
        ...
        private int hashPointer(byte[] bArr, int i) {
            return hashPointer(ywd.d(i, bArr));
        }
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, LZ4Utils.Match match) {
            ...
            if (iCommonBytes != 0) {
                ...
                do {
                    this.chainTable[i & MASK] = (short) i3;
                    this.hashTable[LZ4Utils.hashHC(ywd.d(i, bArr))] = i;
                    i++;
                } while (i < i5);
