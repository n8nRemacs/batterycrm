...
public class AlertDialogLayout extends w48 {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == zxc.topPanel) {
                    view = childAt;
                } else if (id == zxc.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != zxc.contentPanel && id != zxc.customPanel) || view3 != null) {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    v48 v48Var = (v48) childAt3.getLayoutParams();
                    if (((LinearLayout.LayoutParams) v48Var).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) v48Var).height;
                        ((LinearLayout.LayoutParams) v48Var).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) v48Var).height = i9;
                    }
                }
                i8++;
