...
public class DialogTitle extends AppCompatTextView {
    ...
    public final void onMeasure(int i, int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        setSingleLine(false);
        setMaxLines(2);
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, o6d.TextAppearance, R.attr.textAppearanceMedium, R.style.TextAppearance.Medium);
