...
public final class d {
    ...
    public d(@l List<String> list, @k String str, @l List<h> list2, @l String str2, @k String str3, @l String str4) {
        this.badges = list;
        this.name = str;
        this.notes = list2;
        this.phone = str2;
