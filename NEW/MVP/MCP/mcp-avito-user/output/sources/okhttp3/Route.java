...
public final class Route {
    ...
    public Route(@k Address address, @k Proxy proxy, @k InetSocketAddress inetSocketAddress) {
    ...
    public boolean equals(@l Object other) {
        if (other instanceof Route) {
            ...
            if (L.f(route.address, this.address) && L.f(route.proxy, this.proxy) && L.f(route.socketAddress, this.socketAddress)) {
                return true;
            }
        }
        return false;
