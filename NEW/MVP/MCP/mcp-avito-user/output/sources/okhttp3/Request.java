...
public final class Request {
    ...
    public static class Builder {
        ...
        public static /* synthetic */ Builder delete$default(Builder builder, RequestBody requestBody, int i12, Object obj) {
            if (obj != null) {
        ...
        @k
        public Builder method(@k String method, @l RequestBody body) {
            if (method.length() <= 0) {
                throw new IllegalArgumentException("method.isEmpty() == true");
            }
            if (body == null) {
                if (HttpMethod.requiresRequestBody(method)) {
                    throw new IllegalArgumentException(c.k("method ", method, " must have a request body.").toString());
                }
            } else if (!HttpMethod.permitsRequestBody(method)) {
                throw new IllegalArgumentException(c.k("method ", method, " must not have a request body.").toString());
            }
            this.method = method;
            this.body = body;
            return this;
        ...
        @k
        public Builder tag(@l Object tag) {
        ...
        @k
        public <T> Builder tag(@k Class<? super T> type, @l T tag) {
            if (tag == null) {
        ...
        public Builder url(@k String url) {
            if (C43066x.h0(url, "ws:", true)) {
                url = "http:".concat(url.substring(3));
            } else if (C43066x.h0(url, "wss:", true)) {
    ...
    public Request(@k HttpUrl httpUrl, @k String str, @k Headers headers, @l RequestBody requestBody, @k Map<Class<?>, ? extends Object> map) {
        this.url = httpUrl;
        this.method = str;
    ...
    public String toString() {
        ...
        if (this.headers.size() != 0) {
            sb2.append(", headers=[");
            int i12 = 0;
            for (Q<? extends String, ? extends String> q12 : this.headers) {
                int i13 = i12 + 1;
                if (i12 < 0) {
                    C42745f0.H0();
                    throw null;
