...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String javaName) {
            return C43066x.h0(javaName, "TLS_", false) ? "SSL_".concat(javaName.substring(4)) : C43066x.h0(javaName, "SSL_", false) ? "TLS_".concat(javaName.substring(4)) : javaName;
        }
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@k String a12, @k String b12) {
                int iMin = Math.min(a12.length(), b12.length());
                for (int i12 = 4; i12 < iMin; i12++) {
                    char cCharAt = a12.charAt(i12);
                    char cCharAt2 = b12.charAt(i12);
                    if (cCharAt != cCharAt2) {
                        return L.g(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public /* synthetic */ CipherSuite(String str, C42822w c42822w) {
        this(str);
    }
