...
public interface Dns {
    ...
    public static final class Companion {
        ...
        public static final class DnsSystem implements Dns {
            ...
            @k
            public List<InetAddress> lookup(@k String hostname) throws UnknownHostException {
                try {
                    return C42756l.g0(InetAddress.getAllByName(hostname));
    ...
    @k
    List<InetAddress> lookup(@k String hostname);
}
