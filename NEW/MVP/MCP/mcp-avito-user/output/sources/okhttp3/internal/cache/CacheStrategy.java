...
public final class CacheStrategy {
    ...
    public static final class Companion {
        ...
        */
        public final boolean isCacheable(@Y61.k okhttp3.Response r5, @Y61.k okhttp3.Request r6) {
            /*
                r4 = this;
                int r0 = r5.code()
    ...
    public static final class Factory {
        ...
        public Factory(long j12, @k Request request, @l Response response) {
            this.nowMillis = j12;
        ...
        private final CacheStrategy computeCandidate() {
            ...
            if (!cacheControl2.noCache()) {
                long j12 = millis2 + jCacheResponseAge;
                if (j12 < millis + jComputeFreshnessLifetime) {
                    Response.Builder builderNewBuilder = this.cacheResponse.newBuilder();
                    if (j12 >= jComputeFreshnessLifetime) {
