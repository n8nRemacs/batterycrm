...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(@k RealCall realCall, @k List<? extends Interceptor> list, int i12, @l Exchange exchange, @k Request request, int i13, int i14, int i15) {
        this.call = realCall;
        this.interceptors = list;
        this.index = i12;
        this.exchange = exchange;
        this.request = request;
        this.connectTimeoutMillis = i13;
        this.readTimeoutMillis = i14;
        this.writeTimeoutMillis = i15;
    }

    public static /* synthetic */ RealInterceptorChain copy$okhttp$default(RealInterceptorChain realInterceptorChain, int i12, Exchange exchange, Request request, int i13, int i14, int i15, int i16, Object obj) {
        if ((i16 & 1) != 0) {
            i12 = realInterceptorChain.index;
        }
        if ((i16 & 2) != 0) {
        ...
        if ((i16 & 8) != 0) {
            i13 = realInterceptorChain.connectTimeoutMillis;
        }
        int i17 = i13;
        if ((i16 & 16) != 0) {
            i14 = realInterceptorChain.readTimeoutMillis;
        }
        int i18 = i14;
        if ((i16 & 32) != 0) {
            i15 = realInterceptorChain.writeTimeoutMillis;
        }
        return realInterceptorChain.copy$okhttp(i12, exchange2, request2, i17, i18, i15);
    }
    ...
    @Override // okhttp3.Interceptor.Chain
    @k
    public Response proceed(@k Request request) {
