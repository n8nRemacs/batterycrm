...
public final class StatusLine {
    ...
    public static final class Companion {
        ...
        @k
        public final StatusLine parse(@k String statusLine) throws ProtocolException, NumberFormatException {
            Protocol protocol;
            int i12;
            String strSubstring;
            if (C43066x.h0(statusLine, "HTTP/1.", false)) {
                i12 = 9;
                ...
                if (!C43066x.h0(statusLine, "ICY ", false)) {
                    throw new ProtocolException("Unexpected status line: ".concat(statusLine));
                }
                protocol = Protocol.HTTP_1_0;
                i12 = 4;
            ...
            try {
                int i14 = Integer.parseInt(statusLine.substring(i12, i13));
                if (statusLine.length() <= i13) {
                    strSubstring = "";
                } else {
                    ...
                    strSubstring = statusLine.substring(i12 + 4);
                }
                return new StatusLine(protocol, i14, strSubstring);
    ...
    public StatusLine(@k Protocol protocol, int i12, @k String str) {
