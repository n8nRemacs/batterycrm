...
public final class CloseGuard {
    ...
    @l
    public final Object createAndOpen(@k String closer) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Method method = this.getMethod;
        if (method != null) {
            try {
                Object objInvoke = method.invoke(null, new Object[0]);
                this.openMethod.invoke(objInvoke, closer);
                return objInvoke;
            } catch (Exception unused) {
            }
        }
    ...
    public final boolean warnIfOpen(@l Object closeGuardInstance) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
