...
public final class CertificateAdapters$extensionValue$1 extends N implements l<Object, DerAdapter<?>> {
    public static final CertificateAdapters$extensionValue$1 INSTANCE = new CertificateAdapters$extensionValue$1();

    public CertificateAdapters$extensionValue$1() {
        super(1);
    }
    ...
    public final DerAdapter<?> invoke(@Y61.l Object obj) {
        if (L.f(obj, ObjectIdentifiers.subjectAlternativeName)) {
            return CertificateAdapters.subjectAlternativeName;
        }
        if (L.f(obj, ObjectIdentifiers.basicConstraints)) {
