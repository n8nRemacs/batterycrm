...
/* compiled from: PerhapsOnErrorResumeWith.java */
/* loaded from: classes8.dex */
final class T0<T> extends AbstractC41069k0<T> {
    ...
    public static final class a<T> extends o41.f<T> implements org.reactivestreams.d<T> {
        ...
        public final a<T>.C11294a f397625d;

        /* renamed from: e, reason: collision with root package name */
        public org.reactivestreams.e f397626e;

        /* compiled from: PerhapsOnErrorResumeWith.java */
        /* renamed from: hu.akarnokd.rxjava3.basetypes.T0$a$a, reason: collision with other inner class name */
        public final class C11294a extends AtomicReference<org.reactivestreams.e> implements org.reactivestreams.d<T> {
        ...
        public a(org.reactivestreams.d dVar) {
            super(dVar);
            this.f397625d = new C11294a();
        }

        @Override // org.reactivestreams.d
        public final void K(org.reactivestreams.e eVar) {
            if (SubscriptionHelper.i(this.f397626e, eVar)) {
                this.f397626e = eVar;
        ...
        public final void cancel() {
            super.cancel();
            this.f397626e.cancel();
            SubscriptionHelper.a(this.f397625d);
        }
