...
/* compiled from: SoloFlatMap.java */
/* loaded from: classes8.dex */
final class A1<T, R> extends AbstractC41073l1<R> {
    ...
    public static final class a<T, R> extends o41.f<R> implements org.reactivestreams.d<T> {
        ...
        public static final /* synthetic */ int f397540f = 0;
        private static final long serialVersionUID = -7631998337002592538L;

        /* renamed from: d, reason: collision with root package name */
        public final a<T, R>.C11283a f397541d;

        /* renamed from: e, reason: collision with root package name */
        public org.reactivestreams.e f397542e;

        /* compiled from: SoloFlatMap.java */
        /* renamed from: hu.akarnokd.rxjava3.basetypes.A1$a$a, reason: collision with other inner class name */
        public final class C11283a extends AtomicReference<org.reactivestreams.e> implements org.reactivestreams.d<R> {
        ...
        public a(org.reactivestreams.d dVar) {
            super(dVar);
            this.f397541d = new C11283a();
        }

        @Override // org.reactivestreams.d
        public final void K(org.reactivestreams.e eVar) {
            if (SubscriptionHelper.i(this.f397542e, eVar)) {
                this.f397542e = eVar;
        ...
        public final void cancel() {
            super.cancel();
            this.f397542e.cancel();
            SubscriptionHelper.a(this.f397541d);
        }
