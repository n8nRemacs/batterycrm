...
/* compiled from: PerhapsOnErrorReturnItem.java */
/* loaded from: classes8.dex */
final class U0<T> extends AbstractC41069k0<T> {
    ...
    public static final class a<T> extends o41.f<T> implements org.reactivestreams.d<T> {
        ...
        public org.reactivestreams.e f397630d;

        @Override // org.reactivestreams.d
        public final void K(org.reactivestreams.e eVar) {
            if (SubscriptionHelper.i(this.f397630d, eVar)) {
                this.f397630d = eVar;
