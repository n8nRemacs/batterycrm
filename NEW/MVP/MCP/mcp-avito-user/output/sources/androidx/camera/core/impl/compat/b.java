...
class b {
    ...
    public static S a(@N EncoderProfiles encoderProfiles) {
        ...
        for (EncoderProfiles.VideoProfile videoProfile : videoProfiles) {
            arrayList2.add(S.c.a(videoProfile.getCodec(), videoProfile.getMediaType(), videoProfile.getBitrate(), videoProfile.getFrameRate(), videoProfile.getWidth(), videoProfile.getHeight(), videoProfile.getProfile(), 8, 0, 0));
        }
