...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0010\u0018\u00002\u00020\u00012\u00020\u00022\b\u0012\u0004\u0012\u00020\u00040\u0003:\u0001\u0005¨\u0006\u0006"}, d2 = {"Landroidx/compose/runtime/e3;", "Landroidx/compose/runtime/snapshots/W;", "Landroidx/compose/runtime/w1;", "Landroidx/compose/runtime/snapshots/C;", "", "a", "runtime_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* renamed from: androidx.compose.runtime.e3, reason: case insensitive filesystem */
/* loaded from: classes.dex */
public class C22061e3 extends androidx.compose.runtime.snapshots.W implements InterfaceC22196w1, androidx.compose.runtime.snapshots.C<Integer> {
    ...
    /* compiled from: SnapshotIntState.kt */
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Landroidx/compose/runtime/e3$a;", "Landroidx/compose/runtime/snapshots/X;", "runtime_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    public static final class a extends androidx.compose.runtime.snapshots.X {
        ...
        public final androidx.compose.runtime.snapshots.X c(long j12) {
            return new a(j12, this.f38288c);
        }
    }

    @Override // androidx.compose.runtime.InterfaceC22196w1
    public final void L3(int i12) {
        AbstractC22167l abstractC22167lJ;
        a aVar = (a) C22176v.h(this.f38287c);
        if (aVar.f38288c != i12) {
            a aVar2 = this.f38287c;
            synchronized (C22176v.f38750c) {
                AbstractC22167l.f38720e.getClass();
                abstractC22167lJ = C22176v.j();
                ((a) C22176v.n(aVar2, this, abstractC22167lJ, aVar)).f38288c = i12;
    ...
    public final androidx.compose.runtime.snapshots.X a(@Y61.k androidx.compose.runtime.snapshots.X x12, @Y61.k androidx.compose.runtime.snapshots.X x13, @Y61.k androidx.compose.runtime.snapshots.X x14) {
        if (((a) x13).f38288c == ((a) x14).f38288c) {
            return x13;
        }
        return null;
    }
    ...
    @Override // androidx.compose.runtime.InterfaceC22196w1, androidx.compose.runtime.J0
    public final int e() {
        return ((a) C22176v.s(this.f38287c, this)).f38288c;
    }

    @Override // androidx.compose.runtime.snapshots.C
    @Y61.k
    public final InterfaceC22116k3<Integer> h() {
        return L3.f38023a;
    }
    ...
    public final String toString() {
        return "MutableIntState(value=" + ((a) C22176v.h(this.f38287c)).f38288c + ")@" + hashCode();
    }
}
