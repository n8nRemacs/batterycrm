...
final class I extends SuspendLambda implements Y41.p<kotlinx.coroutines.T, Continuation<? super G0>, Object> {
    ...
    public final /* synthetic */ m0 f29817r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public I(m0 m0Var, Continuation<? super I> continuation) {
    ...
    public final Continuation<G0> create(Object obj, Continuation<?> continuation) {
        return new I(this.f29817r, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i12 = this.f29816q;
        if (i12 == 0) {
            C42729a0.b(obj);
            this.f29816q = 1;
            float f12 = p0.f30020a;
            m0 m0Var = this.f29817r;
            if (m0Var.j() + 1 >= m0Var.m() || (objF = m0Var.f(m0Var.j() + 1, C20310q.d(0.0f, 7, null), this)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                objF = G0.f406611a;
            }
