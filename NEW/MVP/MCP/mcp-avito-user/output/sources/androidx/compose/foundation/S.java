...
final class S extends SuspendLambda implements Y41.p<kotlinx.coroutines.T, Continuation<? super kotlin.G0>, Object> {
    ...
    public final /* synthetic */ Y f26837r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public S(Y y12, Continuation<? super S> continuation) {
    ...
    public final Continuation<kotlin.G0> create(Object obj, Continuation<?> continuation) {
        return new S(this.f26837r, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i12 == 0) {
            C42729a0.b(obj);
            this.f26836q = 1;
            if (((C20411b0) this.f26837r).a(MutatePriority.f26797b, this) == coroutine_suspended) {
