...
final class Ub extends kotlin.jvm.internal.N implements Y41.l<androidx.compose.ui.graphics.drawscope.d, kotlin.G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ float f33263l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ C20805p0 f33264m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Ub(float f12, C20805p0 c20805p0) {
        super(1);
        this.f33263l = f12;
        this.f33264m = c20805p0;
    }
    ...
    public final kotlin.G0 invoke(androidx.compose.ui.graphics.drawscope.d dVar) {
        ...
        float f12 = this.f33263l;
        if (!androidx.compose.ui.unit.h.b(f12, 0.0f)) {
            float f40389c = dVar2.getF40389c() * f12;
            float fC2 = l0.n.c(dVar2.i()) - (f40389c / 2);
            androidx.compose.ui.graphics.drawscope.g.z1(dVar2, this.f33264m.f29790b, l0.h.a(0.0f, fC2), l0.h.a(l0.n.e(dVar2.i()), fC2), f40389c, 0.0f, 496);
        }
