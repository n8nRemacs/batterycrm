...
public final class o implements InterfaceC22365i0 {
    ...
    public static final class b extends N implements Y41.l<K0.a, G0> {
        ...
        /* renamed from: l, reason: collision with root package name */
        public final /* synthetic */ K0 f33685l;
    ...
    public static final class c extends N implements Y41.l<K0.a, G0> {
        ...
        /* renamed from: l, reason: collision with root package name */
        public final /* synthetic */ ArrayList f33686l;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(ArrayList arrayList) {
            super(1);
            this.f33686l = arrayList;
        }

        @Override // Y41.l
        public final G0 invoke(K0.a aVar) {
            K0.a aVar2 = aVar;
            ArrayList arrayList = this.f33686l;
    ...
    public final InterfaceC22367j0 b(InterfaceC22369k0 interfaceC22369k0, List<? extends InterfaceC22363h0> list, long j12) {
        ...
        int i12 = 0;
        if (size == 0) {
            return interfaceC22369k0.L0(0, 0, P0.c(), a.f33684l);
        }
        if (size == 1) {
