...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Landroidx/compose/foundation/U1;", "Landroidx/compose/foundation/Y1;", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
@j.X
...
final class U1 extends Y1 {
    ...
    public final androidx.compose.runtime.collection.e<Rect> k2() {
        ...
        eVar.d(eVar.f38262d, C22423m.a(this).getPreferKeepClearRects());
        return eVar;
    }

    @Override // androidx.compose.foundation.Y1
    public final void l2(@Y61.k androidx.compose.runtime.collection.e<Rect> eVar) {
        C22423m.a(this).setPreferKeepClearRects(eVar.f());
    }
}
