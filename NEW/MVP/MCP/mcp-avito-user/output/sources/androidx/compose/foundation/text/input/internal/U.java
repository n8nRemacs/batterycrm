...
final class U extends kotlin.jvm.internal.N implements Y41.l<InterfaceC43057n, CharSequence> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ l0.f f31001l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ l0.f f31002m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public U(l0.f fVar, l0.f fVar2) {
        super(1);
        this.f31001l = fVar;
        this.f31002m = fVar2;
    }
    ...
    public final CharSequence invoke(InterfaceC43057n interfaceC43057n) {
        ...
        l0.f fVar = this.f31001l;
        if (fVar.f406840b == -1) {
            fVar.f406840b = interfaceC43057n2.b().f406905b;
        }
        this.f31002m.f406840b = interfaceC43057n2.b().f406906c + 1;
        return "";
    }
}
