...
final class C20979p extends kotlin.jvm.internal.N implements Y41.l<androidx.compose.ui.input.key.c, Boolean> {
    static {
        new C20979p();
    }
    ...
    public final Boolean invoke(androidx.compose.ui.input.key.c cVar) {
        KeyCommand keyCommandA = C20961k1.f31559a.a(cVar.f40068a);
        return Boolean.valueOf(keyCommandA == KeyCommand.f30442s || keyCommandA == KeyCommand.f30444u);
    }
}
