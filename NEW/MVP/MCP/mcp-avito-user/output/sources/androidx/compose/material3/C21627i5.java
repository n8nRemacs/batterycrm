...
final class C21627i5 extends kotlin.jvm.internal.N implements Y41.l<androidx.compose.ui.semantics.F, kotlin.G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ String f36528l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C21627i5(String str) {
        super(1);
        this.f36528l = str;
    }
    ...
    public final kotlin.G0 invoke(androidx.compose.ui.semantics.F f12) {
        ...
        androidx.compose.ui.semantics.C.u(f13, new C22602e(this.f36528l, null, null, 6, null));
        androidx.compose.ui.semantics.i.f41744b.getClass();
        androidx.compose.ui.semantics.C.s(f13, 0);
