...
final class C20962k2 extends kotlin.jvm.internal.N implements Y41.l<C21008e1, kotlin.G0> {

    /* renamed from: l, reason: collision with root package name */
    public static final C20962k2 f31560l = new C20962k2();
        ...
        if (c21008e12.f32039g.f42127c.length() > 0) {
            if (c21008e12.e()) {
                ...
                if (c21008e12.f32039g.f42127c.length() > 0) {
                    ...
                    int iB2 = O1.b((int) (j12 & 4294967295L), str);
                    if (iB2 != -1) {
                        c21008e12.l(iB2, iB2);
                    }
                }
                ...
                if (c21008e12.f32039g.f42127c.length() > 0) {
                    ...
                    int iA2 = O1.a((int) (j13 & 4294967295L), str2);
                    if (iA2 != -1) {
                        c21008e12.l(iA2, iA2);
                    }
                }
