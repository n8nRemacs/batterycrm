...
final class Nd extends kotlin.jvm.internal.N implements Y41.p<androidx.compose.runtime.A, Integer, kotlin.G0> {
    public Nd() {
        throw null;
    }
    ...
    public final kotlin.G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        ...
        if (objT == A.a.f37868b) {
            objT = new P(null, null);
            a13.H(objT);
        }
        a13.O();
        androidx.compose.foundation.layout.R1.h(aVar, (P) objT);
        throw null;
    }
}
