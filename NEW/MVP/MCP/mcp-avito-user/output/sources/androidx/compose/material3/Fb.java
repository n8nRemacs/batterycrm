...
final class Fb extends SuspendLambda implements Y41.p<androidx.compose.ui.input.pointer.K, Continuation<? super kotlin.G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f34727q;

    /* renamed from: r, reason: collision with root package name */
    public /* synthetic */ Object f34728r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ Y41.a<kotlin.G0> f34729s;
    ...
    public static final class a extends kotlin.jvm.internal.N implements Y41.l<l0.g, kotlin.G0> {
        ...
        public final /* synthetic */ Y41.a<kotlin.G0> f34730l;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Fb(Y41.a<kotlin.G0> aVar, Continuation<? super Fb> continuation) {
    ...
    public final Continuation<kotlin.G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        Fb fb2 = new Fb(this.f34729s, continuation);
        fb2.f34728r = obj;
        return fb2;
    }
    ...
    public final Object invoke(androidx.compose.ui.input.pointer.K k12, Continuation<? super kotlin.G0> continuation) {
        return ((Fb) create(k12, continuation)).invokeSuspend(kotlin.G0.f406611a);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f34727q;
        if (i12 == 0) {
            C42729a0.b(obj);
            androidx.compose.ui.input.pointer.K k12 = (androidx.compose.ui.input.pointer.K) this.f34728r;
            a aVar = new a(this.f34729s);
            this.f34727q = 1;
