...
final class C21852s2 extends SuspendLambda implements Y41.p<kotlinx.coroutines.T, Continuation<? super kotlin.G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f37250q;

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ androidx.compose.foundation.interaction.m f37251r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ androidx.compose.runtime.snapshots.D<androidx.compose.foundation.interaction.j> f37252s;
    ...
    /* renamed from: androidx.compose.material3.s2$a */
    public static final class a<T> implements InterfaceC43172j {

        /* renamed from: b, reason: collision with root package name */
        public final /* synthetic */ androidx.compose.runtime.snapshots.D<androidx.compose.foundation.interaction.j> f37253b;
        ...
        public final Object emit(Object obj, Continuation continuation) {
            ...
            androidx.compose.runtime.snapshots.D<androidx.compose.foundation.interaction.j> d12 = this.f37253b;
            if (z12) {
                d12.add(jVar);
    ...
    public C21852s2(androidx.compose.foundation.interaction.m mVar, androidx.compose.runtime.snapshots.D d12, Continuation continuation) {
    ...
    public final Continuation<kotlin.G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new C21852s2(this.f37251r, this.f37252s, continuation);
    }

    @Override // Y41.p
    public final Object invoke(kotlinx.coroutines.T t12, Continuation<? super kotlin.G0> continuation) {
        return ((C21852s2) create(t12, continuation)).invokeSuspend(kotlin.G0.f406611a);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f37250q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43160i<androidx.compose.foundation.interaction.j> interfaceC43160iC = this.f37251r.c();
            a aVar = new a(this.f37252s);
            this.f37250q = 1;
