...
public final class C20620t {
    ...
    @F3
    @Y61.k
    public static final androidx.compose.ui.v a(@Y61.k androidx.compose.ui.v vVar, @InterfaceC42167x float f12, boolean z12) {
        return vVar.d0(new AspectRatioElement(f12, z12, C22535v1.f41625a));
    }

    @F3
    public static final boolean b(int i12, int i13, long j12) {
        int iL2 = C22712b.l(j12);
        if (i12 <= C22712b.j(j12) && iL2 <= i12) {
            int iK2 = C22712b.k(j12);
            if (i13 <= C22712b.i(j12) && iK2 <= i13) {
                return true;
            }
        }
        return false;
