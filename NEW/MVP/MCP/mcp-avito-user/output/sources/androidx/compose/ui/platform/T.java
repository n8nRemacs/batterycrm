...
public final class T implements InterfaceC22118l0 {
    ...
    public final /* synthetic */ Context f41273a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ V f41274b;

    public T(Context context, V v12) {
    ...
    public final void dispose() {
        this.f41273a.getApplicationContext().unregisterComponentCallbacks(this.f41274b);
    }
}
