...
final class l1 extends SuspendLambda implements Y41.p<kotlinx.coroutines.T, Continuation<? super kotlin.G0>, Object> {
    ...
    public final /* synthetic */ C21011f1 f32070q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l1(C21011f1 c21011f1, Continuation<? super l1> continuation) {
        super(2, continuation);
        this.f32070q = c21011f1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<kotlin.G0> create(Object obj, Continuation<?> continuation) {
        return new l1(this.f32070q, continuation);
    }
