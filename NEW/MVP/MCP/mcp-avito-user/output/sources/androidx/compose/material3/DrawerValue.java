...
public final class DrawerValue {
    ...
    public static final DrawerValue f34644b;

    /* renamed from: c, reason: collision with root package name */
    public static final DrawerValue f34645c;

    /* renamed from: d, reason: collision with root package name */
    public static final /* synthetic */ DrawerValue[] f34646d;

    static {
        DrawerValue drawerValue = new DrawerValue("Closed", 0);
        f34644b = drawerValue;
        DrawerValue drawerValue2 = new DrawerValue("Open", 1);
        f34645c = drawerValue2;
        f34646d = new DrawerValue[]{drawerValue, drawerValue2};
    }
    ...
    public static DrawerValue[] values() {
        return (DrawerValue[]) f34646d.clone();
    }
}
