...
/* compiled from: WorkDatabase_AutoMigration_19_20_Impl.java */
/* loaded from: classes10.dex */
final class S extends androidx.room.migration.b {

    /* renamed from: c, reason: collision with root package name */
    public final C23548c f55539c;

    public S() {
        super(19, 20);
        this.f55539c = new C23548c();
    }
    ...
    public final void a(@j.N androidx.sqlite.db.framework.b bVar) {
        ...
        this.f55539c.getClass();
        bVar.P4("UPDATE WorkSpec SET `last_enqueue_time` = -1 WHERE `last_enqueue_time` = 0");
    }
}
