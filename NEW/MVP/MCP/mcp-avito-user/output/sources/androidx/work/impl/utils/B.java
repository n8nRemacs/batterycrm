...
final class B extends kotlin.jvm.internal.N implements Y41.l<WorkDatabase, List<? extends WorkInfo>> {
    @Override // Y41.l
    public final List<? extends WorkInfo> invoke(WorkDatabase workDatabase) {
        return (List) androidx.work.impl.model.H.f55794z.apply(workDatabase.A().q());
    }
}
