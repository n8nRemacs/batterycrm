...
final class G extends kotlin.jvm.internal.N implements Y41.a<Boolean> {
    static {
        new G();
    }
    ...
    public final Boolean invoke() throws NoSuchMethodException, SecurityException {
        ...
        if (androidx.window.reflection.b.c(method) && androidx.window.reflection.b.a(method, SplitAttributes.class)) {
            z12 = true;
        }
