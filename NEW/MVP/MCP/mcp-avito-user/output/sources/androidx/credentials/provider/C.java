...
public final class C extends q {
    ...
    @Y61.k
    public static final d f45228q = new d(null);

    /* renamed from: g, reason: collision with root package name */
    @Y61.k
    public final CharSequence f45229g;

    /* renamed from: h, reason: collision with root package name */
    @Y61.l
    public final CharSequence f45230h;

    /* renamed from: i, reason: collision with root package name */
    @Y61.k
    public final CharSequence f45231i;

    /* renamed from: j, reason: collision with root package name */
    @Y61.k
    public final PendingIntent f45232j;

    /* renamed from: k, reason: collision with root package name */
    @Y61.k
    public final Icon f45233k;

    /* renamed from: l, reason: collision with root package name */
    @Y61.l
    public final Instant f45234l;
    ...
    public final boolean f45238p;

    /* compiled from: PublicKeyCredentialEntry.kt */
    @s0
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Landroidx/credentials/provider/C$a;", "", "<init>", "()V", "credentials_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @X
    public static final class a {
        ...
        @Y61.l
        @RestrictTo
        public static final C a(@Y61.k Slice slice) {
            boolean z12 = false;
            boolean z13 = false;
            boolean z14 = false;
            boolean z15 = false;
            ...
            try {
                ...
                aVar.getClass();
                return new C(text2, text3, text4, action, icon, instantOfEpochMilli, z12, new m(bundle, string, "{\"dummy_key\":\"dummy_value\"}", null, 8, null), z13, text5, text6, z14, true, z15);
            } catch (Exception e12) {
                e12.getMessage();
                return null;
            }
        ...
        @Y61.k
        @RestrictTo
        public static final Slice b(@Y61.k C c12) {
            String str = c12.f45235m ? "true" : "false";
            String str2 = c12.f45283d ? "true" : "false";
            Slice.Builder builderAddText = new Slice.Builder(Uri.EMPTY, new SliceSpec(c12.f45280a, 1)).addText(c12.f45231i, null, Collections.singletonList("androidx.credentials.provider.credentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME")).addText(c12.f45229g, null, Collections.singletonList("androidx.credentials.provider.credentialEntry.SLICE_HINT_USER_NAME")).addText(c12.f45230h, null, Collections.singletonList("androidx.credentials.provider.credentialEntry.SLICE_HINT_CREDENTIAL_TYPE_DISPLAY_NAME")).addText(str, null, Collections.singletonList("androidx.credentials.provider.credentialEntry.SLICE_HINT_AUTO_ALLOWED")).addText(c12.f45281b.f45256a, null, Collections.singletonList("androidx.credentials.provider.credentialEntry.SLICE_HINT_OPTION_ID"));
            ...
            builderAddText2.addAction(c12.f45232j, new Slice.Builder(builderAddText2).addHints(Collections.singletonList("androidx.credentials.provider.credentialEntry.SLICE_HINT_PENDING_INTENT")).build(), null);
            return builderAddText2.build();
        }
    }

    /* compiled from: PublicKeyCredentialEntry.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Landroidx/credentials/provider/C$b;", "", "<init>", "()V", "credentials_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @X
    ...
    public C(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, PendingIntent pendingIntent, Icon icon, Instant instant, boolean z12, m mVar, boolean z13, CharSequence charSequence4, CharSequence charSequence5, boolean z14, boolean z15, boolean z16, int i12, C42822w c42822w) {
        boolean z17;
        ...
        if ((i12 & 2048) != 0) {
            ...
            Bundle bundle = mVar.f45258c;
            aVar.getClass();
            z17 = bundle.getBoolean("androidx.credentials.BUNDLE_KEY_IS_AUTO_SELECT_ALLOWED");
        } else {
            z17 = z14;
        }
        this(charSequence, charSequence2, charSequence3, pendingIntent, icon, instant, z12, mVar, z13, charSequence6, charSequence7, z17, (i12 & 4096) != 0 ? false : z15, (i12 & 8192) != 0 ? false : z16);
    }

    public C(@Y61.k CharSequence charSequence, @Y61.l CharSequence charSequence2, @Y61.k CharSequence charSequence3, @Y61.k PendingIntent pendingIntent, @Y61.k Icon icon, @Y61.l Instant instant, boolean z12, @Y61.k m mVar, boolean z13, @Y61.l CharSequence charSequence4, @Y61.l CharSequence charSequence5, boolean z14, boolean z15, boolean z16) {
        super("androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL", mVar, charSequence4 == null ? charSequence : charSequence4, z13, charSequence5);
        this.f45229g = charSequence;
        this.f45230h = charSequence2;
        this.f45231i = charSequence3;
        this.f45232j = pendingIntent;
        this.f45233k = icon;
        this.f45234l = instant;
        this.f45235m = z12;
        this.f45236n = z15;
        this.f45237o = z16;
        this.f45238p = z14;
    ...
    public C(Context context, CharSequence charSequence, PendingIntent pendingIntent, m mVar, CharSequence charSequence2, Instant instant, Icon icon, boolean z12, boolean z13, int i12, C42822w c42822w) {
        this(charSequence, (i12 & 16) != 0 ? null : charSequence2, context.getString(R.string.androidx_credentials_TYPE_PUBLIC_KEY_CREDENTIAL), pendingIntent, (i12 & 64) != 0 ? Icon.createWithResource(context, R.drawable.ic_passkey) : icon, (i12 & 32) != 0 ? null : instant, (i12 & 128) != 0 ? false : z12, mVar, (i12 & 256) != 0 ? false : z13, null, null, false, false, false, 15872, null);
    }

    public /* synthetic */ C(Context context, CharSequence charSequence, PendingIntent pendingIntent, m mVar, CharSequence charSequence2, Instant instant, Icon icon, boolean z12, int i12, C42822w c42822w) {
        this(context, charSequence, pendingIntent, mVar, (i12 & 16) != 0 ? null : charSequence2, (i12 & 32) != 0 ? null : instant, (i12 & 64) != 0 ? Icon.createWithResource(context, R.drawable.ic_passkey) : icon, (i12 & 128) != 0 ? false : z12);
    }

    @InterfaceC42830m
    public /* synthetic */ C(Context context, CharSequence charSequence, PendingIntent pendingIntent, m mVar, CharSequence charSequence2, Instant instant, Icon icon, boolean z12) {
        this(charSequence, charSequence2, context.getString(R.string.androidx_credentials_TYPE_PUBLIC_KEY_CREDENTIAL), pendingIntent, icon, instant, z12, mVar, false, null, null, false, false, false, 15872, null);
    }
}
