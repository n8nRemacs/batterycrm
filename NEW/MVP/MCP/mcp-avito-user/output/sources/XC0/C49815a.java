...
public final class C49815a {
    ...
    public C49815a(@l Boolean bool, @l String str, @k String str2, @l DeepLink deepLink) {
        this.isEnabled = bool;
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
