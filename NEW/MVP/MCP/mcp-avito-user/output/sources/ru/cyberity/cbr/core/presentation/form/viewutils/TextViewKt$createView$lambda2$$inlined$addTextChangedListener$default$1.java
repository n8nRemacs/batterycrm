...
/* renamed from: ru.cyberity.cbr.core.presentation.form.viewutils.TextViewKt$createView$lambda-2$$inlined$addTextChangedListener$default$1, reason: invalid class name */
/* loaded from: classes9.dex */
public final class TextViewKt$createView$lambda2$$inlined$addTextChangedListener$default$1 implements TextWatcher {
    final /* synthetic */ FormFieldCallback $callback$inlined;
    final /* synthetic */ FormItem.Text $this_createView$inlined;
    final /* synthetic */ CBRApplicantDataFieldView $view$inlined;
    ...
    public void afterTextChanged(@l Editable s5) {
        ...
        if (formFieldCallback2 != null) {
            FormItem.Text text2 = this.$this_createView$inlined;
            formFieldCallback2.onValueChanged(text2, FormItemViewUtilsKt.getValueForItem(this.$view$inlined, text2));
        }
    }
