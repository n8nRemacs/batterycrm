...
public final class c extends AbstractC22993a {
    ...
    public <T extends M0> T create(@k String key, @k Class<T> modelClass, @k C23060r0 state) {
        return new b(this.document, state, new m(this.serviceLocator), this.serviceLocator.k(), this.serviceLocator.m(), this.serviceLocator.getExtensionProvider(), this.serviceLocator.x(), ru.cyberity.ml.badphotos.a.INSTANCE.a(this.serviceLocator.g(), this.serviceLocator.i(), this.serviceLocator.getSession().getUrl(), this.document.getType()), new ru.cyberity.cbr.core.domain.b(this.serviceLocator.k(), this.serviceLocator.m()));
    }
