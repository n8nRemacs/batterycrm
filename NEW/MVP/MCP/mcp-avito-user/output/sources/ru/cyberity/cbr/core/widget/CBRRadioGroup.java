...
public final class CBRRadioGroup extends RadioGroup implements CBRStepStateProvider {
    ...
    @j
    public CBRRadioGroup(@k Context context, @l AttributeSet attributeSet) {
    ...
    public void addView(@k View child, int index, @k ViewGroup.LayoutParams params) {
        ...
        if (!(child instanceof RadioButton) || customTheme == null) {
            return;
        }
        ...
        ((RadioButton) child).setButtonTintList(new ColorStateList(iArr, new int[]{iIntValue, themeColor != null ? themeColor.intValue() : iIntValue}));
    }
    ...
    public /* synthetic */ CBRRadioGroup(Context context, AttributeSet attributeSet, int i12, int i13, int i14, C42822w c42822w) {
        this(context, (i14 & 2) != 0 ? null : attributeSet, (i14 & 4) != 0 ? ru.cyberity.cbr.core.R.attr.cbr_RadioGroupStyle : i12, (i14 & 8) != 0 ? ru.cyberity.cbr.core.R.style.Widget_CBRRadioGroup : i13);
    }

    @j
    public CBRRadioGroup(@k Context context, @l AttributeSet attributeSet, int i12, int i13) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ru.cyberity.cbr.core.R.styleable.CBRRadioGroup, i12, i13);
        kVar.n(s.a(typedArrayObtainStyledAttributes, context, ru.cyberity.cbr.core.R.styleable.CBRRadioGroup_cbr_radioBackgroundColor));
        setBackground(kVar);
        setShowDividers(typedArrayObtainStyledAttributes.getInt(ru.cyberity.cbr.core.R.styleable.CBRRadioGroup_android_showDividers, 0));
        setDividerDrawable(typedArrayObtainStyledAttributes.getDrawable(ru.cyberity.cbr.core.R.styleable.CBRRadioGroup_android_divider));
        typedArrayObtainStyledAttributes.recycle();
        int[][] iArr = {new int[]{ru.cyberity.cbr.core.R.attr.cbr_stateInit}, new int[]{ru.cyberity.cbr.core.R.attr.cbr_stateRejected}, new int[0]};
        ThemeHelper themeHelper = ThemeHelper.INSTANCE;
        ...
        if (themeColor != null) {
            kVar.n(new ColorStateList(iArr, new int[]{0, themeColor.intValue(), 0}));
        }
