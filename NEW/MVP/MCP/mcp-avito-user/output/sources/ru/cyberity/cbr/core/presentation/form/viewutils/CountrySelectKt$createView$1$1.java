...
final class CountrySelectKt$createView$1$1 extends N implements l<CBRCountryPicker.CountryItem, G0> {
    final /* synthetic */ FormFieldCallback $callback;
    final /* synthetic */ FormItem.CountrySelect $this_createView;
    ...
    public final void invoke2(@k CBRCountryPicker.CountryItem countryItem) {
        ...
        if (formFieldCallback != null) {
            FormItem.CountrySelect countrySelect = this.$this_createView;
            formFieldCallback.onValueChanged(countrySelect, FormItemViewUtilsKt.getValueForItem(this.$view, countrySelect));
        }
    }
}
