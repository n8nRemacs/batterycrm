...
final class DateVIewKt$createView$1$1 extends N implements l<String, G0> {
    final /* synthetic */ FormFieldCallback $callback;
    final /* synthetic */ FormItem.Date $this_createView;
    ...
    public final void invoke2(@Y61.l String str) {
        ...
        if (formFieldCallback != null) {
            FormItem.Date date = this.$this_createView;
            formFieldCallback.onValueChanged(date, FormItemViewUtilsKt.getValueForItem(this.$view, date));
        }
    }
}
