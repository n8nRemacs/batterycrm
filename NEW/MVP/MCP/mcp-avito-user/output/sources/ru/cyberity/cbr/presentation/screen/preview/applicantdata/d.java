...
public final class d extends AbstractC22993a {
    ...
    public /* synthetic */ d(Document document, InterfaceC23487e interfaceC23487e, ru.cyberity.cbr.core.b bVar, Bundle bundle, int i12, C42822w c42822w) {
    ...
    public <T extends M0> T create(@k String key, @k Class<T> modelClass, @k C23060r0 state) {
        return new c(this.document, state, this.serviceLocator.k(), this.serviceLocator.m(), new ru.cyberity.cbr.domain.k(this.serviceLocator), new ru.cyberity.cbr.core.domain.b(this.serviceLocator.k(), this.serviceLocator.m()), new y0());
    }

    public d(@k Document document, @k InterfaceC23487e interfaceC23487e, @k ru.cyberity.cbr.core.b bVar, @l Bundle bundle) {
