...
final class v<T, R> implements l41.o {
    ...
    public final Object apply(Object obj) {
        return ((MessengerApi) obj).setOptions(Collections.singletonMap("addHideExchangeItem", P0.g(new Q("itemId", Long.valueOf(Long.parseLong(null))), new Q("channelId", null))));
    }
}
