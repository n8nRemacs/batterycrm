...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u0001:\u0001\u0004B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Lru/avito/messenger/generated/api/send_text_message/DomainErrorCodeTypeAdapterFactory;", "Lcom/google/gson/r;", "<init>", "()V", "DomainErrorCodeTypeAdapter", "_avito-discouraged_messenger"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes9.dex */
public final class DomainErrorCodeTypeAdapterFactory implements r {

    /* compiled from: DomainErrorCodeTypeAdapterFactory.kt */
    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001¨\u0006\u0003"}, d2 = {"Lru/avito/messenger/generated/api/send_text_message/DomainErrorCodeTypeAdapterFactory$DomainErrorCodeTypeAdapter;", "Lcom/google/gson/TypeAdapter;", "Lru/avito/messenger/generated/api/send_text_message/DomainError$Code;", "_avito-discouraged_messenger"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class DomainErrorCodeTypeAdapter extends TypeAdapter<DomainError.Code> {

        /* renamed from: a, reason: collision with root package name */
        @k
        public final TypeAdapter<DomainError.Code> f431142a;

        public DomainErrorCodeTypeAdapter(@k TypeAdapter<DomainError.Code> typeAdapter) {
            this.f431142a = typeAdapter;
        }

        @Override // com.google.gson.TypeAdapter
        public final DomainError.Code read(a aVar) {
            DomainError.Code code = this.f431142a.read(aVar);
            return code == null ? DomainError.Code.CoreError : code;
        }

        @Override // com.google.gson.TypeAdapter
        public final void write(c cVar, DomainError.Code code) {
            this.f431142a.write(cVar, code);
        }
    }
