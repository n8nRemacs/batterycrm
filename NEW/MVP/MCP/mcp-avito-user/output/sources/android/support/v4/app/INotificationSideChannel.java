...
public interface INotificationSideChannel extends IInterface {
    ...
    public static class _Parcel {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static <T extends Parcelable> void writeTypedObject(Parcel parcel, T t12, int i12) {
            if (t12 == null) {
                parcel.writeInt(0);
            } else {
                parcel.writeInt(1);
    ...
    void cancel(String str, int i12, String str2);

    void cancelAll(String str);

    void notify(String str, int i12, String str2, Notification notification);
    ...
    public static abstract class Stub extends Binder implements INotificationSideChannel {
        ...
        public static class Proxy implements INotificationSideChannel {
            ...
            public void cancel(String str, int i12, String str2) {
            ...
            @Override // android.support.v4.app.INotificationSideChannel
            public void notify(String str, int i12, String str2, Notification notification) {
                Parcel parcelObtain = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(INotificationSideChannel.DESCRIPTOR);
                    parcelObtain.writeString(str);
