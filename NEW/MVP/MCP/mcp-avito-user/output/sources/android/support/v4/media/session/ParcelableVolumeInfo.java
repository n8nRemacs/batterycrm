...
public class ParcelableVolumeInfo implements Parcelable {
    public static final Parcelable.Creator<ParcelableVolumeInfo> CREATOR = new Parcelable.Creator<ParcelableVolumeInfo>() { // from class: android.support.v4.media.session.ParcelableVolumeInfo.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ParcelableVolumeInfo[] newArray(int i12) {
            return new ParcelableVolumeInfo[i12];
        }
    };
    ...
    public ParcelableVolumeInfo(int i12, int i13, int i14, int i15, int i16) {
        this.volumeType = i12;
        this.audioStream = i13;
        this.controlType = i14;
        this.maxVolume = i15;
        this.currentVolume = i16;
    }
