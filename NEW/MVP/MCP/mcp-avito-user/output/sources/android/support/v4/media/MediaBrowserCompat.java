...
public final class MediaBrowserCompat {
    ...
    public interface MediaBrowserImpl {
        ...
        void getItem(@N String str, @N ItemCallback itemCallback);
        ...
        void search(@N String str, Bundle bundle, @N SearchCallback searchCallback);

        void sendCustomAction(@N String str, Bundle bundle, @P CustomActionCallback customActionCallback);

        void subscribe(@N String str, @P Bundle bundle, @N SubscriptionCallback subscriptionCallback);

        void unsubscribe(@N String str, SubscriptionCallback subscriptionCallback);
    }
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final C20199a<String, Subscription> mSubscriptions = new C20199a<>();
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void getItem(@N final String str, @N final ItemCallback itemCallback) {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void search(@N final String str, final Bundle bundle, @N final SearchCallback searchCallback) {
            if (!isConnected()) {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void sendCustomAction(@N final String str, final Bundle bundle, @P final CustomActionCallback customActionCallback) {
            if (!isConnected()) {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void subscribe(@N String str, Bundle bundle, @N SubscriptionCallback subscriptionCallback) {
            Subscription subscription = this.mSubscriptions.get(str);
            if (subscription == null) {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void unsubscribe(@N String str, SubscriptionCallback subscriptionCallback) {
            Subscription subscription = this.mSubscriptions.get(str);
            if (subscription == null) {
                return;
            }
    ...
    public static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        public void getItem(@N String str, @N ItemCallback itemCallback) {
            if (this.mServiceBinderWrapper == null) {
    ...
    public static class MediaBrowserImplApi26 extends MediaBrowserImplApi23 {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21, android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void subscribe(@N String str, @P Bundle bundle, @N SubscriptionCallback subscriptionCallback) {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                if (mediaBrowserImplBase.mServiceConnection == this && (i12 = mediaBrowserImplBase.mState) != 0 && i12 != 1) {
                    return true;
                }
                int i13 = mediaBrowserImplBase.mState;
                if (i13 == 0 || i13 == 1) {
                    return false;
                }
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    @Override // java.lang.Runnable
                    public void run() {
                        boolean z12 = MediaBrowserCompat.DEBUG;
                        if (z12) {
        ...
        private static String getStateLabel(int i12) {
            return i12 != 0 ? i12 != 1 ? i12 != 2 ? i12 != 3 ? i12 != 4 ? c.g(i12, "UNKNOWN/") : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }

        private boolean isCurrent(Messenger messenger, String str) {
            int i12;
            if (this.mCallbacksMessenger == messenger && (i12 = this.mState) != 0 && i12 != 1) {
                return true;
            }
            int i13 = this.mState;
            if (i13 == 0 || i13 == 1) {
        ...
        public void connect() {
            int i12 = this.mState;
            if (i12 != 0 && i12 != 1) {
                throw new IllegalStateException(c.s(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
        ...
        public void disconnect() {
            ...
            this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.2
                ...
                public void run() {
                    ...
                    MediaBrowserImplBase mediaBrowserImplBase2 = MediaBrowserImplBase.this;
                    int i12 = mediaBrowserImplBase2.mState;
                    mediaBrowserImplBase2.forceCloseConnection();
                    if (i12 != 0) {
                        MediaBrowserImplBase.this.mState = i12;
                    }
                    if (MediaBrowserCompat.DEBUG) {
                        MediaBrowserImplBase.this.dump();
                    }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(c.s(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(c.s(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(c.i(this.mState, ")", new StringBuilder("getServiceComponent() called while not connected (state=")));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(c.i(this.mState, ")", new StringBuilder("getSessionToken() called while not connected(state=")));
        }
            ...
            if (isCurrent(messenger, "onConnect")) {
                ...
                try {
                    for (Map.Entry<String, Subscription> entry : this.mSubscriptions.entrySet()) {
                        ...
                        for (int i13 = 0; i13 < callbacks.size(); i13++) {
                            this.mServiceBinderWrapper.addSubscription(key, callbacks.get(i13).mToken, optionsList.get(i13), this.mCallbacksMessenger);
                        }
                    }
                } catch (RemoteException unused) {
                }
        ...
        public void search(@N final String str, final Bundle bundle, @N final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(c.s(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException unused) {
    ...
    public static class ServiceBinderWrapper {
        ...
        private void sendRequest(int i12, Bundle bundle, Messenger messenger) throws RemoteException {
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i12 = 0; i12 < this.mOptionsList.size(); i12++) {
                if (C23079c.a(this.mOptionsList.get(i12), bundle)) {
                    return this.mCallbacks.get(i12);
                }
            }
            return null;
        }
        ...
        public void putCallback(Bundle bundle, SubscriptionCallback subscriptionCallback) {
            for (int i12 = 0; i12 < this.mOptionsList.size(); i12++) {
                if (C23079c.a(this.mOptionsList.get(i12), bundle)) {
                    this.mCallbacks.set(i12, subscriptionCallback);
                    return;
                }
            }
    ...
    public static abstract class SubscriptionCallback {
        ...
        public class SubscriptionCallbackApi21 extends MediaBrowser.SubscriptionCallback {
            ...
            public void onChildrenLoaded(@N String str, List<MediaBrowser.MediaItem> list) {
                ...
                List<SubscriptionCallback> callbacks = subscription.getCallbacks();
                List<Bundle> optionsList = subscription.getOptionsList();
                for (int i12 = 0; i12 < callbacks.size(); i12++) {
                    Bundle bundle = optionsList.get(i12);
                    if (bundle == null) {
        ...
        public class SubscriptionCallbackApi26 extends SubscriptionCallbackApi21 {
            ...
            @Override // android.media.browse.MediaBrowser.SubscriptionCallback
            public void onChildrenLoaded(@N String str, @N List<MediaBrowser.MediaItem> list, @N Bundle bundle) {
                MediaSessionCompat.ensureClassLoader(bundle);
        ...
        public void onChildrenLoaded(@N String str, @N List<MediaItem> list) {
        }
        ...
        public void onChildrenLoaded(@N String str, @N List<MediaItem> list, @N Bundle bundle) {
        }
    ...
    public void search(@N String str, Bundle bundle, @N SearchCallback searchCallback) {
        if (TextUtils.isEmpty(str)) {
    ...
    public void sendCustomAction(@N String str, Bundle bundle, @P CustomActionCallback customActionCallback) {
        if (TextUtils.isEmpty(str)) {
    ...
    public void subscribe(@N String str, @N SubscriptionCallback subscriptionCallback) {
        if (TextUtils.isEmpty(str)) {
    ...
    public void unsubscribe(@N String str) {
        if (TextUtils.isEmpty(str)) {
            throw new IllegalArgumentException("parentId is empty");
        }
    ...
    public void unsubscribe(@N String str, @N SubscriptionCallback subscriptionCallback) {
        if (TextUtils.isEmpty(str)) {
            throw new IllegalArgumentException("parentId is empty");
        }
        if (subscriptionCallback != null) {
    ...
    public void subscribe(@N String str, @N Bundle bundle, @N SubscriptionCallback subscriptionCallback) {
        if (TextUtils.isEmpty(str)) {
            throw new IllegalArgumentException("parentId is empty");
        }
        if (subscriptionCallback == null) {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public MediaItem(@N MediaDescriptionCompat mediaDescriptionCompat, int i12) {
    ...
    public static abstract class SearchCallback {
        public void onError(@N String str, Bundle bundle) {
        }

        public void onSearchResult(@N String str, Bundle bundle, @N List<MediaItem> list) {
        }
    }
