...
/* compiled from: LocalTimePlusFunction.kt */
@s0
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"LnU0/e;", "LcU0/a;", "date-time_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class e extends AbstractC27103a {

    /* renamed from: a, reason: collision with root package name */
    @k
    public final RT0.e f415157a;

    /* renamed from: b, reason: collision with root package name */
    @k
    public final String f415158b = "LocalTimePlus";
    ...
    public final com.avito.beduin.v2.engine.field.d c(@k z zVar, @k j jVar, @k m mVar) throws BeduinPropertyException {
        ...
        try {
            ...
            RT0.e eVar = this.f415157a;
            if (iOrdinal == 0) {
                gVar = (g) eVar.f14450b.Q(gVar2, j12);
            } else if (iOrdinal == 1) {
                gVar = (g) eVar.f14450b.D(gVar2, j12);
            } else if (iOrdinal == 2) {
                gVar = (g) eVar.f14450b.p(gVar2, j12);
            } else {
                if (iOrdinal != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                gVar = (g) eVar.f14450b.i(gVar2, j12);
            }
