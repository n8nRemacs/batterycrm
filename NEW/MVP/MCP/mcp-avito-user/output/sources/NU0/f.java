...
/* compiled from: LocalTimeUnitGetFunction.kt */
@s0
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"LnU0/f;", "LcU0/a;", "date-time_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class f extends AbstractC27103a {

    /* renamed from: a, reason: collision with root package name */
    @k
    public final RT0.e f415159a;

    /* renamed from: b, reason: collision with root package name */
    @k
    public final String f415160b = "LocalTimeUnitGet";
    ...
    public final com.avito.beduin.v2.engine.field.d c(@k z zVar, @k j jVar, @k m mVar) throws BeduinPropertyException {
        ...
        try {
            ...
            RT0.e eVar = this.f415159a;
            if (iOrdinal == 0) {
                iB2 = eVar.f14450b.B(gVar);
            } else if (iOrdinal == 1) {
                iB2 = eVar.f14450b.o(gVar);
            } else if (iOrdinal == 2) {
                iB2 = eVar.f14450b.P(gVar);
            } else {
                if (iOrdinal != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                iB2 = eVar.f14450b.w(gVar);
            }
            return C36273j.c(zVar, iB2);
        } catch (Exception e12) {
