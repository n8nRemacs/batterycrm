...
public final class C15228d {
    ...
    public C15228d(@Y61.l String str, @Y61.l DeepLink deepLink, @Y61.l String str2) {
        this.iconTypeAndroid = str;
        this.uri = deepLink;
        this.url = str2;
    }
    ...
    public final String getIconTypeAndroid() {
        return this.iconTypeAndroid;
    }
