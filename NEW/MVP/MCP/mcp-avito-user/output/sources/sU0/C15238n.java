...
public final class C15238n {
    ...
    public C15238n(@Y61.l String str, @Y61.l DeepLink deepLink, @Y61.l String str2) {
        this.title = str;
        this.uri = deepLink;
        this.url = str2;
    }
