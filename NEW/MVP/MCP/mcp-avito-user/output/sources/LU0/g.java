...
/* compiled from: LocalDateUnitGetFunction.kt */
@s0
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"LlU0/g;", "LcU0/a;", "date-time_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class g extends AbstractC27103a {

    /* renamed from: a, reason: collision with root package name */
    @k
    public final RT0.e f413754a;

    /* renamed from: b, reason: collision with root package name */
    @k
    public final String f413755b = "LocalDateUnitGet";
    ...
    public final com.avito.beduin.v2.engine.field.d c(@k z zVar, @k j jVar, @k m mVar) throws BeduinPropertyException {
        ...
        try {
            ...
            RT0.e eVar2 = this.f413754a;
            if (iOrdinal == 0) {
                I12 = eVar2.f14451c.I(eVar);
            } else if (iOrdinal == 1) {
                I12 = eVar2.f14451c.C(eVar);
            } else {
                if (iOrdinal != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                I12 = eVar2.f14451c.m(eVar);
            }
            return C36273j.c(zVar, I12);
        } catch (Exception e12) {
