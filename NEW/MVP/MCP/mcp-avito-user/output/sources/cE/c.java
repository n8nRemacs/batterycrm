...
public final class c {
    ...
    public c(@l Boolean bool, @l String str, @Y61.k String str2, @Y61.k DeepLink deepLink) {
        this.isEnabled = bool;
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
