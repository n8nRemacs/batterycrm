...
public final class P {
    ...
    public P(@Y61.l String str, @Y61.k List<Q> list, @Y61.l String str2, @Y61.l DeepLink deepLink, @Y61.l String str3) {
        this.badgeText = str;
        this.items = list;
        this.title = str2;
        this.uri = deepLink;
