...
public final class C {
    ...
    public C(@Y61.l DeepLink deepLink, @Y61.l String str, @Y61.k AttributedText attributedText) {
        this.uri = deepLink;
        this.url = str;
