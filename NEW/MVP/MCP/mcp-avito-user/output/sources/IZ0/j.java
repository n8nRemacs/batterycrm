...
public final class j {
    ...
    public j(@l String str, @l String str2, @l String str3, @l Long l12, @l String str4, @l String str5, @l Long l13) {
        this.actionType = str;
        this.from = str2;
        this.fromPage = str3;
        this.iid = l12;
