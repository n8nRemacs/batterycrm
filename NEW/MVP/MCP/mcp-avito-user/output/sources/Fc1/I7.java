...
public final class I7 {
    ...
    public static final void a(@Y61.k C22096n c22096n, @Y61.l androidx.compose.runtime.A a12, int i12) {
        androidx.compose.runtime.B bE2 = a12.E(289353147);
        if ((i12 & 11) == 2 && bE2.c()) {
            bE2.f();
        } else {
            ...
            androidx.compose.ui.v vVarM = androidx.compose.foundation.layout.R1.m(aVar, 0.0f, 6, 0.0f, 0.0f, 13);
            bE2.I(733328855);
            ...
            C22096n c22096nC = androidx.compose.ui.layout.M.c(vVarM);
            ...
            H1.a(bE2, 0);
            androidx.compose.ui.v vVarB = androidx.compose.foundation.A.b(androidx.compose.ui.draw.o.b(androidx.compose.ui.input.nestedscroll.e.a(C20588k2.x(aVar, null, 3), androidx.compose.ui.platform.J1.e(bE2), null), new L7(4, 0, -2, interfaceC13779y3.v().a(), C22278p0.f39720a)), C13775y.a(interfaceC13779y3.d()), androidx.compose.foundation.shape.o.c(interfaceC13779y3.v().a(), interfaceC13779y3.v().a(), 0.0f, 0.0f, 12));
            bE2.I(733328855);
            ...
            bE2.X(false);
            bE2.X(true);
            androidx.compose.foundation.H.B(bE2, false, false, false, true);
            bE2.X(false);
            bE2.X(false);
        }
        ...
        c22039c2Z.f38184d = new H7(c22096n, i12);
    }
}
