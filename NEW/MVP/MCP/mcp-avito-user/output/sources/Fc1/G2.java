...
public final class G2 {
    ...
    public static final void a(@Y61.k C22096n c22096n, @Y61.l androidx.compose.runtime.A a12, int i12) {
        androidx.compose.runtime.B bE2 = a12.E(1973119180);
        if ((i12 & 11) == 2 && bE2.c()) {
            bE2.f();
        } else {
            ...
            float f12 = 2;
            androidx.compose.ui.v vVarB = androidx.compose.foundation.A.b(C20588k2.t(androidx.compose.foundation.layout.R1.i(androidx.compose.ui.draw.y.a(androidx.compose.foundation.layout.R1.i(androidx.compose.ui.v.f42878y1, 4), f12, androidx.compose.foundation.shape.o.a(interfaceC13779y3.v().a()), false, 28), f12), 300), C13775y.a(interfaceC13779y3.d()), androidx.compose.foundation.shape.o.a(interfaceC13779y3.v().a()));
            bE2.I(-483455358);
            ...
            if (bE2.f37887P || !kotlin.jvm.internal.L.f(bE2.t(), Integer.valueOf(i13))) {
                C13653k2.a(i13, bE2, i13, pVar);
            }
            A2.a(c22096nC, androidx.compose.runtime.J2.a(bE2), bE2);
            c22096n.invoke(androidx.compose.foundation.layout.K.f28344a, bE2, 54);
            bE2.X(false);
        ...
        c22039c2Z.f38184d = new F2(c22096n, i12);
    }
}
