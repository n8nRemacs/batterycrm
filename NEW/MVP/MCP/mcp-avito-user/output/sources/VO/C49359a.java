...
public final class C49359a {
    ...
    public C49359a(@Y61.l Boolean bool, @Y61.l String str, @Y61.k String str2, @Y61.l DeepLink deepLink) {
        this.isEnabled = bool;
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
