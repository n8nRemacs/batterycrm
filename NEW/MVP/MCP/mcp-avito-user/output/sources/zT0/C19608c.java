...
public final class C19608c {
    ...
    public C19608c(@k String str, @k DeepLink deepLink, @k String str2) {
        this.title = str;
        this.uri = deepLink;
        this.url = str2;
    }
