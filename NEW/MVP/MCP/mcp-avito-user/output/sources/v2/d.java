...
public final class d implements Callback {
    ...
    public final /* synthetic */ SafeContinuation f440383b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ l0.f f440384c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ l0.h f440385d;

    public d(SafeContinuation safeContinuation, l0.f fVar, l0.h hVar) {
        this.f440383b = safeContinuation;
        this.f440384c = fVar;
        this.f440385d = hVar;
    }
    ...
    public final void onFailure(Call call, IOException iOException) {
        SafeContinuation safeContinuation = this.f440383b;
        int i12 = this.f440384c.f406840b;
    ...
    public final void onResponse(Call call, Response response) throws IOException {
        ...
        l0.h hVar = this.f440385d;
        hVar.f406842b = response;
        int iCode = response.code();
        l0.f fVar = this.f440384c;
        fVar.f406840b = iCode;
