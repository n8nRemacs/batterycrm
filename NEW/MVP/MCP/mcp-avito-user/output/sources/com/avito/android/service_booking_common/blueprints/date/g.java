...
final class g extends N implements Y41.p<Integer, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ k f276357l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ C47440d f276358m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(k kVar, C47440d c47440d) {
        super(2);
        this.f276357l = kVar;
        this.f276358m = c47440d;
    }
    ...
    public final G0 invoke(Integer num, Integer num2) {
        ...
        this.f276357l.f276350b.K5(C47440d.b(this.f276358m, null, new C47440d.b(iIntValue, iIntValue2), 7));
        return G0.f406611a;
    }
}
