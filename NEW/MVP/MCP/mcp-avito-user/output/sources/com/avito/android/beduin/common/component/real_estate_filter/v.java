...
public final class v implements TextWatcher {
    ...
    public final /* synthetic */ Input f102347c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ s f102348d;

    public v(Input input, s sVar) {
        this.f102347c = input;
        this.f102348d = sVar;
        this.f102346b = input.getDeformattedText();
    }

    @Override // android.text.TextWatcher
    public final void afterTextChanged(@Y61.l Editable editable) {
        String deformattedText = this.f102347c.getDeformattedText();
        if (L.f(deformattedText, this.f102346b)) {
            return;
        }
        s sVar = this.f102348d;
