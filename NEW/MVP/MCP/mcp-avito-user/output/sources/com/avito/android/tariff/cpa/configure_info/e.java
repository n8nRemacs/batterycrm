...
final class e extends N implements l<P2<?>, G0> {
    ...
    public final /* synthetic */ CpaConfigureInfoFragment f294494l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(CpaConfigureInfoFragment cpaConfigureInfoFragment) {
        super(1);
        this.f294494l = cpaConfigureInfoFragment;
    }
    ...
    public final G0 invoke(P2<?> p22) {
        ...
        CpaConfigureInfoFragment cpaConfigureInfoFragment = this.f294494l;
        if (z12) {
            CpaConfigureInfoFragment.a aVar = CpaConfigureInfoFragment.f294438y0;
            cpaConfigureInfoFragment.r5().k(null);
        } else if (p23 instanceof P2.a) {
            CpaConfigureInfoFragment.a aVar2 = CpaConfigureInfoFragment.f294438y0;
            cpaConfigureInfoFragment.r5().a("");
        } else if (p23 instanceof P2.b) {
            CpaConfigureInfoFragment.a aVar3 = CpaConfigureInfoFragment.f294438y0;
            cpaConfigureInfoFragment.r5().j();
        }
        return G0.f406611a;
    }
}
