...
final class m extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<List<Boolean>, G0> f166959l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public m(Y41.l<? super List<Boolean>, G0> lVar) {
        super(0);
        this.f166959l = lVar;
    }
    ...
    public final G0 invoke() {
        this.f166959l.invoke(C42745f0.U(Boolean.TRUE, Boolean.FALSE));
        return G0.f406611a;
    }
}
