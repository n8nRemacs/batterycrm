...
final class g extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f128147l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f128147l | 1);
        androidx.compose.runtime.B bE2 = a12.E(-775218533);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
