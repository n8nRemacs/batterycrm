...
final class d extends N implements Y41.l<P2<?>, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ VisualVasFragment f322108l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(VisualVasFragment visualVasFragment) {
        super(1);
        this.f322108l = visualVasFragment;
    }
    ...
    public final G0 invoke(P2<?> p22) {
        ...
        VisualVasFragment visualVasFragment = this.f322108l;
        if (z12) {
            ...
            com.avito.android.progress_overlay.l lVar2 = visualVasFragment.f322095z0;
            (lVar2 != null ? lVar2 : null).j();
        } else if (p23 instanceof P2.a) {
            Button button = visualVasFragment.f322092w0;
            if (button == null) {
                button = null;
            }
            D6.w(button);
            com.avito.android.progress_overlay.l lVar3 = visualVasFragment.f322095z0;
