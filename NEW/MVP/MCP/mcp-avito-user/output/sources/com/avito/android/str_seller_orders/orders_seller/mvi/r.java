...
public final class r<T> implements Comparator {
    ...
    public final int compare(T t12, T t13) {
        return kotlin.comparisons.a.b(Boolean.valueOf(((com.avito.android.str_seller_orders.orders_seller.items.filter.c) t13).f289439e), Boolean.valueOf(((com.avito.android.str_seller_orders.orders_seller.items.filter.c) t12).f289439e));
    }
}
