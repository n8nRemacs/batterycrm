...
public final class StatsReport$OutboundRtpVideoStats$$serializer implements N<StatsReport.OutboundRtpVideoStats> {
    ...
    public void serialize(@k Encoder encoder, @k StatsReport.OutboundRtpVideoStats value) {
        ...
        dVarC.p(f412706c, 0, StatsReport$OutboundRtpVideoSourceStats$$serializer.INSTANCE, value.f333574a);
        dVarC.p(f412706c, 1, StatsReport$Codec$$serializer.INSTANCE, value.f333575b);
        j1 j1Var = j1.f412874a;
        dVarC.p(f412706c, 2, j1Var, value.f333576c);
        V0 v02 = V0.f412822a;
        dVarC.p(f412706c, 3, v02, value.f333577d);
        dVarC.p(f412706c, 4, j1Var, value.f333578e);
        dVarC.p(f412706c, 5, j1Var, value.f333579f);
        dVarC.p(f412706c, 6, j1Var, value.f333580g);
        F f12 = F.f412769a;
        dVarC.p(f412706c, 7, f12, value.f333581h);
        dVarC.p(f412706c, 8, j1Var, value.f333582i);
        dVarC.p(f412706c, 9, j1Var, value.f333583j);
        dVarC.p(f412706c, 10, j1Var, value.f333584k);
        dVarC.p(f412706c, 11, j1Var, value.f333585l);
        dVarC.p(f412706c, 12, j1Var, value.f333586m);
        dVarC.p(f412706c, 13, f12, value.f333587n);
        dVarC.p(f412706c, 14, j1Var, value.f333588o);
        dVarC.p(f412706c, 15, j1Var, value.f333589p);
        dVarC.p(f412706c, 16, j1Var, value.f333590q);
        dVarC.p(f412706c, 17, j1Var, value.f333591r);
        dVarC.p(f412706c, 18, j1Var, value.f333592s);
        dVarC.p(f412706c, 19, j1Var, value.f333593t);
        dVarC.p(f412706c, 20, j1Var, value.f333594u);
        dVarC.p(f412706c, 21, f12, value.f333595v);
        dVarC.p(f412706c, 22, j1Var, value.f333596w);
        dVarC.p(f412706c, 23, j1Var, value.f333597x);
        dVarC.p(f412706c, 24, j1Var, value.f333598y);
        dVarC.p(f412706c, 25, v02, value.f333599z);
        dVarC.p(f412706c, 26, v02, value.f333569A);
        dVarC.p(f412706c, 27, f12, value.f333570B);
        dVarC.p(f412706c, 28, C43407i.f412866a, value.f333571C);
        dVarC.p(f412706c, 29, v02, value.f333572D);
        dVarC.p(f412706c, 30, StatsReport$RemoteInboundRtpStats$$serializer.INSTANCE, value.f333573E);
        dVarC.d(f412706c);
    }
