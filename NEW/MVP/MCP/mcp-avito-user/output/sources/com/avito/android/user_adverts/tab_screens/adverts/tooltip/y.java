...
public final class y extends SuspendLambda implements Y41.p<T, Continuation<? super c.b>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f315706q;

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ RecyclerView f315707r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ int f315708s;
    ...
    public static final class b extends kotlin.jvm.internal.N implements Y41.l<Throwable, G0> {
        ...
        public final /* synthetic */ RecyclerView f315712l;

        /* renamed from: m, reason: collision with root package name */
        public final /* synthetic */ a f315713m;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(RecyclerView recyclerView, a aVar) {
            super(1);
            this.f315712l = recyclerView;
            this.f315713m = aVar;
        }

        @Override // Y41.l
        public final G0 invoke(Throwable th2) {
            this.f315712l.t0(this.f315713m);
            return G0.f406611a;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public y(RecyclerView recyclerView, int i12, Continuation continuation) {
        super(2, continuation);
        this.f315707r = recyclerView;
        this.f315708s = i12;
    }
    ...
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new y(this.f315707r, this.f315708s, continuation);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f315706q;
        if (i12 == 0) {
            C42729a0.b(obj);
            RecyclerView recyclerView = this.f315707r;
            this.f315706q = 1;
            kotlinx.coroutines.r rVar = new kotlinx.coroutines.r(1, IntrinsicsKt.intercepted(this));
            rVar.p();
            a aVar = new a(recyclerView, this.f315708s, rVar);
    ...
    public static final class a implements RecyclerView.o {
        ...
        public final /* synthetic */ RecyclerView f315709b;

        /* renamed from: c, reason: collision with root package name */
        public final /* synthetic */ int f315710c;

        /* renamed from: d, reason: collision with root package name */
        public final /* synthetic */ kotlinx.coroutines.r f315711d;

        public a(RecyclerView recyclerView, int i12, kotlinx.coroutines.r rVar) {
            this.f315709b = recyclerView;
            this.f315710c = i12;
            this.f315711d = rVar;
        }
        ...
        public final void j(@Y61.k View view) {
            RecyclerView recyclerView = this.f315709b;
            RecyclerView.C cL2 = recyclerView.L(view);
            if (!(cL2 instanceof c.b)) {
                cL2 = null;
            }
            c.b bVar = (c.b) cL2;
            if (bVar == null || bVar.getBindingAdapterPosition() != this.f315710c) {
                return;
            }
            recyclerView.t0(this);
            int i12 = Z.f406624c;
            this.f315711d.resumeWith(bVar);
        }
