...
final class e extends N implements p<String, Bundle, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ConstructorTabFragment f317971l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(ConstructorTabFragment constructorTabFragment) {
        super(2);
        this.f317971l = constructorTabFragment;
    }

    @Override // Y41.p
    public final G0 invoke(String str, Bundle bundle) {
        ConstructorTabFragment.a aVar = ConstructorTabFragment.f317866y0;
        this.f317971l.q5().accept(a.p.f14330a);
        return G0.f406611a;
    }
}
