...
final class e extends N implements Y41.l<BeduinModel, G0> {
    ...
    public final /* synthetic */ Y41.l<BeduinModel, Boolean> f105329l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ArrayList f105330m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(Y41.l lVar, ArrayList arrayList) {
        super(1);
        this.f105329l = lVar;
        this.f105330m = arrayList;
    }

    @Override // Y41.l
    public final G0 invoke(BeduinModel beduinModel) {
        BeduinModel beduinModel2 = beduinModel;
        if (this.f105329l.invoke(beduinModel2).booleanValue()) {
            this.f105330m.add(beduinModel2);
        }
        return G0.f406611a;
    }
}
