...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u0003¨\u0006\u0004"}, d2 = {"Lcom/avito/android/photo_gallery_carousel/items/video/f;", "Lcom/avito/konveyor/adapter/b;", "Lcom/avito/android/photo_gallery_carousel/items/video/k;", "Lcom/avito/android/photo_gallery_carousel/items/common/c;", "_avito_photo-gallery-carousel_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class f extends com.avito.konveyor.adapter.b implements k, com.avito.android.photo_gallery_carousel.items.common.c {
    ...
    public final /* synthetic */ l f218026b;

    public f(@Y61.k View view, @Y61.k ViewGroup viewGroup) {
        super(view);
        this.f218026b = new l(view, viewGroup);
    ...
    public final void Fg(@Y61.k Y41.a<Boolean> aVar) {
        this.f218026b.f217911d = (N) aVar;
    }

    @Override // com.avito.android.photo_gallery_carousel.items.common.a
    public final void a(@Y61.k Y41.a<G0> aVar) {
        this.f218026b.a(aVar);
    }

    @Override // com.avito.konveyor.adapter.b, TV0.e
    public final void j5() {
        this.f218026b.getClass();
    }
    ...
    public final void uz(@Y61.l Image image, @Y61.l String str, @Y61.k SizableGalleryItem.Type type, @Y61.l CarouselGalleryGroup carouselGalleryGroup) {
        this.f218026b.uz(image, str, type, carouselGalleryGroup);
    }
}
