...
final class p extends N implements Y41.l<A, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC22196w1 f99721l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p(InterfaceC22196w1 interfaceC22196w1) {
        super(1);
        this.f99721l = interfaceC22196w1;
    }

    @Override // Y41.l
    public final G0 invoke(A a12) {
        this.f99721l.L3((int) (a12.a() & 4294967295L));
        return G0.f406611a;
    }
}
