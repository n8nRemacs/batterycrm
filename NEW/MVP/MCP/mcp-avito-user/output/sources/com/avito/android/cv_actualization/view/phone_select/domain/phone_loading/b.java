...
@DebugMetadata(c = "com.avito.android.cv_actualization.view.phone_select.domain.phone_loading.JsxCvActualizationPhoneSelectInitialLoadPhonesInteractor$loadPhones$2", f = "JsxCvActualizationPhoneSelectInitialLoadPhonesInteractor.kt", i = {}, l = {30}, m = "invokeSuspend", n = {}, s = {})
...
final class b extends SuspendLambda implements q<InterfaceC43172j<? super JsxCvActualizationPhoneSelectInternalAction>, Throwable, Continuation<? super G0>, Object> {
    ...
    public /* synthetic */ InterfaceC43172j f131338r;

    /* renamed from: s, reason: collision with root package name */
    public /* synthetic */ Throwable f131339s;
    ...
    public final Object invoke(InterfaceC43172j<? super JsxCvActualizationPhoneSelectInternalAction> interfaceC43172j, Throwable th2, Continuation<? super G0> continuation) {
        ...
        bVar.f131338r = interfaceC43172j;
        bVar.f131339s = th2;
    ...
    public final Object invokeSuspend(@k Object obj) {
        ...
        int i12 = this.f131337q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43172j interfaceC43172j = this.f131338r;
            JsxCvActualizationPhoneSelectInternalAction.ErrorLoadedContent errorLoadedContent = new JsxCvActualizationPhoneSelectInternalAction.ErrorLoadedContent(new J.a(this.f131339s));
            this.f131338r = null;
            this.f131337q = 1;
            if (interfaceC43172j.emit(errorLoadedContent, this) == coroutine_suspended) {
