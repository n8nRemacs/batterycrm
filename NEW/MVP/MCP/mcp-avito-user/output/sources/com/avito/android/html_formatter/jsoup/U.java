...
final class U extends kotlin.jvm.internal.N implements Y41.p<org.jsoup.nodes.k, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ int f164196l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ int f164197m;
    ...
    public final G0 invoke(org.jsoup.nodes.k kVar, Integer num) {
        ...
        if (iIntValue != 0 && ((kVar2 instanceof org.jsoup.nodes.n) || (kVar2 != null && C30810h.f(kVar2)))) {
            kVar2.D();
        }
        if (iIntValue == 0 && (kVar2 instanceof org.jsoup.nodes.n)) {
            org.jsoup.nodes.n nVar = (org.jsoup.nodes.n) kVar2;
            nVar.R(nVar.M().substring(this.f164196l, this.f164197m));
        }
        return G0.f406611a;
    }
}
