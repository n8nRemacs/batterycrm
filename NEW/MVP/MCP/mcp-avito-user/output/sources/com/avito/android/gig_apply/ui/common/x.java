...
final class x extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f159990l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f159990l | 1);
        androidx.compose.runtime.B bE2 = a12.E(-1356540602);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            ...
            w.a(new y("Условия", "— Нужно поднимать тяжёлое\n— Нужно работать в холоде — оденьтесь так, чтобы\n— Внешний вид должен быть опрятным\n— Нужно прийти в брюках или джинсах без надписей и декора. Юбка и шорты не допускаются.\n— Плавающий перерыв — 30 мин в период с 13:00 до 15:00"), bE2, 0);
            bE2.X(true);
        }
