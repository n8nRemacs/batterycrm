...
public final /* data */ class VoipMessageResponse implements com.avito.avcalls.signaling.a {
    ...
    public final boolean equals(@l Object obj) {
        ...
        return (obj instanceof VoipMessageResponse) && this.f333369a == ((VoipMessageResponse) obj).f333369a;
    }

    public final int hashCode() {
        return Boolean.hashCode(this.f333369a);
    }

    @k
    public final String toString() {
        return r.x(new StringBuilder("VoipMessageResponse(ok="), this.f333369a, ')');
    }
}
