...
/* renamed from: com.avito.android.serp.adapter.rich_snippets.service.h, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
final class C34810h extends kotlin.jvm.internal.N implements Y41.q<Integer, Integer, AsyncViewportTracker.ViewContext, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ s f271322l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C34810h(s sVar) {
        super(3);
        this.f271322l = sVar;
    }
    ...
    public final G0 invoke(Integer num, Integer num2, AsyncViewportTracker.ViewContext viewContext) {
        ...
        s sVar = this.f271322l;
        C28456h.a(sVar.f271375f, new ImageViewportEvent(iIntValue, iIntValue2, viewContext.f430437b, null, null, null, null, 120, null));
        return G0.f406611a;
    }
}
