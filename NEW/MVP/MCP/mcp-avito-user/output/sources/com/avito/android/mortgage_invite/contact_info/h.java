...
final class h extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ ApplicationContactInfoFragment f205662l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(ApplicationContactInfoFragment applicationContactInfoFragment) {
        super(0);
        this.f205662l = applicationContactInfoFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        ApplicationContactInfoFragment.a aVar = ApplicationContactInfoFragment.f205577u0;
        this.f205662l.q5().accept(InterfaceC25394a.i.f56835a);
        return G0.f406611a;
    }
}
