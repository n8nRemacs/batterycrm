...
/* compiled from: EnableDefaultCameraOrRequestPermissionAction.kt */
@P
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\bÇ\n\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0013\u0010\u0006\u001a\u00020\u0005*\u00020\u0004H\u0016¢\u0006\u0004\b\u0006\u0010\u0007J\u0010\u0010\t\u001a\u00020\bHÖ\u0001¢\u0006\u0004\b\t\u0010\nJ\u0010\u0010\f\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\f\u0010\rJ\u001a\u0010\u0011\u001a\u00020\u00102\b\u0010\u000f\u001a\u0004\u0018\u00010\u000eHÖ\u0003¢\u0006\u0004\b\u0011\u0010\u0012¨\u0006\u0013"}, d2 = {"Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/video/EnableDefaultCameraOrRequestPermissionAction;", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacAction;", "<init>", "()V", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;", "Lkotlin/G0;", "process", "(Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;)V", "", "toString", "()Ljava/lang/String;", "", "hashCode", "()I", "", PluralsKeys.OTHER, "", "equals", "(Ljava/lang/Object;)Z", "_avito_iac-dialer_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes14.dex */
public final /* data */ class EnableDefaultCameraOrRequestPermissionAction implements IacAction {
    public static final int $stable = 0;

    @k
    public static final EnableDefaultCameraOrRequestPermissionAction INSTANCE = new EnableDefaultCameraOrRequestPermissionAction();

    private EnableDefaultCameraOrRequestPermissionAction() {
    }

    public boolean equals(@l Object other) {
        return this == other || (other instanceof EnableDefaultCameraOrRequestPermissionAction);
    }
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        ...
        if (((IacState.InUse) iacActionProcessing.getState()).getCall().getLocalSendingVideo()) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new p("Camera is already enabled"));
            return;
        }
        if (iacActionProcessing.getState().getAppearance().getCameraPerm().b()) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.AvCalls.EnableSendingVideo(((IacState.InUse) iacActionProcessing.getState()).getCallId(), true));
            return;
        }
        iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new p("No camera permission. Lets request it."));
        IacActionOutput out = iacActionProcessing.getOut();
        String callId = ((IacState.InUse) iacActionProcessing.getState()).getCallId();
        String scenario = ((IacState.InUse) iacActionProcessing.getState()).getCall().getMeta().getScenario();
        CallMeta.Item item = ((IacState.InUse) iacActionProcessing.getState()).getCall().getMeta().getItem();
        iacActionProcessing.plusAssign(out, new IacEvent.CallScreen.RequestCameraPermission(true, callId, scenario, item != null ? Long.valueOf(item.getId()).toString() : null, ((IacState.InUse) iacActionProcessing.getState()).getCall().getDirection()));
    }

    @k
    public String toString() {
        return "EnableDefaultCameraOrRequestPermissionAction";
    }
}
