...
final class f extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ C23678f0<Integer, G0> f214623l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(C23678f0<Integer, G0> c23678f0) {
        super(1);
        this.f214623l = c23678f0;
    }

    /* JADX WARN: Type inference failed for: r0v1, types: [Y41.l, kotlin.jvm.internal.N] */
    @Override // Y41.l
    public final G0 invoke(Integer num) {
        this.f214623l.f56279a.invoke(Integer.valueOf(num.intValue()));
        return G0.f406611a;
    }
}
