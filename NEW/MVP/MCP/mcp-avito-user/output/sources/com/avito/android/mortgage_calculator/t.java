...
final class t extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204848l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public t(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204848l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204848l.getViewModel().accept(b.i.f204579b);
        return G0.f406611a;
    }
}
