...
final class j extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ CampaignsSaleSearchFragment f114557l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(CampaignsSaleSearchFragment campaignsSaleSearchFragment) {
        super(1);
        this.f114557l = campaignsSaleSearchFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        CampaignsSaleSearchFragment.a aVar = CampaignsSaleSearchFragment.f114473A0;
        this.f114557l.v5().accept(new b.p(str));
        return G0.f406611a;
    }
}
