...
public final class P<T> implements InterfaceC23040h0 {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ ChannelFragment f189133b;

    public P(ChannelFragment channelFragment) {
        this.f189133b = channelFragment;
    }
    ...
    public final void onChanged(T t12) {
        if (t12 != 0) {
            ...
            Context context = this.f189133b.getContext();
            if (context != null) {
                L5.b(context, str, 0);
            }
        }
