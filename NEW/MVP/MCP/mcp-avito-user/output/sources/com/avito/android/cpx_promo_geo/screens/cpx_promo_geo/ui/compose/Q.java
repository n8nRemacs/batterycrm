...
final class Q extends kotlin.jvm.internal.N implements Y41.l<DeepLink, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.l<InterfaceC48707a, G0> f127970l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public Q(Y41.l<? super InterfaceC48707a, G0> lVar) {
        super(1);
        this.f127970l = lVar;
    }
    ...
    public final G0 invoke(DeepLink deepLink) {
        this.f127970l.invoke(new InterfaceC48707a.b(deepLink));
        return G0.f406611a;
    }
}
