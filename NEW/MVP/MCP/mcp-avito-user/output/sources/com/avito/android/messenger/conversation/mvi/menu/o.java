...
public final class o extends N implements Y41.a<G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ m f191490l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ChannelMenuAction f191491m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(m mVar, ChannelMenuAction channelMenuAction) {
        super(0);
        this.f191490l = mVar;
        this.f191491m = channelMenuAction;
    }

    @Override // Y41.a
    public final G0 invoke() {
        DeepLink deepLink = this.f191491m.getDeepLink();
        boolean z12 = deepLink instanceof PinChannelLink ? true : deepLink instanceof UnpinChannelLink;
        m mVar = this.f191490l;
        if (z12) {
