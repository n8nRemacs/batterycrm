...
final class g extends N implements l<DeepLink, G0> {
    ...
    public final /* synthetic */ VasUnionFragment f108559l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(VasUnionFragment vasUnionFragment) {
        super(1);
        this.f108559l = vasUnionFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f108559l.f108460p0;
        if (aVar == null) {
            aVar = null;
        }
