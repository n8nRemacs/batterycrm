...
public final class c extends N implements l<Drawable, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC40743a f124986l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(InterfaceC40743a interfaceC40743a) {
        super(1);
        this.f124986l = interfaceC40743a;
    }

    @Override // Y41.l
    public final G0 invoke(Drawable drawable) {
        this.f124986l.setState(State.f135882f);
        return G0.f406611a;
    }
}
