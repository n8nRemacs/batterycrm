...
final class q extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ InterfaceC22204y1 f297720l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(InterfaceC22204y1 interfaceC22204y1) {
        super(0);
        this.f297720l = interfaceC22204y1;
    }

    @Override // Y41.a
    public final G0 invoke() {
        ((Y41.l) this.f297720l.getF42167b()).invoke(InterfaceC44623a.C12176a.f419588a);
        return G0.f406611a;
    }
}
