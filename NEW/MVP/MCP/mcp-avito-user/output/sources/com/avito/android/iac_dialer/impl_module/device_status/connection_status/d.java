...
@DebugMetadata(c = "com.avito.android.iac_dialer.impl_module.device_status.connection_status.IacConnectionStatusProviderImpl$initializeIfNeeded$2", f = "IacConnectionStatusProvider.kt", i = {}, l = {140}, m = "invokeSuspend", n = {}, s = {})
...
final class d extends SuspendLambda implements p<T, Continuation<? super G0>, Object> {
    ...
    public final /* synthetic */ b f165953r;
    ...
    public static final class a<T> implements InterfaceC43172j {
        ...
        public final /* synthetic */ b f165954b;
    ...
    public final Continuation<G0> create(@l Object obj, @k Continuation<?> continuation) {
        return new d(this.f165953r, continuation);
    }
    ...
    public final Object invokeSuspend(@k Object obj) {
        ...
        int i12 = this.f165952q;
        if (i12 == 0) {
            C42729a0.b(obj);
            b bVar = this.f165953r;
            Z1 z1A = bVar.f165940a.a();
            a aVar = new a(bVar);
            this.f165952q = 1;
