...
public final class q extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ InterfaceC40743a f144794l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(InterfaceC40743a interfaceC40743a) {
        super(0);
        this.f144794l = interfaceC40743a;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f144794l.setState(State.f135881e);
        return G0.f406611a;
    }
}
