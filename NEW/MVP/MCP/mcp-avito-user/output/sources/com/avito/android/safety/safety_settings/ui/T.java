...
final class T extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<com.avito.android.safety.safety_settings.mvi.entity.a, G0> f257849l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public T(Y41.l<? super com.avito.android.safety.safety_settings.mvi.entity.a, G0> lVar) {
        super(0);
        this.f257849l = lVar;
    }
    ...
    public final G0 invoke() {
        this.f257849l.invoke(a.i.f257733a);
        return G0.f406611a;
    }
}
