...
public final class m extends N implements Y41.l<androidx.compose.ui.graphics.drawscope.d, G0> {
    ...
    public final /* synthetic */ r f320906l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.analytics.screens.compose.a f320907m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(r rVar, com.avito.android.analytics.screens.compose.a aVar) {
        super(1);
        this.f320906l = rVar;
        this.f320907m = aVar;
    }
    ...
    public final G0 invoke(androidx.compose.ui.graphics.drawscope.d dVar) {
        dVar.y1();
        com.avito.android.analytics.screens.compose.a aVar = this.f320907m;
        r rVar = this.f320906l;
        if (rVar != null) {
