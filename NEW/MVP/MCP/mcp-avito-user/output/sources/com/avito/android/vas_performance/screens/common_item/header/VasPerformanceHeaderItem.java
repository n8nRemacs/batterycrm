...
@K51.d
@P
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/vas_performance/screens/common_item/header/VasPerformanceHeaderItem;", "Lcom/avito/conveyor_item/ParcelableItem;", "_avito_vas-performance_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final /* data */ class VasPerformanceHeaderItem implements ParcelableItem {
    ...
    @k
    public final String f320397b;

    /* renamed from: c, reason: collision with root package name */
    @k
    public final String f320398c;

    /* renamed from: d, reason: collision with root package name */
    @l
    public final CharSequence f320399d;
    ...
    public final boolean equals(@l Object obj) {
        ...
        return L.f(this.f320397b, vasPerformanceHeaderItem.f320397b) && L.f(this.f320398c, vasPerformanceHeaderItem.f320398c) && L.f(this.f320399d, vasPerformanceHeaderItem.f320399d);
    }
    ...
    public final String getF309824c() {
        return this.f320397b;
    }

    public final int hashCode() {
        int iD2 = H.d(this.f320397b.hashCode() * 31, 31, this.f320398c);
        CharSequence charSequence = this.f320399d;
    ...
    public final String toString() {
        ...
        sb2.append(this.f320397b);
        sb2.append(", title=");
        sb2.append(this.f320398c);
        sb2.append(", description=");
        return AK.c.r(sb2, this.f320399d, ')');
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@k Parcel parcel, int i12) {
        parcel.writeString(this.f320397b);
        parcel.writeString(this.f320398c);
        TextUtils.writeToParcel(this.f320399d, parcel, i12);
    }
}
