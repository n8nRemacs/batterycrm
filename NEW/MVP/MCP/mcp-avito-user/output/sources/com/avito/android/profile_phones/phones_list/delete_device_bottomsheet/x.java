...
final class x extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f227642l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f227642l | 1);
        List<DeviceListItem> list = v.f227633a;
        androidx.compose.runtime.B bE2 = a12.E(185799764);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            d.f227538a.getClass();
            com.akita.compose.theme.re23.c.a(false, d.f227540c, bE2, 48, 1);
        }
