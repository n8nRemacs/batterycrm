...
final class n extends N implements Y41.l<OptionItem, OptionItem> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ OptionItem f130650l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(OptionItem optionItem) {
        super(1);
        this.f130650l = optionItem;
    }

    @Override // Y41.l
    public final OptionItem invoke(OptionItem optionItem) {
        OptionItem optionItem2 = optionItem;
        return OptionItem.a(optionItem2, optionItem2.equals(this.f130650l) && !optionItem2.f130371c, null, 61);
    }
}
