...
final class f extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ StickersBuyVasFragment f321951l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(StickersBuyVasFragment stickersBuyVasFragment) {
        super(1);
        this.f321951l = stickersBuyVasFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f321951l.f321940w0;
        if (aVar == null) {
            aVar = null;
        }
