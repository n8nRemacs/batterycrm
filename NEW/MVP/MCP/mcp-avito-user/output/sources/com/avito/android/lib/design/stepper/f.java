...
final class f<T> implements l41.g {
    ...
    public final /* synthetic */ Stepper f180621b;

    public f(Stepper stepper) {
        this.f180621b = stepper;
    }

    @Override // l41.g
    public final void accept(Object obj) {
        G0 g02;
        Stepper stepper = this.f180621b;
        StepperState stepperState = stepper.f180569b;
        if (stepperState != null) {
            l<Integer, G0> lVar = stepperState.f180610g;
            if (lVar != null) {
