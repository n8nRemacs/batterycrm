...
final class u extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204849l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public u(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204849l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204849l.getViewModel().accept(b.m.f204583b);
        return G0.f406611a;
    }
}
