...
final class g extends N implements r<AbstractC15725a, Map<String, ? extends String>, Prompt, C14258a, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ j f286183l;
    ...
    public final G0 invoke(AbstractC15725a abstractC15725a, Map<String, ? extends String> map, Prompt prompt, C14258a c14258a) {
        j jVar = this.f286183l;
        jVar.f286186b.invoke(new a.i(abstractC15725a, map, prompt, c14258a));
        jVar.f286186b.invoke(a.e.f285783a);
        return G0.f406611a;
    }
}
