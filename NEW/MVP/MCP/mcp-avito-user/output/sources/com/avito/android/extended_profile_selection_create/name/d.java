...
final class d extends N implements l<String, G0> {
    ...
    public final /* synthetic */ ExtendedProfileSetSelectionNameFragment f151843l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(ExtendedProfileSetSelectionNameFragment extendedProfileSetSelectionNameFragment) {
        super(1);
        this.f151843l = extendedProfileSetSelectionNameFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        ExtendedProfileSetSelectionNameFragment.a aVar = ExtendedProfileSetSelectionNameFragment.f151810A0;
        this.f151843l.r5().accept(new a.c(str));
        return G0.f406611a;
    }
}
