...
@K51.d
@P
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/profile_settings_extended/adapter/phones/PhoneVerificationStatusPending;", "Lcom/avito/android/profile_settings_extended/adapter/phones/PhoneVerificationStatus;", "_avito_profile-management_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class PhoneVerificationStatusPending extends PhoneVerificationStatus {
    ...
    public static final class a implements Parcelable.Creator<PhoneVerificationStatusPending> {
        ...
        @Override // android.os.Parcelable.Creator
        public final PhoneVerificationStatusPending[] newArray(int i12) {
            return new PhoneVerificationStatusPending[i12];
        }
    }

    public PhoneVerificationStatusPending(@Y61.k String str) {
        super(str, null);
        this.f229698c = str;
    }
    ...
    public final String getF229698c() {
        return this.f229698c;
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@Y61.k Parcel parcel, int i12) {
        parcel.writeString(this.f229698c);
    }
}
