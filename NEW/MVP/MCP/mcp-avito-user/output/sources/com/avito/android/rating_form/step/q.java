...
final class q extends N implements Y41.l<Exception, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ RatingFormStepFragment f249729l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(RatingFormStepFragment ratingFormStepFragment) {
        super(1);
        this.f249729l = ratingFormStepFragment;
    }

    @Override // Y41.l
    public final G0 invoke(Exception exc) {
        Context context = this.f249729l.getContext();
        if (context != null) {
