...
@P
@s0
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001¨\u0006\u0004"}, d2 = {"Lcom/avito/android/advert_details_items/price_history/f;", "LTV0/d;", "Lcom/avito/android/advert_details_items/price_history/i;", "Lcom/avito/android/advert_details_items/price_history/PriceHistoryItem;", "_avito_advert-details-items_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes10.dex */
public final class f implements TV0.d<i, PriceHistoryItem> {

    /* renamed from: b, reason: collision with root package name */
    @k
    public final com.avito.android.deeplink_handler.handler.composite.a f85397b;

    /* renamed from: c, reason: collision with root package name */
    @k
    public final InterfaceC30570d f85398c;

    /* renamed from: d, reason: collision with root package name */
    @k
    public final C43238h f85399d;
    ...
    public f(@k com.avito.android.deeplink_handler.handler.composite.a aVar, @k InterfaceC30570d interfaceC30570d, @k R0 r02) {
        this.f85397b = aVar;
        this.f85398c = interfaceC30570d;
        this.f85399d = U.a(r02.a());
    }

    @Override // TV0.d
    public final void O5(TV0.e eVar, TV0.a aVar, int i12) {
        i iVar = (i) eVar;
        PriceHistoryItem priceHistoryItem = (PriceHistoryItem) aVar;
        this.f85400e = priceHistoryItem.f85383i;
        this.f85401f = C43175k.K(new C43197r1(new c(this, null), A.a(this.f85398c.c())), this.f85399d);
        boolean z12 = priceHistoryItem.f85385k;
        AttributedText attributedText = priceHistoryItem.f85384j;
        if (z12) {
        ...
        iVar.r20(attributedText, new d(this, priceHistoryItem));
        iVar.d(new e(this));
    }
}
