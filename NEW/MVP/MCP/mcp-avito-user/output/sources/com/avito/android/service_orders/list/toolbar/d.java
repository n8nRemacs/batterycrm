...
final class d extends N implements l<DeepLink, G0> {
    ...
    public final /* synthetic */ e f279437l;
    ...
    public final G0 invoke(DeepLink deepLink) {
        ...
        com.avito.android.service_orders.list.l lVar = this.f279437l.f279438b;
        if (lVar != null && deepLink2 != null) {
            lVar.f279388c.accept(new InterfaceC14531a.q(deepLink2));
        }
        return G0.f406611a;
    }
}
