...
final class e extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCategoryFragment f204889l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(MortgageCategoryFragment mortgageCategoryFragment) {
        super(0);
        this.f204889l = mortgageCategoryFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        MortgageCategoryFragment.a aVar = MortgageCategoryFragment.f204856s0;
        this.f204889l.q5().accept(a.b.f12774a);
        return G0.f406611a;
    }
}
