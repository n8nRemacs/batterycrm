...
final class f extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ ProfilesListFragment f213255l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(ProfilesListFragment profilesListFragment) {
        super(0);
        this.f213255l = profilesListFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        ProfilesListFragment.a aVar = ProfilesListFragment.f213192A0;
        this.f213255l.r5().accept(InterfaceC40238a.e.f395665a);
        return G0.f406611a;
    }
}
