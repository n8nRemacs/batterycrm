...
final class d extends N implements Y41.l<ServiceOrdersListSnippetItem.a, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ k f279337l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ServiceOrdersListSnippetItem f279338m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(ServiceOrdersListSnippetItem serviceOrdersListSnippetItem, k kVar) {
        super(1);
        this.f279337l = kVar;
        this.f279338m = serviceOrdersListSnippetItem;
    }

    @Override // Y41.l
    public final G0 invoke(ServiceOrdersListSnippetItem.a aVar) {
        ServiceOrdersListSnippetItem.a aVar2 = aVar;
        com.avito.android.service_orders.list.l lVar = this.f279337l.f279350b;
        if (lVar != null) {
            lVar.d(this.f279338m.f279231d, aVar2);
        }
        return G0.f406611a;
    }
}
