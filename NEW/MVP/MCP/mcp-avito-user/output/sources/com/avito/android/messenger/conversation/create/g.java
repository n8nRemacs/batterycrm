...
public final class g<T, R> implements l41.o {
    ...
    public final /* synthetic */ l f189571b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ MessengerUserHashInfo f189572c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ ChannelActivityArguments.Create f189573d;

    public g(l lVar, MessengerUserHashInfo messengerUserHashInfo, ChannelActivityArguments.Create create) {
        this.f189571b = lVar;
        this.f189572c = messengerUserHashInfo;
        this.f189573d = create;
    }
    ...
    public final Object apply(Object obj) {
        T next;
        c.a aVar = (c.a) obj;
        String str = ((ChannelActivityArguments.Create.ByItem) this.f189573d).f188884c;
        if (str != null && (aVar instanceof c.a.b)) {
            l lVar = this.f189571b;
            M m12 = lVar.f189581c;
            String str2 = ((c.a.b) aVar).f189525a;
            MessengerUserHashInfo messengerUserHashInfo = this.f189572c;
