...
final class e extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ TarifikatorRegionFragment f135789l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(TarifikatorRegionFragment tarifikatorRegionFragment) {
        super(0);
        this.f135789l = tarifikatorRegionFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        TarifikatorRegionFragment.a aVar = TarifikatorRegionFragment.f135744D0;
        this.f135789l.r5().accept(InterfaceC17050a.c.f19133a);
        return G0.f406611a;
    }
}
