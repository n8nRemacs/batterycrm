...
final class i extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ l f309428l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ c f309429m;
    ...
    public final G0 invoke(Integer num) {
        ...
        MyAdvertDetailsActivity myAdvertDetailsActivity = this.f309428l.f309434b;
        if (myAdvertDetailsActivity != null) {
            myAdvertDetailsActivity.g2(this.f309429m, iIntValue);
        }
        return G0.f406611a;
    }
}
