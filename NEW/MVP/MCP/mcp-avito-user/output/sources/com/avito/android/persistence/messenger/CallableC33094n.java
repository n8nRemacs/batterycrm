...
/* renamed from: com.avito.android.persistence.messenger.n, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
class CallableC33094n implements Callable<List<Y>> {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ androidx.room.F0 f215520b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ X f215521c;

    public CallableC33094n(X x12, androidx.room.F0 f02) {
        this.f215521c = x12;
        this.f215520b = f02;
    }
    ...
    public final List<Y> call() throws Throwable {
        ...
        Long lValueOf;
        int i13;
        MessengerDatabase_Impl messengerDatabase_Impl = this.f215521c.f215334a;
        messengerDatabase_Impl.c();
        try {
            try {
                Cursor cursorB = V1.c.b(messengerDatabase_Impl, this.f215520b, false);
                try {
