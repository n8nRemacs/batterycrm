...
final class d extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ l<h0, G0> f193213l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ T1.d f193214m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public d(l<? super h0, G0> lVar, T1.d dVar) {
        super(0);
        this.f193213l = lVar;
        this.f193214m = dVar;
    }
    ...
    public final G0 invoke() {
        T1.d dVar = this.f193214m;
        this.f193213l.invoke(new h0.j(dVar.f189168c, dVar.f189180o));
        return G0.f406611a;
    }
}
