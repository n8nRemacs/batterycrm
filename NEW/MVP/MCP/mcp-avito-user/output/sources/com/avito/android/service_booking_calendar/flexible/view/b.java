...
final class b extends N implements l<o, G0> {
    static {
        new b();
    }
    ...
    public final G0 invoke(o oVar) {
        o oVar2 = oVar;
        oVar2.h(R.string.service_booking_calendar_add_booking_tooltip_title);
        oVar2.a(R.string.service_booking_calendar_add_booking_tooltip_body);
        return G0.f406611a;
    }
}
