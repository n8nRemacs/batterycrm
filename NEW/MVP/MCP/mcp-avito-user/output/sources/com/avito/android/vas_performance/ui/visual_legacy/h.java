...
final class h extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ VisualVasFragment f322112l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(VisualVasFragment visualVasFragment) {
        super(1);
        this.f322112l = visualVasFragment;
    }

    @Override // Y41.l
    public final G0 invoke(Integer num) {
        int iIntValue = num.intValue();
        m mVar = this.f322112l.f322086q0;
        if (mVar == null) {
            mVar = null;
        }
        mVar.c6(Integer.valueOf(iIntValue));
        return G0.f406611a;
    }
}
