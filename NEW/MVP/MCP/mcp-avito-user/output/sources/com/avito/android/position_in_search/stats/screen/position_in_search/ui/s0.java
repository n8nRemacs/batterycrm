...
final class s0 extends kotlin.jvm.internal.N implements Y41.l<C27242f.c.b, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC22204y1<Boolean> f221723l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s0(InterfaceC22204y1<Boolean> interfaceC22204y1) {
        super(1);
        this.f221723l = interfaceC22204y1;
    }

    @Override // Y41.l
    public final G0 invoke(C27242f.c.b bVar) {
        this.f221723l.setValue(Boolean.FALSE);
        return G0.f406611a;
    }
}
