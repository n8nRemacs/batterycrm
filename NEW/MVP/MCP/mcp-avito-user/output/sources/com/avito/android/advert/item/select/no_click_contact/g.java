...
final class g extends N implements Y41.p<String, String, G0> {
    ...
    public final /* synthetic */ d f79453l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ t f79454m;
    ...
    public final G0 invoke(String str, String str2) {
        ...
        d dVar = this.f79453l;
        if (str3.length() == 10) {
            b.a.a(dVar.f79445c, dVar.f79448f.get().b(C43066x.a0(str4, ".phone_number", "7".concat(str3), false)), null, null, 6);
        } else {
            this.f79454m.D6();
        }
        return G0.f406611a;
