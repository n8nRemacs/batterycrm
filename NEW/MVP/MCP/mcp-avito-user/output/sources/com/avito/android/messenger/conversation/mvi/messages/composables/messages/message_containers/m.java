...
final class m extends N implements Y41.l<androidx.compose.ui.graphics.drawscope.g, G0> {
    ...
    public final /* synthetic */ C20268c<T, C20327w> f192415l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(C20268c<T, C20327w> c20268c) {
        super(1);
        this.f192415l = c20268c;
    }

    @Override // Y41.l
    public final G0 invoke(androidx.compose.ui.graphics.drawscope.g gVar) {
        androidx.compose.ui.graphics.drawscope.g.c0(gVar, this.f192415l.f().f39331a, 0L, 0L, 0.0f, null, WebSocketProtocol.PAYLOAD_SHORT);
        return G0.f406611a;
    }
}
