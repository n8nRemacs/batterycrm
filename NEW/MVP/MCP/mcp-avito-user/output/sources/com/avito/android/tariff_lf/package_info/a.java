...
final class a extends N implements l<List<? extends com.avito.conveyor_item.a>, G0> {
    ...
    public final /* synthetic */ TariffPackageInfoFragment f299175l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(TariffPackageInfoFragment tariffPackageInfoFragment) {
        super(1);
        this.f299175l = tariffPackageInfoFragment;
    }

    @Override // Y41.l
    public final G0 invoke(List<? extends com.avito.conveyor_item.a> list) {
        List<? extends com.avito.conveyor_item.a> list2 = list;
        TariffPackageInfoFragment tariffPackageInfoFragment = this.f299175l;
        com.avito.konveyor.adapter.a aVar = tariffPackageInfoFragment.f299163o0;
        if (aVar == null) {
            aVar = null;
        }
        com.avito.android.authorization.auto_recovery.phone_confirm.b.p(aVar, list2);
        j jVar = tariffPackageInfoFragment.f299164p0;
