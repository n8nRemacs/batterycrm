...
@P
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/edit_text_field/s;", "Lcom/avito/android/edit_text_field/p;", "_avito_profile-management_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes13.dex */
public final class s implements p {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final Fragment f147031a;

    /* renamed from: b, reason: collision with root package name */
    public final int f147032b;

    @Inject
    public s(@Y61.k Fragment fragment, @j.D int i12) {
        this.f147031a = fragment;
        this.f147032b = i12;
    }
    ...
    public final void a(@Y61.k String str, @Y61.l String str2, @Y61.l String str3, @Y61.l String str4) {
        ...
        editTextFieldFragment.show(this.f147031a.getChildFragmentManager(), "edit_text_fragment_tag");
    }
    ...
    public final void b() {
        ...
        androidx.fragment.app.H hE2 = this.f147031a.getChildFragmentManager().e();
        hE2.j(this.f147032b, editSellerTypeFragmentA, "edit_seller_type_fragment_tag", 1);
        hE2.c(null);
        hE2.e();
    }
    ...
    public final boolean d() {
        Fragment fragmentH = this.f147031a.getChildFragmentManager().H("edit_text_fragment_tag");
        if (fragmentH == null) {
            return false;
        }
