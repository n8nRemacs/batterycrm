...
/* compiled from: QueryItemPayloadFactory.kt */
@P
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0007¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, d2 = {"Lcom/avito/android/position_in_search/stats/screen/old_position_in_search/view/items/query/d;", "Lcom/avito/android/position_in_search/stats/screen/old_position_in_search/view/items/b$a;", "Lcom/avito/android/position_in_search/stats/screen/old_position_in_search/view/items/query/a;", "<init>", "()V", "_avito_position-in-search_stats_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class d implements b.a<a> {
    ...
    public final Object a(com.avito.android.position_in_search.stats.screen.old_position_in_search.view.items.a aVar, com.avito.android.position_in_search.stats.screen.old_position_in_search.view.items.a aVar2) {
        ...
        if (!L.f(aVar3.f221085c, aVar4.f221085c)) {
            arrayList.add(a.b.c.f221095a);
        }
        if (!L.f(aVar3.f221086d, aVar4.f221086d)) {
            arrayList.add(a.b.C6686a.f221093a);
        }
        if (!aVar3.f221087e.equals(aVar4.f221087e)) {
            arrayList.add(a.b.d.f221096a);
        }
        if (!L.f(aVar3.f221088f, aVar4.f221088f)) {
            arrayList.add(a.b.e.f221097a);
        }
        if (aVar3.f221090h != aVar4.f221090h) {
            arrayList.add(a.b.C6687b.f221094a);
        }
        return new a.C6685a(arrayList);
    }
