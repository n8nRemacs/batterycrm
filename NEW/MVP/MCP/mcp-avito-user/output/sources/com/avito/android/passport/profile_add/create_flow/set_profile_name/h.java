...
final class h extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ SetProfileNameFragment f212115l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(SetProfileNameFragment setProfileNameFragment) {
        super(0);
        this.f212115l = setProfileNameFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        SetProfileNameFragment.a aVar = SetProfileNameFragment.f212039E0;
        this.f212115l.v5().accept(a.b.f16911a);
        return G0.f406611a;
    }
}
