...
final class h extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f117055l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f117055l | 1);
        androidx.compose.runtime.B bE2 = a12.E(1918490347);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            C29371a.f117028a.getClass();
            com.akita.compose.theme.re23.c.a(false, C29371a.f117030c, bE2, 48, 1);
        }
