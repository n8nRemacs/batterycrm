...
public final class l<T, R> implements o {
    ...
    public final /* synthetic */ m f191659b;
    ...
    public final Object apply(Object obj) {
        ...
        m mVar = this.f191659b;
        mVar.getClass();
        MessageBody body = localMessage.getBody();
        boolean z12 = body instanceof MessageBody.File ? true : body instanceof MessageBody.Voice;
        InterfaceC32024m interfaceC32024m = mVar.f191660a;
        InterfaceC35745a5 interfaceC35745a5 = mVar.f191663d;
        return (z12 ? new r(new CallableC13028a(19, mVar, localMessage)).g(interfaceC32024m.N(localMessage.getChannelId(), localMessage.getLocalId(), com.avito.android.messenger.util.i.c(localMessage))).x(interfaceC35745a5.a()).q(interfaceC35745a5.a()) : interfaceC32024m.N(localMessage.getChannelId(), localMessage.getLocalId(), com.avito.android.messenger.util.i.c(localMessage)).x(interfaceC35745a5.a()).q(interfaceC35745a5.a())).B(Boolean.TRUE);
    }
}
