...
/* renamed from: com.avito.android.persistence.messenger.c0, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
class C33051c0 extends androidx.room.L<Z> {
    @Override // androidx.room.O0
    @j.N
    public final String b() {
        return "INSERT OR IGNORE INTO `channel_meta_data` (`local_user_id`,`channel_id`,`last_synced_message_timestamp`,`sellers_suggests_enabled`,`deleted_locally_timestamp`,`local_user_type`,`local_user_account_id`) VALUES (?,?,?,?,?,?,?)";
    }
