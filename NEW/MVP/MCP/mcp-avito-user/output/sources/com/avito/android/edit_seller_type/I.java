...
public final class I extends N implements Y41.r<InterfaceC20793y, Integer, androidx.compose.runtime.A, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ArrayList f146696l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l f146697m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public I(Y41.l lVar, ArrayList arrayList) {
        super(4);
        this.f146696l = arrayList;
        this.f146697m = lVar;
    }
    ...
    public final G0 invoke(InterfaceC20793y interfaceC20793y, Integer num, androidx.compose.runtime.A a12, Integer num2) {
        ...
        if (a13.p(i12 & 1, (i12 & 147) != 146)) {
            c.e eVar = (c.e) this.f146696l.get(iIntValue);
            a13.C(-1463519076);
            o.c(eVar, new E(this.f146697m, eVar), a13, 8);
            a13.h();
        } else {
            a13.f();
        }
