...
@DebugMetadata(c = "com.avito.android.iac_dialer_finished.impl_module.screens.finished_mic_request_screen.mvi.IacFinishedMicRequestScreenActor$onRecallClicked$1", f = "IacFinishedMicRequestScreenActor.kt", i = {}, l = {63}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes14.dex */
final class c extends SuspendLambda implements Y41.p<InterfaceC43172j<? super IacFinishedMicRequestScreenInternalAction>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f166762q;

    /* renamed from: r, reason: collision with root package name */
    public /* synthetic */ Object f166763r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ IacFinishedMicRequestScreenState f166764s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(IacFinishedMicRequestScreenState iacFinishedMicRequestScreenState, Continuation<? super c> continuation) {
        super(2, continuation);
        this.f166764s = iacFinishedMicRequestScreenState;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        c cVar = new c(this.f166764s, continuation);
        cVar.f166763r = obj;
        return cVar;
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f166762q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43172j interfaceC43172j = (InterfaceC43172j) this.f166763r;
            IacFinishedMicRequestScreenState iacFinishedMicRequestScreenState = this.f166764s;
            if (!(iacFinishedMicRequestScreenState instanceof IacFinishedMicRequestScreenState.Granted)) {
                return G0.f406611a;
            }
            IacFinishedMicRequestScreenInternalAction.HandleDeeplink handleDeeplink = new IacFinishedMicRequestScreenInternalAction.HandleDeeplink(new IacPiiDeepLink(new IacMakeRecallLink(iacFinishedMicRequestScreenState.getArgument().getCallId(), iacFinishedMicRequestScreenState.getArgument().getItemId())));
            this.f166762q = 1;
