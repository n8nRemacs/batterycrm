...
final class d extends N implements p<A, Integer, G0> {
    ...
    public final /* synthetic */ int f145094l;
    ...
    public final G0 invoke(A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f145094l | 1);
        B bE2 = a12.E(-1698248288);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            EarlyAccessBannerItem earlyAccessBannerItem = new EarlyAccessBannerItem(null, "Это объявление от собственника, такое жильё уходит быстро", new Image(Collections.singletonMap(new Size(192, 192), Uri.parse("https://avito.st/static/ims/c15b7d76-7f6b-4ac7-a203-2f7c3d1316af_prodazha_ot_sobstvennika_re_day_common_192x192.png"))), BannerType.f145077c, 1, null);
            v.a aVar = v.f42878y1;
