...
final class A extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<com.avito.android.safety.safety_settings.mvi.entity.a, G0> f257812l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public A(Y41.l<? super com.avito.android.safety.safety_settings.mvi.entity.a, G0> lVar) {
        super(0);
        this.f257812l = lVar;
    }
    ...
    public final G0 invoke() {
        this.f257812l.invoke(a.h.f257732a);
        return G0.f406611a;
    }
}
