...
final class a extends N implements p<String, Bundle, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ExpensesTabFragment f317544l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(ExpensesTabFragment expensesTabFragment) {
        super(2);
        this.f317544l = expensesTabFragment;
    }

    @Override // Y41.p
    public final G0 invoke(String str, Bundle bundle) {
        ExpensesTabFragment.a aVar = ExpensesTabFragment.f317520y0;
        ExpensesTabFragment expensesTabFragment = this.f317544l;
        expensesTabFragment.q5().accept(a.p.f14330a);
        Parcelable parcelable = bundle.getParcelable("requestConfig");
        if (parcelable == null) {
            throw new IllegalArgumentException("Required value was null.");
        }
        expensesTabFragment.q5().accept(new a.w((StatsConfig) parcelable));
        return G0.f406611a;
    }
}
