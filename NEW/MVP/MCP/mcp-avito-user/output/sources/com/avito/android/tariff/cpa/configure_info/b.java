...
final class b extends N implements l<List<? extends com.avito.conveyor_item.a>, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ CpaConfigureInfoFragment f294455l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(CpaConfigureInfoFragment cpaConfigureInfoFragment) {
        super(1);
        this.f294455l = cpaConfigureInfoFragment;
    }

    @Override // Y41.l
    public final G0 invoke(List<? extends com.avito.conveyor_item.a> list) {
        List<? extends com.avito.conveyor_item.a> list2 = list;
        CpaConfigureInfoFragment cpaConfigureInfoFragment = this.f294455l;
        com.avito.konveyor.adapter.a aVar = cpaConfigureInfoFragment.f294440n0;
        if (aVar == null) {
            aVar = null;
        }
        com.avito.android.authorization.auto_recovery.phone_confirm.b.p(aVar, list2);
        j jVar = cpaConfigureInfoFragment.f294441o0;
