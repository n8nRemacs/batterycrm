...
final class c extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ AvitoAccordionState f175502l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(AvitoAccordionState avitoAccordionState) {
        super(0);
        this.f175502l = avitoAccordionState;
    }

    @Override // Y41.a
    public final G0 invoke() {
        Y41.a<G0> aVar = this.f175502l.f333701f;
        if (aVar != null) {
            aVar.invoke();
        }
        return G0.f406611a;
