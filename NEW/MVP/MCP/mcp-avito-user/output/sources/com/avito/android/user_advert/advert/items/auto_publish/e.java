...
final class e extends N implements l<Boolean, G0> {
    ...
    public final /* synthetic */ g f309249l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ a f309250m;
    ...
    public final G0 invoke(Boolean bool) {
        ...
        MyAdvertDetailsActivity myAdvertDetailsActivity = this.f309249l.f309254c;
        if (myAdvertDetailsActivity != null) {
            myAdvertDetailsActivity.b2(this.f309250m, zBooleanValue);
        }
        return G0.f406611a;
    }
}
