...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/service_booking_settings/work_hours/item/booking_restrictions/h;", "LTV0/e;", "_avito_service-booking-settings_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public interface h extends TV0.e {
    ...
    void HA(@l Option option);

    void f(@k String str);

    void hn(@k Y41.a<G0> aVar);
