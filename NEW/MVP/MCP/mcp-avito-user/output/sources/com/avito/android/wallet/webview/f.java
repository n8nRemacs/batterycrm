...
final class f extends N implements Y41.l<Throwable, G0> {
    ...
    public final /* synthetic */ WalletWebViewActivity f329410l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(WalletWebViewActivity walletWebViewActivity) {
        super(1);
        this.f329410l = walletWebViewActivity;
    }
    ...
    public final G0 invoke(Throwable th2) {
        if (th2 instanceof TimeoutException) {
            ...
            this.f329410l.b2().accept(InterfaceC49873a.c.f442461a);
        }
        return G0.f406611a;
    }
}
