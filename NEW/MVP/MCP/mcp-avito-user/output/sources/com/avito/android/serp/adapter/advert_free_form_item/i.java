...
final class i extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ l f268722l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ SerpConstructorAdvertItem f268723m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(l lVar, SerpConstructorAdvertItem serpConstructorAdvertItem) {
        super(1);
        this.f268722l = lVar;
        this.f268723m = serpConstructorAdvertItem;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        q qVar = this.f268722l.f268735h.get();
        String f154734b = this.f268723m.getF154734b();
        ContactSource contactSource = ContactSource.f89919d;
        qVar.i(deepLink, f154734b);
        return G0.f406611a;
    }
}
