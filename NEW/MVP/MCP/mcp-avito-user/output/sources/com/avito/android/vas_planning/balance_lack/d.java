...
final class d extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ VasPlanBalanceLackDialogFragment f322215l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(VasPlanBalanceLackDialogFragment vasPlanBalanceLackDialogFragment) {
        super(1);
        this.f322215l = vasPlanBalanceLackDialogFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f322215l.f322203k0;
        if (aVar == null) {
            aVar = null;
        }
