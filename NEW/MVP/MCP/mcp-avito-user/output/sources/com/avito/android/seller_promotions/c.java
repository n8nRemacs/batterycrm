...
final class c extends N implements Y41.l<Bundle, G0> {
    ...
    public final /* synthetic */ SellerPromotionsArguments f267669l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(SellerPromotionsArguments sellerPromotionsArguments) {
        super(1);
        this.f267669l = sellerPromotionsArguments;
    }

    @Override // Y41.l
    public final G0 invoke(Bundle bundle) {
        bundle.putParcelable("promotionData", this.f267669l);
        return G0.f406611a;
    }
}
