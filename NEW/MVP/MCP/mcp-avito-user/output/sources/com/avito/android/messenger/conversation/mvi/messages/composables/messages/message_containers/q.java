...
final class q extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f192441l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f192441l | 1);
        androidx.compose.runtime.B bE2 = a12.E(-1833781177);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            C32133b.f192306a.getClass();
            com.akita.compose.theme.re23.c.a(false, C32133b.f192312g, bE2, 48, 1);
        }
