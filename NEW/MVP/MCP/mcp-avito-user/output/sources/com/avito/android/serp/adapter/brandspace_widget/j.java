...
final class j<T> implements l41.g {
    ...
    public final /* synthetic */ n f269053b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ int f269054c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ BrandspaceWidgetItem f269055d;

    public j(n nVar, int i12, BrandspaceWidgetItem brandspaceWidgetItem) {
        this.f269053b = nVar;
        this.f269054c = i12;
        this.f269055d = brandspaceWidgetItem;
    }

    @Override // l41.g
    public final void accept(Object obj) {
        n nVar = this.f269053b;
        Integer numValueOf = Integer.valueOf(this.f269054c);
        BrandspaceWidgetItem brandspaceWidgetItem = this.f269055d;
