...
final class x extends N implements Y41.l<TextView, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ AbstractC32118b.C5660b f191822l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(AbstractC32118b.C5660b c5660b) {
        super(1);
        this.f191822l = c5660b;
    }

    @Override // Y41.l
    public final G0 invoke(TextView textView) {
        this.f191822l.getClass();
