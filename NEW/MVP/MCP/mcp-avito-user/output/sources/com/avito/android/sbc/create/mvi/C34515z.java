...
@DebugMetadata(c = "com.avito.android.sbc.create.mvi.CreateDiscountDispatchActor$handle$$inlined$flowWithAccessToStateFromOverloaded$14", f = "CreateDiscountDispatchActor.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* renamed from: com.avito.android.sbc.create.mvi.z, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C34515z extends SuspendLambda implements Y41.p<InterfaceC43172j<? super Uo0.f>, Continuation<? super kotlin.G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public /* synthetic */ Object f259939q;

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.arch.mvi.utils.o f259940r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ e.C15551f f259941s;

    /* renamed from: t, reason: collision with root package name */
    public final /* synthetic */ C34469a f259942t;

    /* compiled from: PrivateStateHolder.kt */
    @kotlin.jvm.internal.s0
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.avito.android.sbc.create.mvi.z$a */
    ...
    public C34515z(com.avito.android.arch.mvi.utils.o oVar, e.C15551f c15551f, Continuation continuation, C34469a c34469a) {
        super(2, continuation);
        this.f259940r = oVar;
        this.f259941s = c15551f;
        this.f259942t = c34469a;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<kotlin.G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        C34515z c34515z = new C34515z(this.f259940r, this.f259941s, continuation, this.f259942t);
        c34515z.f259939q = obj;
        return c34515z;
    }

    @Override // Y41.p
    public final Object invoke(InterfaceC43172j<? super Uo0.f> interfaceC43172j, Continuation<? super kotlin.G0> continuation) {
        return ((C34515z) create(interfaceC43172j, continuation)).invokeSuspend(kotlin.G0.f406611a);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        C42729a0.b(obj);
        InterfaceC43172j interfaceC43172j = (InterfaceC43172j) this.f259939q;
        Object value = this.f259940r.f92114c.getValue();
        ...
        if (createDiscountDispatchState instanceof CreateDiscountDispatchState.DiscountDispatchDataLoaded) {
            ...
            CreateDiscountDispatchState.DiscountDispatchDataLoaded.i.a aVar = iVar instanceof CreateDiscountDispatchState.DiscountDispatchDataLoaded.i.a ? (CreateDiscountDispatchState.DiscountDispatchDataLoaded.i.a) iVar : null;
            if (aVar != null && !aVar.f259703f) {
                C34469a c34469a = this.f259942t;
                ...
                interfaceC28373a.c(new Oo0.p(strA, c34469a.f259554o, Boxing.boxLong(discountDispatchDataLoaded.f259622b), c34469a.D(), boolBoxBoolean, discountDispatchDataLoaded.f259627g, C43066x.z0(discountDispatchDataLoaded.f259641u), discountDispatchDataLoaded.f259623c.getF259734b(), c34469a.C()));
            }
        }
