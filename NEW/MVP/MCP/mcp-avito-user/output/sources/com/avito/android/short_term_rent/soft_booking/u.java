...
final class u extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ StrSoftBookingFragment f282882l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public u(StrSoftBookingFragment strSoftBookingFragment) {
        super(0);
        this.f282882l = strSoftBookingFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        kotlin.reflect.n<Object>[] nVarArr = StrSoftBookingFragment.f282537y0;
        this.f282882l.q5().accept(InterfaceC44950a.g.f422339a);
        return G0.f406611a;
    }
}
