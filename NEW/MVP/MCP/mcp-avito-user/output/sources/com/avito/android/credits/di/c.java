...
public final class c implements InterfaceC28898u {
    ...
    public final Class<?> a() {
        return CreditPartnerFragmentData.class;
    }

    @Override // com.avito.android.bottom_navigation.InterfaceC28898u
    @Y61.k
    public final TabBaseFragment b(@Y61.k TabFragmentFactory.Data data) {
        CreditPartnerFragment.f128738H0.getClass();
        CreditPartnerFragment creditPartnerFragment = new CreditPartnerFragment();
        creditPartnerFragment.f128747t0.setValue(creditPartnerFragment, CreditPartnerFragment.f128739I0[0], ((CreditPartnerFragmentData) data).f128761b);
