...
final class j extends N implements Y41.p<ContactInfoFieldId, String, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ApplicationContactInfoFragment f205664l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(ApplicationContactInfoFragment applicationContactInfoFragment) {
        super(2);
        this.f205664l = applicationContactInfoFragment;
    }
    ...
    public final G0 invoke(ContactInfoFieldId contactInfoFieldId, String str) {
        ...
        this.f205664l.q5().accept(new InterfaceC25394a.e(contactInfoFieldId, str));
        return G0.f406611a;
    }
}
