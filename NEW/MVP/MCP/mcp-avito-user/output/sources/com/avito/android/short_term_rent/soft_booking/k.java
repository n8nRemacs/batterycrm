...
final class k extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ StrSoftBookingFragment f282664l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(StrSoftBookingFragment strSoftBookingFragment) {
        super(0);
        this.f282664l = strSoftBookingFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        kotlin.reflect.n<Object>[] nVarArr = StrSoftBookingFragment.f282537y0;
        this.f282664l.q5().accept(InterfaceC44950a.m.f422347a);
        return G0.f406611a;
    }
}
