...
final class g<T> implements r {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ PermissionSystemRequestLink f166280b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ String f166281c;

    public g(PermissionSystemRequestLink permissionSystemRequestLink, String str) {
        this.f166280b = permissionSystemRequestLink;
        this.f166281c = str;
    }
    ...
    public final boolean test(Object obj) {
        ...
        if (L.f(aVar.f134520a, this.f166280b)) {
            if (L.f(aVar.f134521b, this.f166281c)) {
                return true;
            }
        }
        return false;
