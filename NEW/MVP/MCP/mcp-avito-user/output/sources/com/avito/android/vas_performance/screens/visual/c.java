...
final class c extends N implements l<DeepLink, G0> {
    ...
    public final /* synthetic */ VisualVasFragment f320989l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(VisualVasFragment visualVasFragment) {
        super(1);
        this.f320989l = visualVasFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f320989l.f320964u0;
        if (aVar == null) {
            aVar = null;
        }
