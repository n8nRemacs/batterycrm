...
final class c extends N implements Y41.l<Bundle, G0> {
    ...
    public final /* synthetic */ DeliveryTarifikatorParams f135556l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(DeliveryTarifikatorParams deliveryTarifikatorParams) {
        super(1);
        this.f135556l = deliveryTarifikatorParams;
    }

    @Override // Y41.l
    public final G0 invoke(Bundle bundle) {
        bundle.putParcelable("TARIFIKATOR_MAIN_PARAMS", this.f135556l);
        return G0.f406611a;
    }
}
