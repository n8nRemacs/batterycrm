...
final class f extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ JobCvPackagesActivity f174389l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(JobCvPackagesActivity jobCvPackagesActivity) {
        super(1);
        this.f174389l = jobCvPackagesActivity;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        int i12 = JobCvPackagesActivity.f174316r;
        ((k) this.f174389l.f174318n.getValue()).accept(new b.C2044b(deepLink));
        return G0.f406611a;
    }
}
