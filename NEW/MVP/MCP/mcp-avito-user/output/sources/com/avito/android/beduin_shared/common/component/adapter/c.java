...
public final class c extends b {
    ...
    @l
    public Integer f105273e;

    /* renamed from: f, reason: collision with root package name */
    @l
    public AbstractC40112a<BeduinModel, InterfaceC40116e> f105274f;

    /* renamed from: g, reason: collision with root package name */
    @k
    public List<? extends AbstractC40112a<BeduinModel, InterfaceC40116e>> f105275g = C42784z0.f406748b;
    ...
    public final int getItemCount() {
        return this.f105275g.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final int getItemViewType(int i12) {
        AbstractC40112a<BeduinModel, InterfaceC40116e> abstractC40112a = this.f105275g.get(i12);
        this.f105274f = abstractC40112a;
    ...
    */
    public final androidx.recyclerview.widget.RecyclerView.C onCreateViewHolder(android.view.ViewGroup r5, int r6) {
        /*
            r4 = this;
            ej.a<com.avito.android.beduin_models.BeduinModel, ej.e> r0 = r4.f105274f
            if (r0 == 0) goto Lf
            int r1 = r4.j(r0)
            if (r1 != r6) goto Lb
            goto Lc
        ...
        Lc:
            ...
            goto L2a
        Lf:
            java.util.List<? extends ej.a<com.avito.android.beduin_models.BeduinModel, ej.e>> r0 = r4.f105275g
        ...
        L17:
            ...
            r0 = r1
        L2a:
            java.lang.Integer r6 = r4.f105273e
            if (r6 == 0) goto L33
            int r1 = r6.intValue()
            goto L35
        L33:
    ...
    public final void onViewAttachedToWindow(RecyclerView.C c12) {
        b.a aVar = (b.a) c12;
        Object objK = C42745f0.K(aVar.getAdapterPosition(), this.f105275g);
