...
@DebugMetadata(c = "com.avito.beduin.v2.interaction.network.flow.HttpRequestInteractionHandler$handle$2", f = "HttpRequestInteractionHandler.kt", i = {}, l = {99}, m = "invokeSuspend", n = {}, s = {})
...
final class e extends SuspendLambda implements Y41.p<InterfaceC43172j<? super dU0.f>, Continuation<? super G0>, Object> {
    ...
    public /* synthetic */ Object f337616r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ a f337617s;
    ...
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        e eVar = new e(this.f337617s, continuation);
        eVar.f337616r = obj;
        return eVar;
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f337615q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43172j interfaceC43172j = (InterfaceC43172j) this.f337616r;
            RU0.b bVar = RU0.b.f14467a;
            LogLevel[] logLevelArr = LogLevel.f337864b;
            bVar.getClass();
            if (1 >= RU0.b.f14469c) {
                RU0.b.f14468b.d(RU0.b.f14470d + ":HttpRequest", "onStarted");
            }
            dU0.f fVar = (dU0.f) ((a.C10458a.b) this.f337617s.f337577h).invoke();
            if (fVar != null) {
                this.f337615q = 1;
