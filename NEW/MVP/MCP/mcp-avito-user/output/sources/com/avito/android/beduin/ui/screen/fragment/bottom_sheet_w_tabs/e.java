...
final class e extends N implements Y41.l<List<? extends BeduinAction>, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ BottomSheetWithTabsScreenFragment f104238l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(BottomSheetWithTabsScreenFragment bottomSheetWithTabsScreenFragment) {
        super(1);
        this.f104238l = bottomSheetWithTabsScreenFragment;
    }

    @Override // Y41.l
    public final G0 invoke(List<? extends BeduinAction> list) {
        this.f104238l.q5().ke(list);
        return G0.f406611a;
    }
}
