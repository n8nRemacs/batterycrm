...
final class B extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f167194l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f167194l | 1);
        androidx.compose.runtime.B bE2 = a12.E(-639153190);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            n.f167217a.getClass();
            com.akita.compose.theme.re23.c.a(false, n.f167218b, bE2, 48, 1);
        }
