...
final class g extends N implements Y41.l<Boolean, G0> {
    ...
    public final /* synthetic */ m f316505l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ UserAdvertItem f316506m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(m mVar, UserAdvertItem userAdvertItem) {
        super(1);
        this.f316505l = mVar;
        this.f316506m = userAdvertItem;
    }

    @Override // Y41.l
    public final G0 invoke(Boolean bool) {
        boolean zBooleanValue = bool.booleanValue();
        com.avito.android.user_adverts_views_pub.a aVar = this.f316505l.f316516b.get();
        UserAdvertItem userAdvertItem = this.f316506m;
