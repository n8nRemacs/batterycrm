...
final class i extends N implements Y41.l<Image, Boolean> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ TV0.a f225448l;
    ...
    public final Boolean invoke(Image image) {
        return Boolean.valueOf(!L.f(image, ((com.avito.android.profile.user_profile.cards.service_booking.items.order.ServiceBookingItem) this.f225448l).f225458f));
    }
}
