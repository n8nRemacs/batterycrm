...
final class B extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204034l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public B(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204034l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204034l.getViewModel().accept(b.r.C6101b.f204589b);
        return G0.f406611a;
    }
}
