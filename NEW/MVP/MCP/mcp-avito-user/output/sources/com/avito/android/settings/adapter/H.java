...
final class H extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ I f280738l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ i0.f f280739m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public H(I i12, i0.f fVar) {
        super(0);
        this.f280738l = i12;
        this.f280739m = fVar;
    }
    ...
    public final G0 invoke() {
        this.f280738l.f280740b.invoke(new InterfaceC14616a.c(this.f280739m.f280792b));
        return G0.f406611a;
    }
}
