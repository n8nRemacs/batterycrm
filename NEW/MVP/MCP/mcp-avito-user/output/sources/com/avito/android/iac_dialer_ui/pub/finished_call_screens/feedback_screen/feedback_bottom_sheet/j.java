...
final class j extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ InterfaceC22204y1<String> f167574l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(InterfaceC22204y1<String> interfaceC22204y1) {
        super(1);
        this.f167574l = interfaceC22204y1;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        IacUIFeedbackBottomSheetState iacUIFeedbackBottomSheetState = A.f167550a;
        this.f167574l.setValue(str);
        return G0.f406611a;
    }
}
