...
@s0
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n¢\u0006\u0002\b\u0003"}, d2 = {"<anonymous>", "Lcom/avito/android/remote/model/SerpAdvertXl;", "Landroid/os/Parcel;", "invoke"}, k = 3, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes17.dex */
public final class SerpAdvertXl$Companion$CREATOR$1 extends N implements l<Parcel, SerpAdvertXl> {
    ...
    @Override // Y41.l
    @k
    public final SerpAdvertXl invoke(@k Parcel parcel) {
        Long l12;
        String str;
        String str2;
        C20199a c20199a;
        ...
        SerpAdvertDelivery serpAdvertDelivery = ((String) value) != null ? new SerpAdvertDelivery() : null;
        ...
        if (i12 < 0) {
            ...
            while (i12 > 0) {
                ...
                c20199a2.put(str5, (String) value6);
                i12--;
                string7 = str3;
                string6 = str4;
                l13 = l14;
        ...
        return new SerpAdvertXl(string, string2, string3, string4, serpAdvertDelivery, deliveryTerms, string5, coordinates, l12, str, str2, string9, advertImage, nameIdEntity, nameIdEntity2, serpSellerVerification, arrayListCreateStringArrayList, universalColor, string10, string11, string12, string13, string14, string15, discountIcon, priceList, string16, video, string17, zC2, bool, bool2, deepLink, c20199a, serpAdvertStr, parcel.readLong(), listA, listA2, action, string18, legacySerpAdvertBadge, serpBadgeBar, advertItemActions, advertActions, radiusInfo, listA3, quorumFilterInfo, advertSellerInfo, gigShiftInfo, bool3, bool4, string19, arrayListCreateStringArrayList2, string20, string21, string8, (Action) parcel.readParcelable(Action.class.getClassLoader()), (Action) parcel.readParcelable(Action.class.getClassLoader()), num, zC3, string22, serpAdvertSpecification, bool5, Boolean.valueOf(zC4), realtorBonus, badgeSticker, snippetType, buyWithDeliveryButton, keyAttributes, buyerBonuses, null, hotelRating, geoDistance, strRatingAndReviews, bool6, (Boolean) value12, (TravelInstallments) parcel.readParcelable(TravelInstallments.class.getClassLoader()), (AdvertTravelPriceVersion) parcel.readParcelable(AdvertTravelPriceVersion.class.getClassLoader()), 0, 0, 64, null);
    }
}
