...
final class f extends N implements Y41.r<String, Double, Double, VideoStopReason, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ z f269668l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ SerpConstructorAdvertItem f269669m;

    /* renamed from: n, reason: collision with root package name */
    public final /* synthetic */ int f269670n;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(z zVar, SerpConstructorAdvertItem serpConstructorAdvertItem, int i12) {
        super(4);
        this.f269668l = zVar;
        this.f269669m = serpConstructorAdvertItem;
        this.f269670n = i12;
    }
    ...
    public final G0 invoke(String str, Double d12, Double d13, VideoStopReason videoStopReason) {
        ...
        this.f269668l.f269716e.c(new mc.g(str, this.f269669m.getF80719f(), C44049b.a(VideoEventFromPage.f90107c), Double.valueOf(dDoubleValue), Double.valueOf(dDoubleValue2), Integer.valueOf(this.f269670n), null, videoStopReason, null, 256, null));
        return G0.f406611a;
    }
}
