...
final class c extends N implements l<Integer, G0> {
    ...
    public final /* synthetic */ com.avito.beduin.v2.component.scroll_container.state.d f176412l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(com.avito.beduin.v2.component.scroll_container.state.d dVar) {
        super(1);
        this.f176412l = dVar;
    }
    ...
    public final G0 invoke(Integer num) {
        ...
        l<Integer, G0> lVar = this.f176412l.f336195c;
        if (lVar != null) {
