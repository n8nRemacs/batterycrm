...
final class d extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ f f154518l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ AdvertItem f154519m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(f fVar, AdvertItem advertItem) {
        super(0);
        this.f154518l = fVar;
        this.f154519m = advertItem;
    }

    @Override // Y41.a
    public final G0 invoke() {
        f fVar = this.f154518l;
        fVar.f154522b.invoke(new r(this.f154519m.f268396O));
        return G0.f406611a;
    }
}
