...
public final class j<T> implements InterfaceC23040h0 {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ a.e f134663b;
    ...
    public final void onChanged(T t12) {
        if (t12 != 0) {
            for (i.a aVar : ((HashMap) t12).values()) {
                this.f134663b.A1(aVar.f134661a, new k(aVar));
            }
        }
    }
}
