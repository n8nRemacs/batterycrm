...
final class k extends N implements Y41.p<Filter, InlineFilterValue, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ f f273131l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Filter f273132m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(f fVar, Filter filter) {
        super(2);
        this.f273131l = fVar;
        this.f273132m = filter;
    }

    @Override // Y41.p
    public final G0 invoke(Filter filter, InlineFilterValue inlineFilterValue) {
        this.f273131l.u(this.f273132m, inlineFilterValue);
        return G0.f406611a;
    }
}
