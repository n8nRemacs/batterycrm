...
final class s extends N implements Y41.p<A, Integer, G0> {
    ...
    public final /* synthetic */ int f158150l;
    ...
    public final G0 invoke(A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f158150l | 1);
        B bE2 = a12.E(-1722962737);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            com.akita.compose.theme.re23.c.a(false, androidx.compose.runtime.internal.r.c(448659562, new r(new FeesByPackageState.e(null, "Кресло", null, "Мебель", "Москва")), bE2), bE2, 48, 1);
        }
