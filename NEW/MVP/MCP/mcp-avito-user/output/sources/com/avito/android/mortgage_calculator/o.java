...
final class o extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204843l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204843l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204843l.getViewModel().accept(b.l.f204582b);
        return G0.f406611a;
    }
}
