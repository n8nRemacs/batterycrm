...
public final class i {
    ...
    public static final class a implements InterfaceC23040h0, D {
        ...
        public final /* synthetic */ N f171873b;

        /* JADX WARN: Multi-variable type inference failed */
        public a(l lVar) {
            this.f171873b = (N) lVar;
        }

        public final boolean equals(@Y61.l Object obj) {
            if ((obj instanceof InterfaceC23040h0) && (obj instanceof D)) {
                return this.f171873b.equals(((D) obj).getFunctionDelegate());
            }
            return false;
        }
        ...
        public final InterfaceC43072x<?> getFunctionDelegate() {
            return this.f171873b;
        }

        public final int hashCode() {
            return this.f171873b.hashCode();
        }

        /* JADX WARN: Type inference failed for: r0v0, types: [Y41.l, kotlin.jvm.internal.N] */
        @Override // androidx.view.InterfaceC23040h0
        public final /* synthetic */ void onChanged(Object obj) {
            this.f171873b.invoke(obj);
        }
    }
}
