...
public final /* data */ class Badge implements Parcelable {
    ...
    @k
    public final Badge copy(@k String title, @k String subtitle) {
        return new Badge(title, subtitle);
    }
    ...
    public boolean equals(@l Object other) {
        ...
        return L.f(this.title, badge.title) && L.f(this.subtitle, badge.subtitle);
    }
