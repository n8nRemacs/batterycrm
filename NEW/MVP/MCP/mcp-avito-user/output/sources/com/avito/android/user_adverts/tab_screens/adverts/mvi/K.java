...
@DebugMetadata(c = "com.avito.android.user_adverts.tab_screens.adverts.mvi.UserAdvertsListActor$searchAnalytics$2", f = "UserAdvertsListActor.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes5.dex */
final class K extends SuspendLambda implements Y41.p<UserAdvertsListInternalAction, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public /* synthetic */ Object f315221q;

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ C35670a f315222r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ UserAdvertsListParams f315223s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public K(C35670a c35670a, UserAdvertsListParams userAdvertsListParams, Continuation<? super K> continuation) {
        super(2, continuation);
        this.f315222r = c35670a;
        this.f315223s = userAdvertsListParams;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        K k12 = new K(this.f315222r, this.f315223s, continuation);
        k12.f315221q = obj;
        return k12;
    }
    ...
    public final Object invoke(UserAdvertsListInternalAction userAdvertsListInternalAction, Continuation<? super G0> continuation) {
        return ((K) create(userAdvertsListInternalAction, continuation)).invokeSuspend(G0.f406611a);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        C42729a0.b(obj);
        UserAdvertsListInternalAction userAdvertsListInternalAction = (UserAdvertsListInternalAction) this.f315221q;
        if (userAdvertsListInternalAction instanceof UserAdvertsListInternalAction.LoadingResult) {
            ...
            if (loadingResult.f315354e) {
                InterfaceC28373a interfaceC28373a = this.f315222r.f315277f;
                UserAdvertsListParams.SearchInfo searchInfo = this.f315223s.f314698d;
                String str = searchInfo.f314700b;
                Integer num = loadingResult.f315351b.f395106c;
                String str2 = loadingResult.f315353d;
                UserAdvertsListParams.SearchInfo.StartType startType = searchInfo.f314704f;
                boolean z12 = searchInfo.f314701c;
                Map<String, Object> map = searchInfo.f314702d;
                int i12 = startType == null ? -1 : c.a.f429158b[startType.ordinal()];
