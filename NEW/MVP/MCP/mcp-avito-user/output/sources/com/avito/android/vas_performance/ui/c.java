...
final class c extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ PerformanceVasFragment f321462l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(PerformanceVasFragment performanceVasFragment) {
        super(1);
        this.f321462l = performanceVasFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f321462l.f321390r0;
        if (aVar == null) {
            aVar = null;
        }
