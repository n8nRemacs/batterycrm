...
@DebugMetadata(c = "com.avito.android.extended_profile_serp.mvi.ExtendedProfileSerpActor$process$2", f = "ExtendedProfileSerpActor.kt", i = {}, l = {96}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes13.dex */
final class h extends SuspendLambda implements Y41.p<InterfaceC43172j<? super ExtendedProfileSerpInternalAction>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f152990q;

    /* renamed from: r, reason: collision with root package name */
    public /* synthetic */ Object f152991r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ InterfaceC25487a f152992s;

    /* renamed from: t, reason: collision with root package name */
    public final /* synthetic */ ExtendedProfileSerpState f152993t;

    /* renamed from: u, reason: collision with root package name */
    public final /* synthetic */ n f152994u;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(InterfaceC25487a interfaceC25487a, n nVar, ExtendedProfileSerpState extendedProfileSerpState, Continuation continuation) {
        super(2, continuation);
        this.f152992s = interfaceC25487a;
        this.f152993t = extendedProfileSerpState;
        this.f152994u = nVar;
    }
    ...
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        ExtendedProfileSerpState extendedProfileSerpState = this.f152993t;
        h hVar = new h(this.f152992s, this.f152994u, extendedProfileSerpState, continuation);
        hVar.f152991r = obj;
        return hVar;
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f152990q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43172j interfaceC43172j = (InterfaceC43172j) this.f152991r;
            InterfaceC25487a.q qVar = (InterfaceC25487a.q) this.f152992s;
            String str = qVar.f56966a;
            ExtendedProfileSerpState extendedProfileSerpState = this.f152993t;
            ...
            if (!L.f(str, query)) {
                InterfaceC30552o interfaceC30552o = this.f152994u.f153022b;
                String str2 = qVar.f56966a;
