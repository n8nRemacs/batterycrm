...
public final /* data */ class OnAudioStateChangedFromTelecomAction implements IacAction {
    ...
    @k
    private final AudioState newAudioState;

    public OnAudioStateChangedFromTelecomAction(@k String str, @k AudioState audioState) {
        this.callId = str;
        this.newAudioState = audioState;
    }

    public static /* synthetic */ OnAudioStateChangedFromTelecomAction copy$default(OnAudioStateChangedFromTelecomAction onAudioStateChangedFromTelecomAction, String str, AudioState audioState, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = onAudioStateChangedFromTelecomAction.callId;
        }
        if ((i12 & 2) != 0) {
            audioState = onAudioStateChangedFromTelecomAction.newAudioState;
        }
        return onAudioStateChangedFromTelecomAction.copy(str, audioState);
    }
    ...
    public final AudioState getNewAudioState() {
        return this.newAudioState;
    }

    @k
    public final OnAudioStateChangedFromTelecomAction copy(@k String callId, @k AudioState newAudioState) {
        return new OnAudioStateChangedFromTelecomAction(callId, newAudioState);
    }
    ...
    public boolean equals(@l Object other) {
        ...
        if (!(other instanceof OnAudioStateChangedFromTelecomAction)) {
            return false;
        }
        OnAudioStateChangedFromTelecomAction onAudioStateChangedFromTelecomAction = (OnAudioStateChangedFromTelecomAction) other;
        return L.f(this.callId, onAudioStateChangedFromTelecomAction.callId) && L.f(this.newAudioState, onAudioStateChangedFromTelecomAction.newAudioState);
    }
    ...
    public int hashCode() {
        return this.newAudioState.hashCode() + (this.callId.hashCode() * 31);
    }
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        ...
        CallInit callInitCopy$default = CallInit.copy$default(callInitA, null, null, false, null, false, null, this.newAudioState, 63, null);
    ...
    public String toString() {
        return "OnAudioStateChangedFromTelecomAction(callId=" + this.callId + ", newAudioState=" + this.newAudioState + ')';
    }
}
