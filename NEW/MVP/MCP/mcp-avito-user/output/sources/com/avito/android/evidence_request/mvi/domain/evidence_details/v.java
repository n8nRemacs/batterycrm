...
@s0
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/avito/android/evidence_request/mvi/domain/evidence_details/v;", "Lcom/avito/android/evidence_request/mvi/domain/evidence_details/u;", "<init>", "()V", "_avito_evidence-request_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class v implements u {
    ...
    @Override // com.avito.android.evidence_request.mvi.domain.evidence_details.u
    @Y61.k
    public final C30389i a(@Y61.k Structure structure) {
        List list;
        String[] strArr;
        String value;
        Long lZ02;
        C30389i c30389i = new C30389i(0L, null, 3, null);
        ...
        if (list2 != null) {
            for (Validation validation : list2) {
                ...
                if (L.f(rule, "type")) {
                    ...
                    if (value2 != null) {
                        try {
                            list = (List) new Gson().e(value2, new x().getType());
                        ...
                        if (list != null && (strArr = (String[]) list.toArray(new String[0])) != null) {
                            ...
                            if (strArr2 != null) {
                                c30389i = new C30389i(c30389i.f148703a, strArr2);
                            }
                        }
                    }
                } else if (L.f(rule, "size") && (value = validation.getValue()) != null && (lZ02 = C43066x.z0(value)) != null) {
                    c30389i = new C30389i(lZ02.longValue(), c30389i.f148704b);
                }
            }
        }
        return c30389i;
