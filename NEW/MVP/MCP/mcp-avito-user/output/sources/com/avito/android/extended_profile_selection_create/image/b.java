...
final class b extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ ExtendedProfileSetSelectionImageFragment f151677l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ a.b f151678m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(ExtendedProfileSetSelectionImageFragment extendedProfileSetSelectionImageFragment, a.b bVar) {
        super(0);
        this.f151677l = extendedProfileSetSelectionImageFragment;
        this.f151678m = bVar;
    }
    ...
    public final G0 invoke() {
        ...
        this.f151677l.s5().accept(this.f151678m);
        return G0.f406611a;
    }
}
