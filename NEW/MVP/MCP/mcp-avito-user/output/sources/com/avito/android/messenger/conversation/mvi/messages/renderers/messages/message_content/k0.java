...
final class k0 extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<com.avito.android.messenger.conversation.mvi.messages.h0, G0> f193379l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ T1.d f193380m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public k0(Y41.l<? super com.avito.android.messenger.conversation.mvi.messages.h0, G0> lVar, T1.d dVar) {
        super(0);
        this.f193379l = lVar;
        this.f193380m = dVar;
    }
    ...
    public final G0 invoke() {
        this.f193379l.invoke(new h0.t(this.f193380m));
        return G0.f406611a;
    }
}
