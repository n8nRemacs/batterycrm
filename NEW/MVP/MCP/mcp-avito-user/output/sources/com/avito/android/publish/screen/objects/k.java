...
final class k extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ e f240175l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ N f240176m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public k(e eVar, Y41.a<G0> aVar) {
        super(0);
        this.f240175l = eVar;
        this.f240176m = (N) aVar;
    }

    /* JADX WARN: Type inference failed for: r0v2, types: [Y41.a, kotlin.jvm.internal.N] */
    @Override // Y41.a
    public final G0 invoke() {
        Dialog dialog = this.f240175l.f240158q;
        if (dialog != null) {
            dialog.dismiss();
        }
        this.f240176m.invoke();
        return G0.f406611a;
    }
}
