...
final class f extends N implements Y41.l<ServiceOrderRequestItem.Action, ServiceOrderRequestItem.Action> {

    /* renamed from: l, reason: collision with root package name */
    public static final f f79898l = new f();
    ...
    public final ServiceOrderRequestItem.Action invoke(ServiceOrderRequestItem.Action action) {
        return ServiceOrderRequestItem.Action.a(action, false);
    }
}
