...
@DebugMetadata(c = "com.avito.android.cpx_promo.v2.mvi.CpxPromoV2Actor$processCashbackBannerClick$1", f = "CpxPromoV2Actor.kt", i = {}, l = {471}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes12.dex */
final class g extends SuspendLambda implements Y41.p<InterfaceC43172j<? super CpxPromoV2InternalAction.OpenDeeplink>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f127706q;

    /* renamed from: r, reason: collision with root package name */
    public /* synthetic */ Object f127707r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ CpxPromoV2State f127708s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(CpxPromoV2State cpxPromoV2State, Continuation<? super g> continuation) {
        super(2, continuation);
        this.f127708s = cpxPromoV2State;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        g gVar = new g(this.f127708s, continuation);
        gVar.f127707r = obj;
        return gVar;
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f127706q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43172j interfaceC43172j = (InterfaceC43172j) this.f127707r;
            a.b bVar = this.f127708s.f127631i.f127654b;
            if (bVar != null && (deepLink = bVar.f127405g) != null) {
