...
@DebugMetadata(c = "com.avito.android.map.mvi.MyLocationInteractorImpl$isPermissionsGrantedDialog$2", f = "MyLocationInteractor.kt", i = {}, l = {70}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes14.dex */
final class X extends SuspendLambda implements Y41.q<InterfaceC43172j<? super MapInternalAction>, Throwable, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f184993q;

    /* renamed from: r, reason: collision with root package name */
    public /* synthetic */ InterfaceC43172j f184994r;

    /* renamed from: s, reason: collision with root package name */
    public /* synthetic */ Throwable f184995s;
    ...
    public final Object invoke(InterfaceC43172j<? super MapInternalAction> interfaceC43172j, Throwable th2, Continuation<? super G0> continuation) {
        X x12 = new X(3, continuation);
        x12.f184994r = interfaceC43172j;
        x12.f184995s = th2;
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f184993q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43172j interfaceC43172j = this.f184994r;
            MapInternalAction.Error error = new MapInternalAction.Error(new Exception(this.f184995s), MapErrorType.f185057f);
            this.f184994r = null;
            this.f184993q = 1;
