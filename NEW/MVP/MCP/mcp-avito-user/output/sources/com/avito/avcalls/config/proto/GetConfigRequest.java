...
public final /* data */ class GetConfigRequest implements b {
    ...
    public final long f332871a;

    /* renamed from: b, reason: collision with root package name */
    @k
    public final JsonObject f332872b;
    ...
    public /* synthetic */ GetConfigRequest(int i12, long j12, JsonObject jsonObject, P0 p02) {
        ...
        this.f332871a = j12;
        if ((i12 & 2) == 0) {
            this.f332872b = new JsonObject(kotlin.collections.P0.c());
        } else {
            this.f332872b = jsonObject;
        }
    }

    @Override // com.avito.avcalls.signaling.b
    public final b a(long j12) {
        return new GetConfigRequest(j12, this.f332872b);
    }
    ...
    public final boolean equals(@l Object obj) {
        ...
        return this.f332871a == getConfigRequest.f332871a && L.f(this.f332872b, getConfigRequest.f332872b);
    }

    public final int hashCode() {
        return this.f332872b.f412952b.hashCode() + (Long.hashCode(this.f332871a) * 31);
    }

    @k
    public final String toString() {
        return "GetConfigRequest(sqn=" + this.f332871a + ", params=" + this.f332872b + ')';
    }
