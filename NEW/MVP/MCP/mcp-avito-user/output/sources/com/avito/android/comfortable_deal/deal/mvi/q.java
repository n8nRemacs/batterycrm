...
@DebugMetadata(c = "com.avito.android.comfortable_deal.deal.mvi.DealActor$process$8", f = "DealActor.kt", i = {}, l = {303}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes12.dex */
final class q extends SuspendLambda implements Y41.p<InterfaceC43172j<? super DealInternalAction>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f121706q;

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ C29453a f121707r;
    ...
    @DebugMetadata(c = "com.avito.android.comfortable_deal.deal.mvi.DealActor$process$8$invokeSuspend$$inlined$doOnMainThread$1", f = "DealActor.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    public static final class a extends SuspendLambda implements Y41.p<T, Continuation<? super G0>, Object> {

        /* renamed from: q, reason: collision with root package name */
        public final /* synthetic */ C29453a f121708q;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(C29453a c29453a, Continuation continuation) {
            super(2, continuation);
            this.f121708q = c29453a;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @Y61.k
        public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
            return new a(this.f121708q, continuation);
        }
        ...
        public final Object invokeSuspend(@Y61.k Object obj) {
            ...
            C42729a0.b(obj);
            this.f121708q.f121586g = false;
            return G0.f406611a;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(C29453a c29453a, Continuation<? super q> continuation) {
        super(2, continuation);
        this.f121707r = c29453a;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new q(this.f121707r, continuation);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f121706q;
        if (i12 == 0) {
            C42729a0.b(obj);
            C29453a c29453a = this.f121707r;
