...
public final /* data */ class AutoDisableCameraMiddleware implements IacMiddlewareDistinctBy<Payload> {
    ...
    public static final /* data */ class Payload implements IacMiddlewarePayload {
        ...
        @k
        public final Payload copy(boolean videoTxAllowed) {
            return new Payload(videoTxAllowed);
        }
        ...
        public boolean equals(@l Object other) {
            ...
            return (other instanceof Payload) && this.videoTxAllowed == ((Payload) other).videoTxAllowed;
        }
        ...
        public int hashCode() {
            return Boolean.hashCode(this.videoTxAllowed);
        }

        @k
        public String toString() {
            return r.x(new StringBuilder("Payload(videoTxAllowed="), this.videoTxAllowed, ')');
        }
    }

    private AutoDisableCameraMiddleware() {
    }

    public boolean equals(@l Object other) {
        return this == other || (other instanceof AutoDisableCameraMiddleware);
    }
    ...
    public Payload getPayloadFromState(@k IacState state) {
        ...
        boolean z12 = false;
        if (inUseAsInUse != null && (call = inUseAsInUse.getCall()) != null && call.getVideoTxAllowed()) {
            z12 = true;
        }
    ...
    public void process(@k IacMiddlewareProcessing iacMiddlewareProcessing, @k Payload payload, @k Payload payload2) {
        if ((iacMiddlewareProcessing.getNewState() instanceof IacState.InUse) && !payload2.getVideoTxAllowed()) {
            iacMiddlewareProcessing.plusAssign(iacMiddlewareProcessing.getOut(), new IacEvent.AvCalls.EnableSendingVideo(((IacState.InUse) iacMiddlewareProcessing.getNewState()).getCallId(), false));
        }
    }
}
