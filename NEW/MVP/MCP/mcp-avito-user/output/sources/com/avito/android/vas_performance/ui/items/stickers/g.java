...
final class g extends N implements p<com.avito.android.lib.design.chips.h, Boolean, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ b f321733l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ h f321734m;
    ...
    public final G0 invoke(com.avito.android.lib.design.chips.h hVar, Boolean bool) {
        ...
        Boolean bool2 = bool;
        bool2.getClass();
        Iterator it = this.f321733l.f321727c.iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
            ...
            next = it.next();
            if (L.f(((a) next).f321722b, ((a) hVar2).f321722b)) {
                break;
            }
        }
        a aVar = (a) next;
        if (aVar != null) {
            aVar.f321724d = bool2;
            this.f321734m.f321735b.accept(aVar);
        }
        return G0.f406611a;
    }
}
