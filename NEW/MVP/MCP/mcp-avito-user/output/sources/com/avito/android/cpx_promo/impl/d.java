...
final class d extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ CpxPromoFragment f126942l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(CpxPromoFragment cpxPromoFragment) {
        super(0);
        this.f126942l = cpxPromoFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        CpxPromoFragment cpxPromoFragment = this.f126942l;
