...
final class n extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ AvlPlayerActivity f98396l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(AvlPlayerActivity avlPlayerActivity) {
        super(1);
        this.f98396l = avlPlayerActivity;
    }
    ...
    public final G0 invoke(DeepLink deepLink) {
        ...
        if (deepLink2 != null) {
            com.avito.android.deeplink_handler.handler.composite.a aVar = this.f98396l.f98308m;
            if (aVar == null) {
                aVar = null;
            }
