...
final class h extends N implements p<A, Integer, G0> {
    ...
    public final /* synthetic */ int f228230l;
    ...
    public final G0 invoke(A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f228230l | 1);
        UniversalImage universalImage = g.f228225a;
        B bE2 = a12.E(-1043417195);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            b.f228208a.getClass();
            com.akita.compose.theme.re23.c.a(false, b.f228210c, bE2, 48, 1);
        }
