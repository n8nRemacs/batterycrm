...
final class f extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ RealtyAgencySearchFragment f138644l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(RealtyAgencySearchFragment realtyAgencySearchFragment) {
        super(0);
        this.f138644l = realtyAgencySearchFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        DevelopmentSort.f138655b.getClass();
        DevelopmentSort developmentSort = DevelopmentSort.f138656c;
        RealtyAgencySearchFragment.a aVar = RealtyAgencySearchFragment.f138222V0;
        this.f138644l.D5().accept(new InterfaceC14443a.k(developmentSort));
        return G0.f406611a;
    }
}
