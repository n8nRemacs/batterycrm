...
final class f extends N implements Y41.l<Throwable, G0> {
    ...
    public final /* synthetic */ WebPaymentMviActivity f214924l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(WebPaymentMviActivity webPaymentMviActivity) {
        super(1);
        this.f214924l = webPaymentMviActivity;
    }
    ...
    public final G0 invoke(Throwable th2) {
        if (th2 instanceof TimeoutException) {
            ...
            this.f214924l.b2().accept(InterfaceC49775a.d.f442225a);
        }
        return G0.f406611a;
    }
}
