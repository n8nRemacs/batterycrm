...
final class e extends SuspendLambda implements p<InterfaceC43160i<Object>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public final /* synthetic */ C40052a f337211q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(C40052a c40052a, Continuation<? super e> continuation) {
        super(2, continuation);
        this.f337211q = c40052a;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @k
    public final Continuation<G0> create(@l Object obj, @k Continuation<?> continuation) {
        return new e(this.f337211q, continuation);
    }

    @Override // Y41.p
    public final Object invoke(InterfaceC43160i<Object> interfaceC43160i, Continuation<? super G0> continuation) {
        return ((e) create(interfaceC43160i, continuation)).invokeSuspend(G0.f406611a);
    }
    ...
    public final Object invokeSuspend(@k Object obj) {
        ...
        bVar.getClass();
        if (1 >= RU0.b.f14469c) {
            RU0.b.f14468b.d(AK.c.s(new StringBuilder(), RU0.b.f14470d, ":InteractionsProcessor"), "~~ after debounce " + this.f337211q);
        }
        return G0.f406611a;
    }
}
