...
final class j extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ N f167638l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public j(p<? super Integer, ? super Boolean, G0> pVar) {
        super(1);
        this.f167638l = (N) pVar;
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [Y41.p, kotlin.jvm.internal.N] */
    @Override // Y41.l
    public final G0 invoke(Integer num) {
        this.f167638l.invoke(Integer.valueOf(num.intValue()), Boolean.TRUE);
        return G0.f406611a;
    }
}
