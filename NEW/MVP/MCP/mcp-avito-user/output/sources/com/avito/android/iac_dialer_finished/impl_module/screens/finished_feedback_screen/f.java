...
final class f extends N implements l<String, G0> {
    ...
    public final /* synthetic */ IacFinishedFeedbackScreenFragment f166665l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(IacFinishedFeedbackScreenFragment iacFinishedFeedbackScreenFragment) {
        super(1);
        this.f166665l = iacFinishedFeedbackScreenFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        IacFinishedFeedbackScreenFragment.a aVar = IacFinishedFeedbackScreenFragment.f166628t0;
        this.f166665l.r5().accept(new a.C1262a(str));
        return G0.f406611a;
    }
}
