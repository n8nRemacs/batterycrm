...
/* renamed from: com.avito.android.mortgage_invite.participant.f, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
final class C32836f extends kotlin.jvm.internal.N implements Y41.p<ParticipantFieldId, String, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ParticipantFragment f206136l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C32836f(ParticipantFragment participantFragment) {
        super(2);
        this.f206136l = participantFragment;
    }
    ...
    public final G0 invoke(ParticipantFieldId participantFieldId, String str) {
        ...
        this.f206136l.q5().accept(new InterfaceC46876a.b(participantFieldId, str));
        return G0.f406611a;
    }
}
