...
/* renamed from: com.avito.android.messenger.conversation.v, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
public final class C32354v<T> implements InterfaceC23040h0 {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ ChannelFragment f195265b;

    public C32354v(ChannelFragment channelFragment) {
        this.f195265b = channelFragment;
    }
    ...
    public final void onChanged(T t12) throws Resources.NotFoundException {
        if (t12 != 0) {
            ...
            ChannelFragment channelFragment = this.f195265b;
            if (zBooleanValue) {
                String string = channelFragment.getResources().getString(R.string.channel_deleted);
