...
final class e extends N implements p<com.avito.android.lib.design.chips.h, Boolean, G0> {
    ...
    public final /* synthetic */ ParameterElement.v f105873l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ f f105874m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(f fVar, ParameterElement.v vVar) {
        super(2);
        this.f105873l = vVar;
        this.f105874m = fVar;
    }
    ...
    public final G0 invoke(com.avito.android.lib.design.chips.h hVar, Boolean bool) {
        ...
        ParameterElement.v vVar = this.f105873l;
        ...
        if (mVar != null) {
            ...
            this.f105874m.f105877d.accept(new Ij.b(str, mVar, null, 4, null));
        }
        return G0.f406611a;
    }
}
