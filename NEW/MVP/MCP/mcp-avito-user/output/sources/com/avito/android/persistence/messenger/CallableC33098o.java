...
/* renamed from: com.avito.android.persistence.messenger.o, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
class CallableC33098o implements Callable<List<Y>> {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ androidx.room.F0 f215524b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ X f215525c;

    public CallableC33098o(X x12, androidx.room.F0 f02) {
        this.f215525c = x12;
        this.f215524b = f02;
    }
    ...
    public final List<Y> call() throws Throwable {
        ...
        Long lValueOf;
        int i13;
        MessengerDatabase_Impl messengerDatabase_Impl = this.f215525c.f215334a;
        messengerDatabase_Impl.c();
        try {
            try {
                Cursor cursorB = V1.c.b(messengerDatabase_Impl, this.f215524b, false);
                try {
