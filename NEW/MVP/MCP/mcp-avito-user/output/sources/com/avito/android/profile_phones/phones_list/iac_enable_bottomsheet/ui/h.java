...
final class h extends N implements p<A, Integer, G0> {
    ...
    public final /* synthetic */ int f227887l;
    ...
    public final G0 invoke(A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f227887l | 1);
        UniversalImage universalImage = d.f227867a;
        B bE2 = a12.E(-1503564689);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            c.f227864a.getClass();
            com.akita.compose.theme.re23.c.a(false, c.f227865b, bE2, 48, 1);
        }
