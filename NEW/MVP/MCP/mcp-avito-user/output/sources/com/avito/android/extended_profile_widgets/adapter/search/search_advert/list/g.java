...
/* compiled from: SearchAdvertListItemBlueprint.kt */
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001¨\u0006\u0004"}, d2 = {"Lcom/avito/android/extended_profile_widgets/adapter/search/search_advert/list/g;", "LTV0/b;", "Lcom/avito/android/serp/adapter/rich_snippets/job/m;", "Lcom/avito/android/extended_profile_widgets/adapter/search/search_advert/SearchAdvertItem;", "_avito_extended-profile-widgets_public"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes13.dex */
public final class g implements TV0.b<m, SearchAdvertItem> {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final i f154728a;

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public final g.a<n> f154729b = new g.a<>(R.layout.profile_advert_item_rich_job, a.f154730l);
    ...
    public static final class a extends N implements p<ViewGroup, View, n> {
        ...
        public static final a f154730l = new a();
    ...
    public final boolean d(@Y61.k TV0.a aVar) {
        if (aVar instanceof SearchAdvertItem) {
            if (L.f(((SearchAdvertItem) aVar).f154690c, GridElementType.FullWidth.f161209b)) {
                return true;
            }
        }
        return false;
