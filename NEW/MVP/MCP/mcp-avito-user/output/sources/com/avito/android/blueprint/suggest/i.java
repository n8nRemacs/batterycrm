...
final class i extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ w f105713l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ParameterElement.H f105714m;
    ...
    public i(w wVar, ParameterElement.H h12) {
        super(1);
        this.f105713l = wVar;
        this.f105714m = h12;
    }
    ...
    public final G0 invoke(String str) {
        ...
        w wVar = this.f105713l;
        int iOrdinal = wVar.f105743h.getF181688a().ordinal();
        com.jakewharton.rxrelay3.c<com.avito.android.llm.ui.a> cVar = wVar.f105748m;
        ParameterElement.H h12 = this.f105714m;
        if (iOrdinal == 0) {
            CharParameter.AutoDescription autoDescription = h12.f117317w;
            if (autoDescription != null) {
                LlmDescriptionPresenter.Feature feature = LlmDescriptionPresenter.Feature.f181677b;
                LlmDescriptionPresenter llmDescriptionPresenter = wVar.f105743h;
                cVar.accept(new C28876a(autoDescription.getOverlay(), (llmDescriptionPresenter.a() || llmDescriptionPresenter.getF181689b().length() <= 0) ? null : autoDescription.getConfirmDialog(), autoDescription.getTimeout(), h12, new u(1, llmDescriptionPresenter, LlmDescriptionPresenter.class, "rememberGenerateDescriptionText", "rememberGenerateDescriptionText(Ljava/lang/String;)V", 0), L.f(autoDescription.getNeedPreviousFieldsValidation(), Boolean.TRUE), new v(0, llmDescriptionPresenter, LlmDescriptionPresenter.class, "onValidationError", "onValidationError()V", 0)));
            }
        } else if (iOrdinal == 1 && (autoBeautification = h12.f117318x) != null) {
            cVar.accept(new a.C5343a(autoBeautification, h12, new C28875d(wVar)));
        }
        return G0.f406611a;
    }
}
