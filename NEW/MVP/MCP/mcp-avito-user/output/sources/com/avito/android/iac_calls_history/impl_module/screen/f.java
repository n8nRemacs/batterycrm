...
final class f extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ CallsHistoryScreenActivity f164782l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(CallsHistoryScreenActivity callsHistoryScreenActivity) {
        super(0);
        this.f164782l = callsHistoryScreenActivity;
    }

    @Override // Y41.a
    public final G0 invoke() {
        CallsHistoryScreenActivity.a aVar = CallsHistoryScreenActivity.f164759q;
        this.f164782l.a2().accept(a.e.f164835a);
        return G0.f406611a;
    }
}
