...
final class t extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ T f167610l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ C43108m f167611m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public t(T t12, C43108m c43108m) {
        super(0);
        this.f167610l = t12;
        this.f167611m = c43108m;
    }

    @Override // Y41.a
    public final G0 invoke() {
        C43259k.d(this.f167610l, null, null, new s(this.f167611m, null), 3);
        return G0.f406611a;
    }
}
