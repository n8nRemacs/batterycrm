...
final class C<T> implements l41.g {
    ...
    public final /* synthetic */ m f300172b;
    ...
    public final void accept(Object obj) {
        P2 p22 = (P2) obj;
        m mVar = this.f300172b;
        mVar.getClass();
        boolean z12 = p22 instanceof P2.b;
        com.avito.android.util.architecture_components.D<Boolean> d12 = mVar.f300217b0;
        if (z12) {
            d12.setValue(Boolean.FALSE);
            C47284b c47284b = (C47284b) ((P2.b) p22).f318720a;
            DeepLink deeplink = c47284b.getDeeplink();
            if (deeplink != null) {
                mVar.f300209T.setValue(deeplink);
            }
            mVar.f300223h0 = c47284b.getSuccessFinishFlowUri();
            return;
        }
        ...
        if (p22 instanceof P2.a) {
            ...
            ScreenPerformanceTracker.a.d(mVar.f300202M, null, null, new J.a(apiError), null, 11);
            ...
            mVar.f300210U.setValue(com.avito.android.error.z.k(apiError));
