...
@DebugMetadata(c = "com.avito.android.extended_profile_serp.ExtendedProfileSerpView$initInlineFilters$2", f = "ExtendedProfileSerpView.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes13.dex */
final class K extends SuspendLambda implements Y41.p<String, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public /* synthetic */ Object f152557q;

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ F f152558r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public K(F f12, Continuation<? super K> continuation) {
    ...
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        K k12 = new K(this.f152558r, continuation);
        k12.f152557q = obj;
        return k12;
    }
    ...
    public final Object invoke(String str, Continuation<? super G0> continuation) {
        return ((K) create(str, continuation)).invokeSuspend(G0.f406611a);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        C42729a0.b(obj);
        String str = (String) this.f152557q;
        F f12 = this.f152558r;
