...
@s0
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u00012\u00020\u0002¨\u0006\u0003"}, d2 = {"Lcom/avito/android/search/filter/adapter/inline_select/j;", "Lcom/avito/android/search/filter/adapter/inline_select/i;", "Lcom/avito/konveyor/adapter/b;", "_avito_search_filter_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class j extends com.avito.konveyor.adapter.b implements i {

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public final TextView f262404b;

    /* renamed from: c, reason: collision with root package name */
    @Y61.k
    public final InlineSelectView f262405c;

    /* renamed from: d, reason: collision with root package name */
    @Y61.k
    public final TextView f262406d;
    ...
    public j(@Y61.k View view) {
        ...
        this.f262404b = (TextView) viewFindViewById;
        ...
        this.f262405c = (InlineSelectView) viewFindViewById2;
        View viewFindViewById3 = view.findViewById(R.id.badge_new);
        if (viewFindViewById3 == null) {
            throw new NullPointerException("null cannot be cast to non-null type android.widget.TextView");
        }
        this.f262406d = (TextView) viewFindViewById3;
    }
    ...
    public final void i00(@Y61.k List<Cp0.e> list, @l Cp0.e eVar, @Y61.k p<? super Cp0.e, ? super Boolean, G0> pVar) {
        this.f262405c.a(list, eVar, pVar);
    }

    @Override // com.avito.android.search.filter.adapter.inline_select.i
    public final void setTitle(@Y61.k String str) {
        this.f262404b.setText(str);
    }
}
