...
final class h extends N implements Y41.l<G0, G0> {
    ...
    public final /* synthetic */ VerificationInputInnFragment f323891l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(VerificationInputInnFragment verificationInputInnFragment) {
        super(1);
        this.f323891l = verificationInputInnFragment;
    }

    @Override // Y41.l
    public final G0 invoke(G0 g02) {
        this.f323891l.requireActivity().onBackPressed();
        return G0.f406611a;
    }
}
