...
final class d extends N implements Y41.l<GuestsSelectorOutput, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ StrSoftBookingFragment f282580l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(StrSoftBookingFragment strSoftBookingFragment) {
        super(1);
        this.f282580l = strSoftBookingFragment;
    }
    ...
    public final G0 invoke(GuestsSelectorOutput guestsSelectorOutput) {
        ...
        this.f282580l.q5().accept(new InterfaceC44950a.i(guestsSelectorOutput));
        return G0.f406611a;
    }
}
