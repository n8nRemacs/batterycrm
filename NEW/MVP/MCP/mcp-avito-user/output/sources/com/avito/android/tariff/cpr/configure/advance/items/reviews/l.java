...
final class l extends N implements Y41.r<InterfaceC20640y, T1, A, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ x f295300l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ N f295301m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public l(x xVar, Y41.l<? super com.avito.android.lib.design.text_view.a, G0> lVar) {
        super(4);
        this.f295300l = xVar;
        this.f295301m = (N) lVar;
    }
    ...
    public final G0 invoke(InterfaceC20640y interfaceC20640y, T1 t12, A a12, Integer num) {
        ...
        if ((i12 & 731) == 146 && a13.c()) {
            ...
            x xVar = this.f295300l;
            AttributedText f295321a = xVar.getF295321a();
            ...
            com.avito.android.lib.compose.design.component.attributedtext.a.b(f295321a, vVarM.d0(vVarD), 0, this.f295301m, null, 0, a13, 8, 52);
        }
        return G0.f406611a;
    }
}
