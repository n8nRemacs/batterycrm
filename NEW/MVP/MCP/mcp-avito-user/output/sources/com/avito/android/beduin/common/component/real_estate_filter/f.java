...
@s0
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0005\u001a\u00020\u00022\b\u0010\u0001\u001a\u0004\u0018\u00010\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"", "selectedDevelopmentId", "Lkotlin/G0;", "invoke", "(Ljava/lang/String;)V", "<anonymous>"}, k = 3, mv = {1, 9, 0})
/* loaded from: classes11.dex */
final class f extends N implements Y41.l<String, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ List<RealEstateDevelopment> f102315l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ C28803d f102316m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(List<RealEstateDevelopment> list, C28803d c28803d) {
        super(1);
        this.f102315l = list;
        this.f102316m = c28803d;
    }
    ...
    public final G0 invoke(String str) {
        Object next;
        String str2 = str;
        Iterator<T> it = this.f102315l.iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
