...
final class l extends N implements Y41.l<Boolean, G0> {
    ...
    public final /* synthetic */ ConfigureAdvanceFragment f294366l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(ConfigureAdvanceFragment configureAdvanceFragment) {
        super(1);
        this.f294366l = configureAdvanceFragment;
    }

    @Override // Y41.l
    public final G0 invoke(Boolean bool) {
        Boolean bool2 = bool;
        ConfigureAdvanceFragment configureAdvanceFragment = this.f294366l;
        if (configureAdvanceFragment.getContext() != null) {
            configureAdvanceFragment.q5().setEnabled(bool2.booleanValue());
        }
        return G0.f406611a;
    }
}
