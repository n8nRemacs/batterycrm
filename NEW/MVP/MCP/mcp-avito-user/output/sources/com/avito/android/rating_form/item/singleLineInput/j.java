...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/rating_form/item/singleLineInput/j;", "LTV0/e;", "_avito_rating-form_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public interface j extends TV0.e {
    ...
    void Ts(@l String str);

    void X0(@l Boolean bool);

    void Y1(@l AttributedText attributedText);

    void YD(@l Integer num);

    void aw(@l RatingFormField.MaskType maskType);
