...
final class e extends N implements Y41.l<ContentPlaceholder, G0> {
    ...
    public final /* synthetic */ CodeRequestFragment f212854l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(CodeRequestFragment codeRequestFragment) {
        super(1);
        this.f212854l = codeRequestFragment;
    }

    @Override // Y41.l
    public final G0 invoke(ContentPlaceholder contentPlaceholder) {
        com.avito.android.passport.profile_add.g.a(contentPlaceholder, new d(this.f212854l));
        return G0.f406611a;
    }
}
