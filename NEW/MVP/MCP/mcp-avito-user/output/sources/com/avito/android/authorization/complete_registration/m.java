...
@DebugMetadata(c = "com.avito.android.authorization.complete_registration.CompleteRegistrationFragment$setupCallbacks$8", f = "CompleteRegistrationFragment.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes11.dex */
final class m extends SuspendLambda implements Y41.p<G0, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public final /* synthetic */ CompleteRegistrationFragment f93450q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(CompleteRegistrationFragment completeRegistrationFragment, Continuation<? super m> continuation) {
        super(2, continuation);
        this.f93450q = completeRegistrationFragment;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new m(this.f93450q, continuation);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        C42729a0.b(obj);
        CompleteRegistrationFragment completeRegistrationFragment = this.f93450q;
