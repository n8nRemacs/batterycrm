...
final class i extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ Y41.l<InterfaceC50462a, G0> f160321l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public i(Y41.l<? super InterfaceC50462a, G0> lVar) {
        super(1);
        this.f160321l = lVar;
    }
    ...
    public final G0 invoke(DeepLink deepLink) {
        this.f160321l.invoke(new InterfaceC50462a.d(deepLink));
        return G0.f406611a;
    }
}
