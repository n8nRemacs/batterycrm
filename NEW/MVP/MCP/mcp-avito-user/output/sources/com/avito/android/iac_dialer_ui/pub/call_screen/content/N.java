...
final class N extends kotlin.jvm.internal.N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f167090l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f167090l | 1);
        androidx.compose.runtime.B bE2 = a12.E(1235163633);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            C30860a.f167114a.getClass();
            com.akita.compose.theme.re23.c.a(false, C30860a.f167117d, bE2, 48, 1);
        }
