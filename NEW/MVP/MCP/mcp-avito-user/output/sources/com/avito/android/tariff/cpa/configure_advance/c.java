...
final class c extends N implements Y41.l<List<? extends com.avito.conveyor_item.a>, G0> {
    ...
    public final /* synthetic */ ConfigureAdvanceFragment f294259l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(ConfigureAdvanceFragment configureAdvanceFragment) {
        super(1);
        this.f294259l = configureAdvanceFragment;
    }
    ...
    public final G0 invoke(List<? extends com.avito.conveyor_item.a> list) {
        ...
        com.avito.konveyor.adapter.d dVar = this.f294259l.f294243n0;
        B b12 = dVar;
        if (dVar == null) {
            b12 = 0;
        }
