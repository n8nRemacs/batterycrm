...
final class g extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ VisualVasFragment f322111l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(VisualVasFragment visualVasFragment) {
        super(1);
        this.f322111l = visualVasFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f322111l.f322089t0;
        if (aVar == null) {
            aVar = null;
        }
