...
final class q extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ InputWithCounter f153375l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(InputWithCounter inputWithCounter) {
        super(1);
        this.f153375l = inputWithCounter;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        InputWithCounter inputWithCounter = this.f153375l;
        inputWithCounter.c(inputWithCounter.f153303b.hasFocus());
        return G0.f406611a;
    }
}
