...
@DebugMetadata(c = "com.avito.android.oauth.presentation.mvi.OAuthActor$process$3", f = "OAuthActor.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes15.dex */
final class n extends SuspendLambda implements Y41.p<InterfaceC43172j<? super OAuthInternalAction>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public final /* synthetic */ C32904a f208351q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(C32904a c32904a, Continuation<? super n> continuation) {
        super(2, continuation);
        this.f208351q = c32904a;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new n(this.f208351q, continuation);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        C42729a0.b(obj);
        b.a.a(this.f208351q.f208278a, new ProfileCreateExtendedLink(ProfileCreateExtendedLink.Flow.ProfileUpgrade.f133601b, "oauth", false), null, null, 6);
        return G0.f406611a;
    }
}
