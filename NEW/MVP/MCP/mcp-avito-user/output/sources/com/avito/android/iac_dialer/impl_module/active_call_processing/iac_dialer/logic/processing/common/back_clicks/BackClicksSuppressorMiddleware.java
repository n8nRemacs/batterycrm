...
public final /* data */ class BackClicksSuppressorMiddleware implements IacMiddlewareDistinctBy<Payload> {
    ...
    public static final /* data */ class Payload implements IacMiddlewarePayload {
        ...
        public Payload(boolean z12) {
            this.shouldSuppress = z12;
        }

        public static /* synthetic */ Payload copy$default(Payload payload, boolean z12, int i12, Object obj) {
            if ((i12 & 1) != 0) {
                z12 = payload.shouldSuppress;
            }
            return payload.copy(z12);
        }

        /* renamed from: component1, reason: from getter */
        public final boolean getShouldSuppress() {
            return this.shouldSuppress;
        }

        @k
        public final Payload copy(boolean shouldSuppress) {
            return new Payload(shouldSuppress);
        }
        ...
        public boolean equals(@l Object other) {
            ...
            return (other instanceof Payload) && this.shouldSuppress == ((Payload) other).shouldSuppress;
        }
        ...
        public int hashCode() {
            return Boolean.hashCode(this.shouldSuppress);
        }

        @k
        public String toString() {
            return r.x(new StringBuilder("Payload(shouldSuppress="), this.shouldSuppress, ')');
        }
    }

    private BackClicksSuppressorMiddleware() {
    }

    public boolean equals(@l Object other) {
        return this == other || (other instanceof BackClicksSuppressorMiddleware);
    }
    ...
    public Payload getPayloadFromState(@k IacState state) {
        return new Payload(state instanceof IacState.InUse);
    }

    @Override // com.avito.android.iac_dialer.impl_module.active_call_processing.iac_dialer.core.IacMiddlewareDistinctBy
    public void process(@k IacMiddlewareProcessing iacMiddlewareProcessing, @k Payload payload, @k Payload payload2) {
        iacMiddlewareProcessing.plusAssign(iacMiddlewareProcessing.getOut(), new IacEvent.BackClicksSuppressor.SetEnabled(payload2.getShouldSuppress()));
    }
}
