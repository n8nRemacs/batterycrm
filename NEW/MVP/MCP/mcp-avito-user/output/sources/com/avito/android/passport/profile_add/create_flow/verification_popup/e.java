...
final class e extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ VerificationPopupFragment f212255l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(VerificationPopupFragment verificationPopupFragment) {
        super(0);
        this.f212255l = verificationPopupFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        VerificationPopupFragment.a aVar = VerificationPopupFragment.f212207x0;
        this.f212255l.t5().accept(a.C1250a.f17738a);
        return G0.f406611a;
    }
}
