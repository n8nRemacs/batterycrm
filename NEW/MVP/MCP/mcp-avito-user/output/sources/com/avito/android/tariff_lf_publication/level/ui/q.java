...
final class q extends N implements Y41.l<com.avito.android.lib.design.text_view.a, G0> {
    ...
    public final /* synthetic */ AttributedText f300995l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l<UD0.a, G0> f300996m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(Y41.l lVar, AttributedText attributedText) {
        super(1);
        this.f300995l = attributedText;
        this.f300996m = lVar;
    }

    @Override // Y41.l
    public final G0 invoke(com.avito.android.lib.design.text_view.a aVar) {
        this.f300995l.setOnDeepLinkClickListener(new com.avito.android.mortgage.document_upload.B(25, this.f300996m));
        return G0.f406611a;
    }
}
