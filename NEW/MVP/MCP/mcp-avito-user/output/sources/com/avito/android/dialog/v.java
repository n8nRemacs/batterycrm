...
final class v extends N implements Y41.l<DialogInterface, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ DialogWithDeeplinkActions f144802l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v(DialogWithDeeplinkActions dialogWithDeeplinkActions) {
        super(1);
        this.f144802l = dialogWithDeeplinkActions;
    }

    @Override // Y41.l
    public final G0 invoke(DialogInterface dialogInterface) {
        this.f144802l.g5(null, null);
        return G0.f406611a;
    }
}
