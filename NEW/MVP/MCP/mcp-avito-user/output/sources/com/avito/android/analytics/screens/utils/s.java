...
final class s extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<P2.b<Object>, G0> f90996l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ P2<Object> f90997m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public s(Y41.l<? super P2.b<Object>, G0> lVar, P2<Object> p22) {
        super(0);
        this.f90996l = lVar;
        this.f90997m = p22;
    }
    ...
    public final G0 invoke() {
        this.f90996l.invoke(this.f90997m);
        return G0.f406611a;
    }
}
