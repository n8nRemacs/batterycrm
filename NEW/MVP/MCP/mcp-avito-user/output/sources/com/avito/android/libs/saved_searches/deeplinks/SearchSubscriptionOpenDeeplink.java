...
/* compiled from: SearchSubscriptionOpenDeeplink.kt */
...
public final class SearchSubscriptionOpenDeeplink extends PublicDeeplink {
    ...
    @l
    public final String f181441b;

    /* renamed from: c, reason: collision with root package name */
    @l
    public final String f181442c;
    ...
    public static final class a implements Parcelable.Creator<SearchSubscriptionOpenDeeplink> {
        ...
        @Override // android.os.Parcelable.Creator
        public final SearchSubscriptionOpenDeeplink[] newArray(int i12) {
            return new SearchSubscriptionOpenDeeplink[i12];
        }
    }
    ...
    public final void writeToParcel(@k Parcel parcel, int i12) {
        parcel.writeString(this.f181441b);
        parcel.writeString(this.f181442c);
    }

    public /* synthetic */ SearchSubscriptionOpenDeeplink(String str, String str2, int i12, C42822w c42822w) {
