...
final class j extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<com.avito.beduin.v2.engine.field.m, G0> f334293l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public j(Y41.l<? super com.avito.beduin.v2.engine.field.m, G0> lVar) {
        super(0);
        this.f334293l = lVar;
    }
    ...
    public final G0 invoke() {
        ...
        this.f334293l.invoke(com.avito.beduin.v2.engine.field.m.f336869c);
        return G0.f406611a;
    }
}
