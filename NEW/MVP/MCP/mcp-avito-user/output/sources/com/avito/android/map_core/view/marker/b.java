...
final class b extends N implements Y41.a<ImageView> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ MarkerPinView f185799l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(MarkerPinView markerPinView) {
        super(0);
        this.f185799l = markerPinView;
    }

    @Override // Y41.a
    public final ImageView invoke() {
        return (ImageView) this.f185799l.findViewById(R.id.icon);
    }
}
