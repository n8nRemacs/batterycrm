...
final class m extends N implements Y41.l<com.avito.android.lib.design.text_view.a, G0> {
    ...
    public final /* synthetic */ AttributedText f172934l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l<DeepLink, G0> f172935m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(Y41.l lVar, AttributedText attributedText) {
        super(1);
        this.f172934l = attributedText;
        this.f172935m = lVar;
    }

    @Override // Y41.l
    public final G0 invoke(com.avito.android.lib.design.text_view.a aVar) {
        this.f172934l.setOnDeepLinkClickListener(new b.g(this.f172935m));
        return G0.f406611a;
    }
}
