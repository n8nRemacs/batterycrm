...
final class M extends kotlin.jvm.internal.N implements Y41.l<LocationPickerState, Boolean> {

    /* renamed from: l, reason: collision with root package name */
    public static final M f182523l = new M();
    ...
    public final Boolean invoke(LocationPickerState locationPickerState) {
        return Boolean.valueOf(locationPickerState.f182361f.length() == 0);
    }
}
