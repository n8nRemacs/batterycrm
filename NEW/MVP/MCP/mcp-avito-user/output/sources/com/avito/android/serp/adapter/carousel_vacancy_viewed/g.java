...
final class g extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ h f269182l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ AdvertItem f269183m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(h hVar, AdvertItem advertItem) {
        super(1);
        this.f269182l = hVar;
        this.f269183m = advertItem;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        this.f269182l.f269185c.get().Sa(this.f269183m.f268425c, deepLink, ContactSource.f89919d);
        return G0.f406611a;
    }
}
