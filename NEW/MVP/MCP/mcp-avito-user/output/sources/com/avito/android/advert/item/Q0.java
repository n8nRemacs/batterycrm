...
final class Q0 extends kotlin.jvm.internal.N implements Y41.l<List<? extends TrustFactorsComponent>, List<? extends TrustFactorsComponent>> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.l<TrustFactorsComponent.CombinedButtons, TrustFactorsComponent.CombinedButtons> f71790l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public Q0(Y41.l<? super TrustFactorsComponent.CombinedButtons, TrustFactorsComponent.CombinedButtons> lVar) {
        super(1);
        this.f71790l = lVar;
    }
    ...
    public final List<? extends TrustFactorsComponent> invoke(List<? extends TrustFactorsComponent> list) {
        ...
        for (TrustFactorsComponent trustFactorsComponent : list2) {
            if (trustFactorsComponent instanceof TrustFactorsComponent.CombinedButtons) {
                trustFactorsComponent = (TrustFactorsComponent) this.f71790l.invoke(trustFactorsComponent);
            }
