...
public final /* data */ class RadioButtonTitleIcon implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator<RadioButtonTitleIcon> {
        @Override // android.os.Parcelable.Creator
        public final RadioButtonTitleIcon createFromParcel(Parcel parcel) {
            ...
            if (parcel.readInt() != 0) {
                ...
                int iL2 = 0;
                while (iL2 != i12) {
                    iL2 = com.avito.android.actions_sheet.a.l(RadioButtonTitleIcon.class, parcel, arrayList2, iL2, 1);
                }
                arrayList = arrayList2;
            }
            return new RadioButtonTitleIcon(localIconCreateFromParcel, iconBase64CreateFromParcel, arrayList);
        }

        @Override // android.os.Parcelable.Creator
        public final RadioButtonTitleIcon[] newArray(int i12) {
            return new RadioButtonTitleIcon[i12];
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public RadioButtonTitleIcon(@Y61.l LocalIcon localIcon, @Y61.l IconBase64 iconBase64, @Y61.l List<? extends BeduinAction> list) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ RadioButtonTitleIcon copy$default(RadioButtonTitleIcon radioButtonTitleIcon, LocalIcon localIcon, IconBase64 iconBase64, List list, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            localIcon = radioButtonTitleIcon.localIcon;
        }
        if ((i12 & 2) != 0) {
            iconBase64 = radioButtonTitleIcon.base64Icon;
        }
        if ((i12 & 4) != 0) {
            list = radioButtonTitleIcon.actions;
        }
        return radioButtonTitleIcon.copy(localIcon, iconBase64, list);
    }
    ...
    @Y61.k
    public final RadioButtonTitleIcon copy(@Y61.l LocalIcon localIcon, @Y61.l IconBase64 base64Icon, @Y61.l List<? extends BeduinAction> actions) {
        return new RadioButtonTitleIcon(localIcon, base64Icon, actions);
    }
    ...
    public boolean equals(@Y61.l Object other) {
        ...
        if (!(other instanceof RadioButtonTitleIcon)) {
            return false;
        }
        RadioButtonTitleIcon radioButtonTitleIcon = (RadioButtonTitleIcon) other;
        return L.f(this.localIcon, radioButtonTitleIcon.localIcon) && L.f(this.base64Icon, radioButtonTitleIcon.base64Icon) && L.f(this.actions, radioButtonTitleIcon.actions);
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("RadioButtonTitleIcon(localIcon=");
