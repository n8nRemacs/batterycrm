...
final class i extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ VinScannerFragment f239481l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(VinScannerFragment vinScannerFragment) {
        super(0);
        this.f239481l = vinScannerFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        VinScannerFragment.a aVar = VinScannerFragment.f239432D0;
        this.f239481l.t5().accept(InterfaceC13390a.d.f3314a);
        return G0.f406611a;
    }
}
