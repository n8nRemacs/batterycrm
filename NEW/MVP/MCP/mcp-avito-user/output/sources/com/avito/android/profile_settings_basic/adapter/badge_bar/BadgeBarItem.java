...
@K51.d
@P
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/profile_settings_basic/adapter/badge_bar/BadgeBarItem;", "Lcom/avito/android/profile_settings_basic/adapter/BasicSettingsListItem;", "_avito_profile-management_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes16.dex */
public final /* data */ class BadgeBarItem implements BasicSettingsListItem {
    ...
    @k
    public final String f228572b;

    /* renamed from: c, reason: collision with root package name */
    @k
    public final List<BadgeItem> f228573c;
    ...
    public final boolean equals(@l Object obj) {
        ...
        return L.f(this.f228572b, badgeBarItem.f228572b) && L.f(this.f228573c, badgeBarItem.f228573c);
    }
    ...
    public final String getF154542b() {
        return this.f228572b;
    }

    public final int hashCode() {
        return this.f228573c.hashCode() + (this.f228572b.hashCode() * 31);
    }

    @k
    public final String toString() {
        StringBuilder sb2 = new StringBuilder("BadgeBarItem(stringId=");
        sb2.append(this.f228572b);
        sb2.append(", badges=");
        return H.p(sb2, this.f228573c, ')');
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@k Parcel parcel, int i12) {
        parcel.writeString(this.f228572b);
        Iterator itJ = C0.j(this.f228573c, parcel);
        while (itJ.hasNext()) {
