...
public final class q extends N implements Y41.r<InterfaceC20793y, Integer, A, Integer, G0> {
    ...
    public final /* synthetic */ List f94996l;
    ...
    public final G0 invoke(InterfaceC20793y interfaceC20793y, Integer num, A a12, Integer num2) {
        ...
        if (a13.p(i12 & 1, (i12 & 147) != 146)) {
            AutoContactsPackage autoContactsPackage = (AutoContactsPackage) this.f94996l.get(iIntValue);
            a13.C(-712754357);
            h.a aVar = androidx.compose.ui.unit.h.f42849c;
            com.avito.android.auto_contacts.presentation.h.a(autoContactsPackage, R1.m(v.f42878y1, 0.0f, 0.0f, 0.0f, 20, 7), a13, 48, 0);
            a13.h();
        } else {
            a13.f();
        }
