...
public final class g extends N implements l<Drawable, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC40743a f224899l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(InterfaceC40743a interfaceC40743a) {
        super(1);
        this.f224899l = interfaceC40743a;
    }

    @Override // Y41.l
    public final G0 invoke(Drawable drawable) {
        this.f224899l.setState(State.f135882f);
        return G0.f406611a;
    }
}
