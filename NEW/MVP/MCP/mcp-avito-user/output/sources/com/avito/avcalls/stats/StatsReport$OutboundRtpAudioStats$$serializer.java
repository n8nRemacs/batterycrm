...
public final class StatsReport$OutboundRtpAudioStats$$serializer implements N<StatsReport.OutboundRtpAudioStats> {
    ...
    public void serialize(@k Encoder encoder, @k StatsReport.OutboundRtpAudioStats value) {
        ...
        dVarC.p(f412706c, 0, StatsReport$Codec$$serializer.INSTANCE, value.f333552a);
        dVarC.p(f412706c, 1, StatsReport$OutboundRtpAudioSourceStats$$serializer.INSTANCE, value.f333553b);
        j1 j1Var = j1.f412874a;
        dVarC.p(f412706c, 2, j1Var, value.f333554c);
        dVarC.p(f412706c, 3, j1Var, value.f333555d);
        dVarC.p(f412706c, 4, j1Var, value.f333556e);
        dVarC.p(f412706c, 5, j1Var, value.f333557f);
        dVarC.p(f412706c, 6, j1Var, value.f333558g);
        dVarC.p(f412706c, 7, j1Var, value.f333559h);
        dVarC.p(f412706c, 8, j1Var, value.f333560i);
        F f12 = F.f412769a;
        dVarC.p(f412706c, 9, f12, value.f333561j);
        dVarC.p(f412706c, 10, j1Var, value.f333562k);
        dVarC.p(f412706c, 11, f12, value.f333563l);
        dVarC.p(f412706c, 12, StatsReport$RemoteInboundRtpStats$$serializer.INSTANCE, value.f333564m);
        dVarC.d(f412706c);
    }
