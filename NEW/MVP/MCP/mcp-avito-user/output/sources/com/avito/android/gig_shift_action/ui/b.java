...
final class b extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ GigShiftActionDialogFragment f160584l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(GigShiftActionDialogFragment gigShiftActionDialogFragment) {
        super(0);
        this.f160584l = gigShiftActionDialogFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        GigShiftActionDialogFragment.a aVar = GigShiftActionDialogFragment.f160550v0;
        this.f160584l.f5().accept(a.d.f160465a);
        return G0.f406611a;
    }
}
