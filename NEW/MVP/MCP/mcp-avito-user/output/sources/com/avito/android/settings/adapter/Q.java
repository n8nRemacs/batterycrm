...
final class Q extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ S f280750l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ i0.g f280751m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Q(S s5, i0.g gVar) {
        super(0);
        this.f280750l = s5;
        this.f280751m = gVar;
    }
    ...
    public final G0 invoke() {
        Y41.l<InterfaceC14616a, G0> lVar = this.f280750l.f280752b;
        this.f280751m.getClass();
        lVar.invoke(new InterfaceC14616a.c("version"));
        return G0.f406611a;
    }
}
