...
final class r extends N implements Y41.l<com.avito.android.lib.design.text_view.a, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ActionMode.Callback f192561l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(ActionMode.Callback callback) {
        super(1);
        this.f192561l = callback;
    }

    @Override // Y41.l
    public final G0 invoke(com.avito.android.lib.design.text_view.a aVar) {
        aVar.setCustomSelectionActionModeCallback(this.f192561l);
        return G0.f406611a;
    }
}
