...
@d
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0081\b\u0018\u00002\u00020\u00012\u00020\u0002¨\u0006\u0003"}, d2 = {"Lcom/avito/android/crm_candidates/features/full_filters/entity/FiltersState;", "Landroid/os/Parcelable;", "Lcom/avito/android/analytics/screens/mvi/q;", "_avito_job_crm-candidates_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final /* data */ class FiltersState extends q implements Parcelable {
    ...
    @k
    public final List<FilterItem> f129586b;
    ...
    public final boolean equals(@l Object obj) {
        ...
        return (obj instanceof FiltersState) && L.f(this.f129586b, ((FiltersState) obj).f129586b);
    }

    public final int hashCode() {
        return this.f129586b.hashCode();
    }

    @k
    public final String toString() {
        return H.p(new StringBuilder("FiltersState(filters="), this.f129586b, ')');
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@k Parcel parcel, int i12) {
        Iterator itJ = C0.j(this.f129586b, parcel);
        while (itJ.hasNext()) {
