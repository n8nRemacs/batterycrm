...
final class n extends N implements Y41.l<A, G0> {
    ...
    public final /* synthetic */ InterfaceC22196w1 f159195l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(InterfaceC22196w1 interfaceC22196w1) {
        super(1);
        this.f159195l = interfaceC22196w1;
    }

    @Override // Y41.l
    public final G0 invoke(A a12) {
        this.f159195l.L3((int) (a12.a() & 4294967295L));
        return G0.f406611a;
    }
}
