...
final class s extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204847l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204847l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204847l.getViewModel().accept(b.o.f204585b);
        return G0.f406611a;
    }
}
