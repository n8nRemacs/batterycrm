...
import com.avito.android.advert.item.safedeal.real_one_click_payment_block.payment_slider.l;
...
public final class m implements Animator.AnimatorListener {
    ...
    public final /* synthetic */ l f78998a;
    ...
    public final void onAnimationEnd(Animator animator) {
        l lVar = this.f78998a;
        lVar.f78994e.postDelayed(new l.b(lVar.f78995f), 1500L);
    }
