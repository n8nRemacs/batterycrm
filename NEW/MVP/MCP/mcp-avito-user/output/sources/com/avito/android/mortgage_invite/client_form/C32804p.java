...
/* renamed from: com.avito.android.mortgage_invite.client_form.p, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
final class C32804p extends kotlin.jvm.internal.N implements Y41.p<ContactInfoFieldId, String, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.p<ContactInfoFieldId, String, G0> f205272l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public C32804p(Y41.p<? super ContactInfoFieldId, ? super String, G0> pVar) {
        super(2);
        this.f205272l = pVar;
    }
    ...
    public final G0 invoke(ContactInfoFieldId contactInfoFieldId, String str) {
        this.f205272l.invoke(contactInfoFieldId, str);
        return G0.f406611a;
    }
}
