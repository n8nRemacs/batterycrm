...
/* compiled from: AdvertDetailsBadgeBarLightFactoryImpl.kt */
...
public final class C implements com.avito.android.advert_core.blocks.a {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final com.avito.android.advert.item.blocks.items_factories.P f73422a;

    @Inject
    public C(@Y61.k com.avito.android.advert.item.blocks.items_factories.P p12) {
        this.f73422a = p12;
    }
    ...
    public final List<PersistableSpannedItem> a(@Y61.k a.b bVar) {
        return C42745f0.V(this.f73422a.a(bVar.f83013a.f82645b));
    }
