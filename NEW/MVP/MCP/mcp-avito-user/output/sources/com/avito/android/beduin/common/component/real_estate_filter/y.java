...
public final class y implements TextWatcher {
    ...
    @Y61.k
    public String f102355b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ Input f102356c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ s f102357d;

    public y(Input input, s sVar) {
        this.f102356c = input;
        this.f102357d = sVar;
        this.f102355b = input.getDeformattedText();
    }

    @Override // android.text.TextWatcher
    public final void afterTextChanged(@Y61.l Editable editable) {
        String deformattedText = this.f102356c.getDeformattedText();
        if (L.f(deformattedText, this.f102355b)) {
            return;
        }
        s sVar = this.f102357d;
