...
public final class m implements InterfaceC28898u {
    ...
    public final Class<?> a() {
        return RedesignedOrderFragmentData.class;
    }

    @Override // com.avito.android.bottom_navigation.InterfaceC28898u
    @Y61.k
    public final TabBaseFragment b(@Y61.k TabFragmentFactory.Data data) {
        RedesignedOrderFragmentData redesignedOrderFragmentData = (RedesignedOrderFragmentData) data;
        OrderFragment.a aVar = OrderFragment.f209724F0;
        String str = redesignedOrderFragmentData.f209720b;
        aVar.getClass();
        return OrderFragment.a.a(str, redesignedOrderFragmentData.f209722d);
    }
}
