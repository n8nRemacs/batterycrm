...
final class U extends kotlin.jvm.internal.N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ Y41.l<InterfaceC48707a, G0> f127973l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public U(Y41.l<? super InterfaceC48707a, G0> lVar) {
        super(1);
        this.f127973l = lVar;
    }
    ...
    public final G0 invoke(Integer num) {
        this.f127973l.invoke(new InterfaceC48707a.d(num.intValue()));
        return G0.f406611a;
    }
}
