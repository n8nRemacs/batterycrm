...
final class h extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ EarlyAccessDialog f145386l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(EarlyAccessDialog earlyAccessDialog) {
        super(0);
        this.f145386l = earlyAccessDialog;
    }

    @Override // Y41.a
    public final G0 invoke() {
        EarlyAccessDialog.a aVar = EarlyAccessDialog.f145055q0;
        this.f145386l.f5().accept(InterfaceC14538a.c.f11107a);
        return G0.f406611a;
    }
}
