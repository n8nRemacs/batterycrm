...
@d
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u0003¨\u0006\u0004"}, d2 = {"Lcom/avito/android/profile/user_profile/analytics/AvitoFinanceSensitiveDataEvent;", "Lcom/avito/android/analytics/provider/clickstream/a;", "Lcom/avito/android/analytics/provider/clickstream/ParcelableClickStreamEvent;", "Lcc/e;", "_avito_profile_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class AvitoFinanceSensitiveDataEvent implements com.avito.android.analytics.provider.clickstream.a, ParcelableClickStreamEvent, e {
    ...
    public final int f224266b;

    /* renamed from: c, reason: collision with root package name */
    public final int f224267c;

    /* renamed from: d, reason: collision with root package name */
    @k
    public final Map<String, Object> f224268d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ ParametrizedClickStreamEvent f224269e;
    ...
    public AvitoFinanceSensitiveDataEvent(int i12, int i13, @k Map<String, ? extends Object> map) {
        ...
        this.f224267c = i13;
        this.f224268d = map;
        this.f224269e = new ParametrizedClickStreamEvent(i12, i13, map, null, 8, null);
    }
    ...
    public final int getF224266b() {
        return this.f224266b;
    }

    @Override // com.avito.android.analytics.provider.clickstream.a
    @k
    public final Map<String, Object> getParams() {
        return this.f224269e.f90249d;
    }

    @Override // com.avito.android.analytics.provider.clickstream.a
    /* renamed from: getVersion, reason: from getter */
    public final int getF224267c() {
        return this.f224267c;
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@k Parcel parcel, int i12) {
        parcel.writeInt(this.f224266b);
        parcel.writeInt(this.f224267c);
        Iterator itI = C0.i(parcel, this.f224268d);
        while (itI.hasNext()) {
