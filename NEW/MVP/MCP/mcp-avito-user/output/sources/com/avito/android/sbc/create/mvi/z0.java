...
final class z0<T> implements l41.g {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ CreateDiscountDispatchFragment f259943b;

    public z0(CreateDiscountDispatchFragment createDiscountDispatchFragment) {
        this.f259943b = createDiscountDispatchFragment;
    }

    @Override // l41.g
    public final void accept(Object obj) {
        CreateDiscountDispatchFragment.a aVar = CreateDiscountDispatchFragment.f259243G0;
        this.f259943b.q5().accept(new e.C15553h((String) obj));
    }
}
