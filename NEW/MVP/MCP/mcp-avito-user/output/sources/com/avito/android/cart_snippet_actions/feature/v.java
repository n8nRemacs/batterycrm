...
final class v extends N implements Y41.l<Map.Entry<? extends String, ? extends Stepper>, Stepper> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC48693b f116248l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v(InterfaceC48693b interfaceC48693b) {
        super(1);
        this.f116248l = interfaceC48693b;
    }
    ...
    public final Stepper invoke(Map.Entry<? extends String, ? extends Stepper> entry) {
        ...
        return com.avito.android.cart_snippet_actions.utils.i.a(entry2.getValue(), (CartItemInfo) ((TrueCartSnippetActionsInternalAction.j) this.f116248l).f116201b.get(entry2.getKey()));
    }
}
