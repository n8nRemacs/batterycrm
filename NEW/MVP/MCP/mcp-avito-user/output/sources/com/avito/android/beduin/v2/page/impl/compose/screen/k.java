...
public final class k extends N implements Y41.l<androidx.compose.ui.graphics.drawscope.d, G0> {
    ...
    public final /* synthetic */ r f105068l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.analytics.screens.compose.a f105069m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(r rVar, com.avito.android.analytics.screens.compose.a aVar) {
        super(1);
        this.f105068l = rVar;
        this.f105069m = aVar;
    }
    ...
    public final G0 invoke(androidx.compose.ui.graphics.drawscope.d dVar) {
        dVar.y1();
        com.avito.android.analytics.screens.compose.a aVar = this.f105069m;
        r rVar = this.f105068l;
        if (rVar != null) {
