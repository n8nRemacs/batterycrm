...
/* compiled from: AdvertRichTravelPriceV11ItemBlueprint.kt */
@P
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001¨\u0006\u0004"}, d2 = {"Lcom/avito/android/serp/adapter/rich_snippets/travel/e;", "LTV0/b;", "Lcom/avito/android/serp/adapter/rich_snippets/regular/x;", "Lcom/avito/android/serp/adapter/AdvertItem;", "_avito-discouraged_avito-libs_serp-core_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class e implements TV0.b<InterfaceC34800x, AdvertItem> {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final InterfaceC34782e f271423a;

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public final RecyclerView.t f271424b;

    /* renamed from: c, reason: collision with root package name */
    @Y61.k
    public final p f271425c;

    /* renamed from: d, reason: collision with root package name */
    @Y61.k
    public final com.avito.android.pinch_to_zoom.b f271426d;

    /* renamed from: e, reason: collision with root package name */
    @Y61.k
    public final g.a<C34801y> f271427e = new g.a<>(R.layout.advert_item_rich_travel_price_v11, new a());
    ...
    public static final class a extends N implements Y41.p<ViewGroup, View, C34801y> {
        ...
        public final C34801y invoke(ViewGroup viewGroup, View view) {
            ...
            n nVar = n.f271464a;
            e eVar = e.this;
            p pVar = eVar.f271425c;
            nVar.getClass();
            return new C34801y(view2, new com.avito.android.cyclic_gallery_widget.image_carousel.m(0.32f, 1.3333334f, f12, f13), eVar.f271424b, i12 == 2 ? pVar.b() : pVar.a(), AsyncViewportTracker.ViewContext.f430431u, eVar.f271426d, null, 64, null);
        }
    }

    @Inject
    public e(@Y61.k InterfaceC34782e interfaceC34782e, @Y61.k RecyclerView.t tVar, @Y61.k p pVar, @Y61.k com.avito.android.pinch_to_zoom.b bVar) {
        this.f271423a = interfaceC34782e;
        this.f271424b = tVar;
        this.f271425c = pVar;
        this.f271426d = bVar;
    }
    ...
    public final boolean d(@Y61.k TV0.a aVar) {
        if (aVar instanceof AdvertItem) {
            ...
            if (advertItem.f268374D == SerpViewType.f268582b && advertItem.f268378F.isRich() && advertItem.f268409U0) {
                if (advertItem.f268415X0 == AdvertTravelPriceVersion.NewPrice1Discount1) {
                    return true;
                }
            }
        }
