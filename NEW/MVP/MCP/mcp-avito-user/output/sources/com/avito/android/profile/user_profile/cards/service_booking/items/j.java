...
final class j extends N implements Y41.l<String, Boolean> {
    ...
    public final /* synthetic */ TV0.a f225449l;
    ...
    public final Boolean invoke(String str) {
        return Boolean.valueOf(!L.f(str, ((com.avito.android.profile.user_profile.cards.service_booking.items.order.ServiceBookingItem) this.f225449l).f225456d));
    }
}
