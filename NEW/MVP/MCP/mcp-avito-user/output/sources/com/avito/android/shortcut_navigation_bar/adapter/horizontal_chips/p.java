...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001¨\u0006\u0004"}, d2 = {"Lcom/avito/android/shortcut_navigation_bar/adapter/horizontal_chips/p;", "LTV0/b;", "Lcom/avito/android/shortcut_navigation_bar/adapter/horizontal_chips/t;", "Lcom/avito/android/shortcut_navigation_bar/adapter/ShortcutNavigationItem;", "_avito_shortcut-bar_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class p implements TV0.b<t, ShortcutNavigationItem> {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final s f283317a;

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public final InterfaceC50637a f283318b;
    ...
    public static final class a extends N implements Y41.p<ViewGroup, View, u> {
        ...
        public final u invoke(ViewGroup viewGroup, View view) {
            return new u(view, p.this.f283318b);
        }
    }

    public p(@Y61.k s sVar, @Y61.k InterfaceC50637a interfaceC50637a) {
        this.f283317a = sVar;
        this.f283318b = interfaceC50637a;
    }

    @Override // TV0.b
    public final TV0.d a() {
        return this.f283317a;
    }
    ...
    public final boolean d(@Y61.k TV0.a aVar) {
        Uri uri;
        if ((aVar instanceof ShortcutNavigationItem) && !(aVar instanceof SkeletonItem) && !(aVar instanceof InlineFilterNavigationItem) && !(aVar instanceof TagShortcutItem)) {
