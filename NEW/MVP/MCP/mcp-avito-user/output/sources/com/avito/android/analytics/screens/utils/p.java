...
final class p extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Object f90988l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Throwable f90989m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p(Y41.l<? super Throwable, G0> lVar, Throwable th2) {
        super(0);
        this.f90988l = lVar;
        this.f90989m = th2;
    }
    ...
    public final G0 invoke() {
        this.f90988l.invoke(this.f90989m);
        return G0.f406611a;
    }
}
