...
final class B extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f159888l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f159888l | 1);
        androidx.compose.runtime.B bE2 = a12.E(1935614418);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            ...
            z.a(new C(null, "Подготовьтесь к смене", "Вам помогут материалы заказчика"), A.f159887l, bE2, 56);
            bE2.X(true);
        }
