...
final class l extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ CrmPaidCvsFragment f130772l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ CvItem f130773m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(CrmPaidCvsFragment crmPaidCvsFragment, CvItem cvItem) {
        super(0);
        this.f130772l = crmPaidCvsFragment;
        this.f130773m = cvItem;
    }

    @Override // Y41.a
    public final G0 invoke() {
        CrmPaidCvsFragment.a aVar = CrmPaidCvsFragment.f130713C0;
        this.f130772l.r5().accept(new a.m(this.f130773m.f130326b));
        return G0.f406611a;
    }
}
