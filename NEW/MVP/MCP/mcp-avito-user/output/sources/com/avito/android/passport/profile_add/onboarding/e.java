...
final class e extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ PassportOnboardingActivity f213571l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(PassportOnboardingActivity passportOnboardingActivity) {
        super(0);
        this.f213571l = passportOnboardingActivity;
    }

    @Override // Y41.a
    public final G0 invoke() {
        PassportOnboardingActivity.a aVar = PassportOnboardingActivity.f213545v;
        this.f213571l.b2().accept(InterfaceC40776a.b.f396998a);
        return G0.f406611a;
    }
}
