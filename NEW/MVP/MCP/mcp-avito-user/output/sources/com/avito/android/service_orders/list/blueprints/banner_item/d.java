...
final class d extends N implements l<DeepLink, G0> {
    ...
    public final /* synthetic */ f f279262l;
    ...
    public final G0 invoke(DeepLink deepLink) {
        ...
        com.avito.android.service_orders.list.l lVar = this.f279262l.f279265b;
        if (lVar != null) {
            lVar.f279388c.accept(new InterfaceC14531a.g(deepLink2));
        }
        return G0.f406611a;
    }
}
