...
/* compiled from: AdvertDetailsSimilarItemsBlockFactoryImpl.kt */
...
public final class A2 implements com.avito.android.advert_core.blocks.a {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final S4 f73417a;

    @Inject
    public A2(@Y61.k S4 s42) {
        this.f73417a = s42;
    }
    ...
    public final List<PersistableSpannedItem> a(@Y61.k a.b bVar) {
        return C42745f0.V(this.f73417a.a());
    }
