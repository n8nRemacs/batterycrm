...
final class f extends N implements Y41.l<Boolean, G0> {
    ...
    public final /* synthetic */ a f309516l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ h f309517m;
    ...
    public final G0 invoke(Boolean bool) {
        ...
        bool.getClass();
        a aVar = this.f309516l;
        if (aVar.f309495g != null && (myAdvertDetailsActivity = this.f309517m.f309525f) != null) {
            myAdvertDetailsActivity.i2(aVar);
        }
        return G0.f406611a;
    }
}
