...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\n\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/str_seller_orders_calendar/strorderscalendar/l;", "Landroidx/recyclerview/widget/RecyclerView$r;", "_avito_str-seller-orders-calendar_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class l extends RecyclerView.r {

    /* renamed from: b, reason: collision with root package name */
    @Y61.l
    public Integer f290970b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ StrOrdersCalendarView f290971c;

    public l(StrOrdersCalendarView strOrdersCalendarView) {
        this.f290971c = strOrdersCalendarView;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.r
    public final void i(int i12, @Y61.k RecyclerView recyclerView) {
        StrOrdersCalendarView strOrdersCalendarView = this.f290971c;
        if (i12 != 0) {
            if (i12 != 1) {
                return;
            }
    ...
    public final void k(@Y61.k RecyclerView recyclerView, int i12, int i13) {
        Integer num = this.f290970b;
        if (Math.abs((num != null ? num.intValue() : i13) - i13) <= 500) {
            RecyclerView recyclerView2 = this.f290971c.f290544D;
            if (recyclerView2 == null) {
                recyclerView2 = null;
            }
            recyclerView2.scrollBy(0, i13);
        }
        this.f290970b = Integer.valueOf(i13);
    }
}
