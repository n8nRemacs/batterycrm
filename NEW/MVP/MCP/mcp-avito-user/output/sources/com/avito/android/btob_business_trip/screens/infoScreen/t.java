...
public final class t extends N implements Y41.r<InterfaceC20793y, Integer, A, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ List f108022l;
    ...
    public final G0 invoke(InterfaceC20793y interfaceC20793y, Integer num, A a12, Integer num2) {
        ...
        if (a13.p(i12 & 1, (i12 & 147) != 146)) {
            ConditionItemInfo conditionItemInfo = (ConditionItemInfo) this.f108022l.get(iIntValue);
            a13.C(-1676394201);
            com.avito.android.btob_business_trip.screens.infoScreen.composables.g.a(0, a13, null, conditionItemInfo.f107853b, conditionItemInfo.f107854c);
            a13.h();
        } else {
            a13.f();
        }
