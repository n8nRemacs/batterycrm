...
final class e extends N implements p<Integer, Parcelable, G0> {
    ...
    public final /* synthetic */ f f154906l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ SelectionsItem f154907m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(f fVar, SelectionsItem selectionsItem) {
        super(2);
        this.f154906l = fVar;
        this.f154907m = selectionsItem;
    }

    @Override // Y41.p
    public final G0 invoke(Integer num, Parcelable parcelable) {
        f fVar = this.f154906l;
        fVar.f154908b.invoke(new B(this.f154907m, num.intValue(), parcelable));
        return G0.f406611a;
    }
}
