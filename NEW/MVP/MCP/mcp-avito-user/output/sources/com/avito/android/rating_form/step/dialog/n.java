...
final class n extends N implements Y41.l<Exception, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ FullscreenDialogFragment f249466l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(FullscreenDialogFragment fullscreenDialogFragment) {
        super(1);
        this.f249466l = fullscreenDialogFragment;
    }

    @Override // Y41.l
    public final G0 invoke(Exception exc) {
        Context context = this.f249466l.getContext();
        if (context != null) {
