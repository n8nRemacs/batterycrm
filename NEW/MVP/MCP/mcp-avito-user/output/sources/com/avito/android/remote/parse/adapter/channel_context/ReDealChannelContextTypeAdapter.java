...
/* compiled from: ReDealChannelContextTypeAdapter.kt */
@s0
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, d2 = {"Lcom/avito/android/remote/parse/adapter/channel_context/ReDealChannelContextTypeAdapter;", "Lcom/google/gson/h;", "Lcom/avito/android/remote/model/messenger/context/ChannelContext$ReDeal;", "<init>", "()V", "_avito-discouraged_api-models_models"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class ReDealChannelContextTypeAdapter implements h<ChannelContext.ReDeal> {
    ...
    public final ChannelContext.ReDeal deserialize(i iVar, Type type, g gVar) {
        ...
        return new ChannelContext.ReDeal((MessageBody.Location) (iVarD3 != null ? gVar.b(iVarD3, MessageBody.Location.class) : null), arrayList, attachMenu, C2.c(kVarI, ChannelContext.AVATAR_USER_ID));
    }
}
