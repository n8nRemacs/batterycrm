...
final class e extends N implements l<Integer, G0> {
    ...
    public final /* synthetic */ BbipPrivateFragment f260558l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(BbipPrivateFragment bbipPrivateFragment) {
        super(1);
        this.f260558l = bbipPrivateFragment;
    }
    ...
    public final G0 invoke(Integer num) {
        ...
        this.f260558l.q5().accept(new InterfaceC47705a.g(Integer.valueOf(iIntValue)));
        return G0.f406611a;
    }
}
