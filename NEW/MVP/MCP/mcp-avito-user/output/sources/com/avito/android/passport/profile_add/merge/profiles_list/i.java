...
final class i extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ ProfilesListFragment f213258l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(ProfilesListFragment profilesListFragment) {
        super(0);
        this.f213258l = profilesListFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        ProfilesListFragment.a aVar = ProfilesListFragment.f213192A0;
        this.f213258l.r5().accept(InterfaceC40238a.C11126a.f395661a);
        return G0.f406611a;
    }
}
