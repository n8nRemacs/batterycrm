...
final class b extends N implements l<Exception, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Uri f291247l;
    ...
    public final G0 invoke(Exception exc) {
        V2.f318762a.j("StrSellerImportantToNoteFragmentTag", "openWebView() failed to open uri = " + this.f291247l, null);
        return G0.f406611a;
    }
}
