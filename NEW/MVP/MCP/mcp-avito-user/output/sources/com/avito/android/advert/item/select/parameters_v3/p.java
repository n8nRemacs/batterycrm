...
final class p extends N implements Y41.l<com.avito.android.lib.design.text_view.a, G0> {
    ...
    public final /* synthetic */ y f79599l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l<DeepLink, G0> f79600m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public p(y yVar, Y41.l<? super DeepLink, G0> lVar) {
        super(1);
        this.f79599l = yVar;
        this.f79600m = lVar;
    }
    ...
    public final G0 invoke(com.avito.android.lib.design.text_view.a aVar) {
        y yVar = this.f79599l;
        yVar.f79625b.setOnDeepLinkClickListener(new x.a(this.f79600m));
        return G0.f406611a;
    }
}
