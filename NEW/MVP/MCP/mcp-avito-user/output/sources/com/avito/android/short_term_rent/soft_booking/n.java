...
final class n extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ StrSoftBookingFragment f282875l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(StrSoftBookingFragment strSoftBookingFragment) {
        super(1);
        this.f282875l = strSoftBookingFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        kotlin.reflect.n<Object>[] nVarArr = StrSoftBookingFragment.f282537y0;
        this.f282875l.q5().accept(new InterfaceC44950a.w(deepLink));
        return G0.f406611a;
    }
}
