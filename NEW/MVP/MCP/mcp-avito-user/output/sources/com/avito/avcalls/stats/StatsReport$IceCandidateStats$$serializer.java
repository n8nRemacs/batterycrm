...
public final class StatsReport$IceCandidateStats$$serializer implements N<StatsReport.IceCandidateStats> {
    ...
    public void serialize(@k Encoder encoder, @k StatsReport.IceCandidateStats value) {
        ...
        V0 v02 = V0.f412822a;
        dVarC.p(f332717a, 0, v02, value.f333456a);
        dVarC.p(f332717a, 1, v02, value.f333457b);
        dVarC.p(f332717a, 2, v02, value.f333458c);
        dVarC.p(f332717a, 3, v02, value.f333459d);
        Y y12 = Y.f412835a;
        dVarC.p(f332717a, 4, y12, value.f333460e);
        dVarC.p(f332717a, 5, v02, value.f333461f);
        dVarC.p(f332717a, 6, y12, value.f333462g);
        dVarC.p(f332717a, 7, v02, value.f333463h);
        dVarC.p(f332717a, 8, v02, value.f333464i);
        dVarC.p(f332717a, 9, v02, value.f333465j);
        dVarC.p(f332717a, 10, v02, value.f333466k);
        dVarC.p(f332717a, 11, C43407i.f412866a, value.f333467l);
        dVarC.d(f332717a);
    }
