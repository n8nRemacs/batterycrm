...
final class a extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ SearchPositionBottomBar f221288l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(SearchPositionBottomBar searchPositionBottomBar) {
        super(0);
        this.f221288l = searchPositionBottomBar;
    }

    @Override // Y41.a
    public final G0 invoke() {
        SearchPositionBottomButtonState searchPositionBottomButtonState;
        e eVar = this.f221288l.f221275i;
        if (eVar != null) {
            e.a aVar = eVar instanceof e.a ? (e.a) eVar : null;
            if (aVar != null && (searchPositionBottomButtonState = aVar.f221295d) != null) {
