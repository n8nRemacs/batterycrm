...
final class r extends N implements Y41.p<CharSequence, String, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ x f237159l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ParameterElement.H f237160m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(x xVar, ParameterElement.H h12) {
        super(2);
        this.f237159l = xVar;
        this.f237160m = h12;
    }
    ...
    public final G0 invoke(CharSequence charSequence, String str) {
        ...
        x xVar = this.f237159l;
        ParameterElement.H h12 = this.f237160m;
        h12.f117300f = str2;
        if (h12.f117302h) {
