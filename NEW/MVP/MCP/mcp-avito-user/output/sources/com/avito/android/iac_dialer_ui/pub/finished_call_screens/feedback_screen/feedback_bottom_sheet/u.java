...
final class u extends N implements Y41.l<String, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC22204y1<String> f167612l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public u(InterfaceC22204y1<String> interfaceC22204y1) {
        super(1);
        this.f167612l = interfaceC22204y1;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        IacUIFeedbackBottomSheetState iacUIFeedbackBottomSheetState = A.f167550a;
        this.f167612l.setValue(str);
        return G0.f406611a;
    }
}
