...
/* renamed from: com.avito.android.mortgage_invite.participant.d, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
final class C32834d extends kotlin.jvm.internal.N implements Y41.p<ParticipantFieldId, Boolean, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ParticipantFragment f206074l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C32834d(ParticipantFragment participantFragment) {
        super(2);
        this.f206074l = participantFragment;
    }
    ...
    public final G0 invoke(ParticipantFieldId participantFieldId, Boolean bool) {
        ...
        this.f206074l.q5().accept(new InterfaceC46876a.C12252a(participantFieldId, zBooleanValue));
        return G0.f406611a;
    }
}
