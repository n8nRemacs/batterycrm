...
final class d extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ VinScannerFragment f239474l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(VinScannerFragment vinScannerFragment) {
        super(0);
        this.f239474l = vinScannerFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        VinScannerFragment.a aVar = VinScannerFragment.f239432D0;
        this.f239474l.t5().accept(InterfaceC13390a.c.f3313a);
        return G0.f406611a;
    }
}
