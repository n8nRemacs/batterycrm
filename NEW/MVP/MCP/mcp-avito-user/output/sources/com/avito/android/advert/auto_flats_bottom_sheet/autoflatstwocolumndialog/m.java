...
final class m extends N implements Y41.p<A, Integer, G0> {
    ...
    public final /* synthetic */ U3.c f68706l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ androidx.compose.ui.v f68707m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(U3.c cVar, androidx.compose.ui.v vVar, int i12) {
        super(2);
        this.f68706l = cVar;
        this.f68707m = vVar;
    }
    ...
    public final G0 invoke(A a12, Integer num) {
        ...
        n.a(this.f68706l, this.f68707m, a12, iA2);
        return G0.f406611a;
    }
}
