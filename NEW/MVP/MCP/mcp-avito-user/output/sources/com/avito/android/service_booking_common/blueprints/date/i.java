...
final class i extends N implements Y41.p<Integer, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ k f276360l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ C47440d f276361m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(k kVar, C47440d c47440d) {
        super(2);
        this.f276360l = kVar;
        this.f276361m = c47440d;
    }
    ...
    public final G0 invoke(Integer num, Integer num2) {
        ...
        this.f276360l.f276350b.K5(C47440d.b(this.f276361m, null, new C47440d.b(iIntValue, iIntValue2), 7));
        return G0.f406611a;
    }
}
