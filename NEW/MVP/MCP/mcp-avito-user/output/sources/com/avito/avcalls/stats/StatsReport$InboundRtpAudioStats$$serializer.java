...
public final class StatsReport$InboundRtpAudioStats$$serializer implements N<StatsReport.InboundRtpAudioStats> {
    ...
    public void serialize(@k Encoder encoder, @k StatsReport.InboundRtpAudioStats value) {
        ...
        dVarC.p(f412706c, 0, StatsReport$Codec$$serializer.INSTANCE, value.f333478a);
        j1 j1Var = j1.f412874a;
        dVarC.p(f412706c, 1, j1Var, value.f333479b);
        dVarC.p(f412706c, 2, j1Var, value.f333480c);
        dVarC.p(f412706c, 3, C43412k0.f412877a, value.f333481d);
        dVarC.p(f412706c, 4, j1Var, value.f333482e);
        dVarC.p(f412706c, 5, j1Var, value.f333483f);
        dVarC.p(f412706c, 6, j1Var, value.f333484g);
        dVarC.p(f412706c, 7, j1Var, value.f333485h);
        dVarC.p(f412706c, 8, j1Var, value.f333486i);
        dVarC.p(f412706c, 9, j1Var, value.f333487j);
        dVarC.p(f412706c, 10, j1Var, value.f333488k);
        dVarC.p(f412706c, 11, j1Var, value.f333489l);
        dVarC.p(f412706c, 12, j1Var, value.f333490m);
        dVarC.p(f412706c, 13, j1Var, value.f333491n);
        F f12 = F.f412769a;
        dVarC.p(f412706c, 14, f12, value.f333492o);
        dVarC.p(f412706c, 15, j1Var, value.f333493p);
        dVarC.p(f412706c, 16, j1Var, value.f333494q);
        dVarC.p(f412706c, 17, j1Var, value.f333495r);
        dVarC.p(f412706c, 18, j1Var, value.f333496s);
        dVarC.p(f412706c, 19, j1Var, value.f333497t);
        dVarC.p(f412706c, 20, j1Var, value.f333498u);
        dVarC.p(f412706c, 21, j1Var, value.f333499v);
        dVarC.p(f412706c, 22, j1Var, value.f333500w);
        dVarC.p(f412706c, 23, f12, value.f333501x);
        dVarC.p(f412706c, 24, f12, value.f333502y);
        dVarC.p(f412706c, 25, f12, value.f333503z);
        dVarC.p(f412706c, 26, f12, value.f333468A);
        dVarC.p(f412706c, 27, f12, value.f333469B);
        dVarC.p(f412706c, 28, f12, value.f333470C);
        dVarC.p(f412706c, 29, j1Var, value.f333471D);
        dVarC.p(f412706c, 30, f12, value.f333472E);
        dVarC.p(f412706c, 31, j1Var, value.f333473F);
        dVarC.p(f412706c, 32, f12, value.f333474G);
        dVarC.p(f412706c, 33, f12, value.f333475H);
        dVarC.p(f412706c, 34, j1Var, value.f333476I);
        dVarC.p(f412706c, 35, StatsReport$RemoteOutboundRtpStats$$serializer.INSTANCE, value.f333477J);
        dVarC.d(f412706c);
    }
