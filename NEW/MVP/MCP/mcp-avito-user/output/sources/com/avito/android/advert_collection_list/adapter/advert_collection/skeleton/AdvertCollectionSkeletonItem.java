...
@K51.d
@P
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0081\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/advert_collection_list/adapter/advert_collection/skeleton/AdvertCollectionSkeletonItem;", "Lcom/avito/conveyor_item/ParcelableItem;", "_avito_advert-collection-list_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final /* data */ class AdvertCollectionSkeletonItem implements ParcelableItem {
    ...
    public final boolean equals(@l Object obj) {
        ...
        return (obj instanceof AdvertCollectionSkeletonItem) && L.f(this.f82073b, ((AdvertCollectionSkeletonItem) obj).f82073b);
    }
    ...
    public final int hashCode() {
        return this.f82073b.hashCode();
    }

    @k
    public final String toString() {
        return C22026a.c(new StringBuilder("AdvertCollectionSkeletonItem(stringId="), this.f82073b, ')');
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@k Parcel parcel, int i12) {
        parcel.writeString(this.f82073b);
    }
