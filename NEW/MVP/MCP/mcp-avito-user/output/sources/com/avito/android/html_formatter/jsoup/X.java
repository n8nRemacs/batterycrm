...
final class X extends kotlin.jvm.internal.N implements Y41.p<org.jsoup.nodes.k, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ int f164200l;
    ...
    public final G0 invoke(org.jsoup.nodes.k kVar, Integer num) {
        ...
        if (iIntValue == 0 && (kVar2 instanceof org.jsoup.nodes.n)) {
            ...
            nVar.R(nVar.M().substring(this.f164200l, nVar.M().length()));
        }
        return G0.f406611a;
    }
}
