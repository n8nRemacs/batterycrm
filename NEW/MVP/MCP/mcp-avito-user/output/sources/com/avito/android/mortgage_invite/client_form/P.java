...
final class P extends kotlin.jvm.internal.N implements Y41.p<ContactInfoFieldId, String, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.l<U10.a, G0> f205082l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public P(Y41.l<? super U10.a, G0> lVar) {
        super(2);
        this.f205082l = lVar;
    }
    ...
    public final G0 invoke(ContactInfoFieldId contactInfoFieldId, String str) {
        this.f205082l.invoke(new a.d(contactInfoFieldId, str));
        return G0.f406611a;
    }
}
