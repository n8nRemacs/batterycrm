...
public final class l extends N implements Y41.l<Drawable, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC40743a f179816l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(InterfaceC40743a interfaceC40743a) {
        super(1);
        this.f179816l = interfaceC40743a;
    }

    @Override // Y41.l
    public final G0 invoke(Drawable drawable) {
        this.f179816l.setState(State.f135882f);
        return G0.f406611a;
    }
}
