...
final class g extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ CompleteRegistrationFragment f93444l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(CompleteRegistrationFragment completeRegistrationFragment) {
        super(1);
        this.f93444l = completeRegistrationFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        InterfaceC40093a.e eVar = new InterfaceC40093a.e(str);
        CompleteRegistrationFragment.a aVar = CompleteRegistrationFragment.f93381E0;
        this.f93444l.s5(eVar);
        return G0.f406611a;
    }
}
