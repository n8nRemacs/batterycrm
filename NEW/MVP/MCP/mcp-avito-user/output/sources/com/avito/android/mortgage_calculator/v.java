...
final class v extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204850l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204850l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204850l.getViewModel().accept(b.d.C6100d.f204574b);
        return G0.f406611a;
    }
}
