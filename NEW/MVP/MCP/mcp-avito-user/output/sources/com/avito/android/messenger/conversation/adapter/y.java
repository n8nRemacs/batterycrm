...
final class y extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ T1.d f189312l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ z.a f189313m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public y(T1.d dVar, z.a aVar) {
        super(0);
        this.f189312l = dVar;
        this.f189313m = aVar;
    }
    ...
    public final G0 invoke() {
        MessageDeliveryStatus messageDeliveryStatus = this.f189312l.f189173h;
