...
final class a extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ AdvertDetailStatsMVIFragment f86051l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Action f86052m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(AdvertDetailStatsMVIFragment advertDetailStatsMVIFragment, Action action) {
        super(0);
        this.f86051l = advertDetailStatsMVIFragment;
        this.f86052m = action;
    }
    ...
    public final G0 invoke() {
        ...
        this.f86051l.D5().accept(new InterfaceC19855a.C1497a(this.f86052m.getDeepLink()));
        return G0.f406611a;
    }
}
