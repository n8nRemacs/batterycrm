...
final class l extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ ToastState f221261l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(ToastState toastState) {
        super(0);
        this.f221261l = toastState;
    }

    @Override // Y41.a
    public final G0 invoke() {
        ToastState toastState = this.f221261l;
        toastState.a().invoke(toastState.getF221229a());
        return G0.f406611a;
    }
}
