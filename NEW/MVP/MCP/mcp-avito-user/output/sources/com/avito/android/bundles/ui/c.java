...
final class c extends N implements l<DeepLink, G0> {
    ...
    public final /* synthetic */ VasBundlesFragment f108354l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(VasBundlesFragment vasBundlesFragment) {
        super(1);
        this.f108354l = vasBundlesFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f108354l.f108342t0;
        if (aVar == null) {
            aVar = null;
        }
