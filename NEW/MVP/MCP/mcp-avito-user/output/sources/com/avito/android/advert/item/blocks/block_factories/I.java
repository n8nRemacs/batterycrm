...
/* compiled from: AdvertDetailsBuzzoolaCreditBannerBlockFactory.kt */
...
public final class I implements com.avito.android.advert_core.blocks.a {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final com.avito.android.advert.item.blocks.items_factories.Z f73445a;

    @Inject
    public I(@Y61.k com.avito.android.advert.item.blocks.items_factories.Z z12) {
        this.f73445a = z12;
    }
    ...
    public final List<PersistableSpannedItem> a(@Y61.k a.b bVar) {
        return C42745f0.V(this.f73445a.a(bVar.f83013a.f82645b));
    }
