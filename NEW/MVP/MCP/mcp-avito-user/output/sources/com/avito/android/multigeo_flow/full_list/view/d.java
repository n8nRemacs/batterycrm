...
final class d extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ JobMultiGeoFullListFragment f206952l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ AddressItem f206953m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(JobMultiGeoFullListFragment jobMultiGeoFullListFragment, AddressItem addressItem) {
        super(0);
        this.f206952l = jobMultiGeoFullListFragment;
        this.f206953m = addressItem;
    }

    @Override // Y41.a
    public final G0 invoke() {
        JobMultiGeoFullListFragment.a aVar = JobMultiGeoFullListFragment.f206922x0;
        this.f206952l.r5().accept(new a.e(this.f206953m));
        return G0.f406611a;
    }
}
