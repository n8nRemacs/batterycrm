...
final class e extends N implements l<Integer, G0> {
    ...
    public final /* synthetic */ StickersBuyFragment f320658l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(StickersBuyFragment stickersBuyFragment) {
        super(1);
        this.f320658l = stickersBuyFragment;
    }
    ...
    public final G0 invoke(Integer num) {
        ...
        this.f320658l.u5().accept(new a.b(iIntValue));
        return G0.f406611a;
    }
}
