...
final class w extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ x f270857l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ AdvertXlItem f270858m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public w(x xVar, AdvertXlItem advertXlItem) {
        super(1);
        this.f270857l = xVar;
        this.f270858m = advertXlItem;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        this.f270857l.f270860c.get().Sa(this.f270858m.f268777c, deepLink, ContactSource.f89919d);
        return G0.f406611a;
    }
}
