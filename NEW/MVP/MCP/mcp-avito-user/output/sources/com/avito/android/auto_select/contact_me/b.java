...
final class b extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ AutoSelectContactMeBottomSheetFragment f95956l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(AutoSelectContactMeBottomSheetFragment autoSelectContactMeBottomSheetFragment) {
        super(1);
        this.f95956l = autoSelectContactMeBottomSheetFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        AutoSelectContactMeBottomSheetFragment.a aVar = AutoSelectContactMeBottomSheetFragment.f95928m0;
        this.f95956l.f5().accept(new InterfaceC40670a.c(deepLink));
        return G0.f406611a;
    }
}
