...
final class d extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ TarifikatorRegionFragment f135775l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(TarifikatorRegionFragment tarifikatorRegionFragment) {
        super(0);
        this.f135775l = tarifikatorRegionFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        TarifikatorRegionFragment.a aVar = TarifikatorRegionFragment.f135744D0;
        this.f135775l.r5().accept(InterfaceC17050a.d.f19134a);
        return G0.f406611a;
    }
}
