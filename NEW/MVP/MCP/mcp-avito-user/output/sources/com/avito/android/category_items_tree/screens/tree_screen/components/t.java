...
final class t extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f117074l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f117074l | 1);
        androidx.compose.runtime.B bE2 = a12.E(-1556651765);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            c.f117034a.getClass();
            com.akita.compose.theme.re23.c.a(false, c.f117036c, bE2, 48, 1);
        }
