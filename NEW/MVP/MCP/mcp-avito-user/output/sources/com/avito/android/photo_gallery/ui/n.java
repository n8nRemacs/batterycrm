...
final class n extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ com.avito.android.advert_details_items.photogallery.k f217729l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(com.avito.android.advert_details_items.photogallery.k kVar) {
        super(1);
        this.f217729l = kVar;
    }
    ...
    public final G0 invoke(DeepLink deepLink) {
        ...
        com.avito.android.advert_details_items.photogallery.k kVar = this.f217729l;
        if (kVar != null) {
            kVar.f85074b.D1(deepLink2);
        }
        return G0.f406611a;
    }
}
