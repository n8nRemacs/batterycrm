...
/* renamed from: com.avito.android.mortgage_calculator.f, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
final class C32709f extends kotlin.jvm.internal.N implements Y41.l<InterfaceC27333b, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ MortgageCalculatorView f204079l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C32709f(MortgageCalculatorView mortgageCalculatorView) {
        super(1);
        this.f204079l = mortgageCalculatorView;
    }

    @Override // Y41.l
    public final G0 invoke(InterfaceC27333b interfaceC27333b) {
        this.f204079l.getViewModel().accept(new b.u(interfaceC27333b));
        return G0.f406611a;
    }
}
