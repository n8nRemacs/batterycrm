...
/* compiled from: OnCallDeliveredByPushAction.kt */
@P
@s0
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\b\u0087\b\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0013\u0010\b\u001a\u00020\u0007*\u00020\u0006H\u0016¢\u0006\u0004\b\b\u0010\tJ\u0010\u0010\n\u001a\u00020\u0002HÆ\u0003¢\u0006\u0004\b\n\u0010\u000bJ\u001a\u0010\f\u001a\u00020\u00002\b\b\u0002\u0010\u0003\u001a\u00020\u0002HÆ\u0001¢\u0006\u0004\b\f\u0010\rJ\u0010\u0010\u000f\u001a\u00020\u000eHÖ\u0001¢\u0006\u0004\b\u000f\u0010\u0010J\u0010\u0010\u0012\u001a\u00020\u0011HÖ\u0001¢\u0006\u0004\b\u0012\u0010\u0013J\u001a\u0010\u0017\u001a\u00020\u00162\b\u0010\u0015\u001a\u0004\u0018\u00010\u0014HÖ\u0003¢\u0006\u0004\b\u0017\u0010\u0018R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0019\u001a\u0004\b\u001a\u0010\u000b¨\u0006\u001b"}, d2 = {"Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/incoming/init/OnCallDeliveredByPushAction;", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacAction;", "Lcom/avito/android/iac_dialer/impl_module/push_handler/IacVoipPush;", "push", "<init>", "(Lcom/avito/android/iac_dialer/impl_module/push_handler/IacVoipPush;)V", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;", "Lkotlin/G0;", "process", "(Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;)V", "component1", "()Lcom/avito/android/iac_dialer/impl_module/push_handler/IacVoipPush;", "copy", "(Lcom/avito/android/iac_dialer/impl_module/push_handler/IacVoipPush;)Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/incoming/init/OnCallDeliveredByPushAction;", "", "toString", "()Ljava/lang/String;", "", "hashCode", "()I", "", PluralsKeys.OTHER, "", "equals", "(Ljava/lang/Object;)Z", "Lcom/avito/android/iac_dialer/impl_module/push_handler/IacVoipPush;", "getPush", "_avito_iac-dialer_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes14.dex */
public final /* data */ class OnCallDeliveredByPushAction implements IacAction {
    public static final int $stable = 8;

    @k
    private final IacVoipPush push;

    public OnCallDeliveredByPushAction(@k IacVoipPush iacVoipPush) {
        this.push = iacVoipPush;
    }

    public static /* synthetic */ OnCallDeliveredByPushAction copy$default(OnCallDeliveredByPushAction onCallDeliveredByPushAction, IacVoipPush iacVoipPush, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            iacVoipPush = onCallDeliveredByPushAction.push;
        }
        return onCallDeliveredByPushAction.copy(iacVoipPush);
    }
    ...
    @k
    public final OnCallDeliveredByPushAction copy(@k IacVoipPush push) {
        return new OnCallDeliveredByPushAction(push);
    }
    ...
    public boolean equals(@l Object other) {
        ...
        return (other instanceof OnCallDeliveredByPushAction) && L.f(this.push, ((OnCallDeliveredByPushAction) other).push);
    }
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        ...
        if (i.a(iacActionProcessing.getState(), this.push.getCallId()) != null) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new p("This callId is already in handling. Skip push."));
            return;
        }
        IacActionOutput out = iacActionProcessing.getOut();
        IacState state = iacActionProcessing.getState();
        String callId = this.push.getCallId();
        CallInit.Telecom.Creating creating = CallInit.Telecom.Creating.INSTANCE;
        CallInit.IncomingPayload incomingPayload = new CallInit.IncomingPayload(this.push.getCallId(), this.push.getRawJson(), this.push.isVideo(), true);
        ...
        iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.Telecom.AddCall(this.push.getCallId(), IacCallDirection.INCOMING, this.push.isVideo(), this.push.getTags()));
    }

    @k
    public String toString() {
        return "OnCallDeliveredByPushAction(push=" + this.push + ')';
    }
}
