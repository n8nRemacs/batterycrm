...
final class w extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ N f206455l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public w(Y41.a<G0> aVar) {
        super(2);
        this.f206455l = (N) aVar;
    }
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && a13.c()) {
            ...
            com.akita.compose.component.navbar.t.b(null, com.akita.compose.theme.re23.b.n(a13).getF66453a(), 0, this.f206455l, null, a13, 0, 21);
        }
        return G0.f406611a;
    }
}
