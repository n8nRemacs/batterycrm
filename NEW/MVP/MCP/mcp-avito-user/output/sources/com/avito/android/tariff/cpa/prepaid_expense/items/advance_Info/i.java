...
@P
@s0
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u00012\u00020\u0002¨\u0006\u0003"}, d2 = {"Lcom/avito/android/tariff/cpa/prepaid_expense/items/advance_Info/i;", "Lcom/avito/konveyor/adapter/b;", "Lcom/avito/android/tariff/cpa/prepaid_expense/items/advance_Info/h;", "_avito_tariff_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class i extends com.avito.konveyor.adapter.b implements h {

    /* renamed from: b, reason: collision with root package name */
    @k
    public final Input f295026b;

    /* renamed from: c, reason: collision with root package name */
    @k
    public final TextView f295027c;
    ...
    public static final class b implements Runnable {
        ...
        public final void run() {
            Object systemService = i.this.f295026b.getContext().getSystemService("input_method");
    ...
    public i(@k View view) {
        ...
        this.f295026b = input;
        this.f295027c = (TextView) view.findViewById(R.id.tv_error);
        input.setOnLongClickListener(null);
    }

    @Override // com.avito.android.tariff.cpa.prepaid_expense.items.advance_Info.h
    public final void Hd(@k String str) {
        this.f295026b.setHint(str);
    }

    @Override // com.avito.android.tariff.cpa.prepaid_expense.items.advance_Info.h
    public final void K(@k l<? super String, G0> lVar) {
        Input input = this.f295026b;
        input.b(new a(input, lVar));
    }

    @Override // com.avito.android.tariff.cpa.prepaid_expense.items.advance_Info.h
    public final void h9(boolean z12) {
        TextView textView = this.f295027c;
        if (z12) {
    ...
    public final void k6(@k String str) {
        this.f295027c.setText(str);
    }

    @Override // com.avito.android.tariff.cpa.prepaid_expense.items.advance_Info.h
    public final void x6(@k String str) {
        Input.t(this.f295026b, str, false, 6);
    }
    ...
    public static final class c implements View.OnAttachStateChangeListener {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final /* synthetic */ View f295032b;

        /* renamed from: c, reason: collision with root package name */
        public final /* synthetic */ b f295033c;
        ...
        public final void onViewDetachedFromWindow(@k View view) {
            this.f295032b.removeOnAttachStateChangeListener(this);
            view.removeCallbacks(this.f295033c);
        }
    ...
    public static final class a implements TextWatcher {
        ...
        /* renamed from: b, reason: collision with root package name */
        @k
        public String f295028b;

        /* renamed from: c, reason: collision with root package name */
        public final /* synthetic */ Input f295029c;

        /* renamed from: d, reason: collision with root package name */
        public final /* synthetic */ l f295030d;

        public a(Input input, l lVar) {
            this.f295029c = input;
            this.f295030d = lVar;
            this.f295028b = input.getDeformattedText();
        }

        @Override // android.text.TextWatcher
        public final void afterTextChanged(@Y61.l Editable editable) {
            String deformattedText = this.f295029c.getDeformattedText();
            if (L.f(deformattedText, this.f295028b)) {
                return;
            }
            this.f295030d.invoke(deformattedText);
            this.f295028b = deformattedText;
        }
