...
/* renamed from: com.avito.android.messenger.channels.mvi.data.u, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
final class C31712u<T, R> implements l41.o {
    @Override // l41.o
    public final Object apply(Object obj) {
        ...
        B0 b0D02 = io.reactivex.rxjava3.core.z.m(arrayList3, C.f187173b).D(oVar).d0(new D());
        if (arrayList.size() <= 500) {
            throw null;
        }
        ...
        if (!it4.hasNext()) {
            return io.reactivex.rxjava3.core.z.j(b0D0, b0D02, io.reactivex.rxjava3.core.z.m(arrayList4, A.f187171b).D(oVar).d0(B.f187172b), new I(null, list));
        }
        throw null;
    }
}
