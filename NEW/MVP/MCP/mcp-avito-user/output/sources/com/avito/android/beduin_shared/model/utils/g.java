...
final class g extends N implements Y41.l<BeduinModel, Boolean> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ N f105333l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public g(Y41.l<? super BeduinModel, G0> lVar) {
        super(1);
        this.f105333l = (N) lVar;
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [Y41.l, kotlin.jvm.internal.N] */
    @Override // Y41.l
    public final Boolean invoke(BeduinModel beduinModel) {
        this.f105333l.invoke(beduinModel);
