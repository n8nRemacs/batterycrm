...
final class j extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ l f309430l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ c f309431m;
    ...
    public final G0 invoke(Integer num) {
        ...
        MyAdvertDetailsActivity myAdvertDetailsActivity = this.f309430l.f309434b;
        if (myAdvertDetailsActivity != null) {
            ...
            interfaceC35426j0.x0(this.f309431m, iIntValue);
        }
        return G0.f406611a;
    }
}
