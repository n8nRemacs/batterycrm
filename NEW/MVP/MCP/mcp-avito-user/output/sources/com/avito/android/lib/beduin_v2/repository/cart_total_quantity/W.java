...
final class W extends kotlin.jvm.internal.N implements Y41.l<C31169l, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.l<C25569a, G0> f176494l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public W(Y41.l<? super C25569a, G0> lVar) {
        super(1);
        this.f176494l = lVar;
    }
    ...
    public final G0 invoke(C31169l c31169l) {
        Integer num = c31169l.f176504a;
        this.f176494l.invoke(num != null ? new C25569a(num.intValue()) : null);
        return G0.f406611a;
    }
}
