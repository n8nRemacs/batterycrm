...
/* compiled from: TariffLfPublicationCountOneTimeEventProducer.kt */
@P
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0000\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0007¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"Lcom/avito/android/tariff_lf_publication/count/mvi/i;", "Lcom/avito/android/arch/mvi/t;", "Lcom/avito/android/tariff_lf_publication/count/mvi/entity/TariffLfPublicationCountInternalAction;", "LMD0/b;", "<init>", "()V", "_avito_tariff-lf-publication_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class i implements t<TariffLfPublicationCountInternalAction, MD0.b> {
    @Inject
    public i() {
    }

    @Override // com.avito.android.arch.mvi.t
    public final MD0.b b(TariffLfPublicationCountInternalAction tariffLfPublicationCountInternalAction) {
        MD0.b cVar;
        ...
        if (tariffLfPublicationCountInternalAction2 instanceof TariffLfPublicationCountInternalAction.HandleDeeplink) {
            ...
            cVar = new b.C0664b(handleDeeplink.f300829b, handleDeeplink.f300830c);
            ...
            cVar = new b.d(((TariffLfPublicationCountInternalAction.ShowSimpleDeeplinkLoading) tariffLfPublicationCountInternalAction2).f300835b);
        } else {
            ...
            cVar = new b.c(onScreenError.f300832c, com.avito.android.printable_text.b.f(z.l(onScreenError.f300831b)));
        }
        return cVar;
    }
}
