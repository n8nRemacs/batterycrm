...
final class k extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Action f268681l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ g f268682m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(Action action, g gVar) {
        super(0);
        this.f268681l = action;
        this.f268682m = gVar;
    }

    @Override // Y41.a
    public final G0 invoke() {
        DeepLink deepLink = ((Action.Predefined) this.f268681l).f268644g;
        if (deepLink != null) {
            b.a.a(this.f268682m.f268675d, deepLink, null, null, 6);
        }
        return G0.f406611a;
    }
}
