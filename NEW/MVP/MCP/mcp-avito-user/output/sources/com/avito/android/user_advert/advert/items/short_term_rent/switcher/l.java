...
final class l extends N implements Y41.l<Boolean, G0> {
    ...
    public final /* synthetic */ p f310268l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ OH0.e f310269m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(p pVar, OH0.e eVar) {
        super(1);
        this.f310268l = pVar;
        this.f310269m = eVar;
    }
    ...
    public final G0 invoke(Boolean bool) {
        ...
        MyAdvertDetailsActivity myAdvertDetailsActivity = this.f310268l.f310274b;
        if (myAdvertDetailsActivity != null) {
            myAdvertDetailsActivity.n2(this.f310269m, zBooleanValue);
        }
        return G0.f406611a;
    }
}
