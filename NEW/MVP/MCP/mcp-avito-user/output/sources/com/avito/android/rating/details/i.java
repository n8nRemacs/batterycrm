...
final class i extends N implements Y41.p<a.b, DialogInterface, G0> {
    ...
    public final /* synthetic */ BaseRatingReviewItem.ReviewAction.ConfirmDialog f247018l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ RatingDetailsFragment f247019m;

    /* renamed from: n, reason: collision with root package name */
    public final /* synthetic */ long f247020n;
    ...
    public i(BaseRatingReviewItem.ReviewAction.ConfirmDialog confirmDialog, RatingDetailsFragment ratingDetailsFragment, long j12) {
        super(2);
        this.f247018l = confirmDialog;
        this.f247019m = ratingDetailsFragment;
        this.f247020n = j12;
    }
    ...
    public final G0 invoke(a.b bVar, DialogInterface dialogInterface) {
        ...
        BaseRatingReviewItem.ReviewAction.ConfirmDialog confirmDialog = this.f247018l;
        ...
        for (BaseRatingReviewItem.ReviewAction.Button button : confirmDialog.f250257d) {
            ...
            if (iOrdinal == 0) {
                bVar2.L3(str, new g(this.f247019m, this.f247020n, dialogInterface2));
            } else if (iOrdinal == 1 || iOrdinal == 2) {
                bVar2.M3(str, new h(dialogInterface2));
            }
        }
        return G0.f406611a;
    }
