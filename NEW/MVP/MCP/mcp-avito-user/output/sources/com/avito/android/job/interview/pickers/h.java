...
final class h extends N implements Y41.a<List<? extends com.avito.android.lib.design.picker.k<Integer>>> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ TimePickerDialog f174672l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(TimePickerDialog timePickerDialog) {
        super(0);
        this.f174672l = timePickerDialog;
    }

    @Override // Y41.a
    public final List<? extends com.avito.android.lib.design.picker.k<Integer>> invoke() {
        return TimePickerDialog.V(this.f174672l, 24);
    }
}
