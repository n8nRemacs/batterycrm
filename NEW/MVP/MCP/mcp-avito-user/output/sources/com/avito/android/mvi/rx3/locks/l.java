...
final class l extends N implements Y41.a<hu.akarnokd.rxjava3.schedulers.c> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.a<H> f207081l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public l(Y41.a<? extends H> aVar) {
        super(0);
        this.f207081l = aVar;
    }
    ...
    public final hu.akarnokd.rxjava3.schedulers.c invoke() {
        return new hu.akarnokd.rxjava3.schedulers.c(this.f207081l.invoke());
    }
}
