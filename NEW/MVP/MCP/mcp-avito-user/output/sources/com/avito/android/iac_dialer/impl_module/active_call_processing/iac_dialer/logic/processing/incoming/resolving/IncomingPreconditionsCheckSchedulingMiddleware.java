...
public final /* data */ class IncomingPreconditionsCheckSchedulingMiddleware implements BasePreconditionsCheckSchedulingMiddleware {
    ...
    public IacAction createCheckPreconditionAction() {
        return IncomingPreconditionsCheckAction.INSTANCE;
    }

    public boolean equals(@l Object other) {
        return this == other || (other instanceof IncomingPreconditionsCheckSchedulingMiddleware);
    }
    ...
    public boolean isResolvingState(@k IacState state) {
        return state instanceof IacState.InUse.Alive.Incoming.Resolving;
    }

    @Override // com.avito.android.iac_dialer.impl_module.active_call_processing.iac_dialer.logic.processing.common.resolving.BasePreconditionsCheckSchedulingMiddleware
    public boolean isStepNotChecked(@k IacState state) {
        return (state instanceof IacState.InUse.Alive.Incoming.Resolving) && L.f(((IacState.InUse.Alive.Incoming.Resolving) state).getPreconditions().getStep(), IncomingPreconditions.Step.NotChecked.INSTANCE);
    }

    @Override // com.avito.android.iac_dialer.impl_module.active_call_processing.iac_dialer.logic.processing.common.resolving.BasePreconditionsCheckSchedulingMiddleware
    public boolean isStepRoutedToSystemSettingsForPermissions(@k IacState state) {
        return (state instanceof IacState.InUse.Alive.Incoming.Resolving) && L.f(((IacState.InUse.Alive.Incoming.Resolving) state).getPreconditions().getStep(), IncomingPreconditions.Step.RoutedToSystemSettingsForPermissions.INSTANCE);
    }

    @Override // com.avito.android.iac_dialer.impl_module.active_call_processing.iac_dialer.logic.processing.common.resolving.BasePreconditionsCheckSchedulingMiddleware
    public int preconditionScreenId(@k IacState state) {
        IncomingPreconditions preconditions;
        if (!(state instanceof IacState.InUse.Alive.Incoming.Resolving)) {
            state = null;
        }
        IacState.InUse.Alive.Incoming.Resolving resolving = (IacState.InUse.Alive.Incoming.Resolving) state;
