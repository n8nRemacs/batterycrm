...
final class j extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ Y41.l<Integer, G0> f251622l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ k f251623m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public j(Y41.l<? super Integer, G0> lVar, k kVar) {
        super(1);
        this.f251622l = lVar;
        this.f251623m = kVar;
    }
    ...
    public final G0 invoke(Integer num) {
        this.f251622l.invoke(null);
        this.f251623m.f251628f = null;
        return G0.f406611a;
    }
}
