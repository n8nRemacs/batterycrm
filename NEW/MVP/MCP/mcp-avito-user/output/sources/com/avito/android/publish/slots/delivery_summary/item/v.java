...
final class v extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ com.avito.android.publish.slots.delivery_summary_edit.item.o f243605l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v(com.avito.android.publish.slots.delivery_summary_edit.item.o oVar) {
        super(0);
        this.f243605l = oVar;
    }
