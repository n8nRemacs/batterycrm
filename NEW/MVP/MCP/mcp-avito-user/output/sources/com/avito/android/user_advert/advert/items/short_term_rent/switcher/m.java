...
final class m extends N implements Y41.l<Boolean, G0> {
    ...
    public final /* synthetic */ p f310270l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ OH0.e f310271m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(p pVar, OH0.e eVar) {
        super(1);
        this.f310270l = pVar;
        this.f310271m = eVar;
    }
    ...
    public final G0 invoke(Boolean bool) {
        ...
        MyAdvertDetailsActivity myAdvertDetailsActivity = this.f310270l.f310274b;
        if (myAdvertDetailsActivity != null) {
            myAdvertDetailsActivity.n2(this.f310271m, zBooleanValue);
        }
        return G0.f406611a;
    }
}
