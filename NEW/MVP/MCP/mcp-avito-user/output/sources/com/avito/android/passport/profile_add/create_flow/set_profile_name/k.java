...
final class k extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ SetProfileNameFragment f212118l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(SetProfileNameFragment setProfileNameFragment) {
        super(0);
        this.f212118l = setProfileNameFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        SetProfileNameFragment.a aVar = SetProfileNameFragment.f212039E0;
        this.f212118l.v5().accept(a.C1163a.f16910a);
        return G0.f406611a;
    }
}
