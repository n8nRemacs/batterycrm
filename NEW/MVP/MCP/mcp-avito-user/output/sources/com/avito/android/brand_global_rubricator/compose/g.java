...
public final class g extends N implements r<InterfaceC20793y, Integer, A, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ArrayList f107442l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ l f107443m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(l lVar, ArrayList arrayList) {
        super(4);
        this.f107442l = arrayList;
        this.f107443m = lVar;
    }
    ...
    public final G0 invoke(InterfaceC20793y interfaceC20793y, Integer num, A a12, Integer num2) {
        ...
        if (a13.p(i12 & 1, (i12 & 147) != 146)) {
            com.avito.android.brand_global_rubricator.h hVar = (com.avito.android.brand_global_rubricator.h) this.f107442l.get(iIntValue);
            a13.C(-1990032505);
            h.c(hVar, this.f107443m, a13, 8);
            a13.h();
        } else {
            a13.f();
        }
