...
public final class PaddingInfo extends SuggestItem {
    ...
    public static final class Creator implements Parcelable.Creator<PaddingInfo> {
        ...
        @k
        public final PaddingInfo createFromParcel(@k Parcel parcel) {
            return new PaddingInfo(parcel.readInt() == 0 ? null : Integer.valueOf(parcel.readInt()), parcel.readInt() != 0 ? Integer.valueOf(parcel.readInt()) : null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        @k
        public final PaddingInfo[] newArray(int i12) {
            return new PaddingInfo[i12];
        }
    }

    public PaddingInfo(@l Integer num, @l Integer num2) {
        super(null);
        this.top = num;
        this.bottom = num2;
    }
