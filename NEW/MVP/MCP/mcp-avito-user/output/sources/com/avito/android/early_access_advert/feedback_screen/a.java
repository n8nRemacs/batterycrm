...
final class a extends N implements l<String, G0> {
    ...
    public final /* synthetic */ EarlyAccessAdvertFeedbackFragment f145643l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(EarlyAccessAdvertFeedbackFragment earlyAccessAdvertFeedbackFragment) {
        super(1);
        this.f145643l = earlyAccessAdvertFeedbackFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        EarlyAccessAdvertFeedbackFragment.a aVar = EarlyAccessAdvertFeedbackFragment.f145620s0;
        ((d) this.f145643l.f145623o0.getValue()).accept(new InterfaceC15579a.b(str));
        return G0.f406611a;
    }
}
