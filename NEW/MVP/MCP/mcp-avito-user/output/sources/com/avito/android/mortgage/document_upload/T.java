...
public final class T implements InterfaceC22118l0 {
    ...
    public final /* synthetic */ com.avito.android.lib.design.progress_bar.e f199097a;

    public T(com.avito.android.lib.design.progress_bar.e eVar) {
        this.f199097a = eVar;
    }

    @Override // androidx.compose.runtime.InterfaceC22118l0
    public final void dispose() {
        com.avito.android.lib.design.progress_bar.e eVar = this.f199097a;
        eVar.f180106f.end();
        eVar.f180102b = null;
    }
}
