...
final class f extends N implements q<F, A, Integer, G0> {
    ...
    public final /* synthetic */ MiuiBottomsheetRemoteImageLanguage f168824l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(MiuiBottomsheetRemoteImageLanguage miuiBottomsheetRemoteImageLanguage) {
        super(3);
        this.f168824l = miuiBottomsheetRemoteImageLanguage;
    }
    ...
    public final G0 invoke(F f12, A a12, Integer num) {
        ...
        if ((iIntValue & 91) == 18 && a13.c()) {
            ...
            int iOrdinal = this.f168824l.ordinal();
            if (iOrdinal == 0) {
                universalImage = (UniversalImage) k.f168837a.getValue();
            } else {
                if (iOrdinal != 1) {
                    throw new NoWhenBranchMatchedException();
                }
                universalImage = (UniversalImage) k.f168839c.getValue();
            }
