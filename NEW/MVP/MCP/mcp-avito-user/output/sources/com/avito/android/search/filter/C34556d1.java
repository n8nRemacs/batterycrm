...
/* compiled from: FiltersToastRenderer.kt */
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/search/filter/d1;", "Lcom/avito/android/deeplink_handler/view/a$i;", "_avito_search_filter_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* renamed from: com.avito.android.search.filter.d1, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C34556d1 implements a.i {

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public final ActivityC22955m f263001b;

    /* renamed from: c, reason: collision with root package name */
    @Y61.k
    public final View f263002c;

    public C34556d1(@Y61.k View view, @Y61.k ActivityC22955m activityC22955m) {
        this.f263001b = activityC22955m;
        this.f263002c = view;
    }
    ...
    public final void V0(@Y61.k PrintableText printableText, @Y61.l List<? extends c.a> list, @Y61.l List<? extends c.a> list2, @Y61.l FrameLayout frameLayout, @Y61.k com.avito.android.component.toast.f fVar, int i12, @Y61.k ToastBarPosition toastBarPosition, boolean z12, boolean z13, @Y61.l i.b bVar, @Y61.l String str) {
        ...
        if (fVar.equals(f.a.f125253a) ? true : fVar.equals(f.b.f125254a)) {
            ...
            toastBarPosition2 = ToastBarPosition.f181046d;
        }
        com.avito.android.component.toast.c.b(com.avito.android.component.toast.c.f125244a, this.f263002c, printableText, list, list2, frameLayout, fVar, i12, toastBarPosition2, null, z12, z13, bVar, null, 2176);
    }

    @Override // com.avito.android.deeplink_handler.view.a.i
    public final void Y1(int i12) {
        L5.a(this.f263001b, i12, 1);
    }
