...
public final class c implements InterfaceC28898u {
    ...
    public final Class<?> a() {
        return ServiceOrdersTabFragmentData.class;
    }

    @Override // com.avito.android.bottom_navigation.InterfaceC28898u
    @Y61.k
    public final TabBaseFragment b(@Y61.k TabFragmentFactory.Data data) {
        ServiceOrdersListFragment.a aVar = ServiceOrdersListFragment.f279189B0;
        ServiceOrdersArguments serviceOrdersArguments = ((ServiceOrdersTabFragmentData) data).f279058c;
        aVar.getClass();
        ServiceOrdersListFragment serviceOrdersListFragment = new ServiceOrdersListFragment();
        Bundle bundle = new Bundle(2);
        bundle.putParcelable("arg.orders_arguments", serviceOrdersArguments);
