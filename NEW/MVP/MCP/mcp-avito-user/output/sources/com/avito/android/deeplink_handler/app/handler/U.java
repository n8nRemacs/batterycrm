...
final class U extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ ToastMessageLink f134405l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ S f134406m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public U(ToastMessageLink toastMessageLink, S s5) {
        super(0);
        this.f134405l = toastMessageLink;
        this.f134406m = s5;
    }

    @Override // Y41.a
    public final G0 invoke() {
        DeepLink deepLink = this.f134405l.f133722f;
        if (deepLink != null) {
