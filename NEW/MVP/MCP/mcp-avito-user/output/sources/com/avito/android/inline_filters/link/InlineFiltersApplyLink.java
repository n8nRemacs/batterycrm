...
/* compiled from: InlineFiltersApplyLink.kt */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0087\b\u0018\u00002\u00020\u0001:\u0001\u0002¨\u0006\u0003"}, d2 = {"Lcom/avito/android/inline_filters/link/InlineFiltersApplyLink;", "Lcom/avito/android/deep_linking/links/DeepLink;", "FilterValue", "_avito_inline-filters_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
@K51.d
@InterfaceC29686l
@InterfaceC47204b
...
public final /* data */ class InlineFiltersApplyLink extends DeepLink {
    ...
    @k
    public final List<FilterValue> f172309b;

    /* renamed from: c, reason: collision with root package name */
    @l
    public final DeepLink f172310c;

    /* compiled from: InlineFiltersApplyLink.kt */
    @K51.d
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\t\b\u0087\b\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0002¢\u0006\u0004\b\u0005\u0010\u0006R\u001a\u0010\u0003\u001a\u00020\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b\u0003\u0010\u0007\u001a\u0004\b\b\u0010\tR\u001c\u0010\u0004\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b\u0004\u0010\u0007\u001a\u0004\b\n\u0010\t¨\u0006\u000b"}, d2 = {"Lcom/avito/android/inline_filters/link/InlineFiltersApplyLink$FilterValue;", "Landroid/os/Parcelable;", "", "id", "value", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", "Ljava/lang/String;", "getId", "()Ljava/lang/String;", "getValue", "_avito_inline-filters_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    public static final class a implements Parcelable.Creator<InlineFiltersApplyLink> {
        ...
        @Override // android.os.Parcelable.Creator
        public final InlineFiltersApplyLink[] newArray(int i12) {
            return new InlineFiltersApplyLink[i12];
        }
    }

    public InlineFiltersApplyLink(@k List<FilterValue> list, @l DeepLink deepLink) {
        this.f172309b = list;
        this.f172310c = deepLink;
    }
    ...
    public final boolean equals(@l Object obj) {
        ...
        return L.f(this.f172309b, inlineFiltersApplyLink.f172309b) && L.f(this.f172310c, inlineFiltersApplyLink.f172310c);
    }

    public final int hashCode() {
        int iHashCode = this.f172309b.hashCode() * 31;
        DeepLink deepLink = this.f172310c;
        return iHashCode + (deepLink == null ? 0 : deepLink.hashCode());
    }

    @k
    public final String toString() {
        StringBuilder sb2 = new StringBuilder("InlineFiltersApplyLink(values=");
        sb2.append(this.f172309b);
        sb2.append(", afterFiltersLoadedAction=");
        return com.avito.android.actions_sheet.a.v(sb2, this.f172310c, ')');
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@k Parcel parcel, int i12) {
        Iterator itJ = C0.j(this.f172309b, parcel);
        while (itJ.hasNext()) {
            ((FilterValue) itJ.next()).writeToParcel(parcel, i12);
        }
        parcel.writeParcelable(this.f172310c, i12);
    }
}
