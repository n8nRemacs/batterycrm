...
public final class M implements com.avito.android.analytics.provider.clickstream.a {
    ...
    public final /* synthetic */ ParametrizedClickStreamEvent f199517b;

    public M(@Y61.k String str) {
        this.f199517b = new ParametrizedClickStreamEvent(10339, 1, "Mortgage / Ипотечный лендинг / Клик на Рассчитать ипотеку", Collections.singletonMap("from_page", str));
    }

    @Override // com.avito.android.analytics.provider.clickstream.a
    /* renamed from: getEventId */
    public final int getF19127b() {
        return this.f199517b.f90247b;
    }

    @Override // com.avito.android.analytics.provider.clickstream.a
    @Y61.k
    public final Map<String, Object> getParams() {
        return this.f199517b.f90249d;
    }

    @Override // com.avito.android.analytics.provider.clickstream.a
    /* renamed from: getVersion */
    public final int getF11770c() {
        return this.f199517b.f90248c;
    }
}
