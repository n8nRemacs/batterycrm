...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001a\u0010\u0007\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005HÖ\u0001¢\u0006\u0004\b\u0007\u0010\bJ\u0018\u0010\u000b\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\tHÖ\u0001¢\u0006\u0004\b\u000b\u0010\fJ \u0010\u0011\u001a\u00020\u00102\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000f\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u0011\u0010\u0012R\u0014\u0010\u0016\u001a\u00020\u00138VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0017"}, d2 = {"com/avito/avcalls/android/config/Config.$serializer", "Lkotlinx/serialization/internal/N;", "Lcom/avito/avcalls/android/config/Config;", "<init>", "()V", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "(Lkotlinx/serialization/encoding/Decoder;)Lcom/avito/avcalls/android/config/Config;", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "Lkotlin/G0;", "serialize", "(Lkotlinx/serialization/encoding/Encoder;Lcom/avito/avcalls/android/config/Config;)V", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "sdk_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
@InterfaceC42830m
...
public final class Config$$serializer implements N<Config> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.avito.avcalls.android.config.Config", config$$serializer, 14);
        ...
        pluginGeneratedSerialDescriptor.j("call.enable_manual_audio_device_managing", true);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{c43412k0, Y.f412835a, c43412k0, c43412k0, c43412k0, c43412k0, c43412k0, c43412k0, c43407i, c43407i, c43412k0, c43412k0, c43412k0, F.f412769a};
    }
    ...
    public Config deserialize(@Y61.k Decoder decoder) {
        ...
        while (z12) {
            ...
            switch (iJ2) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    zD3 = cVarC.D(f412706c, 9);
                    i12 |= 512;
                    break;
                case 10:
                    jP9 = cVarC.p(f412706c, 10);
                    i12 |= 1024;
                    break;
                case 11:
                    jP10 = cVarC.p(f412706c, 11);
                    i12 |= 2048;
                    break;
                case 12:
                    jP11 = cVarC.p(f412706c, 12);
                    i12 |= 4096;
                    break;
                case 13:
                    dL2 = cVarC.l(f412706c, 13);
                    i12 |= 8192;
                    break;
                default:
        ...
        cVarC.d(f412706c);
        return new Config(i12, jP2, iQ2, jP3, jP4, jP5, jP6, jP7, jP8, zD2, zD3, jP9, jP10, jP11, dL2, (P0) null);
    }
    ...
    public void serialize(@Y61.k Encoder encoder, @Y61.k Config value) {
        ...
        boolean zU2 = dVarC.u();
        long j12 = value.f331653a;
        if (zU2 || j12 != 15000) {
            dVarC.o(f412706c, 0, j12);
        }
        boolean zU3 = dVarC.u();
        int i12 = value.f331654b;
        if (zU3 || i12 != 30) {
            dVarC.D(1, i12, f412706c);
        }
        boolean zU4 = dVarC.u();
        long j13 = value.f331655c;
        if (zU4 || j13 != 1000) {
            dVarC.o(f412706c, 2, j13);
        }
        boolean zU5 = dVarC.u();
        long j14 = value.f331656d;
        if (zU5 || j14 != 60000) {
            dVarC.o(f412706c, 3, j14);
        }
        boolean zU6 = dVarC.u();
        long j15 = value.f331657e;
        if (zU6 || j15 != 40000) {
            dVarC.o(f412706c, 4, j15);
        }
        boolean zU7 = dVarC.u();
        long j16 = value.f331658f;
        if (zU7 || j16 != 60000) {
            dVarC.o(f412706c, 5, j16);
        }
        boolean zU8 = dVarC.u();
        long j17 = value.f331659g;
        if (zU8 || j17 != 59000) {
            dVarC.o(f412706c, 6, j17);
        }
        boolean zU9 = dVarC.u();
        long j18 = value.f331660h;
        if (zU9 || j18 != 30000) {
            dVarC.o(f412706c, 7, j18);
        }
        boolean zU10 = dVarC.u();
        boolean z12 = value.f331661i;
        if (zU10 || !z12) {
            dVarC.k(f412706c, 8, z12);
        }
        boolean zU11 = dVarC.u();
        boolean z13 = value.f331662j;
        if (zU11 || z13) {
            dVarC.k(f412706c, 9, z13);
        }
        boolean zU12 = dVarC.u();
        long j19 = value.f331663k;
        if (zU12 || j19 != 500) {
            dVarC.o(f412706c, 10, j19);
        }
        boolean zU13 = dVarC.u();
        long j22 = value.f331664l;
        if (zU13 || j22 != 250) {
            dVarC.o(f412706c, 11, j22);
        }
        boolean zU14 = dVarC.u();
        long j23 = value.f331665m;
        if (zU14 || j23 != 100) {
            dVarC.o(f412706c, 12, j23);
        }
        boolean zU15 = dVarC.u();
        double d12 = value.f331666n;
        if (zU15 || Double.compare(d12, 30.0d) != 0) {
            dVarC.G(f412706c, 13, d12);
        }
        dVarC.d(f412706c);
    }
