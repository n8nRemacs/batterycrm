...
final class p extends N implements Y41.l<com.avito.conveyor_item.a, Boolean> {
    ...
    public final /* synthetic */ SelectParameter f287462l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p(SelectParameter selectParameter) {
        super(1);
        this.f287462l = selectParameter;
    }

    @Override // Y41.l
    public final Boolean invoke(com.avito.conveyor_item.a aVar) {
        return Boolean.valueOf(L.f(aVar.getF212582h(), this.f287462l.getId()));
    }
}
