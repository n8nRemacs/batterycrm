...
final class e extends N implements l<Map.Entry<? extends String, ? extends Boolean>, CharSequence> {

    /* renamed from: l, reason: collision with root package name */
    public static final e f254434l = new e();
    ...
    public final CharSequence invoke(Map.Entry<? extends String, ? extends Boolean> entry) {
        ...
        return "\"" + entry2.getKey() + "\":\"" + entry2.getValue().booleanValue() + '\"';
    }
}
