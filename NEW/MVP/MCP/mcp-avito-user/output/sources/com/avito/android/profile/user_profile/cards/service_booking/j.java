...
final class j extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ o f225479l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ k f225480m;
    ...
    public final G0 invoke() {
        DeepLink deepLink;
        ServiceBookingItem.Action action = this.f225479l.f225490e.f318650b;
        if (action != null && (deepLink = action.getDeepLink()) != null) {
            this.f225480m.f225481b.invoke(new InterfaceC15503a.j(deepLink));
        }
        return G0.f406611a;
    }
}
