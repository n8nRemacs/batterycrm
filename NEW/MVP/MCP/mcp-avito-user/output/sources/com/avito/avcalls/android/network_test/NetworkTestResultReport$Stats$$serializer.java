...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001a\u0010\u0007\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005HÖ\u0001¢\u0006\u0004\b\u0007\u0010\bJ\u0018\u0010\u000b\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\tHÖ\u0001¢\u0006\u0004\b\u000b\u0010\fJ \u0010\u0011\u001a\u00020\u00102\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000f\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u0011\u0010\u0012R\u0014\u0010\u0016\u001a\u00020\u00138VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0017"}, d2 = {"com/avito/avcalls/android/network_test/NetworkTestResultReport.Stats.$serializer", "Lkotlinx/serialization/internal/N;", "Lcom/avito/avcalls/android/network_test/NetworkTestResultReport$Stats;", "<init>", "()V", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "(Lkotlinx/serialization/encoding/Decoder;)Lcom/avito/avcalls/android/network_test/NetworkTestResultReport$Stats;", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "Lkotlin/G0;", "serialize", "(Lkotlinx/serialization/encoding/Encoder;Lcom/avito/avcalls/android/network_test/NetworkTestResultReport$Stats;)V", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "sdk_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
@InterfaceC42830m
...
public final class NetworkTestResultReport$Stats$$serializer implements N<NetworkTestResultReport.Stats> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.avito.avcalls.android.network_test.NetworkTestResultReport.Stats", networkTestResultReport$Stats$$serializer, 7);
    ...
    public void serialize(@Y61.k Encoder encoder, @Y61.k NetworkTestResultReport.Stats value) {
        ...
        dVarC.D(0, value.f331776a, f412706c);
        boolean zU2 = dVarC.u();
        Double d12 = value.f331777b;
        if (zU2 || d12 != null) {
            dVarC.p(f412706c, 1, F.f412769a, d12);
        }
        boolean zU3 = dVarC.u();
        Double d13 = value.f331778c;
        if (zU3 || d13 != null) {
            dVarC.p(f412706c, 2, F.f412769a, d13);
        }
        boolean zU4 = dVarC.u();
        Double d14 = value.f331779d;
        if (zU4 || d14 != null) {
            dVarC.p(f412706c, 3, F.f412769a, d14);
        }
        boolean zU5 = dVarC.u();
        Double d15 = value.f331780e;
        if (zU5 || d15 != null) {
            dVarC.p(f412706c, 4, F.f412769a, d15);
        }
        boolean zU6 = dVarC.u();
        Double d16 = value.f331781f;
        if (zU6 || d16 != null) {
            dVarC.p(f412706c, 5, F.f412769a, d16);
        }
        boolean zU7 = dVarC.u();
        Double d17 = value.f331782g;
        if (zU7 || d17 != null) {
