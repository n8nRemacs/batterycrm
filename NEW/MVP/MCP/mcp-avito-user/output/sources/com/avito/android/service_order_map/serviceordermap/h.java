...
final class h extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ k f278681l;
    ...
    public final G0 invoke() {
        Y41.l<? super com.avito.android.service_order_map.serviceordermap.mvi.entity.a, G0> lVar = this.f278681l.f278699p;
        if (lVar != null) {
            ((a) lVar).invoke(new a.b(ServiceOrderMapState.MapMode.f278784c));
        }
        return G0.f406611a;
    }
}
