...
final class c extends N implements l<DeepLink, G0> {
    ...
    public final /* synthetic */ AutoprolongFragment f319473l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(AutoprolongFragment autoprolongFragment) {
        super(1);
        this.f319473l = autoprolongFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f319473l.f319459p0;
        if (aVar == null) {
            aVar = null;
        }
