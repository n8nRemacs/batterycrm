...
public final class x implements TextWatcher {
    ...
    public final /* synthetic */ Input f102353c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ s f102354d;

    public x(Input input, s sVar) {
        this.f102353c = input;
        this.f102354d = sVar;
        this.f102352b = input.getDeformattedText();
    }

    @Override // android.text.TextWatcher
    public final void afterTextChanged(@Y61.l Editable editable) {
        String deformattedText = this.f102353c.getDeformattedText();
        if (L.f(deformattedText, this.f102352b)) {
            return;
        }
        s sVar = this.f102354d;
