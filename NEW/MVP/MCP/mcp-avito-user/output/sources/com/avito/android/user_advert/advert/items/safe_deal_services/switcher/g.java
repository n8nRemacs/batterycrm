...
final class g extends N implements l<Boolean, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ h f310071l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ c.b f310072m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(h hVar, c.b bVar) {
        super(1);
        this.f310071l = hVar;
        this.f310072m = bVar;
    }
    ...
    public final G0 invoke(Boolean bool) {
        ...
        MyAdvertDetailsActivity myAdvertDetailsActivity = this.f310071l.f310073b;
        if (myAdvertDetailsActivity != null) {
            myAdvertDetailsActivity.l2((c.b.a) this.f310072m, zBooleanValue);
        }
        return G0.f406611a;
    }
}
