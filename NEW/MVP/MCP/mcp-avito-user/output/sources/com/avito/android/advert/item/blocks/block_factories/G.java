...
/* compiled from: AdvertDetailsBuyerTrustBannerBlockFactoryImpl.kt */
...
public final class G implements com.avito.android.advert_core.blocks.a {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final com.avito.android.advert.item.blocks.items_factories.W f73437a;

    @Inject
    public G(@Y61.k com.avito.android.advert.item.blocks.items_factories.W w12) {
        this.f73437a = w12;
    }
    ...
    public final List<PersistableSpannedItem> a(@Y61.k a.b bVar) {
        return C42745f0.V(this.f73437a.a(bVar.f83013a.f82645b));
    }
