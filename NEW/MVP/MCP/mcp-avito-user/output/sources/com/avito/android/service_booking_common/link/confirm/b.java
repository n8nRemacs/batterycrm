...
final class b<T> implements l41.g {
    ...
    public final /* synthetic */ d f276604b;
    ...
    public final void accept(Object obj) {
        ...
        d dVar = this.f276604b;
        a.g gVar = dVar.f276608h;
        if (!z12) {
        ...
        gVar.g(dVar.d(), false);
        if (message != null) {
            a.i.C4057a.d(dVar.f276610j, com.avito.android.printable_text.b.f(message), null, null, f.a.f125253a, 0, ToastBarPosition.f181047e, null, null, 1966);
        }
        dVar.j(new ServiceBookingConfirmLink.b.C8218b(message));
    }
}
