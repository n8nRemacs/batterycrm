...
final class i extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ TfaDisablePasswordFragment f258103l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(TfaDisablePasswordFragment tfaDisablePasswordFragment) {
        super(1);
        this.f258103l = tfaDisablePasswordFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        InterfaceC49659a.e eVar = new InterfaceC49659a.e(str);
        TfaDisablePasswordFragment.a aVar = TfaDisablePasswordFragment.f258071x0;
        this.f258103l.r5(eVar);
        return G0.f406611a;
    }
}
