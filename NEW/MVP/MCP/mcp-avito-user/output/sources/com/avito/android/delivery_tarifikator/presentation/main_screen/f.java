...
final class f extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ TarifikatorMainFragment f135600l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(TarifikatorMainFragment tarifikatorMainFragment) {
        super(0);
        this.f135600l = tarifikatorMainFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        TarifikatorMainFragment.a aVar = TarifikatorMainFragment.f135523E0;
        this.f135600l.r5().accept(InterfaceC15412c.k.f15997a);
        return G0.f406611a;
    }
}
