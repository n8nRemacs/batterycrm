...
final class g extends N implements Y41.l<CallParams, Map<String, ? extends String>> {

    /* renamed from: l, reason: collision with root package name */
    public static final g f165611l = new g();
    ...
    public final Map<String, ? extends String> invoke(CallParams callParams) {
        return callParams.getAnalyticsExtraParams();
    }
}
