...
public final /* data */ class GuestsDetailedValue implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator<GuestsDetailedValue> {
        ...
        public final GuestsDetailedValue createFromParcel(Parcel parcel) {
            ...
            return new GuestsDetailedValue(numValueOf, numValueOf2, numValueOf3, arrayListCreateStringArrayList, boolValueOf);
        }

        @Override // android.os.Parcelable.Creator
        public final GuestsDetailedValue[] newArray(int i12) {
            return new GuestsDetailedValue[i12];
        }
    }

    public GuestsDetailedValue(@l Integer num, @l Integer num2, @l Integer num3, @l List<String> list, @l Boolean bool) {
        this.version = num;
    ...
    public final boolean equals(@l Object obj) {
        ...
        return L.f(this.version, guestsDetailedValue.version) && L.f(this.totalCount, guestsDetailedValue.totalCount) && L.f(this.adultsCount, guestsDetailedValue.adultsCount) && L.f(this.children, guestsDetailedValue.children) && L.f(this.withPets, guestsDetailedValue.withPets);
    }
    ...
    public final String toString() {
        StringBuilder sb2 = new StringBuilder("GuestsDetailedValue(version=");
