...
final class x extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204852l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204852l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204852l.getViewModel().accept(b.d.C6099b.f204572b);
        return G0.f406611a;
    }
}
