...
final class O extends kotlin.jvm.internal.N implements Y41.p<Integer, InterfaceC27333b, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.l<Integer, G0> f120136l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public O(Y41.l<? super Integer, G0> lVar) {
        super(2);
        this.f120136l = lVar;
    }
    ...
    public final G0 invoke(Integer num, InterfaceC27333b interfaceC27333b) {
        this.f120136l.invoke(Integer.valueOf(num.intValue()));
        return G0.f406611a;
    }
}
