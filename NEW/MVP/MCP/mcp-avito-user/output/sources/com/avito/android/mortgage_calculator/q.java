...
final class q extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204845l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204845l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204845l.getViewModel().accept(b.s.f204590b);
        return G0.f406611a;
    }
}
