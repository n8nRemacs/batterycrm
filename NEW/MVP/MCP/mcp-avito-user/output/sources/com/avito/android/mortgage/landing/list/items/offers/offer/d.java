...
final class d extends N implements l<Boolean, G0> {
    ...
    public final /* synthetic */ e f199856l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ OfferItem f199857m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(e eVar, OfferItem offerItem) {
        super(1);
        this.f199856l = eVar;
        this.f199857m = offerItem;
    }
    ...
    public final G0 invoke(Boolean bool) {
        Boolean bool2 = bool;
        bool2.booleanValue();
        this.f199856l.f199858b.invoke(this.f199857m.f199846b, bool2);
        return G0.f406611a;
    }
}
