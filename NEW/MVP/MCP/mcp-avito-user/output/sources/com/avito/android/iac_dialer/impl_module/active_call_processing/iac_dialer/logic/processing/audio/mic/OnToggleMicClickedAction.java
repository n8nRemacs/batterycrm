package com.avito.android.iac_dialer.impl_module.active_call_processing.iac_dialer.logic.processing.audio.mic;
...
public final /* data */ class OnToggleMicClickedAction implements IacAction {
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        if (iacActionProcessing.getState() instanceof IacState.InUse) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.AvCalls.EnableSendingAudio(((IacState.InUse) iacActionProcessing.getState()).getCallId(), true ^ ((IacState.InUse) iacActionProcessing.getState()).getCall().getLocalSendingAudio()));
        } else {
    ...
    public String toString() {
        return "OnToggleMicClickedAction";
    }
}
