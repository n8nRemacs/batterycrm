...
public final class C implements View.OnLayoutChangeListener {
    ...
    public final /* synthetic */ s f159815b;
    ...
    public final void onLayoutChange(View view, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19) {
        ...
        s sVar = this.f159815b;
        ScrollView scrollView = sVar.f160037R;
        scrollView.setPadding(scrollView.getPaddingLeft(), scrollView.getPaddingTop(), scrollView.getPaddingRight(), sVar.f160038S.getHeight());
    }
}
