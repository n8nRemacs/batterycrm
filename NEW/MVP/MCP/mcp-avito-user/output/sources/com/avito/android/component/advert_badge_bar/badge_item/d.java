...
public final class d extends N implements Y41.a<G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC40743a f124987l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(InterfaceC40743a interfaceC40743a) {
        super(0);
        this.f124987l = interfaceC40743a;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f124987l.setState(State.f135881e);
        return G0.f406611a;
    }
}
