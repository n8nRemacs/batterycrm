...
final class j extends N implements Y41.l<AddressWorkSchedule, AddressWorkSchedule> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ TimeInterval f145966l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(TimeInterval timeInterval) {
        super(1);
        this.f145966l = timeInterval;
    }

    @Override // Y41.l
    public final AddressWorkSchedule invoke(AddressWorkSchedule addressWorkSchedule) {
        return AddressWorkSchedule.a(addressWorkSchedule, null, this.f145966l, null, 23);
    }
}
