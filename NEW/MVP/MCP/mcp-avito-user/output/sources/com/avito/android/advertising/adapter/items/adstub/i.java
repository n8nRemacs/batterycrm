...
/* compiled from: NotLoadAdRichStubNewBlueprint.kt */
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001¨\u0006\u0004"}, d2 = {"Lcom/avito/android/advertising/adapter/items/adstub/i;", "LTV0/b;", "LEb/c;", "Lcom/avito/android/advertising/adapter/CommercialBannerItem;", "_avito_advertising_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes11.dex */
public final class i implements TV0.b<Eb.c, CommercialBannerItem> {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final s f86950a;

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public final g.a<Eb.c> f86951b = new g.a<>(R.layout.rds_not_load_ad_stub, a.f86952l);
    ...
    public static final class a extends N implements Y41.p<ViewGroup, View, Eb.c> {
        ...
        public static final a f86952l = new a();
        ...
        public final Eb.c invoke(ViewGroup viewGroup, View view) throws Resources.NotFoundException {
            View view2 = view;
            C44743g.a(view2);
            Eb.c cVar = new Eb.c(view2, AdStyle.f88542g, null, 4, null);
            cVar.C80();
            return cVar;
        }
    }
    ...
    public final boolean d(@Y61.k TV0.a aVar) {
        if (aVar instanceof CommercialBannerItem) {
            ...
            if (commercialBannerItem.getHasNotLoadedAd() && commercialBannerItem.getDisplayType().isInformative()) {
                return true;
            }
        }
        return false;
