...
final class c extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ m f316481l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ UserAdvertItem f316482m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(m mVar, UserAdvertItem userAdvertItem) {
        super(1);
        this.f316481l = mVar;
        this.f316482m = userAdvertItem;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        this.f316481l.f316516b.get().X(new a.InterfaceC9834a.b(deepLink, this.f316482m));
        return G0.f406611a;
    }
}
