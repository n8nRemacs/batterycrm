...
final class G extends kotlin.jvm.internal.N implements Y41.q<InterfaceC20793y, androidx.compose.runtime.A, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ MetroLineItem f265961l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l<MetroLineItem, G0> f265962m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public G(Y41.l lVar, MetroLineItem metroLineItem) {
        super(3);
        this.f265961l = metroLineItem;
        this.f265962m = lVar;
    }
    ...
    public final G0 invoke(InterfaceC20793y interfaceC20793y, androidx.compose.runtime.A a12, Integer num) {
        ...
        if ((num.intValue() & 81) == 16 && a13.c()) {
            ...
            C34645l.a(this.f265961l, this.f265962m, a13, 8);
        }
        return G0.f406611a;
    }
}
