...
final class l extends N implements Y41.l<ContentPlaceholder, G0> {
    ...
    public final /* synthetic */ d f292760l;
    ...
    public final G0 invoke(ContentPlaceholder contentPlaceholder) {
        ...
        d dVar = this.f292760l;
        contentPlaceholder2.setImageResource(Integer.valueOf(dVar.getF292736e()));
        contentPlaceholder2.setTitle(dVar.getF292737f());
        contentPlaceholder2.setSubtitle(dVar.getF292738g());
        contentPlaceholder2.setButtonTitle(dVar.getF292739h());
        return G0.f406611a;
    }
}
