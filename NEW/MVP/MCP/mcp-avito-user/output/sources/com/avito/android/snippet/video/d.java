...
final class d<T> implements l41.g {
    ...
    public final /* synthetic */ b f284004b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ String f284005c;
    ...
    public final void accept(Object obj) {
        ...
        m mVar = this.f284004b.f283998m;
        LinkedHashMap linkedHashMap = mVar.f284023g;
        String str = this.f284005c;
        g.c cVar = (g.c) linkedHashMap.get(str);
        if (cVar == null) {
            return;
        }
        mVar.f284020d.c(new mc.e(c10076b.f326064a, str, mVar.f284019c.getF220326i(), Integer.valueOf(cVar.f326089c), null, null, null, 96, null));
    }
}
