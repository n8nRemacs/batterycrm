...
/* renamed from: com.avito.android.comfortable_deal.end_deal.i, reason: case insensitive filesystem */
/* loaded from: classes12.dex */
final class C29479i extends kotlin.jvm.internal.N implements Y41.p<Integer, InterfaceC27333b, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.l<String, G0> f122192l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public C29479i(Y41.l<? super String, G0> lVar) {
        super(2);
        this.f122192l = lVar;
    }
    ...
    public final G0 invoke(Integer num, InterfaceC27333b interfaceC27333b) {
        ...
        EndDealField.ChipGroup.Chip chip = interfaceC27333b2 instanceof EndDealField.ChipGroup.Chip ? (EndDealField.ChipGroup.Chip) interfaceC27333b2 : null;
        if (chip != null) {
            this.f122192l.invoke(chip.f122263c);
        }
        return G0.f406611a;
    }
}
