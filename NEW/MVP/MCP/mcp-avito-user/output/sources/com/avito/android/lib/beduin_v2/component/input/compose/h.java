...
final class h extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ AvitoInputState f175688l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(AvitoInputState avitoInputState) {
        super(0);
        this.f175688l = avitoInputState;
    }

    @Override // Y41.a
    public final G0 invoke() {
        Y41.a<G0> aVar = this.f175688l.f334474m;
        if (aVar != null) {
            aVar.invoke();
        }
        return G0.f406611a;
