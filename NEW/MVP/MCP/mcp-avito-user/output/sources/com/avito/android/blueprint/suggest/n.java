...
final class n extends N implements Y41.p<CharSequence, String, G0> {
    ...
    public final /* synthetic */ w f105720l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ParameterElement.H f105721m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(w wVar, ParameterElement.H h12) {
        super(2);
        this.f105720l = wVar;
        this.f105721m = h12;
    }
    ...
    public final G0 invoke(CharSequence charSequence, String str) {
        ...
        w wVar = this.f105720l;
        wVar.getClass();
        ParameterElement.H h12 = this.f105721m;
        h12.f117300f = str2;
        if (h12.f117302h) {
