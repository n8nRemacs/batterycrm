...
/* compiled from: OnNotificationDisplayingResultAction.kt */
@P
@s0
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\b\b\u0087\b\u0018\u00002\u00020\u0001B\u001b\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\u0010\u0006\u001a\u00060\u0004j\u0002`\u0005¢\u0006\u0004\b\u0007\u0010\bJ\u0013\u0010\u000b\u001a\u00020\n*\u00020\tH\u0016¢\u0006\u0004\b\u000b\u0010\fJ\u0010\u0010\r\u001a\u00020\u0002HÆ\u0003¢\u0006\u0004\b\r\u0010\u000eJ\u0014\u0010\u000f\u001a\u00060\u0004j\u0002`\u0005HÆ\u0003¢\u0006\u0004\b\u000f\u0010\u0010J(\u0010\u0011\u001a\u00020\u00002\b\b\u0002\u0010\u0003\u001a\u00020\u00022\f\b\u0002\u0010\u0006\u001a\u00060\u0004j\u0002`\u0005HÆ\u0001¢\u0006\u0004\b\u0011\u0010\u0012J\u0010\u0010\u0013\u001a\u00020\u0004HÖ\u0001¢\u0006\u0004\b\u0013\u0010\u0010J\u0010\u0010\u0015\u001a\u00020\u0014HÖ\u0001¢\u0006\u0004\b\u0015\u0010\u0016J\u001a\u0010\u0019\u001a\u00020\u00022\b\u0010\u0018\u001a\u0004\u0018\u00010\u0017HÖ\u0003¢\u0006\u0004\b\u0019\u0010\u001aR\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u001b\u001a\u0004\b\u001c\u0010\u000eR\u001b\u0010\u0006\u001a\u00060\u0004j\u0002`\u00058\u0006¢\u0006\f\n\u0004\b\u0006\u0010\u001d\u001a\u0004\b\u001e\u0010\u0010¨\u0006\u001f"}, d2 = {"Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/init/notification/OnNotificationDisplayingResultAction;", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacAction;", "", "wasDisplayed", "", "Lcom/avito/android/iac_dialer_models/abstract_module/CallId;", FailedBinderCallBack.CALLER_ID, "<init>", "(ZLjava/lang/String;)V", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;", "Lkotlin/G0;", "process", "(Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;)V", "component1", "()Z", "component2", "()Ljava/lang/String;", "copy", "(ZLjava/lang/String;)Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/init/notification/OnNotificationDisplayingResultAction;", "toString", "", "hashCode", "()I", "", PluralsKeys.OTHER, "equals", "(Ljava/lang/Object;)Z", "Z", "getWasDisplayed", "Ljava/lang/String;", "getCallId", "_avito_iac-dialer_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes14.dex */
public final /* data */ class OnNotificationDisplayingResultAction implements IacAction {
    ...
    public OnNotificationDisplayingResultAction(boolean z12, @k String str) {
        this.wasDisplayed = z12;
        this.callId = str;
    }

    public static /* synthetic */ OnNotificationDisplayingResultAction copy$default(OnNotificationDisplayingResultAction onNotificationDisplayingResultAction, boolean z12, String str, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            z12 = onNotificationDisplayingResultAction.wasDisplayed;
        }
        if ((i12 & 2) != 0) {
            str = onNotificationDisplayingResultAction.callId;
        }
        return onNotificationDisplayingResultAction.copy(z12, str);
    }
    ...
    @k
    public final OnNotificationDisplayingResultAction copy(boolean wasDisplayed, @k String callId) {
        return new OnNotificationDisplayingResultAction(wasDisplayed, callId);
    }
    ...
    public boolean equals(@l Object other) {
        ...
        if (!(other instanceof OnNotificationDisplayingResultAction)) {
            return false;
        }
        OnNotificationDisplayingResultAction onNotificationDisplayingResultAction = (OnNotificationDisplayingResultAction) other;
        return this.wasDisplayed == onNotificationDisplayingResultAction.wasDisplayed && L.f(this.callId, onNotificationDisplayingResultAction.callId);
    }
    ...
    public int hashCode() {
        return this.callId.hashCode() + (Boolean.hashCode(this.wasDisplayed) * 31);
    }
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        ...
        if (!this.wasDisplayed && callInitA.getDirection() == IacCallDirection.INCOMING) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new TerminateCallInAvCallsAndTelecomAction(getName(), this.callId, null, 4, null));
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.Analytics.TrackStatsdCount("iac.dialer.init_fail.notification_not_displayed"));
            return;
        }
        IacActionOutput out = iacActionProcessing.getOut();
        IacState state = iacActionProcessing.getState();
        String str = this.callId;
        CallInit callInitCopy$default = CallInit.copy$default(callInitA, null, null, this.wasDisplayed, null, false, null, null, 123, null);
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("OnNotificationDisplayingResultAction(wasDisplayed=");
        sb2.append(this.wasDisplayed);
        sb2.append(", callId=");
