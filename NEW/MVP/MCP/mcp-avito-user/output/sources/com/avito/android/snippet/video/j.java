...
final class j<T> implements l41.g {
    ...
    public final /* synthetic */ b f284012b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ String f284013c;
    ...
    public final void accept(Object obj) {
        ...
        m mVar = this.f284012b.f283998m;
        LinkedHashMap linkedHashMap = mVar.f284023g;
        String str = this.f284013c;
        g.c cVar = (g.c) linkedHashMap.get(str);
        if (cVar == null) {
            return;
        }
        mVar.f284020d.c(new C44048a(aVar.f326062a, str, mVar.f284019c.getF220326i(), aVar.f326063b, Integer.valueOf(cVar.f326089c)));
    }
}
