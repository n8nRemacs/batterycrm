...
final class c extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ SelectSpecificFragment f211660l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(SelectSpecificFragment selectSpecificFragment) {
        super(0);
        this.f211660l = selectSpecificFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        SelectSpecificFragment.a aVar = SelectSpecificFragment.f211624C0;
        this.f211660l.t5().accept(a.C1046a.f15362a);
        return G0.f406611a;
    }
}
