...
@K51.d
@P
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/comfortable_deal/submitting/recycler/items/titleBulletItem/TitleItem;", "Lcom/avito/conveyor_item/ParcelableItem;", "_avito_comfortable-deal_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final /* data */ class TitleItem implements ParcelableItem {
    ...
    public final boolean equals(@l Object obj) {
        ...
        return L.f(this.f123255b, titleItem.f123255b) && L.f(this.f123256c, titleItem.f123256c);
    }
    ...
    public final int hashCode() {
        return this.f123256c.hashCode() + (this.f123255b.hashCode() * 31);
    }
    ...
    public final String toString() {
        ...
        sb2.append(", title=");
        return C22026a.c(sb2, this.f123256c, ')');
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@k Parcel parcel, int i12) {
        parcel.writeString(this.f123255b);
        parcel.writeString(this.f123256c);
    }
}
