...
final class O extends kotlin.jvm.internal.N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ Y41.l<InterfaceC48707a, G0> f127968l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public O(Y41.l<? super InterfaceC48707a, G0> lVar) {
        super(1);
        this.f127968l = lVar;
    }
    ...
    public final G0 invoke(DeepLink deepLink) {
        this.f127968l.invoke(new InterfaceC48707a.e(deepLink));
        return G0.f406611a;
    }
}
