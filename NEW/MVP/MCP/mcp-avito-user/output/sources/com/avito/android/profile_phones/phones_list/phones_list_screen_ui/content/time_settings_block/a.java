...
final class a extends N implements p<A, Integer, G0> {
    ...
    public final /* synthetic */ int f228290l;
    ...
    public final G0 invoke(A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f228290l | 1);
        B bE2 = a12.E(-793469498);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            b.a("13.30 - 18.30", true, C20588k2.d(v.f42878y1, 1.0f), null, bE2, 438, 8);
        }
