...
final class e extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ CpxPromoV2Fragment f127545l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(CpxPromoV2Fragment cpxPromoV2Fragment) {
        super(0);
        this.f127545l = cpxPromoV2Fragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        CpxPromoV2Fragment.b bVar = CpxPromoV2Fragment.f127346s0;
        this.f127545l.r5().accept(a.d.f127692a);
        return G0.f406611a;
    }
}
