...
final class r extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f201495l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f201495l | 1);
        androidx.compose.runtime.B bE2 = a12.E(-1577422645);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            C32667a.f201376a.getClass();
            com.akita.compose.theme.re23.c.a(false, C32667a.f201380e, bE2, 48, 1);
        }
