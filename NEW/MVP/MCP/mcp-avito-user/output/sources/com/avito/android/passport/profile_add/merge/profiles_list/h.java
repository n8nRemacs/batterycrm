...
final class h extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ ProfilesListFragment f213257l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(ProfilesListFragment profilesListFragment) {
        super(0);
        this.f213257l = profilesListFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        ProfilesListFragment.a aVar = ProfilesListFragment.f213192A0;
        this.f213257l.r5().accept(InterfaceC40238a.d.f395664a);
        return G0.f406611a;
    }
}
