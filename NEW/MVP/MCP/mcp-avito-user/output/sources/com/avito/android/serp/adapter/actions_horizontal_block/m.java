...
final class m extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ g f268685l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Action f268686m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(Action action, g gVar) {
        super(0);
        this.f268685l = gVar;
        this.f268686m = action;
    }

    @Override // Y41.a
    public final G0 invoke() {
        g gVar = this.f268685l;
        gVar.f268673b.a(((Action.InlineFilter) this.f268686m).f268638d);
        return G0.f406611a;
    }
}
