...
/* compiled from: AdvertDetailsRepairCalculatorBlockFactoryImpl.kt */
...
public final class S1 implements com.avito.android.advert_core.blocks.a {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public final N3 f73488a;

    @Inject
    public S1(@Y61.k N3 n32) {
        this.f73488a = n32;
    }
    ...
    public final List<PersistableSpannedItem> a(@Y61.k a.b bVar) {
        return C42745f0.V(this.f73488a.a(bVar.f83013a.f82645b));
    }
