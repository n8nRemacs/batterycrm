...
final class l extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ PasswordChangeFragment f257288l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(PasswordChangeFragment passwordChangeFragment) {
        super(1);
        this.f257288l = passwordChangeFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        InterfaceC47696a.h hVar = new InterfaceC47696a.h(str);
        PasswordChangeFragment.a aVar = PasswordChangeFragment.f257203H0;
        this.f257288l.t5(hVar);
        return G0.f406611a;
    }
}
