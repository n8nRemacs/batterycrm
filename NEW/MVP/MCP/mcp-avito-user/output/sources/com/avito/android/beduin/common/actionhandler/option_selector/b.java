...
final class b extends N implements Y41.l<OpenOptionSelectorAction.Option, Boolean> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.beduin.common.actionhandler.option_selector.konveyor.a f100301l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(com.avito.android.beduin.common.actionhandler.option_selector.konveyor.a aVar) {
        super(1);
        this.f100301l = aVar;
    }
    ...
    public final Boolean invoke(OpenOptionSelectorAction.Option option) {
        return Boolean.valueOf(L.f(option.getId(), this.f100301l.f100325b));
    }
}
