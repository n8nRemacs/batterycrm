...
/* renamed from: com.avito.android.html_formatter.jsoup.p, reason: case insensitive filesystem */
/* loaded from: classes13.dex */
final class C30818p extends kotlin.jvm.internal.N implements Y41.p<org.jsoup.nodes.k, Integer, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ int f164229l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C30818p(int i12) {
        super(2);
        this.f164229l = i12;
    }
    ...
    public final G0 invoke(org.jsoup.nodes.k kVar, Integer num) {
        ...
        if (num.intValue() == 0 && (kVar2 instanceof org.jsoup.nodes.n)) {
            ...
            String strM = nVar.M();
            nVar.R(strM.substring(this.f164229l, strM.length()));
        }
        return G0.f406611a;
    }
}
