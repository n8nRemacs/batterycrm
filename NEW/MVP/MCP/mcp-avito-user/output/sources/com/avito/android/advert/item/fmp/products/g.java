...
final class g extends N implements Y41.l<Tile, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ d f75614l;
    ...
    public final G0 invoke(Tile tile) {
        Tile tile2 = tile;
        ArrayList arrayList = tile2.f75590j;
        d dVar = this.f75614l;
        if (arrayList != null) {
        ...
        String str = tile2.f75585e;
        if (str != null) {
            b.a.a(dVar.f75599e, dVar.f75600f.b(str), null, null, 6);
        }
        return G0.f406611a;
    }
}
