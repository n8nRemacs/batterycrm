...
final /* synthetic */ class o extends H implements Y41.q<String, String, ParsingAllowance, I<ParsingPermissionResult>> {
    @Override // Y41.q
    public final I<ParsingPermissionResult> invoke(String str, String str2, ParsingAllowance parsingAllowance) {
        return ((h) this.receiver).b(str, str2, parsingAllowance);
    }
}
