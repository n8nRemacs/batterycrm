...
final class k extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ l f244905l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ SelectedBedType f244906m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(l lVar, SelectedBedType selectedBedType) {
        super(1);
        this.f244905l = lVar;
        this.f244906m = selectedBedType;
    }

    @Override // Y41.l
    public final G0 invoke(Integer num) {
        int iIntValue = num.intValue();
        p<? super String, ? super Integer, G0> pVar = this.f244905l.f244914i;
        if (pVar != null) {
            pVar.invoke(this.f244906m.getStringId(), Integer.valueOf(iIntValue));
        }
        return G0.f406611a;
    }
}
