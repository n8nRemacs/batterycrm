...
public final class g extends N implements Y41.l<androidx.compose.ui.graphics.drawscope.d, G0> {
    ...
    public final /* synthetic */ r f181518l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.analytics.screens.compose.a f181519m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(r rVar, com.avito.android.analytics.screens.compose.a aVar) {
        super(1);
        this.f181518l = rVar;
        this.f181519m = aVar;
    }
    ...
    public final G0 invoke(androidx.compose.ui.graphics.drawscope.d dVar) {
        dVar.y1();
        com.avito.android.analytics.screens.compose.a aVar = this.f181519m;
        r rVar = this.f181518l;
        if (rVar != null) {
