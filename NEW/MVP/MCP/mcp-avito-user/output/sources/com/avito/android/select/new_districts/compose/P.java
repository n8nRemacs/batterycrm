...
final class P extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<DistrictChip, G0> f265718l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ DistrictChip f265719m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public P(Y41.l<? super DistrictChip, G0> lVar, DistrictChip districtChip) {
        super(0);
        this.f265718l = lVar;
        this.f265719m = districtChip;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f265718l.invoke(this.f265719m);
        return G0.f406611a;
    }
}
