...
/* compiled from: PlayerFragmentComponent.kt */
@B
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\bg\u0018\u00002\u00020\u0001:\u0001\u0002¨\u0006\u0003"}, d2 = {"Lcom/avito/android/player/di/f;", "", "a", "_avito_player_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
@h31.d
...
public interface f {
    ...
    /* compiled from: PlayerFragmentComponent.kt */
    @d.a
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bg\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/avito/android/player/di/f$a;", "", "_avito_player_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public interface a {
        @Y61.k
        ...
        @h31.b
        @Y61.k
        a i(@Y61.k PlayerFragment playerFragment);

        @h31.b
        @Y61.k
        a j(@Y61.k PlayerScreen playerScreen);
    }

    void a(@Y61.k PlayerFragment playerFragment);
}
