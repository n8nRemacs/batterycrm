...
public final /* data */ class UpdateStorageMiddleware implements IacMiddlewareDistinctBy<Payload> {
    ...
    public static final /* data */ class Payload implements IacMiddlewarePayload {
        ...
        public Payload(@k CallStorage callStorage) {
            this.storage = callStorage;
        }

        public static /* synthetic */ Payload copy$default(Payload payload, CallStorage callStorage, int i12, Object obj) {
            if ((i12 & 1) != 0) {
                callStorage = payload.storage;
            }
            return payload.copy(callStorage);
        }
        ...
        @k
        public final Payload copy(@k CallStorage storage) {
            return new Payload(storage);
        }
        ...
        public boolean equals(@l Object other) {
            ...
            return (other instanceof Payload) && L.f(this.storage, ((Payload) other).storage);
        }
        ...
        public String toString() {
            return "Payload(storage=" + this.storage + ')';
        }
    }

    private UpdateStorageMiddleware() {
    }

    public boolean equals(@l Object other) {
        return this == other || (other instanceof UpdateStorageMiddleware);
    }
    ...
    public Payload getPayloadFromState(@k IacState state) {
        return new Payload(state.getAppearance().getStorage());
    }

    @Override // com.avito.android.iac_dialer.impl_module.active_call_processing.iac_dialer.core.IacMiddlewareDistinctBy
    public void process(@k IacMiddlewareProcessing iacMiddlewareProcessing, @k Payload payload, @k Payload payload2) {
        iacMiddlewareProcessing.plusAssign(iacMiddlewareProcessing.getOut(), new IacEvent.Storage.Update(payload2.getStorage()));
    }
}
