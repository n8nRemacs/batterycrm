...
final class e extends N implements Y41.l<Parcelable, G0> {
    ...
    public final /* synthetic */ BaseRatingReviewItem.ReviewAnswer f250177l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(BaseRatingReviewItem.ReviewAnswer reviewAnswer) {
        super(1);
        this.f250177l = reviewAnswer;
    }

    @Override // Y41.l
    public final G0 invoke(Parcelable parcelable) {
        this.f250177l.f250317p = parcelable;
        return G0.f406611a;
    }
}
