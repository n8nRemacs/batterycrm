...
final class x extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ y f222284l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ SubLocationItem f222285m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(y yVar, SubLocationItem subLocationItem) {
        super(0);
        this.f222284l = yVar;
        this.f222285m = subLocationItem;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f222284l.f222286b.accept(this.f222285m);
        return G0.f406611a;
    }
}
