...
public final class n extends N implements Y41.l<androidx.compose.ui.graphics.drawscope.d, G0> {
    ...
    public final /* synthetic */ r f329333l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.analytics.screens.compose.a f329334m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(r rVar, com.avito.android.analytics.screens.compose.a aVar) {
        super(1);
        this.f329333l = rVar;
        this.f329334m = aVar;
    }
    ...
    public final G0 invoke(androidx.compose.ui.graphics.drawscope.d dVar) {
        dVar.y1();
        com.avito.android.analytics.screens.compose.a aVar = this.f329334m;
        r rVar = this.f329333l;
        if (rVar != null) {
