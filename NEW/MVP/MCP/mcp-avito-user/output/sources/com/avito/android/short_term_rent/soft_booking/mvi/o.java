...
@DebugMetadata(c = "com.avito.android.short_term_rent.soft_booking.mvi.StrSoftBookingActor$process$1", f = "StrSoftBookingActor.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
final class o extends SuspendLambda implements Y41.p<InterfaceC43172j<? super StrSoftBookingInternalAction>, Continuation<? super G0>, Object> {
    ...
    public final /* synthetic */ C34981a f282782q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(C34981a c34981a, Continuation<? super o> continuation) {
        super(2, continuation);
        this.f282782q = c34981a;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new o(this.f282782q, continuation);
    }
