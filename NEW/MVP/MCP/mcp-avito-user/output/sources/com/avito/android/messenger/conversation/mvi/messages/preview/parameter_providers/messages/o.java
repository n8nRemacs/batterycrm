...
/* compiled from: UnknownMessagesPreviewParameterProvider.kt */
@P
...
public final class o extends MessengerPreviewParameterProvider {
    ...
    public final InterfaceC43030m<MessengerPreviewParameterProvider.a> b() {
        ...
        return C42756l.f(new MessengerPreviewParameterProvider.a[]{new MessengerPreviewParameterProvider.a(mVar.k(new MessageBody.Unknown("", "Unknown message"), MessageDeliveryStatus.f186165d, "Исходящее неизвестное сообщение"), false), new MessengerPreviewParameterProvider.a(com.avito.android.messenger.conversation.mvi.messages.utils.m.d(mVar, new MessageBody.Unknown("", "Unknown message"), "Входящее неизвестное сообщение", null, null, null, null, 122), true)});
    }

    public o(MessengerPreviewParameterProvider.PreviewConfig previewConfig, int i12, C42822w c42822w) {
