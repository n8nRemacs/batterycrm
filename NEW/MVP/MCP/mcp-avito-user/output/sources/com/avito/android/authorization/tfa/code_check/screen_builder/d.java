...
final class d extends N implements Y41.a<com.avito.android.code_check_public.a> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ h f94717l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ l0.a f94718m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(h hVar, l0.a aVar) {
        super(0);
        this.f94717l = hVar;
        this.f94718m = aVar;
    }
    ...
    public final com.avito.android.code_check_public.a invoke() {
        this.f94717l.f94725d.c(new C47641b(this.f94718m.f406838b, false));
        return null;
    }
}
