...
final class e extends N implements l<Throwable, G0> {
    ...
    public final /* synthetic */ BarcodeScannerFragment f98953l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(BarcodeScannerFragment barcodeScannerFragment) {
        super(1);
        this.f98953l = barcodeScannerFragment;
    }

    @Override // Y41.l
    public final G0 invoke(Throwable th2) {
        BarcodeScannerFragment.a aVar = BarcodeScannerFragment.f98915I0;
        this.f98953l.q5().accept(new InterfaceC25648a.k(th2));
        return G0.f406611a;
    }
}
