...
final class f extends N implements l<Boolean, G0> {
    ...
    public final /* synthetic */ d f102608l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ConstructorAdvertItem f102609m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(d dVar, ConstructorAdvertItem constructorAdvertItem) {
        super(1);
        this.f102608l = dVar;
        this.f102609m = constructorAdvertItem;
    }

    @Override // Y41.l
    public final G0 invoke(Boolean bool) {
        bool.getClass();
        d dVar = this.f102608l;
        dVar.f102599h.Ld(this.f102609m, null);
        return G0.f406611a;
    }
}
