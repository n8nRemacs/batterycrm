...
final class r extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204846l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204846l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204846l.getViewModel().accept(b.h.f204578b);
        return G0.f406611a;
    }
}
