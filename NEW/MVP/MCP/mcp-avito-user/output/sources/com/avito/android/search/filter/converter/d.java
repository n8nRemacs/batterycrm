...
final class d extends N implements Y41.l<SectionedMultiselectParameter.Value, Boolean> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Set<String> f262973l;
    ...
    public final Boolean invoke(SectionedMultiselectParameter.Value value) {
        return Boolean.valueOf(this.f262973l.contains(value.getId()));
    }
}
