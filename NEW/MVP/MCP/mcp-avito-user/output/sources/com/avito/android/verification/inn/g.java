...
final class g extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ RecyclerView f323889l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ d f323890m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(RecyclerView recyclerView, d dVar) {
        super(1);
        this.f323889l = recyclerView;
        this.f323890m = dVar;
    }
    ...
    public final G0 invoke(Integer num) {
        ...
        RecyclerView recyclerView = this.f323889l;
        if (recyclerView != null) {
            int i12 = d.f323882d;
            this.f323890m.getClass();
            i iVar = new i(recyclerView.getContext());
            iVar.f53878a = iIntValue;
