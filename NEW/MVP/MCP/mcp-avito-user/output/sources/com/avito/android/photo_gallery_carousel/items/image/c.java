...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u0003¨\u0006\u0004"}, d2 = {"Lcom/avito/android/photo_gallery_carousel/items/image/c;", "Lcom/avito/konveyor/adapter/b;", "Lcom/avito/android/photo_gallery_carousel/items/image/k;", "Lcom/avito/android/photo_gallery_carousel/items/common/c;", "_avito_photo-gallery-carousel_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class c extends com.avito.konveyor.adapter.b implements k, com.avito.android.photo_gallery_carousel.items.common.c {
    ...
    public final /* synthetic */ l f217952b;

    public c(@Y61.k View view, @Y61.k ViewGroup viewGroup, @Y61.k com.avito.android.pinch_to_zoom.b bVar) {
        super(view);
        this.f217952b = new l(view, viewGroup, bVar);
    ...
    public final void H7(@Y61.k PinchToZoomSource pinchToZoomSource) {
        this.f217952b.H7(pinchToZoomSource);
    }
    ...
    public final void p7(@Y61.k z80.e eVar) {
        this.f217952b.f217969h.f220009d = eVar;
    }
    ...
    public final void uz(@Y61.l Image image, @Y61.l String str, @Y61.k SizableGalleryItem.Type type, @Y61.l CarouselGalleryGroup carouselGalleryGroup) {
        this.f217952b.uz(image, str, type, carouselGalleryGroup);
    }
}
