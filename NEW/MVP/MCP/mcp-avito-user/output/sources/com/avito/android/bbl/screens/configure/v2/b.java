...
final class b extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ BblConfigureV2Fragment f99295l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(BblConfigureV2Fragment bblConfigureV2Fragment) {
        super(1);
        this.f99295l = bblConfigureV2Fragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        BblConfigureV2Fragment.a aVar = BblConfigureV2Fragment.f99264C0;
        this.f99295l.w5().accept(new InterfaceC13032a.e(deepLink));
        return G0.f406611a;
    }
}
