...
final class j extends N implements Y41.l<com.avito.android.lib.design.text_view.a, G0> {
    ...
    public final /* synthetic */ AttributedText f158132l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l<FE.a, G0> f158133m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(Y41.l lVar, AttributedText attributedText) {
        super(1);
        this.f158132l = attributedText;
        this.f158133m = lVar;
    }

    @Override // Y41.l
    public final G0 invoke(com.avito.android.lib.design.text_view.a aVar) {
        this.f158132l.setOnDeepLinkClickListener(new SE0.a(25, this.f158133m));
        return G0.f406611a;
    }
}
