...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/avito/android/messenger/conversation/mvi/messages/renderers/messages/message_content/J;", "Lcom/avito/android/messenger/conversation/mvi/messages/renderers/messages/message_content/d;", "<init>", "()V", "_avito_messenger_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes15.dex */
public final class J extends AbstractC32157d {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public static final J f193251a = new J();
    ...
    public static final class a extends kotlin.jvm.internal.N implements Y41.a<G0> {
        ...
        public final /* synthetic */ Y41.l<com.avito.android.messenger.conversation.mvi.messages.h0, G0> f193252l;

        /* renamed from: m, reason: collision with root package name */
        public final /* synthetic */ T1.d f193253m;
        ...
        public final G0 invoke() {
            T1.d dVar = this.f193253m;
            this.f193252l.invoke(new h0.i(dVar.f189168c, dVar.f189180o, dVar.f189181p, dVar.f189182q));
            return G0.f406611a;
        }
    }
    ...
    public final void a(@Y61.k T1.d dVar, @Y61.k Y41.l lVar, @Y61.k v.a aVar, @Y61.l androidx.compose.runtime.A a12, int i12) {
        int i13;
        androidx.compose.runtime.B bE2 = a12.E(-169294841);
        if ((i12 & 14) == 0) {
        ...
        if ((i13 & 731) == 146 && bE2.c()) {
            ...
            boolean z12 = f189195a instanceof MessageBody.SystemMessageBody.Platform.Bubble.Item;
            ...
            if (z12) {
                ...
                com.avito.android.messenger.conversation.mvi.messages.composables.messages.message_content.p.a(item.getTitle(), item.getPriceString(), item.getOldPriceString(), item.getLocationWithMetro(), item.getImageBySizes(), aVar, quoteViewData == null, bE2, ((i13 << 12) & 3670016) | 265216);
                bE2.X(false);
            } else {
                bE2.C(-1408551524);
                lVar.invoke(new h0.o(new NonFatalErrorEvent("PlatformItemMessageFromUserContentRenderer: Unsupported bodyOrBubble: " + bVar, null, null, null, 14, null)));
        ...
        if (c22039c2Z != null) {
            c22039c2Z.f38184d = new I(this, dVar, lVar, aVar, i12);
        }
    }
