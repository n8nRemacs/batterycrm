...
final class c extends N implements Y41.l<List<? extends com.avito.conveyor_item.a>, G0> {
    ...
    public final /* synthetic */ ConstructorConfigureSizeFragment f300264l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(ConstructorConfigureSizeFragment constructorConfigureSizeFragment) {
        super(1);
        this.f300264l = constructorConfigureSizeFragment;
    }

    @Override // Y41.l
    public final G0 invoke(List<? extends com.avito.conveyor_item.a> list) {
        List<? extends com.avito.conveyor_item.a> list2 = list;
        ConstructorConfigureSizeFragment constructorConfigureSizeFragment = this.f300264l;
        com.avito.konveyor.adapter.a aVar = constructorConfigureSizeFragment.f300247n0;
        if (aVar == null) {
            aVar = null;
        }
        com.avito.android.authorization.auto_recovery.phone_confirm.b.p(aVar, list2);
        com.avito.konveyor.adapter.j jVar = constructorConfigureSizeFragment.f300248o0;
