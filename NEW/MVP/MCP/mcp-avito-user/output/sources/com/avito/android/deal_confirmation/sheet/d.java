...
final class d extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ c f132795l;
    ...
    public final G0 invoke(DeepLink deepLink) {
        ...
        DealConfirmationSheetActivity dealConfirmationSheetActivity = this.f132795l.f132787H;
        if (dealConfirmationSheetActivity != null) {
            dealConfirmationSheetActivity.a(deepLink2);
        }
        return G0.f406611a;
    }
}
