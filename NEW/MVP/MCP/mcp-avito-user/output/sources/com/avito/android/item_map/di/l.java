...
public final class l implements InterfaceC28898u {
    @Override // com.avito.android.bottom_navigation.InterfaceC28898u
    @Y61.k
    public final Class<?> a() {
        return ItemMapFragmentData.class;
    }

    @Override // com.avito.android.bottom_navigation.InterfaceC28898u
    @Y61.k
    public final TabBaseFragment b(@Y61.k TabFragmentFactory.Data data) {
        ItemMapFragment.a aVar = ItemMapFragment.f173231V0;
        ItemMapArguments itemMapArguments = ((ItemMapFragmentData) data).f173266b;
        aVar.getClass();
        return ItemMapFragment.a.a(itemMapArguments);
    }
}
