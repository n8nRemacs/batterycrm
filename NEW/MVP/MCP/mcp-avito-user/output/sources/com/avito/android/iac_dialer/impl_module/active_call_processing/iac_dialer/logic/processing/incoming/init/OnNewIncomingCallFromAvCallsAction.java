...
public final /* data */ class OnNewIncomingCallFromAvCallsAction implements IacAction {
    ...
    public static /* synthetic */ OnNewIncomingCallFromAvCallsAction copy$default(OnNewIncomingCallFromAvCallsAction onNewIncomingCallFromAvCallsAction, CallState callState, int i12, Object obj) {
        if ((i12 & 1) != 0) {
    ...
    public boolean equals(@l Object other) {
        ...
        return (other instanceof OnNewIncomingCallFromAvCallsAction) && L.f(this.newCallState, ((OnNewIncomingCallFromAvCallsAction) other).newCallState);
    }
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        Map mapC;
        CallInit callInitA = i.a(iacActionProcessing.getState(), this.newCallState.getCallId());
        if (callInitA == null) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new TerminateCallInAvCallsAndTelecomAction(getName(), this.newCallState.getCallId(), null, 4, null));
        ...
        if (iacActionProcessing.getState().getAppearance().isGsmBusy() && !L.f(callInitA.isRealTelecomImpl(), Boolean.TRUE)) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new r("Can't start incoming call cause GSM is busy and 'callInit.isRealTelecomImpl'!=true"));
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.AvCalls.TerminateCall(this.newCallState.getCallId(), TerminateReason.Busy.INSTANCE));
            return;
        }
        if (!(iacActionProcessing.getState() instanceof IacState.Idle)) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new r("Can't start incoming call cause already one call is active"));
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.AvCalls.TerminateCall(this.newCallState.getCallId(), TerminateReason.Busy.INSTANCE));
            return;
        }
        ...
        Map map = mapC;
        companion.getClass();
        iacActionProcessing.plusAssign(out, idle.toIncoming(new CallParams(iacCallTime, false, false, false, false, map, null, false), this.newCallState));
        ...
        iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.Analytics.Track(new nJ.r(iacActionProcessing.getState().getAppearance().getNetwork().isVpnActive(), this.newCallState.getCallId(), B.a(iacActionProcessing.getState().getAppearance().getConnectionQuality()))));
        iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.Analytics.TrackCallFetchedEvent5446(this.newCallState.getCallId()));
        iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.AvCalls.SendRingingForIncomingCall(this.newCallState.getCallId()));
    }
