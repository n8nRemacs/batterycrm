...
final class b extends N implements Y41.l<Phone, G0> {
    ...
    public final /* synthetic */ c f94114l;
    ...
    public final G0 invoke(Phone phone) {
        ...
        if ((str != null ? Phone.a(str) : null) == null) {
            throw new IllegalArgumentException("Phone must be set for ResetPasswordCodeCheckScenarioBuilder");
        }
        this.f94114l.f94117d.c(new C19873a(str, CodeConfirmationSource.f92756d));
        return G0.f406611a;
    }
}
