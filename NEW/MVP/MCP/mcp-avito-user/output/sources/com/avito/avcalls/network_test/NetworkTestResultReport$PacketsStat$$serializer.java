...
public final class NetworkTestResultReport$PacketsStat$$serializer implements N<NetworkTestResultReport.PacketsStat> {
    ...
    public void serialize(@Y61.k Encoder encoder, @Y61.k NetworkTestResultReport.PacketsStat value) {
        ...
        dVarC.D(0, value.f332969a, f332717a);
        NetworkTestResultReport$IntWithPercent$$serializer networkTestResultReport$IntWithPercent$$serializer = NetworkTestResultReport$IntWithPercent$$serializer.INSTANCE;
        dVarC.F(f332717a, 1, networkTestResultReport$IntWithPercent$$serializer, value.f332970b);
        dVarC.F(f332717a, 2, networkTestResultReport$IntWithPercent$$serializer, value.f332971c);
        dVarC.F(f332717a, 3, networkTestResultReport$IntWithPercent$$serializer, value.f332972d);
        NetworkTestResultReport$Stats$$serializer networkTestResultReport$Stats$$serializer = NetworkTestResultReport$Stats$$serializer.INSTANCE;
        dVarC.F(f332717a, 4, networkTestResultReport$Stats$$serializer, value.f332973e);
        dVarC.F(f332717a, 5, networkTestResultReport$Stats$$serializer, value.f332974f);
        dVarC.F(f332717a, 6, networkTestResultReport$Stats$$serializer, value.f332975g);
        dVarC.d(f332717a);
    }
