...
final class l extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<InterfaceC49852b, G0> f166337l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public l(Y41.l<? super InterfaceC49852b, G0> lVar) {
        super(0);
        this.f166337l = lVar;
    }
    ...
    public final G0 invoke() {
        this.f166337l.invoke(InterfaceC49852b.f.f442346a);
        return G0.f406611a;
    }
}
