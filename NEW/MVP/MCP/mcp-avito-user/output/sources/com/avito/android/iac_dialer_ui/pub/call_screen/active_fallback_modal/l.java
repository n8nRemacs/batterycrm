...
final class l extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ Y41.l<List<Boolean>, G0> f166958l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public l(Y41.l<? super List<Boolean>, G0> lVar) {
        super(0);
        this.f166958l = lVar;
    }
    ...
    public final G0 invoke() {
        this.f166958l.invoke(Collections.singletonList(Boolean.TRUE));
        return G0.f406611a;
    }
}
