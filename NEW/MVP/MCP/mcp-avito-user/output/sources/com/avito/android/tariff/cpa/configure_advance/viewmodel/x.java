...
final class x<T> implements l41.g {
    ...
    public final /* synthetic */ q f294435b;
    ...
    public final void accept(Object obj) {
        P2 p22 = (P2) obj;
        q qVar = this.f294435b;
        qVar.getClass();
        boolean z12 = p22 instanceof P2.b;
        D<Boolean> d12 = qVar.f294420Z;
        if (z12) {
            d12.setValue(Boolean.FALSE);
            bC0.g gVar = (bC0.g) ((P2.b) p22).f318720a;
            qVar.f294410P.b(gVar.getDeeplink(), gVar.getSuccessFinishFlowUri());
            return;
        }
        ...
        if (p22 instanceof P2.a) {
            ...
            qVar.f294419Y.setValue(com.avito.android.error.z.k(((P2.a) p22).f318719a));
        }
    }
}
