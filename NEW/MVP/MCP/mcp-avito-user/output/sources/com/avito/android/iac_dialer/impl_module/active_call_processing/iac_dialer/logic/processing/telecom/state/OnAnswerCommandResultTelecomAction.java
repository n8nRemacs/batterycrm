...
import com.avito.android.iac_dialer.impl_module.active_call_processing.iac_dialer.logic.processing.incoming.accepting.AcceptAvCallsIncomingCallAction;
...
/* compiled from: OnAnswerCommandResultTelecomAction.kt */
@P
@s0
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u000b\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\t\b\u0087\b\u0018\u00002\u00020\u0001B%\u0012\n\u0010\u0004\u001a\u00060\u0002j\u0002`\u0003\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005\u0012\u0006\u0010\b\u001a\u00020\u0007¢\u0006\u0004\b\t\u0010\nJ\u0013\u0010\r\u001a\u00020\f*\u00020\u000bH\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u0014\u0010\u000f\u001a\u00060\u0002j\u0002`\u0003HÆ\u0003¢\u0006\u0004\b\u000f\u0010\u0010J\u0012\u0010\u0011\u001a\u0004\u0018\u00010\u0005HÆ\u0003¢\u0006\u0004\b\u0011\u0010\u0012J\u0010\u0010\u0013\u001a\u00020\u0007HÆ\u0003¢\u0006\u0004\b\u0013\u0010\u0014J4\u0010\u0015\u001a\u00020\u00002\f\b\u0002\u0010\u0004\u001a\u00060\u0002j\u0002`\u00032\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u00052\b\b\u0002\u0010\b\u001a\u00020\u0007HÆ\u0001¢\u0006\u0004\b\u0015\u0010\u0016J\u0010\u0010\u0017\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u0017\u0010\u0010J\u0010\u0010\u0019\u001a\u00020\u0018HÖ\u0001¢\u0006\u0004\b\u0019\u0010\u001aJ\u001a\u0010\u001d\u001a\u00020\u00072\b\u0010\u001c\u001a\u0004\u0018\u00010\u001bHÖ\u0003¢\u0006\u0004\b\u001d\u0010\u001eR\u001b\u0010\u0004\u001a\u00060\u0002j\u0002`\u00038\u0006¢\u0006\f\n\u0004\b\u0004\u0010\u001f\u001a\u0004\b \u0010\u0010R\u0019\u0010\u0006\u001a\u0004\u0018\u00010\u00058\u0006¢\u0006\f\n\u0004\b\u0006\u0010!\u001a\u0004\b\"\u0010\u0012R\u0017\u0010\b\u001a\u00020\u00078\u0006¢\u0006\f\n\u0004\b\b\u0010#\u001a\u0004\b\b\u0010\u0014¨\u0006$"}, d2 = {"Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/telecom/state/OnAnswerCommandResultTelecomAction;", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacAction;", "", "Lcom/avito/android/iac_dialer_models/abstract_module/CallId;", FailedBinderCallBack.CALLER_ID, "", "err", "", "isVideo", "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;Z)V", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;", "Lkotlin/G0;", "process", "(Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;)V", "component1", "()Ljava/lang/String;", "component2", "()Ljava/lang/Throwable;", "component3", "()Z", "copy", "(Ljava/lang/String;Ljava/lang/Throwable;Z)Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/telecom/state/OnAnswerCommandResultTelecomAction;", "toString", "", "hashCode", "()I", "", PluralsKeys.OTHER, "equals", "(Ljava/lang/Object;)Z", "Ljava/lang/String;", "getCallId", "Ljava/lang/Throwable;", "getErr", "Z", "_avito_iac-dialer_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes14.dex */
public final /* data */ class OnAnswerCommandResultTelecomAction implements IacAction {
    ...
    public OnAnswerCommandResultTelecomAction(@k String str, @l Throwable th2, boolean z12) {
        this.callId = str;
        this.err = th2;
        this.isVideo = z12;
    }

    public static /* synthetic */ OnAnswerCommandResultTelecomAction copy$default(OnAnswerCommandResultTelecomAction onAnswerCommandResultTelecomAction, String str, Throwable th2, boolean z12, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = onAnswerCommandResultTelecomAction.callId;
        }
        if ((i12 & 2) != 0) {
            th2 = onAnswerCommandResultTelecomAction.err;
        }
        if ((i12 & 4) != 0) {
            z12 = onAnswerCommandResultTelecomAction.isVideo;
        }
        return onAnswerCommandResultTelecomAction.copy(str, th2, z12);
    }
    ...
    @k
    public final OnAnswerCommandResultTelecomAction copy(@k String callId, @l Throwable err, boolean isVideo) {
        return new OnAnswerCommandResultTelecomAction(callId, err, isVideo);
    }
    ...
    public boolean equals(@l Object other) {
        ...
        if (!(other instanceof OnAnswerCommandResultTelecomAction)) {
            return false;
        }
        OnAnswerCommandResultTelecomAction onAnswerCommandResultTelecomAction = (OnAnswerCommandResultTelecomAction) other;
        return L.f(this.callId, onAnswerCommandResultTelecomAction.callId) && L.f(this.err, onAnswerCommandResultTelecomAction.err) && this.isVideo == onAnswerCommandResultTelecomAction.isVideo;
    }
    ...
    public int hashCode() {
        ...
        return Boolean.hashCode(this.isVideo) + ((iHashCode + (th2 == null ? 0 : th2.hashCode())) * 31);
    }
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        ...
        if (this.err != null) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new q("Error when answer in telecom", null));
            return;
        }
        ...
        CallInit callInitCopy$default = CallInit.copy$default(callInitA, CallInit.Telecom.Active.INSTANCE, null, false, null, false, null, null, WebSocketProtocol.PAYLOAD_SHORT, null);
        ...
        if ((iacActionProcessing.getState() instanceof IacState.InUse.Alive.Incoming.Resolving) && L.f(((IacState.InUse.Alive.Incoming.Resolving) iacActionProcessing.getState()).getCallId(), this.callId)) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), AcceptAvCallsIncomingCallAction.INSTANCE);
        } else {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new TerminateCallInAvCallsAndTelecomAction(getName(), this.callId, null, 4, null));
        }
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("OnAnswerCommandResultTelecomAction(callId=");
