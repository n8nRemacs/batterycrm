...
final class k extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ CrmPaidCvsFragment f130770l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ CvItem f130771m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(CrmPaidCvsFragment crmPaidCvsFragment, CvItem cvItem) {
        super(0);
        this.f130770l = crmPaidCvsFragment;
        this.f130771m = cvItem;
    }

    @Override // Y41.a
    public final G0 invoke() {
        CrmPaidCvsFragment.a aVar = CrmPaidCvsFragment.f130713C0;
        this.f130770l.r5().accept(new a.n(this.f130771m));
        return G0.f406611a;
    }
}
