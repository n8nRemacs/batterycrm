...
final class t extends N implements Y41.l<com.avito.android.lib.design.text_view.a, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ y.b f79612l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l<DeepLink, G0> f79613m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public t(y.b bVar, Y41.l<? super DeepLink, G0> lVar) {
        super(1);
        this.f79612l = bVar;
        this.f79613m = lVar;
    }
    ...
    public final G0 invoke(com.avito.android.lib.design.text_view.a aVar) {
        this.f79612l.f79634c.setOnDeepLinkClickListener(new x.a(this.f79613m));
        return G0.f406611a;
    }
}
