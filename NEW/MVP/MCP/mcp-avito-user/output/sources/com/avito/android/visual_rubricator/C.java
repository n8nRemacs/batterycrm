...
/* compiled from: TinyAllCatVisualRubricatorSpanProvider.kt */
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/avito/android/visual_rubricator/C;", "Lcom/avito/android/visual_rubricator/J;", "<init>", "()V", "_avito_bx-content_widget_visual-rubricator_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class C implements J {

    /* renamed from: a, reason: collision with root package name */
    @Y61.k
    public UV0.c f327274a = new UV0.c(C42784z0.f406748b);
    ...
    public /* synthetic */ class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final /* synthetic */ int[] f327275a;
    ...
    public final void c(@Y61.k UV0.a<VisualRubricatorWidgetElementItem> aVar) {
        this.f327274a = (UV0.c) aVar;
    }

    @Override // com.avito.android.serp.adapter.g1
    public final int d(int i12) {
        if (i12 < 0 || i12 >= this.f327274a.getCount()) {
            return 1;
        }
        int i13 = a.f327275a[((VisualRubricatorWidgetElementItem) this.f327274a.f16399b.get(i12)).getF327366i().ordinal()];
        if (i13 == 1) {
            return 9;
        }
        if (i13 == 2) {
