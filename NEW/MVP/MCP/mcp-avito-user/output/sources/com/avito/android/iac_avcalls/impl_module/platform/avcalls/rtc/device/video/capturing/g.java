...
final class g extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ f f164426l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ e f164427m;
    ...
    public final G0 invoke() {
        f.a aVar = f.f164419f;
        e eVar = this.f164427m;
        f fVar = this.f164426l;
        fVar.getClass();
        ((J) fVar.f164424d.f289247c).f332584a.K5(eVar.f164417a);
        fVar.f164425e = eVar;
        return G0.f406611a;
    }
}
