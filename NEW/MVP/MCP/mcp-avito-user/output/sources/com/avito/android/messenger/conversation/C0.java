...
public final class C0<T> implements InterfaceC23040h0 {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ ChannelFragment f188880b;

    public C0(ChannelFragment channelFragment) {
        this.f188880b = channelFragment;
    }
    ...
    public final void onChanged(T t12) {
        if (t12 != 0) {
            a.c cVar = (a.c) t12;
            SendMessagePresenter sendMessagePresenter = this.f188880b.f188939G0;
            if (sendMessagePresenter == null) {
                sendMessagePresenter = null;
            }
            sendMessagePresenter.vD(cVar);
        }
    }
}
