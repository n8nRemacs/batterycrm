...
public final class j extends N implements Y41.l<androidx.compose.ui.graphics.drawscope.d, G0> {
    ...
    public final /* synthetic */ r f296661l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.analytics.screens.compose.a f296662m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(r rVar, com.avito.android.analytics.screens.compose.a aVar) {
        super(1);
        this.f296661l = rVar;
        this.f296662m = aVar;
    }
    ...
    public final G0 invoke(androidx.compose.ui.graphics.drawscope.d dVar) {
        dVar.y1();
        com.avito.android.analytics.screens.compose.a aVar = this.f296662m;
        r rVar = this.f296661l;
        if (rVar != null) {
