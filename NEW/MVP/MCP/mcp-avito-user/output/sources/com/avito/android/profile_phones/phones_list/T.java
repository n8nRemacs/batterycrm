...
public final class T implements InterfaceC28898u {
    ...
    public final Class<?> a() {
        return PhonesListTabFragmentData.class;
    }
    ...
    public final TabBaseFragment b(@Y61.k TabFragmentFactory.Data data) {
        ...
        PhonesListFragment.f227380K0.getClass();
        PhonesListFragment phonesListFragment = new PhonesListFragment();
        Bundle bundle = new Bundle();
        bundle.putBoolean("default_ok", phonesListTabFragmentData.f227415b);
        bundle.putString("section_for_open", phonesListTabFragmentData.f227416c);
        phonesListFragment.setArguments(bundle);
