...
/* compiled from: BbipPrivateV2Title.kt */
...
public final class C {
    ...
    public static final void a(@Y61.l String str, @Y61.l androidx.compose.ui.v vVar, @Y61.l androidx.compose.runtime.A a12, int i12) {
        ...
        androidx.compose.runtime.B bE2 = a12.E(-2043751712);
        ...
        if ((i13 & 91) == 18 && bE2.c()) {
            ...
            b12 = bE2;
            com.akita.compose.foundation.ui.p.b(str, com.akita.compose.theme.re23.b.f63988f.f65231b, C22501m2.a(vVar, "BBIP_PRIVATE_V2_TITLE_TEST_TAG"), false, 0L, null, 0, 0, false, null, bE2, i13 & 14, 1016);
        }
        C22039c2 c22039c2Z2 = b12.Z();
        if (c22039c2Z2 != null) {
            c22039c2Z2.f38184d = new B(i12, vVar, str);
        }
    }
}
