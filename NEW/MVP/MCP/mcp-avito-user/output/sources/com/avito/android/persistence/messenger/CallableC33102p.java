...
/* renamed from: com.avito.android.persistence.messenger.p, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
class CallableC33102p implements Callable<List<Y>> {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ androidx.room.F0 f215528b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ X f215529c;

    public CallableC33102p(X x12, androidx.room.F0 f02) {
        this.f215529c = x12;
        this.f215528b = f02;
    }
    ...
    public final List<Y> call() throws Throwable {
        ...
        Long lValueOf;
        int i13;
        MessengerDatabase_Impl messengerDatabase_Impl = this.f215529c.f215334a;
        messengerDatabase_Impl.c();
        try {
            try {
                Cursor cursorB = V1.c.b(messengerDatabase_Impl, this.f215528b, false);
                try {
