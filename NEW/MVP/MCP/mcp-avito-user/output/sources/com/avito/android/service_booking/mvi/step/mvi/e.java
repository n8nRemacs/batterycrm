...
@DebugMetadata(c = "com.avito.android.service_booking.mvi.step.mvi.ServiceBookingMviStepActor$process$5", f = "ServiceBookingMviStepActor.kt", i = {}, l = {167}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class e extends SuspendLambda implements Y41.p<InterfaceC43172j<? super ServiceBookingMviStepInternalAction>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f274670q;

    /* renamed from: r, reason: collision with root package name */
    public /* synthetic */ Object f274671r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ ServiceBookingMviStepState f274672s;

    /* renamed from: t, reason: collision with root package name */
    public final /* synthetic */ InterfaceC14030a f274673t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(ServiceBookingMviStepState serviceBookingMviStepState, InterfaceC14030a interfaceC14030a, Continuation<? super e> continuation) {
        super(2, continuation);
        this.f274672s = serviceBookingMviStepState;
        this.f274673t = interfaceC14030a;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        e eVar = new e(this.f274672s, this.f274673t, continuation);
        eVar.f274671r = obj;
        return eVar;
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f274670q;
        if (i12 == 0) {
            C42729a0.b(obj);
            InterfaceC43172j interfaceC43172j = (InterfaceC43172j) this.f274671r;
            ServiceBookingMviStepState serviceBookingMviStepState = this.f274672s;
            ...
            if (serviceBookingContent != null && (srvBookingNextAction = serviceBookingContent.f274727i) != null) {
                ...
                C47438b c47438b = ((InterfaceC14030a.C0442a) this.f274673t).f7778a;
                String str = c47438b.f429397d;
                String str2 = c47438b.f429399f;
                if (str2 == null) {
                    str2 = "";
                }
