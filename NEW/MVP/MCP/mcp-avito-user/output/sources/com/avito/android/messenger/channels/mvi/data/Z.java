...
public final class Z<T1, T2, T3, R> implements l41.h {
    @Override // l41.h
    @Y61.k
    public final R a(@Y61.k T1 t12, @Y61.k T2 t22, @Y61.k T3 t32) {
        return (R) new C31709q((com.avito.android.persistence.messenger.Y) C42745f0.G((List) t12), (List) t22, (O1) C42745f0.G((List) t32));
    }
}
