...
final class l extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ StrSoftBookingFragment f282665l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(StrSoftBookingFragment strSoftBookingFragment) {
        super(1);
        this.f282665l = strSoftBookingFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        kotlin.reflect.n<Object>[] nVarArr = StrSoftBookingFragment.f282537y0;
        this.f282665l.q5().accept(new InterfaceC44950a.o(deepLink));
        return G0.f406611a;
    }
}
