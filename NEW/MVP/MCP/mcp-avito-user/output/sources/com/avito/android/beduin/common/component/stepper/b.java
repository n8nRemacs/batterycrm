...
final class b extends N implements Y41.l<Stepper, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ a f102719l;
    ...
    public final G0 invoke(Stepper stepper) {
        ...
        a aVar = this.f102719l;
        stepper2.setMinValue(aVar.f102714e.getMinValue());
        BeduinStepperModel beduinStepperModel = aVar.f102714e;
        stepper2.setMaxValue(beduinStepperModel.getMaxValue());
        stepper2.setValue(beduinStepperModel.getValue());
        return G0.f406611a;
    }
}
