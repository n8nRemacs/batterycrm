...
final class f extends N implements Y41.l<DeepLink, Boolean> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ TV0.a f225445l;
    ...
    public final Boolean invoke(DeepLink deepLink) {
        return Boolean.valueOf(!L.f(deepLink, ((com.avito.android.profile.user_profile.cards.service_booking.items.order.ServiceBookingItem) this.f225445l).f225459g));
    }
}
