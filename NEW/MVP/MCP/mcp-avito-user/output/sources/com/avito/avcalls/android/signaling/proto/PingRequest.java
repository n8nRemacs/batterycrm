...
public final /* data */ class PingRequest implements b {
    ...
    public final long f332121a;

    /* renamed from: b, reason: collision with root package name */
    @k
    public final String f332122b;

    /* renamed from: c, reason: collision with root package name */
    @k
    public final String f332123c;

    /* compiled from: Ping.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Lcom/avito/avcalls/android/signaling/proto/PingRequest$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/avito/avcalls/android/signaling/proto/PingRequest;", "sdk_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    public final b a(long j12) {
        return new PingRequest(j12, this.f332122b, this.f332123c);
    }
    ...
    public final boolean equals(@l Object obj) {
        ...
        return this.f332121a == pingRequest.f332121a && L.f(this.f332122b, pingRequest.f332122b) && L.f(this.f332123c, pingRequest.f332123c);
    }

    public final int hashCode() {
        return this.f332123c.hashCode() + H.d(Long.hashCode(this.f332121a) * 31, 31, this.f332122b);
    }

    @k
    public final String toString() {
        StringBuilder sb2 = new StringBuilder("PingRequest(sqn=");
        sb2.append(this.f332121a);
        sb2.append(", callId=");
        sb2.append(this.f332122b);
        sb2.append(", from=");
        return C22026a.c(sb2, this.f332123c, ')');
    }
