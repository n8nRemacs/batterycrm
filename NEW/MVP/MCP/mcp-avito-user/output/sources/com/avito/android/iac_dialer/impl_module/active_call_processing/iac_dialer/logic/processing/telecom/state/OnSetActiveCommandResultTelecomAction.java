...
/* compiled from: OnSetActiveCommandResultTelecomAction.kt */
@P
@s0
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0007\b\u0087\b\u0018\u00002\u00020\u0001B\u001d\u0012\n\u0010\u0004\u001a\u00060\u0002j\u0002`\u0003\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\u0007\u0010\bJ\u0013\u0010\u000b\u001a\u00020\n*\u00020\tH\u0016¢\u0006\u0004\b\u000b\u0010\fJ\u0014\u0010\r\u001a\u00060\u0002j\u0002`\u0003HÆ\u0003¢\u0006\u0004\b\r\u0010\u000eJ\u0012\u0010\u000f\u001a\u0004\u0018\u00010\u0005HÆ\u0003¢\u0006\u0004\b\u000f\u0010\u0010J*\u0010\u0011\u001a\u00020\u00002\f\b\u0002\u0010\u0004\u001a\u00060\u0002j\u0002`\u00032\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0005HÆ\u0001¢\u0006\u0004\b\u0011\u0010\u0012J\u0010\u0010\u0013\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u0013\u0010\u000eJ\u0010\u0010\u0015\u001a\u00020\u0014HÖ\u0001¢\u0006\u0004\b\u0015\u0010\u0016J\u001a\u0010\u001a\u001a\u00020\u00192\b\u0010\u0018\u001a\u0004\u0018\u00010\u0017HÖ\u0003¢\u0006\u0004\b\u001a\u0010\u001bR\u001b\u0010\u0004\u001a\u00060\u0002j\u0002`\u00038\u0006¢\u0006\f\n\u0004\b\u0004\u0010\u001c\u001a\u0004\b\u001d\u0010\u000eR\u0019\u0010\u0006\u001a\u0004\u0018\u00010\u00058\u0006¢\u0006\f\n\u0004\b\u0006\u0010\u001e\u001a\u0004\b\u001f\u0010\u0010¨\u0006 "}, d2 = {"Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/telecom/state/OnSetActiveCommandResultTelecomAction;", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacAction;", "", "Lcom/avito/android/iac_dialer_models/abstract_module/CallId;", FailedBinderCallBack.CALLER_ID, "", "err", "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;", "Lkotlin/G0;", "process", "(Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/core/IacActionProcessing;)V", "component1", "()Ljava/lang/String;", "component2", "()Ljava/lang/Throwable;", "copy", "(Ljava/lang/String;Ljava/lang/Throwable;)Lcom/avito/android/iac_dialer/impl_module/active_call_processing/iac_dialer/logic/processing/telecom/state/OnSetActiveCommandResultTelecomAction;", "toString", "", "hashCode", "()I", "", PluralsKeys.OTHER, "", "equals", "(Ljava/lang/Object;)Z", "Ljava/lang/String;", "getCallId", "Ljava/lang/Throwable;", "getErr", "_avito_iac-dialer_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes14.dex */
public final /* data */ class OnSetActiveCommandResultTelecomAction implements IacAction {
    ...
    public OnSetActiveCommandResultTelecomAction(@k String str, @l Throwable th2) {
        this.callId = str;
        this.err = th2;
    }

    public static /* synthetic */ OnSetActiveCommandResultTelecomAction copy$default(OnSetActiveCommandResultTelecomAction onSetActiveCommandResultTelecomAction, String str, Throwable th2, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = onSetActiveCommandResultTelecomAction.callId;
        }
        if ((i12 & 2) != 0) {
            th2 = onSetActiveCommandResultTelecomAction.err;
        }
        return onSetActiveCommandResultTelecomAction.copy(str, th2);
    }
    ...
    @k
    public final OnSetActiveCommandResultTelecomAction copy(@k String callId, @l Throwable err) {
        return new OnSetActiveCommandResultTelecomAction(callId, err);
    }
    ...
    public boolean equals(@l Object other) {
        ...
        if (!(other instanceof OnSetActiveCommandResultTelecomAction)) {
            return false;
        }
        OnSetActiveCommandResultTelecomAction onSetActiveCommandResultTelecomAction = (OnSetActiveCommandResultTelecomAction) other;
        return L.f(this.callId, onSetActiveCommandResultTelecomAction.callId) && L.f(this.err, onSetActiveCommandResultTelecomAction.err);
    }
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        ...
        if (!(iacActionProcessing.getState() instanceof IacState.InUse.Alive) || !L.f(((IacState.InUse.Alive) iacActionProcessing.getState()).getCallId(), this.callId)) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new TerminateCallInAvCallsAndTelecomAction(getName(), this.callId, null, 4, null));
        } else if (this.err == null && (iacActionProcessing.getState() instanceof IacState.InUse.Alive.Outgoing.Waiting) && L.f(callInitA.getAvCalls(), InvitingState.Allocated.INSTANCE)) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.AvCalls.StartOutgoingCall(this.callId));
        }
    }

    @k
    public String toString() {
        StringBuilder sb2 = new StringBuilder("OnSetActiveCommandResultTelecomAction(callId=");
        sb2.append(this.callId);
        sb2.append(", err=");
        return com.avito.android.advert.item.delivery_suggests.l.t(sb2, this.err, ')');
    }
}
