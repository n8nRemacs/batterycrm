...
/* renamed from: com.avito.android.messenger.conversation.mvi.sync.u, reason: case insensitive filesystem */
/* loaded from: classes15.dex */
public final class C32290u<T, R> implements l41.o {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ List f194848b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ C32275m f194849c;

    public C32290u(C32275m c32275m, List list) {
        this.f194848b = list;
        this.f194849c = c32275m;
    }
    ...
    public final Object apply(Object obj) {
        Map map = (Map) obj;
        List<C32275m.a> list = this.f194848b;
        ...
        for (C32275m.a aVar : list) {
            ...
            while (it.hasNext()) {
                ...
                if (image instanceof MessageBody.SystemMessageBody.Platform.Bubble.Image) {
                    ...
                    if (image2 != null) {
                        image = new MessageBody.SystemMessageBody.Platform.Bubble.Image(image.getImageId(), this.f194849c.f194809b.e(image2).getImage());
                    }
                }
                arrayList2.add(image);
            }
            arrayList.add(aVar.b(new MessageBody.SystemMessageBody.Platform.FromUser(arrayList2, platform.getContextActions(), platform.getFlow(), platform.getFallbackText(), null, 16, null)));
        }
        return arrayList;
    }
}
