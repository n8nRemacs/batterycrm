...
final class k extends N implements Y41.l<com.avito.android.lib.design.text_view.a, G0> {
    ...
    public final /* synthetic */ y.a f79588l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y41.l<DeepLink, G0> f79589m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public k(y.a aVar, Y41.l<? super DeepLink, G0> lVar) {
        super(1);
        this.f79588l = aVar;
        this.f79589m = lVar;
    }
    ...
    public final G0 invoke(com.avito.android.lib.design.text_view.a aVar) {
        this.f79588l.f79631c.setOnDeepLinkClickListener(new x.a(this.f79589m));
        return G0.f406611a;
    }
}
