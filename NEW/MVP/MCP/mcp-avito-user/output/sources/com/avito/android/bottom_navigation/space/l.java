...
public final class l extends N implements Y41.a<S0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ androidx.view.n f107084l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(androidx.view.n nVar) {
        super(0);
        this.f107084l = nVar;
    }
    ...
    public final S0 invoke() {
        return this.f107084l.getF42820b();
    }
}
