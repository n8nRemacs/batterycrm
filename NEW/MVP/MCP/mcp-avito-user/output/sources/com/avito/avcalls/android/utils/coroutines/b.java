...
public final class b extends AbstractCoroutineContextElement implements N {
    ...
    public final /* synthetic */ c f332435b;
    ...
    public final void handleException(@k CoroutineContext coroutineContext, @k Throwable th2) {
        g.Companion.b(com.avito.avcalls.android.logger.g.INSTANCE, "AvCalls.ExceptionHandler", "Exception in " + coroutineContext.get(S.f410719c) + ", message=" + th2.getMessage());
        c cVar = this.f332435b;
        C43259k.d(cVar, cVar.f332436b, null, new a(cVar, th2, null), 2);
    }
}
