...
final class c extends N implements Y41.l<ToggleOptionItem, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ b f281708l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ToggleOptionsItem f281709m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(b bVar, ToggleOptionsItem toggleOptionsItem) {
        super(1);
        this.f281708l = bVar;
        this.f281709m = toggleOptionsItem;
    }

    @Override // Y41.l
    public final G0 invoke(ToggleOptionItem toggleOptionItem) {
        ToggleOptionItem toggleOptionItem2 = toggleOptionItem;
        r<String, String, a.r.InterfaceC8403a, Boolean, G0> rVar = this.f281708l.f281707b;
        ToggleOptionsItem toggleOptionsItem = this.f281709m;
