...
final class u extends N implements Y41.l<Float, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ p f284832l;
    ...
    public final G0 invoke(Float f12) {
        ...
        p pVar = this.f284832l;
        ViewGroup.LayoutParams layoutParams = pVar.f284823b.getLayoutParams();
        layoutParams.height = (int) fFloatValue;
        pVar.f284823b.setLayoutParams(layoutParams);
        return G0.f406611a;
    }
}
