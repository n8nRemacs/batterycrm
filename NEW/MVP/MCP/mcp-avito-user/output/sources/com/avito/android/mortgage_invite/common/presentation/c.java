...
final class c extends N implements l<String, G0> {
    ...
    public final /* synthetic */ p<ContactInfoFieldId, String, G0> f205549l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ Y10.b f205550m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(Y10.b bVar, p pVar) {
        super(1);
        this.f205549l = pVar;
        this.f205550m = bVar;
    }
    ...
    public final G0 invoke(String str) {
        ContactInfoFieldId contactInfoFieldId = this.f205550m.f19261a;
        this.f205549l.invoke(contactInfoFieldId, str);
        return G0.f406611a;
    }
}
