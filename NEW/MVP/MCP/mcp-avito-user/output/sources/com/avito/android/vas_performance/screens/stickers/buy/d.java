...
final class d extends N implements l<DeepLink, G0> {
    ...
    public final /* synthetic */ StickersBuyFragment f320616l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(StickersBuyFragment stickersBuyFragment) {
        super(1);
        this.f320616l = stickersBuyFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f320616l.f320595w0;
        if (aVar == null) {
            aVar = null;
        }
