...
final class h extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ Y41.l<InterfaceC13146a, G0> f99548l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public h(Y41.l<? super InterfaceC13146a, G0> lVar) {
        super(1);
        this.f99548l = lVar;
    }
    ...
    public final G0 invoke(DeepLink deepLink) {
        this.f99548l.invoke(new InterfaceC13146a.C0066a(deepLink));
        return G0.f406611a;
    }
}
