...
@DebugMetadata(c = "com.avito.android.comfortable_deal.deal.mvi.DealActor$process$9", f = "DealActor.kt", i = {0}, l = {303, 187}, m = "invokeSuspend", n = {"$this$flow"}, s = {"L$0"})
/* loaded from: classes12.dex */
final class r extends SuspendLambda implements Y41.p<InterfaceC43172j<? super DealInternalAction>, Continuation<? super G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f121709q;

    /* renamed from: r, reason: collision with root package name */
    public /* synthetic */ Object f121710r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ C29453a f121711s;
    ...
    @DebugMetadata(c = "com.avito.android.comfortable_deal.deal.mvi.DealActor$process$9$invokeSuspend$$inlined$doOnMainThread$1", f = "DealActor.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    public static final class a extends SuspendLambda implements Y41.p<T, Continuation<? super G0>, Object> {

        /* renamed from: q, reason: collision with root package name */
        public final /* synthetic */ C29453a f121712q;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(C29453a c29453a, Continuation continuation) {
            super(2, continuation);
            this.f121712q = c29453a;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @Y61.k
        public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
            return new a(this.f121712q, continuation);
        }
        ...
        public final Object invokeSuspend(@Y61.k Object obj) {
            ...
            C42729a0.b(obj);
            this.f121712q.f121580a.pause();
            return G0.f406611a;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(C29453a c29453a, Continuation<? super r> continuation) {
        super(2, continuation);
        this.f121711s = c29453a;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        r rVar = new r(this.f121711s, continuation);
        rVar.f121710r = obj;
        return rVar;
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f121709q;
        if (i12 == 0) {
            C42729a0.b(obj);
            interfaceC43172j = (InterfaceC43172j) this.f121710r;
            C29453a c29453a = this.f121711s;
            AbstractC43129d1 abstractC43129d1D = c29453a.f121583d.d();
            a aVar = new a(c29453a, null);
            this.f121710r = interfaceC43172j;
            this.f121709q = 1;
        ...
        DealInternalAction.Close close = DealInternalAction.Close.f121604b;
        this.f121710r = null;
        this.f121709q = 2;
