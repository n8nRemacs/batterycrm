...
final class n extends N implements Y41.l<Q<? extends String, ? extends Boolean>, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ h f84224l;
    ...
    public final G0 invoke(Q<? extends String, ? extends Boolean> q12) {
        ...
        h hVar = this.f84224l;
        if (zBooleanValue) {
            hVar.f84212g.add(str);
        } else {
            hVar.f84212g.remove(str);
        }
        ListItemSwitcher listItemSwitcher = (ListItemSwitcher) hVar.f84211f.get(str);
        if (listItemSwitcher != null) {
            listItemSwitcher.setLoading(zBooleanValue);
        }
        return G0.f406611a;
    }
}
