...
/* compiled from: DeliveryTogglesSlotValue.kt */
@d
...
public final /* data */ class DeliveryTogglesSlotValue implements SlotValue {
    ...
    public static final class Creator implements Parcelable.Creator<DeliveryTogglesSlotValue> {
        ...
        public final DeliveryTogglesSlotValue createFromParcel(@k Parcel parcel) {
            ...
            return new DeliveryTogglesSlotValue(boolValueOf, boolValueOf2, boolValueOf3);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        @k
        public final DeliveryTogglesSlotValue[] newArray(int i12) {
            return new DeliveryTogglesSlotValue[i12];
        }
    }
    ...
    public static /* synthetic */ DeliveryTogglesSlotValue copy$default(DeliveryTogglesSlotValue deliveryTogglesSlotValue, Boolean bool, Boolean bool2, Boolean bool3, int i12, Object obj) {
        if ((i12 & 1) != 0) {
    ...
    public boolean equals(@l Object other) {
        ...
        return L.f(this.pvz, deliveryTogglesSlotValue.pvz) && L.f(this.courier, deliveryTogglesSlotValue.courier) && L.f(this.postamat, deliveryTogglesSlotValue.postamat);
    }
