...
final class G0 extends kotlin.jvm.internal.N implements Y41.l<androidx.compose.ui.layout.A, kotlin.G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ InterfaceC22204y1<l0.j> f204141l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public G0(InterfaceC22204y1<l0.j> interfaceC22204y1) {
        super(1);
        this.f204141l = interfaceC22204y1;
    }

    @Override // Y41.l
    public final kotlin.G0 invoke(androidx.compose.ui.layout.A a12) {
        this.f204141l.setValue(androidx.compose.ui.layout.B.b(a12));
