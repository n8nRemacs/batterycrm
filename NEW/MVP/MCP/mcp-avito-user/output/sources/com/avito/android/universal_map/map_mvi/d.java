...
final class d extends N implements l<AbstractC47541a, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ UniversalMapFragmentMvi f306027l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(UniversalMapFragmentMvi universalMapFragmentMvi) {
        super(1);
        this.f306027l = universalMapFragmentMvi;
    }

    @Override // Y41.l
    public final G0 invoke(AbstractC47541a abstractC47541a) {
        UniversalMapFragmentMvi.a aVar = UniversalMapFragmentMvi.f305959P0;
        this.f306027l.q5().accept(abstractC47541a);
        return G0.f406611a;
    }
}
