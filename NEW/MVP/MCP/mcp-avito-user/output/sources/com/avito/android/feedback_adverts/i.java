...
final class i<T, R> implements l41.o {
    ...
    public final /* synthetic */ g.c f157835b;
    ...
    public final Object apply(Object obj) {
        List list = (List) obj;
        g.c cVar = this.f157835b;
        C35995v2 f157826b = cVar.getF157826b();
        List<InterfaceC44788a> list2 = cVar.getF157827c().f157818a;
        ...
        return new g.c.C4611c(f157826b, new g.b(C42745f0.h0(arrayList, list2), list.size() == 20), null, 4, null);
    }
}
