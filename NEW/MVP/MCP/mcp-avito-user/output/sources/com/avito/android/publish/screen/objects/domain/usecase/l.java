...
final class l extends N implements Y41.l<String, G0> {
    ...
    public final /* synthetic */ SafeContinuation f240120l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(SafeContinuation safeContinuation) {
        super(1);
        this.f240120l = safeContinuation;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        int i12 = Z.f406624c;
        this.f240120l.resumeWith(ObjectFillFormInternalAction.NavigateToAuth.f240200b);
        return G0.f406611a;
    }
}
