...
final class z extends kotlin.jvm.internal.N implements Y41.a<G0> {
    ...
    public final /* synthetic */ MortgageCalculatorView f204854l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z(MortgageCalculatorView mortgageCalculatorView) {
        super(0);
        this.f204854l = mortgageCalculatorView;
    }

    @Override // Y41.a
    public final G0 invoke() {
        this.f204854l.getViewModel().accept(b.d.c.f204573b);
        return G0.f406611a;
    }
}
