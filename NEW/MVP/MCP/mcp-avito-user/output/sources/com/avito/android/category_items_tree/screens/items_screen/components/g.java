...
final class g extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f116854l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f116854l | 1);
        androidx.compose.runtime.B bE2 = a12.E(370525007);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            y.f116918a.getClass();
            com.akita.compose.theme.re23.c.a(false, y.f116919b, bE2, 48, 1);
        }
