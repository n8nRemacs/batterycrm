...
final class p<T> implements l41.g {
    ...
    public final /* synthetic */ q f310753b;
    ...
    public final void accept(Object obj) {
        ...
        q qVar = this.f310753b;
        if (z12) {
            qVar.j(new MyAdvertLink.Delete.b.a(((P2.a) p22).f318719a));
        } else if (p22 instanceof P2.b) {
            qVar.j(new MyAdvertLink.Delete.b.C4008b((SuccessResult) ((P2.b) p22).f318720a));
        } else {
