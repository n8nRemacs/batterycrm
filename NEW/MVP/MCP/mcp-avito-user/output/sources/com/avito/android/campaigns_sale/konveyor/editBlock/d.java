...
final class d extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ k f113975l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ C40705b f113976m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(k kVar, C40705b c40705b) {
        super(1);
        this.f113975l = kVar;
        this.f113976m = c40705b;
    }

    @Override // Y41.l
    public final G0 invoke(Integer num) {
        k kVar = this.f113975l;
        String str = this.f113976m.f396773b;
        kVar.f113989b.invoke(new InterfaceC41424a.j(kVar.f113990c.a(num, str)));
        return G0.f406611a;
    }
}
