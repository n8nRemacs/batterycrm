...
final class i extends N implements Y41.p<ContactInfoFieldId, Boolean, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ApplicationContactInfoFragment f205663l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(ApplicationContactInfoFragment applicationContactInfoFragment) {
        super(2);
        this.f205663l = applicationContactInfoFragment;
    }
    ...
    public final G0 invoke(ContactInfoFieldId contactInfoFieldId, Boolean bool) {
        ...
        this.f205663l.q5().accept(new InterfaceC25394a.d(contactInfoFieldId, zBooleanValue));
        return G0.f406611a;
    }
}
