...
final class f extends N implements l<Boolean, G0> {
    ...
    public final /* synthetic */ g.a f272361l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ SnippetItem f272362m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(g.a aVar, SnippetItem snippetItem) {
        super(1);
        this.f272361l = aVar;
        this.f272362m = snippetItem;
    }
    ...
    public final G0 invoke(Boolean bool) {
        Boolean bool2 = bool;
        bool2.booleanValue();
        this.f272361l.f272365d.accept(new Q<>(this.f272362m, bool2));
        return G0.f406611a;
    }
}
