...
final class k extends N implements Y41.l<P2<?>, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ ConstructorConfigureSubCategoryFragment f300482l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(ConstructorConfigureSubCategoryFragment constructorConfigureSubCategoryFragment) {
        super(1);
        this.f300482l = constructorConfigureSubCategoryFragment;
    }
    ...
    public final G0 invoke(P2<?> p22) {
        ...
        ConstructorConfigureSubCategoryFragment constructorConfigureSubCategoryFragment = this.f300482l;
        if (z12) {
            ConstructorConfigureSubCategoryFragment.a aVar = ConstructorConfigureSubCategoryFragment.f300415C0;
            constructorConfigureSubCategoryFragment.r5().k(null);
            ...
            constructorConfigureSubCategoryFragment.r5().a("");
        } else if (p23 instanceof P2.b) {
            ConstructorConfigureSubCategoryFragment.a aVar3 = ConstructorConfigureSubCategoryFragment.f300415C0;
            constructorConfigureSubCategoryFragment.r5().j();
        }
        return G0.f406611a;
    }
}
