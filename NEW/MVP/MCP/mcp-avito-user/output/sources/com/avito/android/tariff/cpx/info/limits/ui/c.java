...
final class c extends N implements Y41.l<Integer, G0> {
    ...
    public final /* synthetic */ Y41.l<InterfaceC49191a, G0> f296630l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public c(Y41.l<? super InterfaceC49191a, G0> lVar) {
        super(1);
        this.f296630l = lVar;
    }
    ...
    public final G0 invoke(Integer num) {
        this.f296630l.invoke(new InterfaceC49191a.c(num.intValue()));
        return G0.f406611a;
    }
}
