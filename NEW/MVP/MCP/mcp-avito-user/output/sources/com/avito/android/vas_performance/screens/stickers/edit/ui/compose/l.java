...
final class l extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ InterfaceC22204y1 f320905l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(InterfaceC22204y1 interfaceC22204y1) {
        super(1);
        this.f320905l = interfaceC22204y1;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        ((Y41.l) this.f320905l.getF42167b()).invoke(deepLink);
        return G0.f406611a;
    }
}
