...
final class a extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ SaveDialog f122632l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(SaveDialog saveDialog) {
        super(0);
        this.f122632l = saveDialog;
    }

    @Override // Y41.a
    public final G0 invoke() {
        SaveDialog.a aVar = SaveDialog.f122629h0;
        SaveDialog saveDialog = this.f122632l;
        boolean z12 = !saveDialog.f5().f122640h;
        FragmentManager parentFragmentManager = saveDialog.getParentFragmentManager();
        SaveArguments saveArgumentsF5 = saveDialog.f5();
        Bundle bundle = new Bundle();
        bundle.putBoolean("result.key", z12);
        G0 g02 = G0.f406611a;
        parentFragmentManager.o0(bundle, saveArgumentsF5.f122634b);
        saveDialog.dismiss();
        return G0.f406611a;
    }
}
