...
final class e extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ VinScannerFragment f239475l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(VinScannerFragment vinScannerFragment) {
        super(0);
        this.f239475l = vinScannerFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        VinScannerFragment.a aVar = VinScannerFragment.f239432D0;
        this.f239475l.t5().accept(InterfaceC13390a.b.f3312a);
        return G0.f406611a;
    }
}
