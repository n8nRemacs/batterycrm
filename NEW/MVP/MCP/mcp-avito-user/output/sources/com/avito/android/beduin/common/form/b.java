...
final class b extends N implements Y41.l<BeduinModel, List<? extends BeduinModel>> {
    ...
    public final /* synthetic */ Map<String, List<BeduinModelTransform>> f103332l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public b(Map<String, ? extends List<? extends BeduinModelTransform>> map) {
        super(1);
        this.f103332l = map;
    }
    ...
    public final List<? extends BeduinModel> invoke(BeduinModel beduinModel) {
        ...
        List<BeduinModelTransform> list = this.f103332l.get(beduinModel2.getId());
        if (list != null) {
