...
final class F extends SuspendLambda implements Y41.p<G0, Continuation<? super G0>, Object> {
    ...
    public final /* synthetic */ A f149336q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public F(A a12, Continuation<? super F> continuation) {
    ...
    public final Continuation<G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new F(this.f149336q, continuation);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        C42729a0.b(obj);
        this.f149336q.f149244d.accept(InterfaceC40265a.j.f395724a);
        return G0.f406611a;
    }
}
