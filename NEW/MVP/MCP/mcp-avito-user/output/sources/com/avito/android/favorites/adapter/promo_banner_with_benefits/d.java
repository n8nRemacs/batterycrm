...
final class d extends N implements l<String, G0> {
    ...
    public final /* synthetic */ g f156734l;
    ...
    public final G0 invoke(String str) {
        Bundle bundleB = C22777e.b(new Q("recalldeeplink.placement", "middle"), new Q("recalldeeplink.pagetype", "favorites"), new Q("recalldeeplink.banner_name", "rre_trx_favorites_2024_v2"));
        g gVar = this.f156734l;
        gVar.f156738b.s(new PpRecallDeeplink("", str, "favorites"), bundleB);
        return G0.f406611a;
    }
}
