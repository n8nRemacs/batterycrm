...
final class f extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ PassportOnboardingActivity f213572l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(PassportOnboardingActivity passportOnboardingActivity) {
        super(0);
        this.f213572l = passportOnboardingActivity;
    }

    @Override // Y41.a
    public final G0 invoke() {
        PassportOnboardingActivity.a aVar = PassportOnboardingActivity.f213545v;
        this.f213572l.b2().accept(InterfaceC40776a.c.f396999a);
        return G0.f406611a;
    }
}
