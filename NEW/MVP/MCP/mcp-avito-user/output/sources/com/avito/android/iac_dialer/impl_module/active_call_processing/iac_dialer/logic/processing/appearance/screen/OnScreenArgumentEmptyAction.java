...
public final /* data */ class OnScreenArgumentEmptyAction implements IacAction {
    ...
    public void process(@k IacActionProcessing iacActionProcessing) {
        iacActionProcessing.plusAssign(iacActionProcessing.getOut(), new IacEvent.Analytics.TrackStatsdCount("calls", "{{%app_ver%}}", "empty_screen_argument_error"));
        if (iacActionProcessing.getState() instanceof IacState.Idle) {
            iacActionProcessing.plusAssign(iacActionProcessing.getOut(), IacEvent.CallScreen.CloseScreenAfterUnsuitableEmptyArgument.INSTANCE);
        }
    }

    @k
    public String toString() {
        return "OnScreenArgumentEmptyAction";
    }
}
