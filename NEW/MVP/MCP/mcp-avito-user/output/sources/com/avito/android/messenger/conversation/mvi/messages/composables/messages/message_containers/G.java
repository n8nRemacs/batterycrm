...
final class G extends N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
    ...
    public final /* synthetic */ int f192283l;
    ...
    public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
        num.intValue();
        int iA2 = C22066f2.a(this.f192283l | 1);
        kotlin.reflect.n<Object>[] nVarArr = v.f192445a;
        androidx.compose.runtime.B bE2 = a12.E(1489892079);
        if (iA2 == 0 && bE2.c()) {
            bE2.f();
        } else {
            C32134c.f192323a.getClass();
            com.akita.compose.theme.re23.c.a(false, C32134c.f192329g, bE2, 48, 1);
        }
