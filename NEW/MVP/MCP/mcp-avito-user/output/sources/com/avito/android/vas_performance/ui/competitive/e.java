...
final class e extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ CompetitiveVasFragment f321485l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(CompetitiveVasFragment competitiveVasFragment) {
        super(1);
        this.f321485l = competitiveVasFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f321485l.f321472t0;
        if (aVar == null) {
            aVar = null;
        }
