...
/* renamed from: com.avito.android.tariff_lf_publication.level.ui.b, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
final class C35230b extends N implements Y41.p<Integer, InterfaceC27333b, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Y41.l<UD0.a, G0> f300959l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public C35230b(Y41.l<? super UD0.a, G0> lVar) {
        super(2);
        this.f300959l = lVar;
    }
    ...
    public final G0 invoke(Integer num, InterfaceC27333b interfaceC27333b) {
        ...
        c.b bVar = interfaceC27333b2 instanceof c.b ? (c.b) interfaceC27333b2 : null;
        Long lValueOf = bVar != null ? Long.valueOf(bVar.f16288d) : null;
        if (lValueOf != null) {
            this.f300959l.invoke(new a.d(lValueOf.longValue()));
        }
        return G0.f406611a;
    }
}
