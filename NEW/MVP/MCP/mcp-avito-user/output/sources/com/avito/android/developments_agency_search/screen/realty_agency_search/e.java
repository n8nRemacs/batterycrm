...
final class e extends N implements Y41.l<com.avito.android.developments_agency_search.adapter.checkable_item.a, G0> {
    ...
    public final /* synthetic */ RealtyAgencySearchFragment f138643l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(RealtyAgencySearchFragment realtyAgencySearchFragment) {
        super(1);
        this.f138643l = realtyAgencySearchFragment;
    }

    @Override // Y41.l
    public final G0 invoke(com.avito.android.developments_agency_search.adapter.checkable_item.a aVar) {
        DevelopmentSort developmentSortValueOf = DevelopmentSort.valueOf(aVar.f136215b);
        RealtyAgencySearchFragment.a aVar2 = RealtyAgencySearchFragment.f138222V0;
        this.f138643l.D5().accept(new InterfaceC14443a.k(developmentSortValueOf));
        return G0.f406611a;
    }
}
