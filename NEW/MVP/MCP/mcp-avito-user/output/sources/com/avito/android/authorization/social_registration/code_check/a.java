...
final class a extends N implements Y41.l<Phone, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ b f94585l;
    ...
    public final G0 invoke(Phone phone) {
        ...
        b bVar = this.f94585l;
        bVar.f94589e.c(new n());
        bVar.f94589e.c(new C19873a(str, CodeConfirmationSource.f92766n));
        return G0.f406611a;
    }
}
