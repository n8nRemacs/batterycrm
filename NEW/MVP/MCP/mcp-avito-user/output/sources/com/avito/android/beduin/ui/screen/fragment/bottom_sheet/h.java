...
final class h extends N implements Y41.l<List<? extends BeduinAction>, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ BottomSheetScreenFragment f104188l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(BottomSheetScreenFragment bottomSheetScreenFragment) {
        super(1);
        this.f104188l = bottomSheetScreenFragment;
    }

    @Override // Y41.l
    public final G0 invoke(List<? extends BeduinAction> list) {
        this.f104188l.q5().ke(list);
        return G0.f406611a;
    }
}
