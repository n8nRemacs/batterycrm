...
final class i extends N implements Y41.l<DeepLink, G0> {
    ...
    public final /* synthetic */ StickersBuyVasFragment f321954l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(StickersBuyVasFragment stickersBuyVasFragment) {
        super(1);
        this.f321954l = stickersBuyVasFragment;
    }

    @Override // Y41.l
    public final G0 invoke(DeepLink deepLink) {
        DeepLink deepLink2 = deepLink;
        com.avito.android.deeplink_handler.handler.composite.a aVar = this.f321954l.f321940w0;
        if (aVar == null) {
            aVar = null;
        }
