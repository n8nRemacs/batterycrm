...
public final class C {
    ...
    @Y61.k
    public static final C f288155a = new C();

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public static final C22096n f288156b = new C22096n(1238573821, a.f288157l, false);
    ...
    public static final class a extends kotlin.jvm.internal.N implements Y41.p<androidx.compose.runtime.A, Integer, G0> {
        ...
        public static final a f288157l = new a();
        ...
        public final G0 invoke(androidx.compose.runtime.A a12, Integer num) {
            ...
            if ((num.intValue() & 11) == 2 && a13.c()) {
                ...
                y0.a("Правила отмены", "Для всех дат в календаре", B.f288154l, a13, 438);
            }
            return G0.f406611a;
        }
    }
