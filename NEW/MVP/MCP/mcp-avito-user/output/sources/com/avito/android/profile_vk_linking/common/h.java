...
final class h extends N implements l<View, G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ VkPopupView f231002l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(VkPopupView vkPopupView) {
        super(1);
        this.f231002l = vkPopupView;
    }

    @Override // Y41.l
    public final G0 invoke(View view) {
        Y41.a<G0> aVar = this.f231002l.f230930d;
        if (aVar != null) {
            aVar.invoke();
        }
        return G0.f406611a;
