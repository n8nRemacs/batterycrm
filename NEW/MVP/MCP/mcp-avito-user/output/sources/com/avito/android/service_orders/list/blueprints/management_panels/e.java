...
final class e extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ g f279318l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ com.avito.android.service_orders.list.blueprints.f f279319m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(g gVar, com.avito.android.service_orders.list.blueprints.f fVar) {
        super(0);
        this.f279318l = gVar;
        this.f279319m = fVar;
    }
    ...
    public final G0 invoke() {
        l lVar = this.f279318l.f279322b;
        if (lVar != null) {
            f.a aVar = this.f279319m.f279305e;
