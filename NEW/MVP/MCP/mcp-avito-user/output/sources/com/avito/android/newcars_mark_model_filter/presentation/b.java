...
final class b extends N implements l<String, G0> {
    ...
    public final /* synthetic */ NewCarsBrandModelFilterFragment f207305l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(NewCarsBrandModelFilterFragment newCarsBrandModelFilterFragment) {
        super(1);
        this.f207305l = newCarsBrandModelFilterFragment;
    }

    @Override // Y41.l
    public final G0 invoke(String str) {
        NewCarsBrandModelFilterFragment.a aVar = NewCarsBrandModelFilterFragment.f207276u0;
        this.f207305l.f5().accept(new InterfaceC44575a.f(str));
        return G0.f406611a;
    }
}
