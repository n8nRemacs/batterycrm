...
/* compiled from: BusinessVrfDuplicationFeatureBuilder.kt */
...
final class h extends N implements Y41.l<q<Z50.a, BusinessVrfDuplicationInternalAction, Z50.c, Z50.b>, G0> {
    ...
    public final /* synthetic */ f f212560l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ a f212561m;

    /* renamed from: n, reason: collision with root package name */
    public final /* synthetic */ ScreenPerformanceTracker f212562n;

    /* renamed from: o, reason: collision with root package name */
    public final /* synthetic */ m f212563o;

    /* renamed from: p, reason: collision with root package name */
    public final /* synthetic */ k f212564p;
    ...
    public h(f fVar, a aVar, ScreenPerformanceTracker screenPerformanceTracker, m mVar, k kVar) {
        ...
        this.f212560l = fVar;
        this.f212561m = aVar;
        this.f212562n = screenPerformanceTracker;
        this.f212563o = mVar;
        this.f212564p = kVar;
    }
    ...
    public final G0 invoke(q<Z50.a, BusinessVrfDuplicationInternalAction, Z50.c, Z50.b> qVar) {
        ...
        qVar2.f92008d = this.f212560l;
        qVar2.f92009e = this.f212561m;
        qVar2.f92011g = new com.avito.android.analytics.screens.mvi.o(this.f212562n, this.f212563o);
        qVar2.f92010f = this.f212564p;
