...
final class d extends N implements Y41.a<G0> {
    ...
    public final /* synthetic */ VerificationPopupFragment f212238l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(VerificationPopupFragment verificationPopupFragment) {
        super(0);
        this.f212238l = verificationPopupFragment;
    }

    @Override // Y41.a
    public final G0 invoke() {
        VerificationPopupFragment.a aVar = VerificationPopupFragment.f212207x0;
        this.f212238l.t5().accept(a.b.f17739a);
        return G0.f406611a;
    }
}
