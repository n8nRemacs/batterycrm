...
public class ReferrerDetails {
    ...
    public ReferrerDetails(String str, long j12, long j13) {
        this(str, j12, j13, -1L, -1L, null, null, null);
    }
    ...
    public ReferrerDetails(String str, long j12, long j13, long j14, long j15, String str2, Boolean bool, Boolean bool2) {
        this.installReferrer = str;
        this.referrerClickTimestampSeconds = j12;
        this.installBeginTimestampSeconds = j13;
        this.referrerClickTimestampServerSeconds = j14;
        this.installBeginTimestampServerSeconds = j15;
        this.installVersion = str2;
        this.googlePlayInstant = bool;
        this.isClick = bool2;
    }

    public ReferrerDetails(String str, long j12, Boolean bool) {
        this(str, j12, -1L, -1L, -1L, null, null, bool);
    }
}
