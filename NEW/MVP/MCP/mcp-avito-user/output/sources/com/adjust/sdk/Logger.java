...
public class Logger implements ILogger {
    ...
    @Override // com.adjust.sdk.ILogger
    public void setLogLevel(LogLevel logLevel, boolean z12) {
        if (this.logLevelLocked) {
            return;
        }
        this.logLevel = logLevel;
        this.isProductionEnvironment = z12;
    }

    @Override // com.adjust.sdk.ILogger
    public void setLogLevelString(String str, boolean z12) {
        if (str != null) {
            try {
                setLogLevel(LogLevel.valueOf(str.toUpperCase(Locale.US)), z12);
