...
class DeviceInfo {
    ...
    public static class UtilDeviceIds {
        ...
        public static int getConnectivityType(Context context, ILogger iLogger) {
            ...
            try {
                ...
                iLogger.warn("Couldn't read connectivity type (%s)", e12.getMessage());
            }
        ...
        public static void getFireAdvertisingIdAsync(ContentResolver contentResolver, OnAmazonAdIdReadListener onAmazonAdIdReadListener) {
            ...
            try {
                ...
                AdjustFactory.getLogger().error(e12.getMessage(), new Object[0]);
            }
        }
    ...
    public DeviceInfo(AdjustConfig adjustConfig) {
        ...
        int i12 = configuration.screenLayout;
        ...
        this.screenSize = getScreenSize(i12);
        this.screenFormat = getScreenFormat(i12);
    ...
    private String getScreenDensity(DisplayMetrics displayMetrics) {
        ...
        return i12 < 140 ? Constants.LOW : i12 > 200 ? Constants.HIGH : "medium";
    }

    private String getScreenFormat(int i12) {
        int i13 = i12 & 48;
        if (i13 == 16) {
    ...
    private String getScreenSize(int i12) {
        int i13 = i12 & 15;
        if (i13 == 1) {
    ...
    public void reloadPlayIds(AdjustConfig adjustConfig) {
        ...
        if (Util.canReadPlayIds(adjustConfig)) {
            ...
            for (int i12 = 1; i12 <= 3; i12++) {
                try {
                    GooglePlayServicesClient.GooglePlayServicesInfo googlePlayServicesInfo = GooglePlayServicesClient.getGooglePlayServicesInfo(context, i12 * 3000);
