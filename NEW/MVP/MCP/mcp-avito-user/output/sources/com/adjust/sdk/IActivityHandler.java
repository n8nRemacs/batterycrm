...
public interface IActivityHandler {
    ...
    void processAndResolveDeeplink(Uri uri, long j12, OnDeeplinkResolvedListener onDeeplinkResolvedListener);

    void processDeeplink(Uri uri, long j12);
    ...
    void setAskingAttribution(boolean z12);

    void setEnabled(boolean z12);

    void setOfflineMode(boolean z12);

    void setPushToken(String str, boolean z12);
    ...
    void trackMeasurementConsent(boolean z12);
