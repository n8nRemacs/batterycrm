...
final class f extends N implements Y41.q<C20288i1.b<ToggleableState>, A, Integer, V<Float>> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ int f63357l;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ androidx.compose.animation.core.N f63358m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(int i12, androidx.compose.animation.core.N n12) {
        super(3);
        this.f63357l = i12;
        this.f63358m = n12;
    }
    ...
    public final V<Float> invoke(C20288i1.b<ToggleableState> bVar, A a12, Integer num) {
        ...
        num.intValue();
        a13.C(-1618453129);
        G1 g1E = C20310q.e(this.f63357l, 0, this.f63358m, 2);
        a13.h();
        return g1E;
    }
}
