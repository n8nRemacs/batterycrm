...
final class h extends N implements r<com.akita.compose.component.avatar.i, v, A, Integer, G0> {
    @Override // Y41.r
    public final G0 invoke(com.akita.compose.component.avatar.i iVar, v vVar, A a12, Integer num) {
        ...
        if ((i12 & 731) == 146 && a13.c()) {
            ...
            com.akita.compose.component.avatar.h.c(iVar2, vVar2, iVar2.f60328c, a13, (i12 << 3) & 1008, 0);
        }
        return G0.f406611a;
    }
}
