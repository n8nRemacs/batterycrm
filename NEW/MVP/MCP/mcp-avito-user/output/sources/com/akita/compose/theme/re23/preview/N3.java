...
final class N3 extends kotlin.jvm.internal.N implements Y41.q<androidx.compose.foundation.layout.T1, androidx.compose.runtime.A, Integer, kotlin.G0> {

    /* renamed from: l, reason: collision with root package name */
    public final /* synthetic */ kotlin.Q<String, com.akita.compose.component.toast_bar.J> f65448l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public N3(kotlin.Q<String, com.akita.compose.component.toast_bar.J> q12) {
        super(3);
        this.f65448l = q12;
    }
    ...
    public final kotlin.G0 invoke(androidx.compose.foundation.layout.T1 t12, androidx.compose.runtime.A a12, Integer num) {
        ...
        if ((iIntValue & 91) == 18 && a13.c()) {
            ...
            aVar.d0(fillElement);
            if (C43066x.q(this.f65448l.f406619b, "inverse", true)) {
            ...
            androidx.compose.ui.v vVarH = androidx.compose.foundation.layout.R1.h(androidx.compose.foundation.A.b(fillElement, pVar.c(a13), androidx.compose.ui.graphics.Y0.f39346a), t13);
            ...
            com.akita.compose.theme.re23.b.f63983a.getClass();
            com.akita.compose.foundation.ui.p.b("ToastBar Preview", com.akita.compose.theme.re23.b.f63988f.f65240k, null, false, 0L, null, 0, 0, false, null, a13, 6, 1020);
            a13.z();
        }
