...
public final class c {
    ...
    @Y61.k
    public static final Y41.l<String, String> f61792a = b.f61795l;

    /* renamed from: b, reason: collision with root package name */
    @Y61.k
    public static final Y41.l<String, String> f61793b = a.f61794l;
    ...
    public static final class a extends N implements Y41.l<String, String> {
        ...
        public static final a f61794l = new a();
    ...
    public static final class b extends N implements Y41.l<String, String> {
        ...
        /* renamed from: l, reason: collision with root package name */
        public static final b f61795l = new b();
    ...
    public static final String a(String str) {
        ...
        return C43066x.t0(10, sb2.toString());
    }
}
