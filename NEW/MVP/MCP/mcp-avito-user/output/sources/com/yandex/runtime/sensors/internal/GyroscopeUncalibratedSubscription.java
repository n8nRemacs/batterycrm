...
public class GyroscopeUncalibratedSubscription implements SensorDataConsumer {
    ...
    public GyroscopeUncalibratedSubscription(NativeObject nativeObject, int i12) {
        this.nativeObject = nativeObject;
        this.sensorSubscription = new SensorSubscription(this, 16, i12);
    }

    private static native void angularSpeedChanged(NativeObject nativeObject, float f12, float f13, float f14, float f15, float f16, float f17, int i12, long j12, long j13);
