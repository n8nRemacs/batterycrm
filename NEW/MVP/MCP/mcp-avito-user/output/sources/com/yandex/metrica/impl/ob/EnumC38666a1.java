...
public enum EnumC38666a1 {
    ...
    EVENT_TYPE_UPDATE_PRE_ACTIVATION_CONFIG(Http2.INITIAL_MAX_FRAME_SIZE, "Update pre-activation config"),
    ...
    static final HashMap<Integer, EnumC38666a1> f380068e0 = new HashMap<>();

    /* renamed from: a, reason: collision with root package name */
    private final int f380091a;

    /* renamed from: b, reason: collision with root package name */
    private final String f380092b;

    static {
        EnumC38666a1[] enumC38666a1ArrValues = values();
        for (int i12 = 0; i12 < 54; i12++) {
            EnumC38666a1 enumC38666a1 = enumC38666a1ArrValues[i12];
            f380068e0.put(Integer.valueOf(enumC38666a1.f380091a), enumC38666a1);
        }
    }

    EnumC38666a1(int i12, String str) {
        this.f380091a = i12;
        this.f380092b = str;
    }

    public String a() {
        return this.f380092b;
    }

    public int b() {
        return this.f380091a;
    }

    @j.N
    public static EnumC38666a1 a(int i12) {
        EnumC38666a1 enumC38666a1 = f380068e0.get(Integer.valueOf(i12));
        return enumC38666a1 == null ? EVENT_TYPE_UNDEFINED : enumC38666a1;
    }
}
