...
public final class zzaw extends zzay {
    public zzaw() {
        this.f350574a.add(zzbv.BITWISE_AND);
        this.f350574a.add(zzbv.BITWISE_LEFT_SHIFT);
        this.f350574a.add(zzbv.BITWISE_NOT);
        this.f350574a.add(zzbv.BITWISE_OR);
        this.f350574a.add(zzbv.BITWISE_RIGHT_SHIFT);
        this.f350574a.add(zzbv.BITWISE_UNSIGNED_RIGHT_SHIFT);
        this.f350574a.add(zzbv.BITWISE_XOR);
    }

    @Override // com.google.android.gms.internal.measurement.zzay
    public final zzaq zza(String str, zzh zzhVar, List<zzaq> list) {
        switch (zzaz.f350575a[zzg.zza(str).ordinal()]) {
            case 1:
