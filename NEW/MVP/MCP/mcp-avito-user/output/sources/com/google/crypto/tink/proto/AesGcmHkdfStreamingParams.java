...
public final class AesGcmHkdfStreamingParams extends GeneratedMessageLite<AesGcmHkdfStreamingParams, Builder> implements AesGcmHkdfStreamingParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<AesGcmHkdfStreamingParams, Builder> implements AesGcmHkdfStreamingParamsOrBuilder {
        ...
        public Builder setCiphertextSegmentSize(int i12) {
            copyOnWrite();
            ((AesGcmHkdfStreamingParams) this.instance).setCiphertextSegmentSize(i12);
            return this;
        }

        public Builder setDerivedKeySize(int i12) {
            copyOnWrite();
            ((AesGcmHkdfStreamingParams) this.instance).setDerivedKeySize(i12);
            return this;
        }
        ...
        public Builder setHkdfHashTypeValue(int i12) {
            copyOnWrite();
            ((AesGcmHkdfStreamingParams) this.instance).setHkdfHashTypeValue(i12);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setCiphertextSegmentSize(int i12) {
        this.ciphertextSegmentSize_ = i12;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setDerivedKeySize(int i12) {
        this.derivedKeySize_ = i12;
    }
