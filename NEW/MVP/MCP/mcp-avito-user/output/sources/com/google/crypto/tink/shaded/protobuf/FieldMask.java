...
public final class FieldMask extends GeneratedMessageLite<FieldMask, Builder> implements FieldMaskOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<FieldMask, Builder> implements FieldMaskOrBuilder {
        ...
        public String getPaths(int i12) {
            return ((FieldMask) this.instance).getPaths(i12);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.FieldMaskOrBuilder
        public ByteString getPathsBytes(int i12) {
            return ((FieldMask) this.instance).getPathsBytes(i12);
        }
        ...
        public Builder setPaths(int i12, String str) {
            copyOnWrite();
            ((FieldMask) this.instance).setPaths(i12, str);
            return this;
        }
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.FieldMaskOrBuilder
    public ByteString getPathsBytes(int i12) {
        return ByteString.copyFromUtf8(this.paths_.get(i12));
    }
