...
public final class Enum extends GeneratedMessageLite<Enum, Builder> implements EnumOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Enum, Builder> implements EnumOrBuilder {
        ...
        public EnumValue getEnumvalue(int i12) {
            return ((Enum) this.instance).getEnumvalue(i12);
        }
        ...
        public Option getOptions(int i12) {
            return ((Enum) this.instance).getOptions(i12);
        }
        ...
        public Builder removeEnumvalue(int i12) {
            copyOnWrite();
            ((Enum) this.instance).removeEnumvalue(i12);
            return this;
        }

        public Builder removeOptions(int i12) {
            copyOnWrite();
            ((Enum) this.instance).removeOptions(i12);
            return this;
        }

        public Builder setEnumvalue(int i12, EnumValue enumValue) {
            copyOnWrite();
            ((Enum) this.instance).setEnumvalue(i12, enumValue);
            return this;
        }
        ...
        public Builder setOptions(int i12, Option option) {
            copyOnWrite();
            ((Enum) this.instance).setOptions(i12, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i12) {
            copyOnWrite();
            ((Enum) this.instance).setSyntaxValue(i12);
            return this;
        }
        ...
        public Builder addEnumvalue(int i12, EnumValue enumValue) {
            copyOnWrite();
            ((Enum) this.instance).addEnumvalue(i12, enumValue);
            return this;
        }

        public Builder addOptions(int i12, Option option) {
            copyOnWrite();
            ((Enum) this.instance).addOptions(i12, option);
            return this;
        }

        public Builder setEnumvalue(int i12, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setEnumvalue(i12, builder.build());
            return this;
        }

        public Builder setOptions(int i12, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setOptions(i12, builder.build());
            return this;
        }
        ...
        public Builder addEnumvalue(int i12, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addEnumvalue(i12, builder.build());
            return this;
        }

        public Builder addOptions(int i12, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addOptions(i12, builder.build());
            return this;
        }
    }
    ...
    public EnumValueOrBuilder getEnumvalueOrBuilder(int i12) {
        return this.enumvalue_.get(i12);
    }
