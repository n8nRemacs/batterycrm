...
public final class Field extends GeneratedMessageLite<Field, Builder> implements FieldOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Field, Builder> implements FieldOrBuilder {
        ...
        public Option getOptions(int i12) {
            return ((Field) this.instance).getOptions(i12);
        }
        ...
        public Builder removeOptions(int i12) {
            copyOnWrite();
            ((Field) this.instance).removeOptions(i12);
            return this;
        }
        ...
        public Builder setCardinalityValue(int i12) {
            copyOnWrite();
            ((Field) this.instance).setCardinalityValue(i12);
            return this;
        }
        ...
        public Builder setKindValue(int i12) {
            copyOnWrite();
            ((Field) this.instance).setKindValue(i12);
            return this;
        }
        ...
        public Builder setNumber(int i12) {
            copyOnWrite();
            ((Field) this.instance).setNumber(i12);
            return this;
        }

        public Builder setOneofIndex(int i12) {
            copyOnWrite();
            ((Field) this.instance).setOneofIndex(i12);
            return this;
        }

        public Builder setOptions(int i12, Option option) {
            copyOnWrite();
            ((Field) this.instance).setOptions(i12, option);
            return this;
        }

        public Builder setPacked(boolean z12) {
            copyOnWrite();
            ((Field) this.instance).setPacked(z12);
            return this;
        }
        ...
        public Builder addOptions(int i12, Option option) {
            copyOnWrite();
            ((Field) this.instance).addOptions(i12, option);
            return this;
        }

        public Builder setOptions(int i12, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).setOptions(i12, builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i12, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).addOptions(i12, builder.build());
            return this;
        }
    }
    ...
    public enum Cardinality implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<Cardinality> internalValueMap = new Internal.EnumLiteMap<Cardinality>() { // from class: com.google.crypto.tink.shaded.protobuf.Field.Cardinality.1
            ...
            public Cardinality findValueByNumber(int i12) {
                return Cardinality.forNumber(i12);
            }
        };
        ...
        public static final class CardinalityVerifier implements Internal.EnumVerifier {
            ...
            public boolean isInRange(int i12) {
                return Cardinality.forNumber(i12) != null;
            }
        }
        ...
        public static Cardinality forNumber(int i12) {
            if (i12 == 0) {
        ...
        @Deprecated
        public static Cardinality valueOf(int i12) {
    ...
    public enum Kind implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<Kind> internalValueMap = new Internal.EnumLiteMap<Kind>() { // from class: com.google.crypto.tink.shaded.protobuf.Field.Kind.1
            @Override // com.google.crypto.tink.shaded.protobuf.Internal.EnumLiteMap
            public Kind findValueByNumber(int i12) {
                return Kind.forNumber(i12);
            }
        };
        private final int value;
        ...
        public static final class KindVerifier implements Internal.EnumVerifier {
            ...
            @Override // com.google.crypto.tink.shaded.protobuf.Internal.EnumVerifier
            public boolean isInRange(int i12) {
                return Kind.forNumber(i12) != null;
            }
        }
        ...
        public static Kind forNumber(int i12) {
            switch (i12) {
                case 0:
                    return TYPE_UNKNOWN;
                case 1:
