...
final class s1 {
    ...
    public static final b f362953a;
    ...
    public static abstract class b {
        ...
        */
        public static int g(int r18, java.nio.ByteBuffer r19, int r20, int r21) {
            /*
                Method dump skipped, instructions count: 307
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.s1.b.g(int, java.nio.ByteBuffer, int, int):int");
        }
        ...
        public final int e(int i12, ByteBuffer byteBuffer, int i13, int i14) {
            if (!byteBuffer.hasArray()) {
                return byteBuffer.isDirect() ? h(i12, byteBuffer, i13, i14) : g(i12, byteBuffer, i13, i14);
            }
            int iArrayOffset = byteBuffer.arrayOffset();
            return f(i12, byteBuffer.array(), i13 + iArrayOffset, iArrayOffset + i14);
        }

        public abstract int f(int i12, byte[] bArr, int i13, int i14);

        public abstract int h(int i12, ByteBuffer byteBuffer, int i13, int i14);
    }
        ...
        */
        public final int f(int r12, byte[] r13, int r14, int r15) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.s1.c.f(int, byte[], int, int):int");
        }

        @Override // com.google.protobuf.s1.b
        public final int h(int i12, ByteBuffer byteBuffer, int i13, int i14) {
            return b.g(i12, byteBuffer, i13, i14);
        }
    }
    ...
    public static final class e extends b {
        public static int i(long j12, int i12, int i13) {
            if (i13 == 0) {
                b bVar = s1.f362953a;
                if (i12 > -12) {
                    return -1;
            ...
            if (i13 == 1) {
                return s1.e(i12, r1.f362946c.f(j12));
            }
            if (i13 != 2) {
                throw new AssertionError();
            }
            r1.e eVar = r1.f362946c;
            return s1.f(i12, eVar.f(j12), eVar.f(j12 + 1));
        }

        public static int j(byte[] bArr, int i12, long j12, int i13) {
            if (i13 == 0) {
                b bVar = s1.f362953a;
                if (i12 > -12) {
                    return -1;
            ...
            if (i13 == 1) {
                return s1.e(i12, r1.h(bArr, j12));
            }
            if (i13 == 2) {
                return s1.f(i12, r1.h(bArr, j12), r1.h(bArr, j12 + 1));
            }
            throw new AssertionError();
        }
        ...
        public final int d(int i12, int i13, String str, byte[] bArr) {
            ...
            while (i15 < length) {
                ...
                if (cCharAt2 < c12 && j14 < j15) {
                    ...
                    long j16 = j14 + j12;
                    r1.q(bArr, j14, (byte) ((cCharAt2 >>> 6) | 960));
                    j14 += 2;
                    r1.q(bArr, j16, (byte) ((cCharAt2 & '?') | 128));
                    str2 = str;
                    j13 = j12;
                    c13 = 128;
                } else {
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j14 > j15 - 3) {
                        ...
                        if (i16 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                j13 = 1;
                                r1.q(bArr, j14, (byte) ((codePoint >>> 18) | 240));
                                c13 = 128;
                                r1.q(bArr, j14 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j17 = j14 + 3;
                                r1.q(bArr, j14 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                j14 += 4;
                                r1.q(bArr, j17, (byte) ((codePoint & 63) | 128));
                                i15 = i16;
                            } else {
                                i15 = i16;
                            }
                    ...
                    r1.q(bArr, j14, (byte) ((cCharAt2 >>> '\f') | 480));
                    long j18 = j14 + 2;
                    r1.q(bArr, j14 + j12, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                    j14 += 3;
                    r1.q(bArr, j18, (byte) ((cCharAt2 & '?') | 128));
                    str2 = str;
                    c13 = 128;
                    j13 = 1;
                }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:13:0x0034, code lost:
            ...
            if (com.google.protobuf.r1.h(r23, r4) > (-65)) goto L16;
         */
        /* JADX WARN: Code restructure failed: missing block: B:31:0x0065, code lost:
        
            if (com.google.protobuf.r1.h(r23, r4) > (-65)) goto L32;
         */
        @Override // com.google.protobuf.s1.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public final int f(int r22, byte[] r23, int r24, int r25) {
            /*
                Method dump skipped, instructions count: 441
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.s1.e.f(int, byte[], int, int):int");
        }

        /* JADX WARN: Code restructure failed: missing block: B:13:0x0040, code lost:
        
            if (com.google.protobuf.r1.f362946c.f(r2) > (-65)) goto L16;
         */
        /* JADX WARN: Code restructure failed: missing block: B:31:0x0074, code lost:
        
            if (com.google.protobuf.r1.f362946c.f(r2) > (-65)) goto L32;
         */
        @Override // com.google.protobuf.s1.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public final int h(int r22, java.nio.ByteBuffer r23, int r24, int r25) {
            /*
                Method dump skipped, instructions count: 444
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.s1.e.h(int, java.nio.ByteBuffer, int, int):int");
        }
    }

    static {
        f362953a = (r1.f362948e && r1.f362947d && !C37675g.a()) ? new e() : new c();
    }
    ...
    public static boolean g(byte[] bArr, int i12, int i13) {
        return f362953a.f(0, bArr, i12, i13) == 0;
    }
}
