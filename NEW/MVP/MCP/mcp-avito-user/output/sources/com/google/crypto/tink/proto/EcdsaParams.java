...
public final class EcdsaParams extends GeneratedMessageLite<EcdsaParams, Builder> implements EcdsaParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EcdsaParams, Builder> implements EcdsaParamsOrBuilder {
        ...
        public Builder setCurveValue(int i12) {
            copyOnWrite();
            ((EcdsaParams) this.instance).setCurveValue(i12);
            return this;
        }
        ...
        public Builder setEncodingValue(int i12) {
            copyOnWrite();
            ((EcdsaParams) this.instance).setEncodingValue(i12);
            return this;
        }
        ...
        public Builder setHashTypeValue(int i12) {
            copyOnWrite();
            ((EcdsaParams) this.instance).setHashTypeValue(i12);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setCurveValue(int i12) {
        this.curve_ = i12;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setEncodingValue(int i12) {
        this.encoding_ = i12;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setHashTypeValue(int i12) {
        this.hashType_ = i12;
    }
