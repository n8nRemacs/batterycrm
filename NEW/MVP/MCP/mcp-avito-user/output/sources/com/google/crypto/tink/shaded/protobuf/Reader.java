...
interface Reader {
    ...
    <T> void mergeGroupField(T t12, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);

    <T> void mergeMessageField(T t12, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);
