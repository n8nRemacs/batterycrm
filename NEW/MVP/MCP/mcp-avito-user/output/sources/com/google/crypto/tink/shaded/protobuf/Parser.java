...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i12, int i13);

    MessageType parseFrom(byte[] bArr, int i12, int i13, ExtensionRegistryLite extensionRegistryLite);
    ...
    MessageType parsePartialFrom(byte[] bArr, int i12, int i13);

    MessageType parsePartialFrom(byte[] bArr, int i12, int i13, ExtensionRegistryLite extensionRegistryLite);
