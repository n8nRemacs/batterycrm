...
public final class d {
    ...
    public final zzst f355711a;

    public d(Context context, zzst zzstVar) {
        zzj.zza(context);
        this.f355711a = zzstVar;
        zzj.zza(context);
    }

    public final void a(zzti zztiVar, zznw zznwVar, zznv zznvVar) {
        ...
        this.f355711a.zzc(new c(zznu.TYPE_THICK, zzmyVar.zzk(), zznvVar, zznwVar == zznw.OPTIONAL_MODULE_FACE_DETECTION_CREATE ? 1 : 0), zznwVar);
    }
}
