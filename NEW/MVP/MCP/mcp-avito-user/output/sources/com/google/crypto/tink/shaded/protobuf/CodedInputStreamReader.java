...
final class CodedInputStreamReader implements Reader {
    ...
    private <T> void mergeGroupFieldInternal(T t12, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) {
    ...
    private <T> void mergeMessageFieldInternal(T t12, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
    ...
    private void requirePosition(int i12) throws InvalidProtocolBufferException {
        if (this.input.getTotalBytesRead() != i12) {
    ...
    public int getFieldNumber() {
        ...
        int i13 = this.tag;
        if (i13 == 0 || i13 == this.endGroupTag) {
            return Integer.MAX_VALUE;
        }
        return WireFormat.getTagFieldNumber(i13);
    }
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.Reader
    public <T> void mergeGroupField(T t12, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException.InvalidWireTypeException {
        requireWireType(3);
        mergeGroupFieldInternal(t12, schema, extensionRegistryLite);
    }
    ...
    public <T> void mergeMessageField(T t12, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        requireWireType(2);
        mergeMessageFieldInternal(t12, schema, extensionRegistryLite);
    }
    ...
    */
    public <K, V> void readMap(java.util.Map<K, V> r8, com.google.crypto.tink.shaded.protobuf.MapEntryLite.Metadata<K, V> r9, com.google.crypto.tink.shaded.protobuf.ExtensionRegistryLite r10) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException.InvalidWireTypeException {
        /*
            r7 = this;
            r0 = 2
        ...
        L26:
            ...
            if (r4 == r5) goto L49
            if (r4 == r0) goto L3c
            boolean r4 = r7.skipField()     // Catch: java.lang.Throwable -> L3a com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException.InvalidWireTypeException -> L51
            if (r4 == 0) goto L34
            goto L14
        L34:
        ...
        L3c:
            ...
            java.lang.Object r3 = r7.readField(r4, r5, r10)     // Catch: java.lang.Throwable -> L3a com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException.InvalidWireTypeException -> L51
            goto L14
        L49:
            ...
            r5 = 0
            java.lang.Object r2 = r7.readField(r4, r5, r5)     // Catch: java.lang.Throwable -> L3a com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException.InvalidWireTypeException -> L51
            goto L14
        L51:
    ...
    public boolean skipField() {
        int i12;
        if (this.input.isAtEnd() || (i12 = this.tag) == this.endGroupTag) {
            return false;
        }
        return this.input.skipField(i12);
    }
