...
public final class d0 {
    @I41.a
    public static String a(@I41.a String str) {
        L.b bVar = L.f358964a;
    ...
    public static String b(@I41.a String str, @I41.a Object... objArr) {
        int iIndexOf;
        String string;
        ...
        int i14 = 0;
        while (i12 < objArr.length && (iIndexOf = strValueOf.indexOf("%s", i14)) != -1) {
            sb2.append((CharSequence) strValueOf, i14, iIndexOf);
            sb2.append(objArr[i12]);
            i14 = iIndexOf + 2;
            i12++;
        }
        sb2.append((CharSequence) strValueOf, i14, strValueOf.length());
