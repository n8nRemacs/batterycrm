...
public final class zzbi extends zzay {
    public zzbi() {
        this.f350574a.add(zzbv.FOR_IN);
        this.f350574a.add(zzbv.FOR_IN_CONST);
        this.f350574a.add(zzbv.FOR_IN_LET);
        this.f350574a.add(zzbv.FOR_LET);
        this.f350574a.add(zzbv.FOR_OF);
        this.f350574a.add(zzbv.FOR_OF_CONST);
        this.f350574a.add(zzbv.FOR_OF_LET);
        this.f350574a.add(zzbv.WHILE);
    }

    public static zzaq b(zzbm zzbmVar, Iterator<zzaq> it, zzaq zzaqVar) {
        if (it != null) {
            while (it.hasNext()) {
    ...
    public static zzaq c(zzbm zzbmVar, zzaq zzaqVar, zzaq zzaqVar2) {
        if (zzaqVar instanceof Iterable) {
            return b(zzbmVar, ((Iterable) zzaqVar).iterator(), zzaqVar2);
        }
