...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.ExtensionSchema
    public Object findExtensionByNumber(ExtensionRegistryLite extensionRegistryLite, MessageLite messageLite, int i12) {
        return extensionRegistryLite.findLiteExtensionByNumber(messageLite, i12);
    }
    ...
    public <UT, UB> UB parseExtension(Object obj, Reader reader, Object obj2, ExtensionRegistryLite extensionRegistryLite, FieldSet<GeneratedMessageLite.ExtensionDescriptor> fieldSet, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            ...
            if (generatedExtension.isRepeated()) {
                ...
                int i12 = AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()];
                if ((i12 == 17 || i12 == 18) && (field = fieldSet.getField(generatedExtension.descriptor)) != null) {
