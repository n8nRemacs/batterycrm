...
public final class j implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iY2) {
            ...
            switch ((char) i12) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    arrayListJ = SafeParcelReader.j(parcel, i12, RegisterRequest.CREATOR);
                    break;
                case 6:
                    arrayListJ2 = SafeParcelReader.j(parcel, i12, RegisteredKey.CREATOR);
                    break;
                case 7:
        ...
        return new RegisterRequestParams(numT, dO2, uri, arrayListJ, arrayListJ2, channelIdValue, strF);
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ Object[] newArray(int i12) {
        return new RegisterRequestParams[i12];
    }
}
