...
public abstract class zzbj extends zzbf implements List, RandomAccess {
    ...
    public static final zzbv f353499c = new zzbh(zzbn.f353504f, 0);
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i12 = 0; i12 < size; i12++) {
                        if (zzau.zza(get(i12), list.get(i12))) {
                        }
                    }
                    return true;
                }
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzbj subList(int i12, int i13) {
        zzav.zzc(i12, i13, size());
        int i14 = i13 - i12;
        return i14 == size() ? this : i14 == 0 ? zzbn.f353504f : new zzbi(this, i12, i14);
    }

    @Override // java.util.List
    /* renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzbv listIterator(int i12) {
        zzav.zzb(i12, size(), "index");
        return isEmpty() ? f353499c : new zzbh(this, i12);
    }
}
