...
public final class EllipticCurvesUtil {
    ...
    public static class JacobianEcPoint {
        ...
        public JacobianEcPoint(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this.f360669x = bigInteger;
            this.f360670y = bigInteger2;
            this.f360671z = bigInteger3;
        }

        public boolean isInfinity() {
            return this.f360671z.equals(BigInteger.ZERO);
        }
        ...
        public ECPoint toECPoint(BigInteger bigInteger) {
            ...
            BigInteger bigIntegerModInverse = this.f360671z.modInverse(bigInteger);
            BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigInteger);
            return new ECPoint(this.f360669x.multiply(bigIntegerMod).mod(bigInteger), this.f360670y.multiply(bigIntegerMod).mod(bigInteger).multiply(bigIntegerModInverse).mod(bigInteger));
        }
    }
    ...
    public static JacobianEcPoint addJacobianPoints(JacobianEcPoint jacobianEcPoint, JacobianEcPoint jacobianEcPoint2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigInteger3 = jacobianEcPoint.f360671z;
        BigInteger bigIntegerMod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = jacobianEcPoint2.f360671z;
        BigInteger bigIntegerMod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger bigIntegerMod3 = jacobianEcPoint.f360669x.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = jacobianEcPoint2.f360669x.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = jacobianEcPoint.f360670y.multiply(jacobianEcPoint2.f360671z).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = jacobianEcPoint2.f360670y.multiply(jacobianEcPoint.f360671z).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        ...
        BigInteger bigIntegerAdd = jacobianEcPoint.f360671z.add(jacobianEcPoint2.f360671z);
    ...
    public static JacobianEcPoint doubleJacobianPoint(JacobianEcPoint jacobianEcPoint, BigInteger bigInteger, BigInteger bigInteger2) {
        if (jacobianEcPoint.f360670y.equals(BigInteger.ZERO)) {
            return JacobianEcPoint.INFINITY;
        }
        BigInteger bigInteger3 = jacobianEcPoint.f360669x;
        BigInteger bigIntegerMod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = jacobianEcPoint.f360670y;
        BigInteger bigIntegerMod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger bigIntegerMod3 = bigIntegerMod2.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigInteger5 = jacobianEcPoint.f360671z;
        BigInteger bigIntegerMod4 = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger bigIntegerAdd = jacobianEcPoint.f360669x.add(bigIntegerMod2);
        ...
        BigInteger bigIntegerAdd3 = jacobianEcPoint.f360670y.add(jacobianEcPoint.f360671z);
    ...
    public static ECPoint multiplyByGenerator(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                jacobianEcPoint = addJacobianPoints(jacobianEcPoint, jacobianEcPoint2, a12, modulus);
                jacobianEcPoint2 = doubleJacobianPoint(jacobianEcPoint2, a12, modulus);
            } else {
                jacobianEcPoint2 = addJacobianPoints(jacobianEcPoint, jacobianEcPoint2, a12, modulus);
                jacobianEcPoint = doubleJacobianPoint(jacobianEcPoint, a12, modulus);
            }
        }
