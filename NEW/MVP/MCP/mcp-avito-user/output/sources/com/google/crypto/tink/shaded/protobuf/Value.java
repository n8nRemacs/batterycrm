...
public final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
        ...
        public Builder setBoolValue(boolean z12) {
            copyOnWrite();
            ((Value) this.instance).setBoolValue(z12);
            return this;
        }
        ...
        public Builder setNullValueValue(int i12) {
            copyOnWrite();
            ((Value) this.instance).setNullValueValue(i12);
            return this;
        }

        public Builder setNumberValue(double d12) {
            copyOnWrite();
            ((Value) this.instance).setNumberValue(d12);
            return this;
        }
    ...
    public enum KindCase {
        ...
        public static KindCase forNumber(int i12) {
            switch (i12) {
                case 0:
                    return KIND_NOT_SET;
                case 1:
        ...
        @Deprecated
        public static KindCase valueOf(int i12) {
