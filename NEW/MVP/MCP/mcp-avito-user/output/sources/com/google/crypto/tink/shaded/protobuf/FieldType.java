...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f360675id] = fieldType52;
        }
    }

    private FieldType(String str, int i12, int i13, Collection collection, JavaType javaType) {
        int i14;
        this.f360675id = i13;
        this.collection = collection;
        this.javaType = javaType;
        int i15 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i15 == 1 || i15 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i14 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i14 == 2 || i14 == 3) ? false : true;
    }

    public static FieldType forId(int i12) {
        if (i12 < 0) {
            return null;
        }
        ...
        while (true) {
            ...
            if (!(genericSuperList instanceof ParameterizedType)) {
                ...
                for (int i13 = 0; i13 < actualTypeArguments.length; i13++) {
                    java.lang.reflect.Type type = actualTypeArguments[i13];
                    if (type instanceof TypeVariable) {
                        TypeVariable<Class<?>>[] typeParameters = cls.getTypeParameters();
                        if (typeArr.length != typeParameters.length) {
                            throw new RuntimeException("Type array mismatch");
                        }
                        for (int i14 = 0; i14 < typeParameters.length; i14++) {
                            if (type == typeParameters[i14]) {
                                actualTypeArguments[i13] = typeArr[i14];
                            }
                        }
