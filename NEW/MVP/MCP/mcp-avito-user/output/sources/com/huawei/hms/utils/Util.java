...
public class Util {
    ...
    public static int getHmsVersion(Context context) {
        ...
        try {
            ...
            HMSLog.e(TAG, "In getHmsVersion, Failed to read meta data for the HMS VERSION.", e12);
            return 0;
        }
    }
    ...
    public static String getProcessName(Context context, int i12) {
        return UIUtil.getProcessName(context, i12);
    }
            ...
            if (!availableInit) {
                ...
                if (packageManager == null) {
                    ...
                    try {
                        ...
                        HMSLog.e(TAG, "In isAvailableLibExist, Failed to read meta data for the availableLoaded.", e12);
                    }
                    z12 = false;
                    isAvailableAvailable = z12;
                    availableInit = true;
                }
                z12 = true;
                isAvailableAvailable = z12;
    ...
    public static void unBindServiceCatchException(Context context, ServiceConnection serviceConnection) {
        try {
            ...
            D8.q(e12, new StringBuilder("On unBindServiceException:"), TAG);
        }
    }
}
