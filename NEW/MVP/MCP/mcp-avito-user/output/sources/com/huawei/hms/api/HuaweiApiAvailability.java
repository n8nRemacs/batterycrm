...
public abstract class HuaweiApiAvailability {
    ...
    private static final Map<String, Integer> f363267a;
    ...
    public static void setServicesVersionCode(int i12) {
        SERVICES_VERSION_CODE = i12;
    }
    ...
    public abstract PendingIntent getErrPendingIntent(Context context, int i12, int i13);

    public abstract PendingIntent getErrPendingIntent(Context context, ConnectionResult connectionResult);

    public abstract Dialog getErrorDialog(Activity activity, int i12, int i13);

    public abstract Dialog getErrorDialog(Activity activity, int i12, int i13, DialogInterface.OnCancelListener onCancelListener);

    public abstract String getErrorString(int i12);

    public abstract Task<Void> getHuaweiServicesReady(Activity activity);

    public abstract Intent getResolveErrorIntent(Activity activity, int i12);

    public abstract PendingIntent getResolveErrorPendingIntent(Activity activity, int i12);
    ...
    public abstract int isHuaweiMobileServicesAvailable(Context context, int i12);

    public abstract boolean isUserResolvableError(int i12);

    public abstract boolean isUserResolvableError(int i12, PendingIntent pendingIntent);

    public abstract void popupErrNotification(Context context, ConnectionResult connectionResult);

    public abstract void resolveError(Activity activity, int i12, int i13);

    public abstract void resolveError(Activity activity, int i12, int i13, PendingIntent pendingIntent);

    public abstract boolean showErrorDialogFragment(Activity activity, int i12, int i13);

    public abstract boolean showErrorDialogFragment(Activity activity, int i12, int i13, DialogInterface.OnCancelListener onCancelListener);

    public abstract boolean showErrorDialogFragment(Activity activity, int i12, Fragment fragment, int i13, DialogInterface.OnCancelListener onCancelListener);

    public abstract void showErrorNotification(Context context, int i12);
}
