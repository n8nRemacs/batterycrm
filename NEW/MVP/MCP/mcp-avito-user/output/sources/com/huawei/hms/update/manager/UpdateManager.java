...
public class UpdateManager {
    ...
    public static void startUpdate(Activity activity, int i12, UpdateBean updateBean) {
        Intent startUpdateIntent = getStartUpdateIntent(activity, updateBean);
        if (startUpdateIntent != null) {
            activity.startActivityForResult(startUpdateIntent, i12);
        }
    }
    ...
    public static boolean b(Context context) {
        ...
        g.j(packageVersionCode, "getHiappVersion is ", "UpdateManager");
    ...
    public static boolean a(Context context) {
        ...
        try {
            ...
            HMSLog.e("UpdateManager", "In getAndroidMarketSetting, Failed to read meta data from android market channel.", e12);
        }
        HMSLog.i("UpdateManager", "In getAndroidMarketSetting, configuration not found for android channel market setting.");
        return true;
    }
