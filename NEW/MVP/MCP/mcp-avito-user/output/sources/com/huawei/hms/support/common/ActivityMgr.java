...
public final class ActivityMgr implements Application.ActivityLifecycleCallbacks {
    ...
    public WeakReference<Activity> f363645a;
    ...
    public Activity getCurrentActivity() {
        if (this.f363645a == null) {
            HMSLog.i("ActivityMgr", "mCurrentActivity is " + this.f363645a);
            return null;
        }
        HMSLog.i("ActivityMgr", "mCurrentActivity.get() is " + this.f363645a.get());
        return this.f363645a.get();
    }
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        this.f363645a = new WeakReference<>(activity);
    }
