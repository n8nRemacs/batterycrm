...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public abstract ConnectionResult holdUpConnect(long j12, TimeUnit timeUnit);
    ...
    public static final class Builder {
        ...
        private final Context f363268a;

        /* renamed from: b, reason: collision with root package name */
        private final List<Scope> f363269b = new ArrayList();

        /* renamed from: c, reason: collision with root package name */
        private final List<PermissionInfo> f363270c = new ArrayList();

        /* renamed from: d, reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f363271d = new HashMap();

        /* renamed from: e, reason: collision with root package name */
        private OnConnectionFailedListener f363272e;

        /* renamed from: f, reason: collision with root package name */
        private ConnectionCallbacks f363273f;

        /* renamed from: g, reason: collision with root package name */
        private int f363274g;

        /* renamed from: h, reason: collision with root package name */
        private Activity f363275h;

        public Builder(Context context) {
            Checker.checkNonNull(context, "context must not be null.");
            Context applicationContext = context.getApplicationContext();
            this.f363268a = applicationContext;
            this.f363274g = -1;
        ...
        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) throws JSONException {
            this.f363271d.put(api, null);
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(this.f363268a.getApplicationContext(), HiAnalyticsConstant.KeyAndValue.GAME_INIT_KEY, HiAnalyticsConstant.REPORT_VAL_SEPARATOR + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public Builder addApiWithScope(Api<? extends Api.ApiOptions.NotRequiredOptions> api, Scope... scopeArr) {
            ...
            this.f363271d.put(api, null);
            this.f363269b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }

        public Builder addConnectionCallbacks(ConnectionCallbacks connectionCallbacks) {
            Checker.checkNonNull(connectionCallbacks, "listener must not be null.");
            this.f363273f = connectionCallbacks;
            return this;
        }

        public Builder addOnConnectionFailedListener(OnConnectionFailedListener onConnectionFailedListener) {
            Checker.checkNonNull(onConnectionFailedListener, "listener must not be null.");
            this.f363272e = onConnectionFailedListener;
            return this;
        }

        public Builder addScope(Scope scope) {
            Checker.checkNonNull(scope, "scope must not be null.");
            this.f363269b.add(scope);
            return this;
        }

        public Builder allowLifeCycleManagement(Activity activity, int i12, OnConnectionFailedListener onConnectionFailedListener) {
            if (i12 < 0) {
                throw new IllegalArgumentException("allowLifeCycleManagement id should be positive");
            }
            this.f363274g = i12;
            this.f363275h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
            return this;
        }

        public HuaweiApiClient build() throws JSONException {
            addApi(new Api<>("Core.API"));
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f363268a);
            huaweiApiClientImpl.setScopes(this.f363269b);
            huaweiApiClientImpl.setPermissionInfos(this.f363270c);
            huaweiApiClientImpl.setApiMap(this.f363271d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f363273f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f363272e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f363274g);
            if (this.f363274g >= 0) {
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f363275h).startAutoMange(this.f363274g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o12, Scope... scopeArr) {
            Checker.checkNonNull(api, "Api must not be null");
            Checker.checkNonNull(o12, "Null options are not permitted for this Api");
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f363271d.put(api, o12);
            if (api.getOptions() != null) {
                this.f363269b.addAll(api.getOptions().getScopeList(o12));
                this.f363270c.addAll(api.getOptions().getPermissionInfoList(o12));
            }
            this.f363269b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }

        public <O extends Api.ApiOptions.HasOptions> Builder addApi(Api<O> api, O o12) {
            Checker.checkNonNull(api, "Api must not be null");
            Checker.checkNonNull(o12, "Null options are not permitted for this Api");
            this.f363271d.put(api, o12);
            if (api.getOptions() != null) {
        ...
        public Builder setPopupsGravity(int i12) {
            return this;
        }
