...
final class b extends HuaweiApiAvailability {
    ...
    private static final b f363330b = new b();

    /* compiled from: HuaweiApiAvailabilityImpl.java */
    public class a implements BusResponseCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ l[] f363331a;

        public a(b bVar, l[] lVarArr) {
            this.f363331a = lVarArr;
        }

        @Override // com.huawei.hms.activity.internal.BusResponseCallback
        public BusResponseResult innerError(Activity activity, int i12, String str) {
            HMSLog.e("HuaweiApiAvailabilityImpl", "Test foreground bus error: resultCode " + i12 + ", errMessage" + str);
            this.f363331a[0].a(new AvailabilityException());
            return null;
        }

        @Override // com.huawei.hms.activity.internal.BusResponseCallback
        public BusResponseResult succeedReturn(Activity activity, int i12, Intent intent) {
            HMSLog.i("HuaweiApiAvailabilityImpl", "Test foreground bus success: resultCode " + i12 + ", data" + intent);
            return null;
        }
    }
    ...
    public PendingIntent b(Context context, int i12) {
        g.j(i12, "Enter getResolveErrorPendingIntent, errorCode: ", "HuaweiApiAvailabilityImpl");
        Intent intentA = a(context, i12);
        if (intentA != null) {
    ...
    public Task<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr) {
        ...
        if (huaweiApi != null) {
            try {
                a(huaweiApi);
            } catch (AvailabilityException e12) {
                HMSLog.i("HuaweiApiAvailabilityImpl", "checkApi has AvailabilityException " + e12.getMessage());
            }
        }
    ...
    public Dialog getErrorDialog(Activity activity, int i12, int i13) {
        ...
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getErrorDialog, errorCode: " + i12);
        return getErrorDialog(activity, i12, i13, null);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public String getErrorString(int i12) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getErrorString, errorCode: " + i12);
        return ConnectionResult.a(i12);
    }
    ...
    public Task<Void> getHuaweiServicesReady(Activity activity) {
        ...
        if (resolveErrorIntent != null) {
            ...
            lVarArr[0].a(new AvailabilityException());
        }
        return task;
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public Intent getResolveErrorIntent(Activity activity, int i12) {
        g.j(i12, "Enter getResolveErrorIntent, errorCode: ", "HuaweiApiAvailabilityImpl");
        if (i12 == 1 || i12 == 2) {
            if (Util.isAvailableLibExist(activity)) {
                ...
                try {
                    ...
                    D8.q(e12, new StringBuilder("getString has Exception:"), "HuaweiApiAvailabilityImpl");
                }
            ...
            if (i12 == 9 && Util.isAvailableLibExist(activity)) {
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public PendingIntent getResolveErrorPendingIntent(Activity activity, int i12) {
        g.j(i12, "Enter getResolveErrorPendingIntent, errorCode: ", "HuaweiApiAvailabilityImpl");
        Intent resolveErrorIntent = getResolveErrorIntent(activity, i12);
        if (resolveErrorIntent != null) {
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public boolean isUserResolvableError(int i12, PendingIntent pendingIntent) {
        if (i12 == 0) {
            return false;
        }
        return pendingIntent != null || i12 == 1 || i12 == 2 || i12 == 6 || i12 == 9;
    }
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public void resolveError(Activity activity, int i12, int i13) throws IntentSender.SendIntentException {
        resolveError(activity, i12, i13, null);
    }
    ...
    public void showErrorNotification(Context context, int i12) {
        Checker.checkNonNull(context, "context must not be null.");
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter showErrorNotification, errorCode: " + i12);
        if (!(context instanceof Activity)) {
            HMSLog.i("HuaweiApiAvailabilityImpl", "context not instanceof Activity");
            return;
        }
        Dialog errorDialog = getErrorDialog((Activity) context, i12, 0);
        if (errorDialog == null) {
    ...
    public boolean isUserResolvableError(int i12) {
        return isUserResolvableError(i12, null);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public void resolveError(Activity activity, int i12, int i13, PendingIntent pendingIntent) throws IntentSender.SendIntentException {
        Checker.checkNonNull(activity, "activity must not be null.");
        if (pendingIntent != null) {
            g.j(i12, "Enter resolveError, param pendingIntent is not null. and.errorCode: ", "HuaweiApiAvailabilityImpl");
        } else {
            g.j(i12, "Enter resolveError, param pendingIntent is  null. get pendingIntent from error code.and.errorCode: ", "HuaweiApiAvailabilityImpl");
            pendingIntent = getResolveErrorPendingIntent(activity, i12);
        }
        if (pendingIntent != null) {
            g.j(i12, "In resolveError, start pendingIntent.errorCode: ", "HuaweiApiAvailabilityImpl");
            try {
                activity.startIntentSenderForResult(pendingIntent.getIntentSender(), i13, null, 0, 0, 0);
            } catch (IntentSender.SendIntentException unused) {
                HMSLog.e("HuaweiApiAvailabilityImpl", "Enter resolveError, start pendingIntent failed.errorCode: " + i12);
            }
        }
    }
    ...
    public Intent a(Context context, int i12) {
        ...
        if (i12 == 1 || i12 == 2) {
            ...
            if (i12 == 9 && Util.isAvailableLibExist(context)) {
    ...
    public Dialog getErrorDialog(Activity activity, int i12, int i13, DialogInterface.OnCancelListener onCancelListener) {
        Checker.checkNonNull(activity, "activity must not be null.");
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getErrorDialog, errorCode: " + i12);
        return a(activity, i12, DialogRedirect.getInstance(activity, a(activity, i12), i13), onCancelListener);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public int isHuaweiMobileServicesAvailable(Context context, int i12) {
        Checker.checkNonNull(context, "context must not be null.");
        return HuaweiMobileServicesUtil.isHuaweiMobileServicesAvailable(context, i12);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public boolean showErrorDialogFragment(Activity activity, int i12, Fragment fragment, int i13, DialogInterface.OnCancelListener onCancelListener) {
        return showErrorDialogFragment(activity, i12, i13, onCancelListener);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public PendingIntent getErrPendingIntent(Context context, int i12, int i13) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorPendingIntent, errorCode: " + i12 + " requestCode: " + i13);
        Intent intentA = a(context, i12);
        if (intentA != null) {
            return PendingIntent.getActivity(context, i13, intentA, 67108864);
        }
        return null;
    }
    ...
    public Task<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr) {
        ...
        if (huaweiApiCallable != null) {
            try {
                ...
                HMSLog.i("HuaweiApiAvailabilityImpl", "HuaweiApiCallable checkApi has AvailabilityException " + e12.getMessage());
            }
        }
    ...
    private Intent a(Activity activity, int i12) {
        g.j(i12, "getErrorResolutionIntent, errorCode: ", "HuaweiApiAvailabilityImpl");
        if (i12 == 1 || i12 == 2) {
            if (Util.isAvailableLibExist(activity)) {
    ...
    private static Dialog a(Activity activity, int i12, DialogRedirect dialogRedirect, DialogInterface.OnCancelListener onCancelListener) {
        if (i12 == 0) {
            return null;
        }
        AlertDialog.Builder builder = new AlertDialog.Builder(activity, a(activity));
        builder.setMessage(ConnectionErrorMessages.getErrorMessage(activity, i12));
        if (onCancelListener != null) {
            builder.setOnCancelListener(onCancelListener);
        }
        builder.setPositiveButton(ConnectionErrorMessages.getErrorDialogButtonMessage(activity, i12), dialogRedirect);
        String errorTitle = ConnectionErrorMessages.getErrorTitle(activity, i12);
        if (errorTitle != null) {
