...
public class ForegroundBusDelegate implements IBridgeActivityDelegate {
    ...
    public void errorReturn(int i12, String str) {
        ...
        if (responseCallback == null || (busResponseResultInnerError = responseCallback.innerError(this.mThisWeakRef.get(), i12, str)) == null) {
    ...
    public void startApkHubActivity() {
        ...
        try {
            ...
            HMSLog.e(TAG, "Launch sign in Intent failed. hms is probably being updated：", e12);
            errorReturn(0, "launch bus intent failed");
        }
    }

    private void succeedReturn(int i12, Intent intent) {
    ...
    @Override // com.huawei.hms.activity.IBridgeActivityDelegate
    public boolean onBridgeActivityResult(int i12, int i13, Intent intent) throws IllegalArgumentException {
        if (i12 != REQUEST_CODE_BUS) {
            return false;
        }
        ...
        if (responseCallback == null) {
            succeedReturn(i13, intent);
            return true;
        }
        BusResponseResult busResponseResultSucceedReturn = responseCallback.succeedReturn(this.mThisWeakRef.get(), i13, intent);
