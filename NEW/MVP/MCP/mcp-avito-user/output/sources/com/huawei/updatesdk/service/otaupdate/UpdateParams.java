...
public class UpdateParams {
    ...
    public static final class Builder {
        ...
        public Builder setIsShowImmediate(boolean z12) {
            this.isShowImmediate = z12;
            return this;
        }

        public Builder setMinIntervalDay(int i12) {
            this.minIntervalDay = i12;
            return this;
        }

        public Builder setMustBtnOne(boolean z12) {
            this.mustBtnOne = z12;
            return this;
        }
