...
public final class PendingResultsCreator {
    ...
    public static <R extends Result> PendingResult<R> discardedPendingResult(R r12) {
        return new DiscardedPendingResult(r12);
    }

    public static <R extends Result> OptionalPendingResult<R> instantPendingResult(R r12) {
        return new OptionalPendingResultImpl(new InstantPendingResult(r12));
    }
}
