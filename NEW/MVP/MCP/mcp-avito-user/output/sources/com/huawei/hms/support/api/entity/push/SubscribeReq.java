...
public class SubscribeReq implements IMessageEntity {
    ...
    public void setFastApp(boolean z12) {
        this.isFastApp = z12;
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("SubscribeReq{packageName='");
        sb2.append(this.packageName);
        sb2.append("', operation='");
        return c.s(sb2, this.operation, "'}");
    }
    ...
    public SubscribeReq(Context context, String str, String str2) {
        ...
        this.projectId = ((d) a.c(context)).getString("client/project_id");
    }
}
