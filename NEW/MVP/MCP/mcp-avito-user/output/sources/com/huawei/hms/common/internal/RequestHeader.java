...
public class RequestHeader implements IMessageEntity {
    ...
    @Packed
    private int sdk_version = 60300303;
    ...
    public boolean fromJson(String str) {
        try {
            ...
            HMSLog.e(TAG, "fromJson failed: " + e12.getMessage());
            return false;
        }
    }
    ...
    public void setSdkVersion(int i12) {
    ...
    public String toJson() throws JSONException {
        ...
        try {
            ...
            HMSLog.e(TAG, "toJson failed: " + e12.getMessage());
        }
