...
public class TransactionIdCreater {
    ...
    public static String getId(String str, String str2) {
        ...
        sb2.append(StringUtil.addByteForNum(str, 9, FILL_BYTE));
        sb2.append(StringUtil.addByteForNum(str2, 6, FILL_BYTE));
        Locale locale = Locale.ENGLISH;
        sb2.append(new SimpleDateFormat("yyyyMMddHHmmssSSS", locale).format(new Date()));
        sb2.append(String.format(locale, "%06d", Integer.valueOf(new Random().nextInt(1000000))));
        return sb2.toString();
    }
}
