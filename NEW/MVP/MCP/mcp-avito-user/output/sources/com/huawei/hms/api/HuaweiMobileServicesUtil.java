...
public abstract class HuaweiMobileServicesUtil {
    ...
    public static Dialog getErrorDialog(int i12, Activity activity, int i13) {
        return HuaweiApiAvailability.getInstance().getErrorDialog(activity, i12, i13, null);
    }

    public static String getErrorString(int i12) {
        return HuaweiApiAvailability.getInstance().getErrorString(i12);
    }
    ...
    public static int isHuaweiMobileServicesAvailable(Context context, int i12) {
        ...
        if (!HMSPackageManager.getInstance(context).isApkUpdateNecessary(i12)) {
            return 0;
        }
    ...
    public static boolean isUserRecoverableError(int i12) {
        return HuaweiApiAvailability.getInstance().isUserResolvableError(i12);
    }

    public static boolean popupErrDlgFragment(int i12, Activity activity, int i13, DialogInterface.OnCancelListener onCancelListener) {
        return HuaweiApiAvailability.getInstance().showErrorDialogFragment(activity, i12, i13, onCancelListener);
    }
    ...
    public static boolean showErrorDialogFragment(int i12, Activity activity, int i13) {
        return HuaweiApiAvailability.getInstance().showErrorDialogFragment(activity, i12, i13, null);
    }

    public static void showErrorNotification(int i12, Context context) {
        HuaweiApiAvailability.getInstance().showErrorNotification(context, i12);
    }

    public static Dialog getErrorDialog(int i12, Activity activity, int i13, DialogInterface.OnCancelListener onCancelListener) {
        return HuaweiApiAvailability.getInstance().getErrorDialog(activity, i12, i13, onCancelListener);
    }

    public static boolean popupErrDlgFragment(int i12, Activity activity, Fragment fragment, int i13, DialogInterface.OnCancelListener onCancelListener) {
        return HuaweiApiAvailability.getInstance().showErrorDialogFragment(activity, i12, fragment, i13, onCancelListener);
    }
