...
public class DataBufferRef {
    ...
    public DataBufferRef(DataHolder dataHolder, int i12) {
    ...
    public final void getWindowIndex(int i12) {
        Preconditions.checkArgument(i12 >= 0 && i12 < this.mDataHolder.getCount(), "rowNum is out of index");
        this.mDataRow = i12;
        this.windowIndex = this.mDataHolder.getWindowIndex(i12);
    }
