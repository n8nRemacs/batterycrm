...
public abstract class HmsClient extends BaseHmsClient implements AnyClient {
    ...
    public void post(IMessageEntity iMessageEntity, String str, AnyClient.CallBack callBack) throws IllegalArgumentException {
        ...
        boolean z12 = cpActivity == null;
        if (z12) {
            HMSLog.i(TAG, "Activity is null for " + getClientSettings().getAppID());
        }
        (z12 ? new BaseAdapter(this) : new BaseAdapter(this, cpActivity)).baseRequest(requestHeader.toJson(), str, requestHeader.getParcelable(), new BaseAdapterCallBack(this, callBack));
    }
