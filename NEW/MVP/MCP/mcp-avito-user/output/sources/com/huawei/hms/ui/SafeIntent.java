...
public class SafeIntent extends Intent {
    ...
    public boolean getBooleanExtra(String str, boolean z12) {
        try {
            return super.getBooleanExtra(str, z12);
        } catch (Exception unused) {
            return z12;
        }
    }
    ...
    public byte getByteExtra(String str, byte b12) {
        try {
            return super.getByteExtra(str, b12);
        } catch (Exception unused) {
            return b12;
        }
    }
    ...
    public char getCharExtra(String str, char c12) {
        try {
            return super.getCharExtra(str, c12);
        } catch (Exception unused) {
            return c12;
        }
    }
    ...
    public double getDoubleExtra(String str, double d12) {
        try {
            return super.getDoubleExtra(str, d12);
        } catch (Exception unused) {
            return d12;
        }
    }
    ...
    public float getFloatExtra(String str, float f12) {
        try {
            return super.getFloatExtra(str, f12);
        } catch (Exception unused) {
            return f12;
        }
    }
    ...
    public int getIntExtra(String str, int i12) {
        try {
            return super.getIntExtra(str, i12);
        } catch (Exception unused) {
            return i12;
        }
    }
    ...
    public long getLongExtra(String str, long j12) {
        try {
            return super.getLongExtra(str, j12);
        } catch (Exception unused) {
            return j12;
        }
    }
