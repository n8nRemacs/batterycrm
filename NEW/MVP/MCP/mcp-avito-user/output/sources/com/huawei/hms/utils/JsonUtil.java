...
public class JsonUtil {
    ...
    public static String createJsonString(IMessageEntity iMessageEntity) {
        ...
        try {
            ...
            HMSLog.e(TAG, "catch IllegalAccessException " + e12.getMessage());
            return "";
        } catch (JSONException e13) {
            HMSLog.e(TAG, "catch JSONException " + e13.getMessage());
            return "";
        }
    }

    private static boolean disposeType(String str, Object obj, JSONObject jSONObject) throws JSONException {
        ...
        if (obj instanceof IMessageEntity) {
            try {
                ...
                HMSLog.e(TAG, "IllegalAccessException , " + e12);
            }
        }
        return false;
    }
    ...
    private static Object getObjectValue(String str, JSONObject jSONObject) {
    ...
    public static IMessageEntity jsonToEntity(String str, IMessageEntity iMessageEntity) throws IllegalArgumentException {
        try {
            ...
            HMSLog.e(TAG, "catch JSONException when parse jsonString" + e12.getMessage());
        }
        return iMessageEntity;
    }

    private static byte[] readByte(JSONObject jSONObject) {
        try {
            return Base64.decode(jSONObject.getString(BYTE_BYTE));
        } catch (IllegalArgumentException e12) {
            HMSLog.e(TAG, "readByte failed : " + e12.getMessage());
            return null;
        }
    }
    ...
    private static Object readJson(IMessageEntity iMessageEntity, Field field, JSONObject jSONObject) throws JSONException {
        ...
        if (objectValue != null) {
            try {
                ...
                int i12 = ((JSONObject) objectValue).getInt(VAL_TYPE);
                if (i12 != 1 && i12 != 0) {
                    if (i12 == 2) {
                    ...
                    HMSLog.e(TAG, "cannot support type : " + i12);
                }
    ...
    private static List<Object> readList(Type type, JSONObject jSONObject) throws JSONException {
        int i12 = jSONObject.getInt(LIST_SIZE);
        int i13 = jSONObject.getInt(VAL_TYPE);
        ArrayList arrayList = new ArrayList(i12);
        for (int i14 = 0; i14 < i12; i14++) {
            Object obj = jSONObject.get(LIST_ITEM_VALUE + i14);
            if (i13 == 0) {
    ...
    private static Map readMap(Type type, JSONObject jSONObject) throws IllegalArgumentException {
        ...
        for (int i12 = 0; i12 < jSONArray.length(); i12 += 2) {
            if (cls.newInstance() instanceof IMessageEntity) {
                map.put(jSONArray.get(i12), jsonToEntity(jSONArray.getString(i12 + 1), (IMessageEntity) cls.newInstance()));
            } else {
                map.put(jSONArray.get(i12), jSONArray.get(i12 + 1));
            }
        }
        return map;
    }

    private static void setAccessible(final Field field, final boolean z12) {
    ...
    private static void writeByte(String str, byte[] bArr, JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            HMSLog.e(TAG, "writeByte failed : " + e12.getMessage());
        }
        jSONObject.put(str, jSONObject2);
    }

    private static void writeList(String str, List<?> list, JSONObject jSONObject) throws JSONException {
        JSONObject jSONObject2 = new JSONObject();
        jSONObject2.put(VAL_TYPE, 1);
        jSONObject2.put(LIST_SIZE, list.size());
        for (int i12 = 0; i12 < list.size(); i12++) {
            disposeType(c.g(i12, LIST_ITEM_VALUE), list.get(i12), jSONObject2);
            if (list.get(i12) instanceof IMessageEntity) {
    ...
    private static void writeMap(String str, Map map, JSONObject jSONObject) throws JSONException {
