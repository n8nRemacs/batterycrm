...
public final class C49061d {
    ...
    public C49061d(@l String str, @k String str2, @k DeepLink deepLink) {
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
    }
