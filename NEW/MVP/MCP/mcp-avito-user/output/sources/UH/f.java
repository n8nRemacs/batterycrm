...
public final class f {
    ...
    public f(@l String str, @k String str2, @l DeepLink deepLink) {
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
    }
