...
/* compiled from: DescriptionItemSpan.kt */
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Ljw/a;", "Landroid/text/style/LeadingMarginSpan;", "_avito_details-sheet_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* renamed from: jw.a, reason: case insensitive filesystem */
/* loaded from: classes12.dex */
public final class C42433a implements LeadingMarginSpan {

    /* renamed from: b, reason: collision with root package name */
    public final int f405888b;

    /* renamed from: c, reason: collision with root package name */
    @k
    public final String f405889c;

    public C42433a(int i12, @k String str) {
        this.f405888b = i12;
        this.f405889c = str;
    }
    ...
    public final void drawLeadingMargin(@k Canvas canvas, @k Paint paint, int i12, int i13, int i14, int i15, int i16, @l CharSequence charSequence, int i17, int i18, boolean z12, @k Layout layout) {
        ...
        if (spanned.getSpanStart(this) == i17) {
            canvas.drawText(this.f405889c, 0.0f, lineBaseline, paint);
        }
    }

    @Override // android.text.style.LeadingMarginSpan
    public final int getLeadingMargin(boolean z12) {
        return this.f405888b;
    }
}
