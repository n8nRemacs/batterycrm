...
public final class j {
    ...
    public j(@Y61.l String str, @Y61.k String str2, @Y61.k DeepLink deepLink) {
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
    }
