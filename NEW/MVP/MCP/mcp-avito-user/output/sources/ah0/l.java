...
public final /* data */ class l {
    ...
    public l(@Y61.k String str, @Y61.k LocationPickerAddressType locationPickerAddressType, @Y61.k String str2, int i12, int i13) {
        this.address = str;
    ...
    public final boolean equals(@Y61.l Object obj) {
        ...
        l lVar = (l) obj;
        return L.f(this.address, lVar.address) && this.addressKind == lVar.addressKind && L.f(this.geoSessionId, lVar.geoSessionId) && this.addressesCount == lVar.addressesCount && this.addressId == lVar.addressId;
    }
    ...
    public final String toString() {
        StringBuilder sb2 = new StringBuilder("UpdateAddressResult(address=");
