...
public final class i {
    ...
    public i(@Y61.l String str, @Y61.k String str2, @Y61.l DeepLink deepLink) {
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
    }
