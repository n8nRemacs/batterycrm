...
public final class C44309e {
    ...
    @l
    private final List<C44313i> notes;
    ...
    public C44309e(@l List<String> list, @k String str, @l List<C44313i> list2, @l String str2, @k String str3, @l String str4) {
        this.badges = list;
        this.name = str;
        this.notes = list2;
        this.phone = str2;
