...
public final class k extends N implements Y41.a {
    ...
    public final /* synthetic */ ru.mts.biometry.sdk.feature.document.chooseDocument.searchCountry.l f11277l;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(ru.mts.biometry.sdk.feature.document.chooseDocument.searchCountry.l lVar) {
        super(0);
        this.f11277l = lVar;
    }
    ...
    public final Object invoke() {
        ru.mts.biometry.sdk.feature.document.chooseDocument.searchCountry.l lVar = this.f11277l;
        lVar.requireContext();
