...
public final class C49194b {
    ...
    public C49194b(@l Boolean bool, @l String str, @k String str2, @l DeepLink deepLink) {
        this.isEnabled = bool;
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
