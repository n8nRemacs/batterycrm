...
public final class C49193a {
    ...
    public C49193a(@l Boolean bool, @l String str, @k String str2, @l DeepLink deepLink) {
        this.isEnabled = bool;
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
