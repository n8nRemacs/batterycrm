...
public abstract class CronetProvider {
    ...
    private static boolean addCronetProviderImplByClassName(Context context, String str, Set<CronetProvider> set, boolean z12) {
        try {
            ...
            logReflectiveOperationException(str, z12, e12);
            return false;
        } catch (IllegalAccessException e13) {
            logReflectiveOperationException(str, z12, e13);
            return false;
        } catch (InstantiationException e14) {
            logReflectiveOperationException(str, z12, e14);
            return false;
        } catch (NoSuchMethodException e15) {
            logReflectiveOperationException(str, z12, e15);
            return false;
        } catch (InvocationTargetException e16) {
            logReflectiveOperationException(str, z12, e16);
            return false;
        }
    }
    ...
    private static void logReflectiveOperationException(String str, boolean z12, Exception exc) {
        if (z12) {
            return;
        }
