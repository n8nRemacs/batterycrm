...
public final class B extends AbstractC44857a {
    private static final long serialVersionUID = -3148237568046877177L;

    /* renamed from: N, reason: collision with root package name */
    public transient B f420474N;

    @Override // org.joda.time.AbstractC44854a
    public final AbstractC44854a N() {
        if (this.f420474N == null) {
            if (o() == AbstractC44868j.f420911c) {
                ...
                this.f420474N = new B(abstractC44854aN, null);
            }
        }
        return this.f420474N;
    }
    ...
    public final AbstractC44854a O(AbstractC44868j abstractC44868j) throws ClassNotFoundException {
        ...
        if (abstractC44854aO != null) {
            return new B(abstractC44854aO, null);
        }
        throw new IllegalArgumentException("Must supply a chronology");
    }
    ...
    public final AbstractC44864f V(AbstractC44864f abstractC44864f) {
        if (abstractC44864f == null) {
            return null;
        }
        if (abstractC44864f instanceof org.joda.time.field.v) {
            abstractC44864f = ((org.joda.time.field.v) abstractC44864f).f420693b;
        }
        return abstractC44864f.A() ? abstractC44864f : new org.joda.time.field.l(this.f420508b, abstractC44864f);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f420508b.equals(((B) obj).f420508b);
    }

    public final int hashCode() {
        return (this.f420508b.hashCode() * 7) + 236548278;
    }

    @Override // org.joda.time.AbstractC44854a
    public final String toString() {
        return "LenientChronology[" + this.f420508b.toString() + ']';
    }
}
