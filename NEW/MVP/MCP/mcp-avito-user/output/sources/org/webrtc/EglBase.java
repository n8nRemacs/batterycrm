...
public interface EglBase {
    ...
    public static class ConfigBuilder {
        ...
        public ConfigBuilder setHasAlphaChannel(boolean z12) {
            this.hasAlphaChannel = z12;
            return this;
        }

        public ConfigBuilder setIsRecordable(boolean z12) {
            this.isRecordable = z12;
            return this;
        }

        public ConfigBuilder setOpenGlesVersion(int i12) {
            if (i12 < 1 || i12 > 3) {
                throw new IllegalArgumentException(G.e(i12, "OpenGL ES version ", " not supported"));
            }
            this.openGlesVersion = i12;
            return this;
        }

        public ConfigBuilder setSupportsPixelBuffer(boolean z12) {
            this.supportsPixelBuffer = z12;
            return this;
        }
    }
    ...
    public interface EglConnection extends RefCounted {
        static EglConnection create(@P Context context, int[] iArr) {
            if (context == null) {
    ...
    void createPbufferSurface(int i12, int i13);
    ...
    static EglBase create(@P Context context, int[] iArr) {
        if (context == null) {
            return createEgl14(iArr);
        }
        if (context instanceof EglBase14.Context) {
