...
public class PeerConnection {
    ...
    public enum AdapterType {
        ...
        @P
        public static AdapterType fromNativeIndex(int i12) {
            return BY_BITMASK.get(Integer.valueOf(i12));
        }
    }
    ...
    public enum IceConnectionState {
        ...
        public static IceConnectionState fromNativeIndex(int i12) {
            return values()[i12];
        }
    }
    ...
    public enum IceGatheringState {
        ...
        public static IceGatheringState fromNativeIndex(int i12) {
            return values()[i12];
        }
    }
    ...
    public static class IceServer {
        ...
        public static class Builder {
            ...
            public /* synthetic */ Builder(List list, int i12) {
                this(list);
            }
        ...
        public /* synthetic */ IceServer(String str, List list, String str2, String str3, TlsCertPolicy tlsCertPolicy, String str4, List list2, List list3, int i12) {
    ...
    public enum PeerConnectionState {
        ...
        public static PeerConnectionState fromNativeIndex(int i12) {
            return values()[i12];
        }
    }
    ...
    public enum SignalingState {
        ...
        public static SignalingState fromNativeIndex(int i12) {
            return values()[i12];
        }
    }
    ...
    private native boolean nativeAddIceCandidate(String str, int i12, String str2);

    private native void nativeAddIceCandidateWithObserver(String str, int i12, String str2, AddIceObserver addIceObserver);

    private native boolean nativeAddLocalStream(long j12);

    private native RtpSender nativeAddTrack(long j12, List<String> list);

    private native RtpTransceiver nativeAddTransceiverOfType(MediaStreamTrack.MediaType mediaType, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit);

    private native RtpTransceiver nativeAddTransceiverWithTrack(long j12, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit);
    ...
    private native void nativeDoCrash();

    private static native void nativeFreeOwnedPeerConnection(long j12);
    ...
    private native void nativeNewGetStatsReceiver(long j12, RTCStatsCollectorCallback rTCStatsCollectorCallback);

    private native void nativeNewGetStatsSender(long j12, RTCStatsCollectorCallback rTCStatsCollectorCallback);

    private native boolean nativeOldGetStats(StatsObserver statsObserver, long j12);

    private native boolean nativeRemoveIceCandidates(IceCandidate[] iceCandidateArr);

    private native void nativeRemoveLocalStream(long j12);

    private native boolean nativeRemoveTrack(long j12);

    private native void nativeRestartIce();

    private native void nativeSetAudioPlayout(boolean z12);

    private native void nativeSetAudioRecording(boolean z12);
    ...
    private native boolean nativeStartRtcEventLog(int i12, int i13);
    ...
    @Deprecated
    public boolean getStats(StatsObserver statsObserver, @P MediaStreamTrack mediaStreamTrack) {
    ...
    public void setAudioPlayout(boolean z12) {
        nativeSetAudioPlayout(z12);
    }

    public void setAudioRecording(boolean z12) {
        nativeSetAudioRecording(z12);
    }
    ...
    public boolean startRtcEventLog(int i12, int i13) {
        return nativeStartRtcEventLog(i12, i13);
    }
    ...
    public RtpTransceiver addTransceiver(MediaStreamTrack mediaStreamTrack, @P RtpTransceiver.RtpTransceiverInit rtpTransceiverInit) {
    ...
    public RtpTransceiver addTransceiver(MediaStreamTrack.MediaType mediaType, @P RtpTransceiver.RtpTransceiverInit rtpTransceiverInit) {
        if (mediaType != null) {
            if (rtpTransceiverInit == null) {
                rtpTransceiverInit = new RtpTransceiver.RtpTransceiverInit();
            }
    ...
    public interface Observer {
        ...
        @CalledByNative("Observer")
        void onIceConnectionReceivingChange(boolean z12);
