...
class Camera1Session implements CameraSession {
    ...
    private Camera1Session(CameraSession.Events events, boolean z12, Context context, SurfaceTextureHelper surfaceTextureHelper, int i12, Camera camera, Camera.CameraInfo cameraInfo, CameraEnumerationAndroid.CaptureFormat captureFormat, long j12) {
    ...
    public static void create(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, boolean z12, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i12, int i13, int i14) throws IOException {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        CameraEnumerationAndroid.CaptureFormat captureFormatFindClosestCaptureFormat = findClosestCaptureFormat(parameters, i12, i13, i14);
                        updateCameraParameters(cameraOpen, parameters, captureFormatFindClosestCaptureFormat, findClosestPictureSize(parameters, i12, i13), z12);
                        if (!z12) {
                        ...
                        try {
                            ...
                            createSessionCallback.onDone(new Camera1Session(events, z12, context, surfaceTextureHelper, cameraIndex, cameraOpen, cameraInfo, captureFormatFindClosestCaptureFormat, jNanoTime));
    ...
    private static CameraEnumerationAndroid.CaptureFormat findClosestCaptureFormat(Camera.Parameters parameters, int i12, int i13, int i14) {
        ...
        CameraEnumerationAndroid.CaptureFormat.FramerateRange closestSupportedFramerateRange = CameraEnumerationAndroid.getClosestSupportedFramerateRange(listConvertFramerates, i14);
        Size closestSupportedSize = CameraEnumerationAndroid.getClosestSupportedSize(Camera1Enumerator.convertSizes(parameters.getSupportedPreviewSizes()), i12, i13);
        CameraEnumerationAndroid.reportCameraResolution(camera1ResolutionHistogram, closestSupportedSize);
        return new CameraEnumerationAndroid.CaptureFormat(closestSupportedSize.width, closestSupportedSize.height, closestSupportedFramerateRange);
    }

    private static Size findClosestPictureSize(Camera.Parameters parameters, int i12, int i13) {
        return CameraEnumerationAndroid.getClosestSupportedSize(Camera1Enumerator.convertSizes(parameters.getSupportedPictureSizes()), i12, i13);
    }
    ...
    private void startCapturing() {
        ...
        this.camera.setErrorCallback(new Camera.ErrorCallback() { // from class: org.webrtc.Camera1Session.1
            ...
            public void onError(int i12, Camera camera) {
                String strG = i12 == 100 ? "Camera server died!" : AK.c.g(i12, "Camera error: ");
                Logging.e(Camera1Session.TAG, strG);
                Camera1Session.this.stopInternal();
                if (i12 == 2) {
                    Camera1Session.this.events.onCameraDisconnected(Camera1Session.this);
                } else {
                    Camera1Session.this.events.onCameraError(Camera1Session.this, strG);
                }
            }
        });
    ...
    private static void updateCameraParameters(Camera camera, Camera.Parameters parameters, CameraEnumerationAndroid.CaptureFormat captureFormat, Size size, boolean z12) {
