...
class GlGenericDrawer implements RendererCommon.GlDrawer {
    ...
    public interface ShaderCallbacks {
        ...
        void onPrepareShader(GlShader glShader, float[] fArr, int i12, int i13, int i14, int i15);
    }
    ...
    private void prepareShader(ShaderType shaderType, float[] fArr, int i12, int i13, int i14, int i15) {
        GlShader glShader;
        ...
        this.shaderCallbacks.onPrepareShader(glShader, fArr, i12, i13, i14, i15);
    ...
    public void drawOes(int i12, float[] fArr, int i13, int i14, int i15, int i16, int i17, int i18) {
        prepareShader(ShaderType.OES, fArr, i13, i14, i17, i18);
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawRgb(int i12, float[] fArr, int i13, int i14, int i15, int i16, int i17, int i18) {
        prepareShader(ShaderType.RGB, fArr, i13, i14, i17, i18);
        GLES20.glActiveTexture(33984);
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawYuv(int[] iArr, float[] fArr, int i12, int i13, int i14, int i15, int i16, int i17) {
        prepareShader(ShaderType.YUV, fArr, i12, i13, i16, i17);
