...
public class Camera1Capturer extends CameraCapturer {
    ...
    public Camera1Capturer(String str, CameraVideoCapturer.CameraEventsHandler cameraEventsHandler, boolean z12) {
        super(str, cameraEventsHandler, new Camera1Enumerator(z12));
    ...
    public void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i12, int i13, int i14) throws IOException {
        Camera1Session.create(createSessionCallback, events, this.captureToTexture, context, surfaceTextureHelper, str, i12, i13, i14);
    }
