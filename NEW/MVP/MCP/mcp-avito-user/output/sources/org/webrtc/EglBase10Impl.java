...
public class EglBase10Impl implements EglBase10 {
    ...
    public static class EglConnection implements EglBase10.EglConnection {
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            this.refCountDelegate = new RefCountDelegate(new c(this, 0));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new com.google.android.datatransport.runtime.scheduling.jobscheduling.b(1));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static EGLContext createEglContext(EGL10 egl10, @P EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i12) {
        EGLContext eGLContextEglCreateContext;
        if (eGLContext != null && eGLContext == EGL10.EGL_NO_CONTEXT) {
            throw new RuntimeException("Invalid sharedContext");
        }
        int[] iArr = {EGL_CONTEXT_CLIENT_VERSION, i12, 12344};
        if (eGLContext == null) {
        ...
        throw new GLException(egl10.eglGetError(), G.f("Failed to create EGL context: 0x", Integer.toHexString(egl10.eglGetError())));
    }
    ...
    private void createSurfaceInternal(Object obj) {
        ...
        if (eGLSurfaceEglCreateWindowSurface == eGLSurface2) {
            throw new GLException(egl.eglGetError(), G.f("Failed to create window surface: 0x", Integer.toHexString(egl.eglGetError())));
        }
    }
    ...
    public static EGLConfig getEglConfig(EGL10 egl10, EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!egl10.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            throw new GLException(egl10.eglGetError(), G.f("eglChooseConfig failed: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (iArr2[0] <= 0) {
    ...
    public static EGLDisplay getEglDisplay(EGL10 egl10) {
        ...
        if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            throw new GLException(egl10.eglGetError(), G.f("Unable to get EGL10 display: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (egl10.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
            return eGLDisplayEglGetDisplay;
        }
        throw new GLException(egl10.eglGetError(), G.f("Unable to initialize EGL10: 0x", Integer.toHexString(egl10.eglGetError())));
    }
    ...
    public void createPbufferSurface(int i12, int i13) {
        ...
        EGL10 egl = this.eglConnection.getEgl();
        EGLSurface eGLSurfaceEglCreatePbufferSurface = egl.eglCreatePbufferSurface(this.eglConnection.getDisplay(), this.eglConnection.getConfig(), new int[]{12375, i12, 12374, i13, 12344});
