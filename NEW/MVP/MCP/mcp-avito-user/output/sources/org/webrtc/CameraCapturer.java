...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    public CameraCapturer(String str, @P CameraVideoCapturer.CameraEventsHandler cameraEventsHandler, CameraEnumerator cameraEnumerator) {
        ...
        if (!listAsList.contains(this.cameraName)) {
            throw new IllegalArgumentException(AK.c.k("Camera name ", this.cameraName, " does not match any known camera device."));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void createSessionInternal(int i12) {
        this.uiThreadHandler.postDelayed(this.openCameraTimeoutRunnable, i12 + 10000);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void reportCameraSwitchError(String str, @P CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler) {
        Logging.e(TAG, str);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void switchCameraInternal(@P CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        Logging.d(TAG, "switchCamera internal");
        if (!Arrays.asList(this.cameraEnumerator.getDeviceNames()).contains(str)) {
            reportCameraSwitchError(G.f("Attempted to switch to unknown camera device ", str), cameraSwitchHandler);
            return;
        }
        synchronized (this.stateLock) {
            try {
                ...
                boolean z12 = this.sessionOpening;
                if (!z12 && this.currentSession == null) {
    ...
    public void changeCaptureFormat(int i12, int i13, int i14) {
        StringBuilder sbY = androidx.appcompat.app.r.y(i12, i13, "changeCaptureFormat: ", "x", "@");
        sbY.append(i14);
    ...
    public abstract void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i12, int i13, int i14);
    ...
    public void startCapture(int i12, int i13, int i14) {
        StringBuilder sbY = androidx.appcompat.app.r.y(i12, i13, "startCapture: ", "x", "@");
        sbY.append(i14);
        Logging.d(TAG, sbY.toString());
