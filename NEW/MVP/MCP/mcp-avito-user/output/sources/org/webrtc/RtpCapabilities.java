...
public class RtpCapabilities {
    ...
    public static class CodecCapability {
        ...
        @CalledByNative("CodecCapability")
        public CodecCapability(int i12, String str, MediaStreamTrack.MediaType mediaType, Integer num, Integer num2, String str2, Map<String, String> map) {
            this.preferredPayloadType = i12;
            this.name = str;
            this.kind = mediaType;
            this.clockRate = num;
    ...
    public static class HeaderExtensionCapability {
        ...
        public HeaderExtensionCapability(String str, int i12, boolean z12) {
            this.uri = str;
            this.preferredId = i12;
            this.preferredEncrypted = z12;
        }
