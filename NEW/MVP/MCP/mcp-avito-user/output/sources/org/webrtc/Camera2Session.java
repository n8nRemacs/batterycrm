...
class Camera2Session implements CameraSession {
    ...
    public static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        public /* synthetic */ CameraCaptureCallback(int i12) {
            this();
        }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        public /* synthetic */ CameraStateCallback(Camera2Session camera2Session, int i12) {
            this();
        }

        private String getErrorDescription(int i12) {
            return i12 != 1 ? i12 != 2 ? i12 != 3 ? i12 != 4 ? i12 != 5 ? AK.c.g(i12, "Unknown camera error: ") : "Camera service has encountered a fatal error." : "Camera device has encountered a fatal error." : "Camera device could not be opened due to a device policy." : "Camera device could not be opened because there are too many other open camera devices." : "Camera device is in use already.";
        }
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            boolean z12 = Camera2Session.this.captureSession == null && Camera2Session.this.state != SessionState.STOPPED;
        ...
        public void onError(CameraDevice cameraDevice, int i12) {
            Camera2Session.this.checkIsOnCameraThread();
            Camera2Session.this.reportError(getErrorDescription(i12));
        }
        ...
        public void onOpened(CameraDevice cameraDevice) throws CameraAccessException {
            ...
            try {
                ...
                Camera2Session.this.reportError("Failed to create capture session. " + e12);
            }
        }
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        public /* synthetic */ CaptureSessionCallback(Camera2Session camera2Session, int i12) {
            this();
        }

        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i12 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i12 == 3) {
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) throws CameraAccessException {
            ...
            try {
                ...
                Camera2Session.this.reportError("Failed to start capture request. " + e12);
            }
        }
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i12, int i13, int i14) throws CameraAccessException {
    ...
    public static void create(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i12, int i13, int i14) {
        new Camera2Session(createSessionCallback, events, context, cameraManager, surfaceTextureHelper, str, i12, i13, i14);
    }
    ...
    private void openCamera() throws CameraAccessException {
        ...
        try {
            ...
            reportError("Failed to open camera: " + e12);
        }
    }
    ...
    public void reportError(String str) {
        ...
        boolean z12 = this.captureSession == null && this.state != SessionState.STOPPED;
    ...
    private void start() throws CameraAccessException {
        ...
        try {
            ...
            reportError(G.f("getCameraCharacteristics(): ", e12.getMessage()));
        }
    }
