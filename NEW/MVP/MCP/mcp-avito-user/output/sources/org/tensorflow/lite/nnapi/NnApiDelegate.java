...
public class NnApiDelegate implements Delegate, AutoCloseable {
    ...
    public static final class Options {
        ...
        public Options setAllowFp16(boolean z12) {
            this.allowFp16 = Boolean.valueOf(z12);
            return this;
        }
        ...
        public Options setExecutionPreference(int i12) {
            this.executionPreference = i12;
            return this;
        }

        public Options setMaxNumberOfDelegatedPartitions(int i12) {
            this.maxDelegatedPartitions = Integer.valueOf(i12);
            return this;
        }
        ...
        public Options setNnApiSupportLibraryHandle(long j12) {
            this.nnApiSupportLibraryHandle = j12;
            return this;
        }

        public Options setUseNnapiCpu(boolean z12) {
            this.useNnapiCpu = Boolean.valueOf(z12);
            return this;
        }
    }
