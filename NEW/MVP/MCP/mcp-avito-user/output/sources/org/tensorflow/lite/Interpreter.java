...
public final class Interpreter extends InterpreterImpl implements InterpreterApi {
    ...
    public static class Options extends InterpreterImpl.Options {
        ...
        public Options setAllowBufferHandleOutput(boolean z12) {
            this.allowBufferHandleOutput = Boolean.valueOf(z12);
            return this;
        }

        @Deprecated
        public Options setAllowFp16PrecisionForFp32(boolean z12) {
            this.allowFp16PrecisionForFp32 = Boolean.valueOf(z12);
            return this;
        }
        ...
        public Options setUseNNAPI(boolean z12) {
            super.setUseNNAPI(z12);
            return this;
        }

        @Override // org.tensorflow.lite.InterpreterApi.Options
        public Options setUseXNNPACK(boolean z12) {
            super.setUseXNNPACK(z12);
            return this;
        }
    ...
    @Override // org.tensorflow.lite.InterpreterImpl, org.tensorflow.lite.InterpreterApi
    public /* bridge */ /* synthetic */ Tensor getInputTensor(int i12) {
        return super.getInputTensor(i12);
    }
    ...
    @Override // org.tensorflow.lite.InterpreterImpl, org.tensorflow.lite.InterpreterApi
    public /* bridge */ /* synthetic */ Tensor getOutputTensor(int i12) {
        return super.getOutputTensor(i12);
    }
    ...
    @Override // org.tensorflow.lite.InterpreterImpl, org.tensorflow.lite.InterpreterApi
    public /* bridge */ /* synthetic */ void resizeInput(int i12, int[] iArr) {
        super.resizeInput(i12, iArr);
    }
    ...
    @Override // org.tensorflow.lite.InterpreterImpl, org.tensorflow.lite.InterpreterApi
    public /* bridge */ /* synthetic */ void resizeInput(int i12, int[] iArr, boolean z12) {
        super.resizeInput(i12, iArr, z12);
    }
