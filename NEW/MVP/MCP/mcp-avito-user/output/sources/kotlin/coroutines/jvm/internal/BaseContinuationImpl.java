...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    @k
    public Continuation<G0> create(@k Continuation<?> completion) {
    ...
    @l
    public abstract Object invokeSuspend(@k Object result);

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlin.coroutines.Continuation
    public final void resumeWith(@k Object result) {
    ...
    @k
    public Continuation<G0> create(@l Object value, @k Continuation<?> completion) {
