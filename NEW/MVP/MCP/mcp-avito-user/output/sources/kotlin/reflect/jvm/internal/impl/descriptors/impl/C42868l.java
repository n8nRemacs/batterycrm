...
public class C42868l extends AbstractC42867k {

    /* renamed from: i, reason: collision with root package name */
    public final Modality f407676i;

    /* renamed from: j, reason: collision with root package name */
    public final ClassKind f407677j;

    /* renamed from: k, reason: collision with root package name */
    public final C42993s f407678k;

    /* renamed from: l, reason: collision with root package name */
    public kotlin.reflect.jvm.internal.impl.resolve.scopes.j f407679l;

    /* renamed from: m, reason: collision with root package name */
    public Set<InterfaceC42850c> f407680m;

    /* renamed from: n, reason: collision with root package name */
    public C42866j f407681n;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C42868l(@Y61.k InterfaceC42882k interfaceC42882k, @Y61.k kotlin.reflect.jvm.internal.impl.name.f fVar, @Y61.k Modality modality, @Y61.k ClassKind classKind, @Y61.k Collection collection, @Y61.k b0 b0Var, @Y61.k kotlin.reflect.jvm.internal.impl.storage.p pVar) {
        super(pVar, interfaceC42882k, fVar, b0Var);
        ...
        this.f407676i = modality;
        this.f407677j = classKind;
        this.f407678k = new C42993s(this, Collections.emptyList(), collection, pVar);
    }
    ...
    public final void F0(@Y61.k kotlin.reflect.jvm.internal.impl.resolve.scopes.j jVar, @Y61.k Set set, @Y61.l C42866j c42866j) {
        if (jVar == null) {
            U(7);
            throw null;
        }
    ...
    public final kotlin.reflect.jvm.internal.impl.resolve.scopes.j N(@Y61.k kotlin.reflect.jvm.internal.impl.types.checker.i iVar) {
        ...
        kotlin.reflect.jvm.internal.impl.resolve.scopes.j jVar = this.f407679l;
        if (jVar != null) {
            return jVar;
        }
        U(13);
    ...
    public final ClassKind getKind() {
        ClassKind classKind = this.f407677j;
        if (classKind != null) {
            return classKind;
        }
        U(15);
    ...
    public final Modality i() {
        Modality modality = this.f407676i;
        if (modality != null) {
            return modality;
        }
        U(16);
