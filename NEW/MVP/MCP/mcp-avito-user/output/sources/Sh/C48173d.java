...
public final class C48173d {
    ...
    public C48173d(@l String str, @k String str2, @k DeepLink deepLink) {
        this.style = str;
        this.title = str2;
        this.uri = deepLink;
    }
