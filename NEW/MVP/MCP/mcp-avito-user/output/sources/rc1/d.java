...
public final class d implements Callback {
    ...
    public final /* synthetic */ SafeContinuation f429913b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ l0.f f429914c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ l0.h f429915d;

    public d(SafeContinuation safeContinuation, l0.f fVar, l0.h hVar) {
        this.f429913b = safeContinuation;
        this.f429914c = fVar;
        this.f429915d = hVar;
    }
    ...
    public final void onFailure(Call call, IOException iOException) {
        SafeContinuation safeContinuation = this.f429913b;
        int i12 = this.f429914c.f406840b;
    ...
    public final void onResponse(Call call, Response response) throws IOException {
        ...
        l0.h hVar = this.f429915d;
        hVar.f406842b = response;
        int iCode = response.code();
        l0.f fVar = this.f429914c;
        fVar.f406840b = iCode;
        ...
        try {
            ...
            c11757a.getClass();
            bVar = c11757a.d(string, L51.a.a(C40659c.INSTANCE.serializer()));
        } catch (Throwable th4) {
            int i14 = Z.f406624c;
            bVar = new Z.b(th4);
        }
        ...
        if (z12 || bVar == null) {
            C40659c.class.toString();
        }
        if (bVar == null) {
            try {
                bVar2 = Dc1.c.f3297a.d(C40659c.class, string);
            } catch (Throwable th5) {
                int i15 = Z.f406624c;
                bVar2 = new Z.b(th5);
            }
