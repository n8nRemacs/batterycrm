...
public final class a implements Callback {
    ...
    public final /* synthetic */ SafeContinuation f10377b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ l0.f f10378c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ l0.h f10379d;

    public a(SafeContinuation safeContinuation, l0.f fVar, l0.h hVar) {
        this.f10377b = safeContinuation;
        this.f10378c = fVar;
        this.f10379d = hVar;
    }
    ...
    public final void onFailure(Call call, IOException iOException) {
        SafeContinuation safeContinuation = this.f10377b;
        int i12 = this.f10378c.f406840b;
    ...
    public final void onResponse(Call call, Response response) throws IOException {
        ...
        l0.h hVar = this.f10379d;
        hVar.f406842b = response;
        int iCode = response.code();
        l0.f fVar = this.f10378c;
        fVar.f406840b = iCode;
        ...
        try {
            ...
            c11757a.getClass();
            g.f18614l.getClass();
            bVar = c11757a.d(string, L51.a.a(e.f18612a));
        } catch (Throwable th4) {
            int i14 = Z.f406624c;
            bVar = new Z.b(th4);
        }
        ...
        if (bVar == null) {
            try {
                bVar2 = Dc1.c.f3297a.d(g.class, string);
            } catch (Throwable th5) {
                int i15 = Z.f406624c;
                bVar2 = new Z.b(th5);
            }
