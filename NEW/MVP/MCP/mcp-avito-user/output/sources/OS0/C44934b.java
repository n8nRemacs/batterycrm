...
@P
@s0
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Los0/b;", "Los0/g;", "_avito-discouraged_avito-libs_serp-core_impl"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* renamed from: os0.b, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C44934b extends g {
    public C44934b(@k ViewGroup viewGroup) {
    ...
    public final void a(int i12, @k String str, @l String str2, boolean z12) {
        ...
        TextView textView = (TextView) layoutInflater.inflate(R.layout.advert_details_geo_after_text_restyle, viewGroup, false);
    ...
    @Override // os0.g
    public final int g() {
        return R.layout.advert_details_geo_content_text_restyle;
    }
}
