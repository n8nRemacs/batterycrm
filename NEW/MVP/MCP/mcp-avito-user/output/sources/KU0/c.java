...
/* compiled from: InstantPlusFunction.kt */
@s0
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"LkU0/c;", "LcU0/a;", "date-time_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class c extends AbstractC27103a {

    /* renamed from: a, reason: collision with root package name */
    @k
    public final e f406291a;

    /* renamed from: b, reason: collision with root package name */
    @k
    public final String f406292b = "InstantPlus";
    ...
    public final com.avito.beduin.v2.engine.field.d c(@k z zVar, @k j jVar, @k m mVar) throws BeduinPropertyException {
        ...
        try {
            ...
            e eVar = this.f406291a;
            if (iOrdinal == 0) {
                dVar = (ST0.d) eVar.f14450b.Q(dVar2, j12);
            } else if (iOrdinal == 1) {
                dVar = (ST0.d) eVar.f14450b.D(dVar2, j12);
            } else if (iOrdinal == 2) {
                dVar = (ST0.d) eVar.f14450b.p(dVar2, j12);
            } else {
                if (iOrdinal != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                dVar = (ST0.d) eVar.f14450b.i(dVar2, j12);
            }
