...
public final class C40485b {
    ...
    public C40485b(@l String str, @l String str2, @l DeepLink deepLink, @l String str3) {
        this.actionType = str;
        this.title = str2;
        this.uri = deepLink;
        this.url = str3;
