...
final class C extends SuspendLambda implements Y41.p<kotlinx.coroutines.T, Continuation<? super kotlin.G0>, Object> {

    /* renamed from: q, reason: collision with root package name */
    public int f411116q;

    /* renamed from: r, reason: collision with root package name */
    public final /* synthetic */ InterfaceC43160i<Object> f411117r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C(InterfaceC43160i<Object> interfaceC43160i, Continuation<? super C> continuation) {
        super(2, continuation);
        this.f411117r = interfaceC43160i;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Y61.k
    public final Continuation<kotlin.G0> create(@Y61.l Object obj, @Y61.k Continuation<?> continuation) {
        return new C(this.f411117r, continuation);
    }
    ...
    public final Object invokeSuspend(@Y61.k Object obj) {
        ...
        int i12 = this.f411116q;
        if (i12 == 0) {
            C42729a0.b(obj);
            this.f411116q = 1;
            if (C43175k.i(this.f411117r, this) == coroutine_suspended) {
