...
public final class RedirectResponseException extends ResponseException {
    ...
    @Y61.k
    public final String f399054b;

    public RedirectResponseException(@Y61.k io.ktor.client.statement.d dVar, @Y61.k String str) {
        super(dVar, str);
        ...
        sb2.append(". Text: \"");
        this.f399054b = C22026a.c(sb2, str, '\"');
    }

    @Override // java.lang.Throwable
    @Y61.k
    public final String getMessage() {
        return this.f399054b;
    }
}
